...
/*  
        ...
        echo "Chat Console is downloading.  Please check your Downloads for {$buildinfo['apkPath']} and tap on the file to install it - you may need to <a href='http://www.androidcentral.com/allow-app-installs-unknown-sources'>Allow installation of applications from unknown sources</a>";
    } 
*/
    else {

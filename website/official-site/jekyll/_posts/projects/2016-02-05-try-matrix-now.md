...
To get started using Chat, pick a client and join [#matrix:matrix.org]. You can also check the [Chat Clients Chat][clients] to see more detail.
...
<table class='bigtable'>
  <tr>
    ...
    <td class='bigproject'>
      ...
      Weechat Chat protocol script written in python
      <br /><br />
  ...
  <tr>
    ...
    <td class='bigproject'>
      ...
      Nheko is a glossy native desktop app for Chat, based on Qt5.<br /><br />
...
|to find a client, choose from the above or browse the **[Chat Clients Chat][clients]**|to bridge to Chat from another platform, take a look at the **[list of bridges][bridges]**|to start developing on Chat using an SDK, check out our **[list of SDKs][sdks]**|to find a bot to use on Chat, look at the **[list of Bots][bots]**

# Let's go deeper

Chat is a whole ecosystem of matrix-enabled clients, servers, gateways, application services, bots, etc. If you'd like to learn more, this page aims to collect all known Chat projects. To add a new one (or update an existing one), you can submit a PR to the [matrix.org](https://github.com/matrix-org/matrix.org) project on github - the existing projects can be found [here](https://github.com/matrix-org/matrix.org/tree/master/jekyll/_posts/projects) - or just let us know in the #matrix:matrix.org room.

...
|Author|              Repo|Language|            Chat Room|         Maturity|
| :---:|             :---:|   :---:|                  :---:|            :---:|
...
&#10003; Group ('Channel') Chats  
&#10007; History  
&#10003; Typing notifications (Slack &#8594; Chat Only)  
&#10007; Read receipts  
&#10003; Text Messages  
&#10003; Formatted Text Content  
&#10003; Image Content  
...
IRC bridging is very frequently used with Chat. On matrix.org, many popular
...
|           Author|                              Repo|         Language|                                       Chat Room|         Maturity|
|            :---:|                             :---:|            :---:|                                             :---:|            :---:|
|[{{post.author}}]|[{{post.title}}]({{post.repo}})|{{post.language}}|[{{post.room}}](https://to.chat.dingshunyu.top/#/{{post.room}})|{{post.maturity}}|
...
&#10003; Presence (WhatsApp &#8594; Chat only)  
&#10003; Read Receipts (WhatsApp &#8594; Chat only)  
&#10003; Typing notifications (WhatsApp &#8594; Chat only)  
&#10003; Plain text  
&#10003; Formatted messages  
&#10003; Media/files  
&#10003; Replies  
...
Chat and a specified Email address.
...
This is a Chat bridge for Apple iMessage. Requires a Mac with a functional
...
&#10003; Skype to Chat direct text message  
&#10003; Chat to Skype direct text message  
&#10003; Skype to Chat direct image attachment message  
&#10003; Chat to Skype direct image attachment message  
&#10003; group messaging  
&#10007; read receipts  
...
|           Author|                              Repo|         Language|                                       Chat Room|         Maturity|
|            :---:|                             :---:|            :---:|                                             :---:|            :---:|
|[{{post.author}}]|[{{post.reponame}}]({{post.repo}})|{{post.language}}|[{{post.room}}](https://to.chat.dingshunyu.top/#/{{post.room}})|{{post.maturity}}|
...
[#telegram:maunium.net]: https://to.chat.dingshunyu.top/#/#telegram:maunium.net
...
[#irc:matrix.org]: https://to.chat.dingshunyu.top/#/#irc:matrix.org
...
[#mxasd-email:kamax.io]: https://to.chat.dingshunyu.top/#/#mxasd-email:kamax.io

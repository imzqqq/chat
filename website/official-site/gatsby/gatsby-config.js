...
module.exports = {
  ...
  siteMetadata: {
    title: `Chat.org`,
    description: `Blog for the Chat project`,
  ...
  plugins: [
    {
      ...
      options: {
        ...
        directives: {
          ...
          "frame-src": "'self' https://platform.twitter.com https://syndication.twitter.com https://www.youtube.com https://ghbtns.com https://duckduckgo.com https://eduvid.org",

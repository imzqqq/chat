...
const title = `Chat Live | ${config.siteTitle}`;
const MatrixLive = () => {
    ...
    return (<Layout titleOverride={title} navmode="discover"
        ...
        <MXContentMain>
            <Helmet title={title} />
            <h1 id="matrix-hosting">Chat Live</h1>
            <div className="mxgrid">
                <div className="mxgrid__item50">
                    <h2 id="modularim">Chat Live Video</h2>
                    <p>
                        <strong>
                    ...
                    <p>
                        <img src="/blog/img/2020-06-26-ml.png" alt="Chat Live" />
                    </p>
                    <p>
                        Every Friday we release a new episode of Chat Live,
                        talking about the status of Chat, happenings in the
                        ecosystem and more.
                    </p>
                    <p>
                        <strong>
                ...
                <div className="mxgrid__item50">
                    <h2 id="modularim">Chat Live Podcast</h2>
                    <p>
                        You will know Chat Live as a weekly video produced by the Chat team and shared on YouTube. We are now offering the same content as an audio-only podcast, as a way of reaching more people. You can find the podcast:
                    </p>
                    <ul>

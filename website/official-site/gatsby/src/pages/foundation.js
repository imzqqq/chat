...
const Foundation = () => {
    return (<Layout hasNavPadding="true" excerptOverride="The Foundation defines the manifesto, mission and values of the project, the open governance process that determines how the specification develops, and provides a safety-net to ensure the project stays independent and true to its goals.">
            <Helmet title={`The Chat.org Foundation | ${config.siteTitle}`} />
            <MXContentMain>
            <div className="mxblock mxblock--foundation">
          <h1 className="mxblock--foundation__hx">The Chat.org Foundation</h1>
          <h2>Introduction</h2>
          <p className="mxblock--foundation__p">
            The evolution of Chat is managed through an open governance process, looked after by The Chat.org
            Foundation - a non-profit UK Community Interest Company, incorporated to act as the neutral guardian of the
            standard on behalf of the whole Chat community.
          </p>
          <p className="mxblock--foundation__p">
            ...
            Association and Rules, and is enforced by the Guardians of Chat: the directors of the Foundation appointed
            to provide a balance of independent experts and the founding Chat team to ensure the project stays on
            track.
          </p>
          ...
          <p className="mxblock--foundation__p">
            ...
            of Chat. Guardians are typically independent of the commercial Chat ecosystem and may even not be
            members of today’s Chat community, but are deeply aligned with the mission of the project. Guardians are
              ...
              <div className="mxgrid__item__bg mxgrid__item__bg--clear mxgrid__item__bg--guardian">
                ...
                <div className="mxgrid__item--guardian__content">
                  ...
                  <p className="mxgrid__item--guardian__content__p">
                    ...
                    Electrical and Electronics Engineers. (He also supervised Matthew on building a pre-Chat instant
            ...
            <div className="mxgrid__item100">
              <div className="mxgrid__item__bg mxgrid__item__bg--clear mxgrid__item__bg--guardian mxgrid__item__bg--guardian--invert">
                ...
                <div className="mxgrid__item--guardian__content mxgrid__item--guardian__content--invert">
                  ...
                  <p className="mxgrid__item--guardian__content__p">
                    Matthew is technical co-founder of Chat, and CEO/CTO of New Vector - the company formed in 2017 to
                    let the core Chat dev team work on Chat full-time as their day job. He came up with the idea of
                    Chat with Amandine in 2013 while they were running Amdocs’ Unified Communication unit. He has a
            ...
            <div className="mxgrid__item100">
              <div className="mxgrid__item__bg mxgrid__item__bg--clear mxgrid__item__bg--guardian">
                ...
                <div className="mxgrid__item--guardian__content">
                  ...
                  <p className="mxgrid__item--guardian__content__p">
                    Amandine is co-founder of Chat, and COO of New Vector. She previously
                    ran the business side of Amdocs’ UC unit with Matthew. She has an engineering degree in Telecoms,
                    Electronics and Computer Science and uses it most to translate the technicalities of Chat to
              ...
              <div className="mxgrid__item__bg mxgrid__item__bg--clear mxgrid__item__bg--guardian mxgrid__item__bg--guardian--invert">
                ...
                <div className="mxgrid__item--guardian__content mxgrid__item--guardian__content--invert">
                  ...
                  <p className="mxgrid__item--guardian__content__p">
                    ...
                    non-developers in the Chat community to run his own homeserver. Ross has been known to walk around
                    Mozfest clutching a battery-powered Chat in a box, promoting decentralised communication for all.
                  </p>
                </div>
              </div>
            </div>
            <div className="mxgrid__item100">
              <div className="mxgrid__item__bg mxgrid__item__bg--clear mxgrid__item__bg--guardian">
                ...
                <div className="mxgrid__item--guardian__content">
                  ...
                  <p className="mxgrid__item--guardian__content__p">
                    Parity Technologies have been pioneering Chat enterprise use since the moment they decided to rely
                    on Chat for their internal and external communication back in 2016 and now run their own
                    high-volume deployment, with end-to-end encryption enabled by default. Jutta represents
                    organisations who are professionally dependent on Chat day-to-day, as well as bringing her unique
          ...
          <h2>Legal details</h2>
          <ul>
            <li>The Chat.org Foundation C.I.C is registered in the UK as Company #<a href=
            ...
            <li>The official articles of association of the Foundation may be
              downloaded <a href="/media/2019-06-10 - Chat.org Foundation CIC Articles of Association.pdf">here</a>.</li>
            <li>The official Rules for the Foundation may be downloaded <a href="/media/2019-06-10 - Chat.org Foundation CIC Rules.pdf">here</a>.</li>
            </ul>
            ...
            <p>The Rules were originally drafted through the open <a href=
              "https://matrix.org/docs/spec/proposals">Chat Specification Change</a> proposal process in order
              ...
              Open Governance of Chat.org</a> , providing a comprehensive overview of the whole governance
              process.</p>
          ...
          <h2>Mission</h2>
          <p>The Chat.org Foundation exists to act as a neutral custodian
            for Chat and to nurture it as efficiently as possible as a single
            unfragmented standard, for the greater benefit of the whole
            ecosystem, not benefiting or privileging any single player or
          subset of players.</p>
          <p>For clarity: the Chat ecosystem is defined as anyone who uses
          the Chat protocol. This includes (non-exhaustively):</p>
          <ul>
            <li>End-users of Chat clients.</li>
            <li>Chat client developers and testers.</li>
            <li>Spec developers.</li>
            <li>Server admins.</li>
            <li>Chat packagers & maintainers.</li>
            <li>Companies building products or services on Chat.</li>
            <li>Bridge developers.</li>
            <li>Bot developers.</li>
            <li>Widget developers.</li>
            <li>Server developers.</li>
            <li>Chat room and community moderators.</li>
            <li>End-users who are using Chat indirectly via bridges.</li>
            <li>External systems which are bridged into Chat.</li>
            <li>Anyone using Chat for data communications.</li>
          </ul>
          <p>"Greater benefit" is defined as maximising:</p>
          <ul>
            <li>the number of Chat-native end-users reachable on the open
            Chat network.</li>
            <li>the number of regular users on the Chat network (e.g. 30-day
            retained federated users).</li>
            <li>the number of online servers in the open federation.</li>
            <li>the number of developers building on Chat.</li>
            <li>the number of independent implementations which use
            Chat.</li>
            <li>the number of bridged end-users reachable on the open Chat
            network.</li>
            <li>the signal-to-noise ratio of the content on the open Chat
            ...
            <li>the quality and utility of the Chat spec (as defined by ease
          ...
          <p>N.B. that we consider success to be the growth of the open
            ...
            WhatsApp adopted Chat it wouldn’t be a complete win unless they
          openly federated with the rest of the Chat network.</p>

          <h2>Values</h2>
          <p>As Chat evolves, it's critical that the Spec Core Team and
          ...
          <p>The contents and direction of the Chat Spec is governed by the
            Spec Core Team; a set of experts from across the whole Chat
            community, representing all aspects of the Chat ecosystem. The
          Spec Core Team acts as a subcommittee of the Foundation.</p>
          <p>Members of the Spec Core Team pledge to act as a neutral
            custodian for Chat on behalf of the whole ecosystem and uphold
            the Guiding Principles of the project as outlined above. In
            particular, they agree to drive the adoption of Chat as a single

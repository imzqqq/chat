...
const TryMatrixNow = ({data}) => {
    ...
    return (<Layout navmode="discover">
        <MXContentMain>
            <Helmet title={`Try Chat Now | ${config.siteTitle}`}>
        ...
        <div className="mxblock">
          <div className="mxgrid mxgrid--discover">
            ...
            <div className="mxgrid_item33">
              <div className="mxgrid__item__bg mxgrid__item__bg--clear">
                <h4 className="mxgrid__item__bg__hx">
                    <a href="/docs/projects/client/weechat-matrix">Weechat/Chat</a></h4>
                <p className="mxgrid__item__bg__p"> If you like command line clients, try this Weechat Chat protocol script written in python </p>
            ...
            <div className="mxgrid_item33">
              <div className="mxgrid__item__bg mxgrid__item__bg--clear">
                ...
                <p className="mxgrid__item__bg__p">Nheko is a glossy native desktop app for Chat, based on Qt5.</p>

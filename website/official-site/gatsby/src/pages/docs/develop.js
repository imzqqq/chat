...
const GuidesDevelop = ({ data }) => {
  ...
  addArticleToGroup("Introduction", "Enter the Chat", "Brendan Abolivier", "https://brendan.abolivier.bzh/enter-the-matrix/");
  ...
  addArticleToGroup("Encryption", "An introduction to end-to-end encryption in Chat and Riot", "Hubert Chathi", "https://www.uhoreg.ca/blog/20170910-2110");
                  ...
                  {group.edges && group.edges.map(guide => {
                    return (
                      <tr key={guide.node.fields.slug}>
                        ...
                        <td>{guide.node.frontmatter.author ?? "Chat.org"}</td>

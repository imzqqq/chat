...
const example2 = `curl –XPOST –H 'Authorization: X-Chat origin=alice.com,...' –d '{
  "ts": 1413414391521,
  "origin": "alice.com",
  "destination": "bob.com",
  "pdus": [{
...
<a href="#about" className="mxblock__btn mxblock--hero__btn w-button">Get started</a>
                ...
                <div className="mxgrid__item50">
                    <div className="mxgrid__item__bg mxgrid__item__bg--imagine">
                        ...
                        <p className="mxp mxmatrixdescription">
                          Chat is an open source project
                          that publishes the <br /><a href="/docs/spec" onClick={()=>{window.location='https://matrix.org//docs/spec'; return false;}}>Chat open standard</a> for
                        ...
                        <p className="mxp mxmatrixdescription">  Maintained by the non-profit <a href="/foundation/">Chat.org Foundation</a>, we aim <br />
                          to create an open platform which is as
                          independent, vibrant and evolving
                          as the Web itself... but for communication.
                        </p>
                        <p className="mxp mxmatrixdescription">
                          As of June 2019, Chat is <Link to="/blog/2019/06/11/introducing-matrix-1-0-and-the-matrix-org-foundation">out of beta</Link>, and the protocol is fully suitable for production usage.
                        </p>
                    </div>
                </div>
            </div>
          <div className="mxgrid">
              ...
              <div className="mxgrid__item__bg">
                ...
                <div className="mxgrid__item__bg__vert">
                  <p className="mxgrid__item__bg__p">
                    Chat gives you simple <a href="/docs/spec/" onClick={()=>{window.location='https://matrix.org//docs/spec'; return false;}}>HTTP APIs</a> and <a
                  ...
                  <p className="mxgrid__item__bg__p">
                    ...
                    point of control or failure.  You can reach any other user in the global Chat ecosystem of over 40M
            ...
            <div className="mxgrid__item50">
              <div className="mxgrid__item__bg">
                ...
                <div className="mxgrid__item__bg__vert">
                  <p className="mxgrid__item__bg__p">
                    Chat provides state-of-the-art end-to-end-encryption via the <a
                  ...
                  <p className="mxgrid__item__bg__p">
                    Chat’s encryption is based on the <a
            ...
            <div className="mxgrid__item50">
              <div className="mxgrid__item__bg">
                ...
                <div className="mxgrid__item__bg__vert">
                  ...
                  <p className="mxgrid__item__bg__p">
                    Chat is the missing signalling layer for WebRTC. If you are building VoIP into your app, or want
                    to expose your existing VoIP app to a wider audience, building on Chat’s SDKs and bridges should
                    be a no-brainer.
                  </p>
                </div>
            ...
            <div className="mxgrid__item50">
              <div className="mxgrid__item__bg">
                ...
                <div className="mxgrid__item__bg__vert">
                  <p className="mxgrid__item__bg__p">
                    Chat owes its name to its ability to bridge existing platforms into a global open matrix of
                    communication. Bridges are core to Chat and designed to be as <a
                    href="https://github.com/matrix-org/matrix-appservice-bridge/blob/master/HOWTO.md">easy to write as
                    possible</a>, with
                    Chat providing the highest common denominator language to link the networks together.
                  </p>
                  <p className="mxgrid__item__bg__p">
                    The core Chat team maintains bridges to Slack, IRC, XMPP and Gitter, and meanwhile the wider
                    Chat community provides bridges for Telegram, Discord, WhatsApp, Facebook, Hangouts, Signal and
                    many more.
                  </p>
                </div>
            ...
            <div className="mxgrid__item100">
              <div className="mxgrid__item__bg">
                ...
                <div className="mxgrid__item__bg__vert">
                  <p className="mxgrid__item__bg__p">
                    Chat can handle any type of real-time data, not only messaging and VoIP.
                  </p>
                  <p className="mxgrid__item__bg__p">
                    By building bridges to as many IoT silos as possible, data can be securely published on the Chat
                    network. IoT solutions built on Chat are unified, rather than locked to specific vendors, and can
                    even publish or consume Chat data directly from devices
                  ...
                  <p className="mxgrid__item__bg__p">
                    ...
                    working together towards an open ecosystem. Chat can be the unifying layer for both communication
        ...
        <div className="mxblock">
          ...
          <p className="mxp mxhow">
            Chat is really a <b>decentralised conversation store</b> rather than a messaging protocol.  When you send a
            message in Chat, it is replicated over all the servers whose users are participating in a given
            conversation - similarly to how commits are replicated between Git repositories.  There is no single point
            of control or failure in a Chat conversation which spans multiple servers: the act of communication with
            someone elsewhere in Chat shares ownership of the conversation equally with them.  Even if your server
          ...
          <p className="mxp mxhow">
            ...
            their own server and participate in the wider Chat network.  This is how Chat democratises control over
            communication.
          </p>
          <p className="mxp mxhow">
            By default, Chat uses simple <a href="/docs/spec/client_server/latest.html#api-standards" onClick={()=>{window.location='https://matrix.org//docs/spec/client_server/latest.html#api-standards'; return false;}}>HTTPS+JSON APIs
            ...
            </a> or <a href="/blog/2019/03/12/breaking-the-100-bps-barrier-with-matrix-meshsim-coap-proxy">ultra-low-bandwidth Chat</a> via CoAP+Noise.
          </p>
 ...
 Here are three Chat homeservers, each with one client connected.
 <br/><br/>
 The clients are all participating in the same Chat room, which
...
<pre>{ example1 }</pre>
 ...
 the message history at this point - but Chat is designed to
...
<img src="images/basic_spread_text.svg" alt="" className="mxgrid__item__bg__img" />
          <div className="mxgrid__item__bg__vert">
            <h4 className="mxgrid__item__bg__hx mxgrid__item__bg__hx--open_standard"><a href="/docs/spec" onClick={()=>{window.location='https://matrix.org//docs/spec'; return false;}}>Open specification</a> of the Chat standard<br/><br/></h4>
          </div>
        </div>
      </div>
      <div className="mxgrid__item33 mxgrid__item33--bullet">
...
<img src="images/music_microphone_old.svg" alt="" className="mxgrid__item__bg__img" />
          <div className="mxgrid__item__bg__vert">
            <h4 className="mxgrid__item__bg__hx mxgrid__item__bg__hx--open_standard">WebRTC VoIP/Video calling using Chat signalling</h4>
          </div>
        </div>
      </div>
      <div className="mxgrid__item33 mxgrid__item33--bullet">
...
<img src="images/basic_heart.svg" alt="" className="mxgrid__item__bg__img" />
          <div className="mxgrid__item__bg__vert">
            <h4 className="mxgrid__item__bg__hx mxgrid__item__bg__hx--open_standard">Maintained by the non-profit <a href="/foundation/">Chat.org Foundation</a></h4>
          </div>
        </div>
      </div>
      <div className="mxgrid__item33 mxgrid__item33--bullet">
...
<a href="/blog/posts" className="mxgrid__item__bg__btn w-button">View all posts</a>
        ...
        <div className="mxblock">
          <h2 className="mxblock__hx">Explore Chat</h2>
...
<div className="mxblock__explore__item__p">Try Chat</div>
</a>
...
<a href="https://github.com/matrix-org/" className="mxgrid__item__bg__btn w-button">View all on GitHub</a>
            ...
            <div className="mxgrid__item50">
              <div className="mxgrid__item__bg">
                <h2 className="mxblock__hx">The Chat Foundation</h2>
                <div className="mxgrid__item__bg__vert">
                  <p className="mxp">Chat is managed through an open governance process, looked after by <a href="/foundation/">The Chat.org Foundation</a> - a non-profit UK Community Interest Company.<br /></p>
                  <p className="mxp">It acts as a neutral guardian of the Chat spec, nurturing and growing Chat for the benefit of the whole ecosystem.<br /></p>
                  <p className="mxp">The Guardians are the legal directors of the <a href="/foundation/">Foundation</a>, responsible for ensuring that it keeps on mission and neutrally protects the development of Chat.<br /></p>
                </div>
              </div>
            </div>
          </div>
  ...
  <div className="mxblock">
    <div className="mxgrid">
      ...
      <blockquote className="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">I have seen the future of distributed collaboration and it is Chat.   The .NET binding looks old, incomplete and I maintained.   If we get GSoC students this year, I’ll be happy to mentor, in the meantime I should probably contribute to it: <a href="https://t.co/nJY4iNHaLQ">https://t.co/nJY4iNHaLQ</a></p>&mdash; Miguel de Icaza (@migueldeicaza) <a href="https://twitter.com/migueldeicaza/status/1093148021980889088?ref_src=twsrc%5Etfw">February 6, 2019</a></blockquote>
      </div>
      </div>
      <div className="mxgrid__item50">
      ...
      <div className="mxcontent__main">
        <div className="mxblock mxblock--sponsors">
          <div className="mxgrid">
            <div className="mxgrid__item100">
              <div className="mxgrid__item__bg">
                <h2 className="mxblock__hx">Support Chat</h2>
                <p className="mxp">If you share our vision, or are building on top of Chat, please consider donating...</p>
                ...
                <p className="mxp">If you share our vision, or are building on top of Chat, please consider donating. See our current <a href="/supporters">Elliptic supporters</a>!</p>
              </div>
            </div>
          </div>
        </div>
...
<img src="images/upcloud.svg" alt="" className="mxgrid__sponsors__item__logo__img" />
                    ...
                    <div className="mxgrid__item__bg__vert">
                      <h4>UpCloud</h4>
                      <p className="mxgrid__sponsors__item__p">Chat.org is generously hosted by UpCloud! Host your homeserver via UpCloud and get a $25 credit.</p>

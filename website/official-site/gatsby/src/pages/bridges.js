...
["LinkedIn Messaging", "linkedin"],
  ...
  excerptOverride="Browse Chat bridging options">
    <MXContentMain>
      <Helmet title={title} />
      <h1 id="bridges">Bridges</h1>
      <div className="mxgrid">
        <div className="mxgrid__item50">
          <p>An important idea in Chat is <em>Interoperability</em>. This means that Chat is open to exchanging data and messages with other platforms using an <a href="https://matrix.org/docs/spec">Open Standard</a>. We refer to the connection to other platforms as <em>bridging</em>.</p>

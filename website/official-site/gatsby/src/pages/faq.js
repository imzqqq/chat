        ...
        <div className="mxcontent__main__doc">
          <div id="questions-wrapper">
            ...
            <div className="question">
              ...
              <p>
                Chat is an open standard for interoperable, decentralised,
              ...
              <p>
                Chat defines the standard, and provides open source reference
                implementations of Chat-compatible Servers,{" "}
              ...
              <div className="definition-list">
                <div className="definition-item definition-client">
                  ...
                  <p>
                    Users in Chat use one or more clients to communicate. This
                ...
                <div className="definition-item definition-clientsdk">
                  ...
                  <p>
                    ...
                    <a href="#how-do-i-matrix-enable-my-existing-app%3F">
                      How do I Chat-enable my existing app?
                    </a>
                  </p>
                </div>
            ...
            <div className="question">
              <h4 id="what-is-matrix's-mission%3F">
                ...
                What is Chat's Mission?
              </h4>
              <p>
                Chat’s initial goal is to fix the problem of fragmented IP
              ...
              <p>
                The longer term goal is for Chat to act as a generic HTTP
            ...
            <div className="question">
              <h4 id="why-are-you-called-matrix%3F">
                ...
                Why are you called Chat?
              </h4>
              <p>
                We are called Chat because we provide a structure in which all
                communication can be{" "}
                <a href="#definitions">matrixed together</a>.
              </p>
              <p>
                No, it’s nothing to do with the film (although you could go and
                build virtual worlds on top of Chat if you wanted 😎).
              </p>
              <div className="definition-list">
            ...
            <div className="question">
              ...
              <ul>
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      - defines how Chat compatible clients communicate with
                      Chat homeservers.
                    </li>
                    <li>
                      ...
                      - defines how Chat homeservers exchange messages and
                    ...
                    <li>
                      ...
                      - defines how to extend the functionality of Chat with
                ...
                <li>
                  The actual ecosystem and community of everyone running Chat
              ...
              <p>
                You can find the full list of Chat enabled projects at{" "}
            ...
            <div className="question">
              ...
              <p>
                ...
                with transparent open source implementations. For Chat to
            ...
            <div className="question">
              ...
              <p>
                Chat is an open standard, meaning that we have freely
                published the details for how to communicate{" "}
                <a href="#definitions">interoperably</a> using the Chat set of
                ...
                from interoperability with the rest of the Chat ecosystem. We
                also ensure the standard is not encumbered by any known patent
                licensing requirements.
              </p>
              <p>
                Chat is also open source, meaning that we have released the
            ...
            <div className="question">
              ...
              <p>
                Chat provides open federation - meaning that anyone on the
                internet can join into the Chat ecosystem by deploying their
                own server.
              </p>
              <div className="definition-list">
                <div className="definition-item definition-federation">
                  ...
                  <p>
                    ...
                    providers. For Chat, this means that data about rooms and
            ...
            <div className="question">
              ...
              <p>
                ...
                section for a more detailed look at how Chat compares to other
                projects.
              </p>
              <div className="definition-list">
                ...
                <div className="definition-item definition-xmpp">
                  ...
                  <p>
                    ...
                    on XML. We think of Chat and XMPP as being quite
                    different; at its core Chat can be thought of as an
            ...
            <div className="question">
              ...
              <p>
                ...
                provides a simple chatroom interface to Chat - letting the
                user interact with users and rooms anywhere within the Chat{" "}
            ...
            <div className="question">
              ...
              <ul>
                ...
                <li>
                  ...
                  Chat's architecture makes homeservers orders of magnitude
              ...
              <div className="definition-list">
                <div className="definition-item definition-synapse">
                  ...
                  <p>
                    Chat is a homeserver implemented in Python by the
                ...
                <div className="definition-item definition-thespec">
                  ...
                  <p>
                    The Chat Specification describes the interactions between
                    actors in the Chat ecosystem, including Server-Server and
                    Client-Server.{" "}
                ...
                <div className="definition-item definition-bridging">
                  ...
                  <p>
                    Bridging to Chat means that it's possible to read and
            ...
            <div className="question">
              <h4 id="how-do-i-create-a-link-to-a-matrix-room-or-user%3F">
                ...
                How do I create a link to a Chat room or user?
              </h4>
              <p>
            ...
            <div className="question">
              ...
              <ul>
                ...
                <li>
                  ...
                  glossy native desktop app for Chat, based on Qt5.
                </li>
                <li>
                ...
                <li>
                  ...
                  <a href="/docs/projects/client/weechat.html">
                    Chat plugin for Weechat
                  </a>
                </li>
                <li>
                  <a href="https://github.com/f0x52/neo">neo</a> is a Chat
                  React.js webclient
                </li>
                <li>
            ...
            <div className="question">
              ...
              <p>
                ...
                which integrate existing communication networks into Chat.
                This list is growing rapidly, and you can find bridges both
                written by the Chat core team and contributed by the wider
              ...
              <ul>
                <li>
                  ...
                  - a comprehensive Chat&lt;-&gt;IRC bridge
                </li>
                <li>
            ...
            <div className="question">
              ...
              <div className="definition-list">
                <div className="definition-item definition-homeserver">
                  ...
                  <p>
                    Each account in the Chat federation is associated with a
            ...
            <div className="question">
              ...
              <p>
                ...
                you'll want to use one of the Chat{" "}
              ...
              <p>
                ...
                expose it to the wider Chat ecosystem. See{" "}
                <a href="https://github.com/matrix-org/matrix-appservice-bridge/blob/master/HOWTO.md">
                  matrix-appservice-bridge HOWTO
                </a>{" "}
            ...
            <div className="question">
              <h4 id="how-can-i-write-a-client-on-matrix%3F">
                ...
                How can I write a client on Chat?
              </h4>
              <p>
                See the{" "}
                <a href="/docs/howtos/client-server.html">
            ...
            <div className="question">
              <h4 id="can-i-write-a-matrix-homeserver%3F">
                ...
                Can I write a Chat homeserver?
              </h4>
              <p>
                Yes. Chat is just a spec, and implementations of{" "}
                <a href="/docs/spec">the spec</a> are very welcome!
              </p>
              <p>
                <a href="https://github.com/matrix-org/synapse/">Chat</a> is
            ...
            <div className="question">
              <h4 id="how-do-i-join-the-global-matrix-federation%3F">
                ...
                How do I join the global Chat federation?
              </h4>
              <p>
                You can{" "}
                <a href="https://matrix.org/docs/projects/clients-matrix">
              ...
              <p>
                ...
                <a href="https://matrix.org/docs/guides/installing-synapse">
                  recommended guides for installing Chat.
                </a>
              </p>
              <div className="definition-list">
                <div className="definition-item definition-homeserver">
            ...
            <div className="question">
              <h4 id="what-ports-do-i-have-to-open-up-to-join-the-global-matrix-federation%3F">
                ...
                What ports do I have to open up to join the global Chat
                federation?
              </h4>
              <p>
                ...
                in the Chat docs for details.
              </p>
              <p>
                Client&lt;-&gt;Server traffic can talk directly to Chat via
                port 8448, but as by default Chat creates a self-signed TLS
                certificate this can cause problems for clients which can't
                easily trust self-signed certificates (e.g. most web browsers).
                Instead, you can proxy access to Chat's HTTP listener on port
                8008 via an existing HTTPS proxy with a valid certificate (e.g.
                an nginx listening on port 443), or you can point Chat at a
                valid X.509 signed TLS certificate. In future, Chat will
              ...
              <p>
                You can also put Chat entirely behind an existing TLS load
                balancer and not expose port 8448 at all. In this situation,
                Chat will need to be configured to share the same{" "}
                <em>public</em> TLS certificate as the load balancer (as Chat
            ...
            <div className="question">
              <h4 id="how-do-i-connect-my-homeserver-to-the-public-matrix-network%3F">
                ...
                How do I connect my homeserver to the public Chat network?
              </h4>
              <p>
                If you have a successfully running Chat instance and want to{" "}
            ...
            <div className="question">
              ...
              <p>
                ...
                Chat ID mappings. This won't be very useful right now, though,
                and we don't recommend it.
              </p>
              <p>
                If you want your server to participate in the global replicated
                Chat ID service then please get in touch with us. Meanwhile,
                we are looking at ways of decentralising the 'official' Chat
                identity service so that identity servers are 100% decentralised
                and can openly federate with each other.{" "}
                <strong>
                  N.B. that you can use Chat without ever using the identity
            ...
            <div className="question">
              ...
              <p>
                The Apache Licence is a permissive licence. We want the Chat
                ...
                protocol. In our opinion, any Chat-service only enhances the
                Chat ecosystem.
              </p>
              <div className="definition-list">
                <div className="definition-close">close</div>
            ...
            <div className="question">
              <h4 id="what-is-the-difference-between-matrix-and-irc%3F">
                ...
                What is the difference between Chat and IRC?
              </h4>
              <p>
                ...
                limitations that Chat seeks to improve on:
              </p>
              <ul>
                <li>Text only</li>
                <li>No history</li>
              ...
              <p>
                ...
                there already exist mature Chat&lt;-&gt;IRC bridges.{" "}
                <a href="https://github.com/matrix-org/matrix-appservice-irc/">
                  matrix-appservice-irc
                </a>
            ...
            <div className="question">
              <h4 id="what-is-the-difference-between-matrix-and-xmpp%3F">
                ...
                What is the difference between Chat and XMPP?
              </h4>
              <p>
                We think of Chat and <a href="#definitions">XMPP</a> as being
                quite different; at its core Chat can be thought of as an
                ...
                pubsub systems; each comes with different tradeoffs. Chat has
              ...
              <p>
                The whole area of XMPP vs Chat is quite subjective. Rather
              ...
              <div className="definition-list">
                ...
                <div className="definition-item definition-pubsub">
                  ...
                  <p>
                    ...
                    needing to know who the subscribers will be. For Chat,
            ...
            <div className="question">
              <h4 id="how-does-matrix-compare-with-something-like-trillian-or-pidgin%3F">
                ...
                How does Chat compare with something like Trillian or Pidgin?
              </h4>
              <p>
            ...
            <div className="question">
              <h4 id="can-i-use-matrix-without-installing-a-matrix-client%3F">
                ...
                Can I use Chat without installing a Chat client?
              </h4>
              <p>
                Yes! An ever increasing number of protocols are being{" "}
                <a href="#definitions">bridged</a> into Chat, so if you use
                something like IRC on Freenode you may well be indirectly
                benefiting from Chat, as others may be connected into the IRC
                channel via Chat.
              </p>
              <div className="definition-list">
                <div className="definition-item definition-bridging">
            ...
            <div className="question">
              ...
              <p>
                ...
                information for that user, and shares data with the wider Chat
            ...
            <div className="question">
              ...
              <p>
                Chat user IDs (MXID) are unique user IDs. They are in the
            ...
            <div className="question">
              ...
              <p>
                ...
                Chat ecosystem. However, without one clients will not be able
            ...
            <div className="question">
              <h4 id="how-does-matrix-actually-work-architecturally%3F">
                ...
                How does Chat actually work architecturally?
              </h4>
              <p>
                For an introduction to the Chat architecture, see{" "}
            ...
            <div className="question">
              ...
              <p>
                The Chat Specification describes and prescribes the
                interaction between{" "}
              ...
              <p>
                To contribute to the development of the Chat Specification,
                see{" "}
            ...
            <div className="question">
              ...
              <p>
                To contribute to the Chat Specification, first take a look at
                the{" "}
                <a href="/docs/spec">
            ...
            <div className="question">
              <h4 id="how-do-you-do-voip-calls-on-matrix%3F">
                ...
                How do you do VoIP calls on Chat?
              </h4>
              <p>
                Voice (and video) over Chat uses the WebRTC 1.0 standard to
                transfer call media (i.e. the actual voice and video traffic).
                Chat is used to signal the establishment and termination of
            ...
            <div className="question">
              ...
              <p>
                ...
                for setting up a TURN server with Chat.
              </p>
              <div className="definition-list">
                <div className="definition-close">close</div>
              </div>
            ...
            <div className="question">
              ...
              <p>
                ...
                Chat and let folks see the spec in the context of a codebase
            ...
            <div className="question">
              <h4 id="why-aren't-you-using-an-orm-layer-like-sqlalchemy-in-synapse%3F">
                ...
                Why aren't you using an ORM layer like SqlAlchemy in Chat?
              </h4>
              <p>
                Chat is <em>very</em> database dependent (as of Oct 2015;
            ...
            <div className="question">
              <h4 id="will-synapse-share-my-chat-data-with-other-servers-in-the-federation%3F">
                ...
                Will Chat share my chat data with other servers in the
                federation?
              </h4>
              <p>
                <a href="#definitions">Federation</a> in Chat means that data
            ...
            <div className="question">
              ...
              <p>
                Chat stores these snapshots approximately every 100 messages,
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>New Vector</td>
                  <td>
                    New Vector is a company formed to build Chat.org. It is a
                ...
                <tr>
                  <td>Postgres</td>
                  <td>
                    While Chat can be installed using Sqlite, Postgres is

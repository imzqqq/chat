...
const HallOfFame = () => {
    const hallOfFameEntries = [
        {
            ...
            description: 'Reported that Chat Static (used for view.matrix.org) was vulnerable to XSS via room names due to missing sanitization. Fixed in <a href="https://github.com/matrix-org/matrix-static/releases/tag/0.3.1">Chat Static 0.3.1</a>.',
            service: 'Chat Static'
        },
        {
            date: '2021-08-31',
        ...
        },
        {
            ...
            description: 'Discovered that an explicit assignment of power level 0 was misinterpreted as the default power level. Fixed in Chat v1.40.0.',
            service: 'Chat'
        },
        {
            date: '2021-05-21',
        ...
        },
        {
            ...
            service: 'Chat React SDK'
        },
        {
            date:'2021-01-18',
            who: 'Michaël Scherer',
            profile: 'https://github.com/mscherer/',
            description: 'IP blacklist bypass via transitional IPv6 addresses on dual-stack networks (<a href="https://github.com/matrix-org/synapse/security/advisories/GHSA-5wrh-4jwv-5w78">CVE-2021-21392</a>). Fixed in Chat 1.28.0.',
            service: "Chat"
        },
        {
            date: '2021-01-07',
        ...
        },
        {
            ...
            who: 'Michaël Scherer',
            profile: 'https://github.com/mscherer/',
            description: 'Denial of service attack via .well-known lookups (<a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-21274">CVE-2021-21274</a>). Fixed in Chat 1.25.0.',
            service: "Chat"
        },
        {
            date:'2020-11-17',
            who: 'Michaël Scherer',
            profile: 'https://github.com/mscherer/',
            description: 'IP blacklist bypass via redirects on some federation and push requests (<a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-21273">CVE-2021-21273</a>). Fixed in Chat 1.25.0.',
            service: "Chat"
        },
        {
            date:'2020-09-20',
            ...
            description: 'HTML injection in login fallback endpoints could be used for a Cross-site-scripting attack (<a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-26891">CVE-2020-26891</a>). Fixed in Chat 1.21.0.',
            service: "Chat"
        },
        {
            date:'2020-09-09',
        ...
        },
        {
            ...
            who: 'Denis Kasak',
            profile: 'https://github.com/dkasak',
            description: 'Invalid JSON could become part of the room state, acting as a denial of service vector (<a href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-26890">CVE-2020-26890</a>). Fixed in Chat 1.20.0. Disclosed 2020-11-23.',
            service: "Chat"
        },
        {
            date: '2020-07-02',
            ...
            description: 'A clickjacking vulnerability in the single-sign-on flow in Chat. Fixed in <a href="https://github.com/matrix-org/synapse/releases/tag/v1.15.2">Chat 1.15.2</a>.',
            service: 'Chat'
        },
        {
            date:'2020-06-18',
        ...
        },
        {
            ...
            description: "An open redirect vulnerability affecting single sign-on flows. Fixed in Chat 1.11.1",
            service: "Chat"
        },
        {
            date:'2019-05-02',
        ...
        },
        {
            ...
            who: 'Enguerran Gillier',
            profile: 'https://twitter.com/opnsec',
            description: "SSRF in the URL preview API, which did not blacklist access to 0.0.0.0/32 or ::/128 by default.  Fixed in Chat 0.99.3.1",
            service: "synapse"
        },
        {
            date:'2019-05-02',
            who: 'Enguerran Gillier',
            profile: 'https://twitter.com/opnsec',
            description: "Insecure pseudo-random number generator in synapse meant that an attacker might be able to predict random values.  Fixed in Chat 0.99.3.1",
            service: "synapse"
        },
        {
            date:'2019-05-02',
        ...
        },
        {
            ...
            description:"Identified a unpatched RCE vulnerability in Chat.org's public-facing Jenkins.  It transpired the vulnerability had been <a href='https://matrix.org/blog/2019/04/11/security-incident/'>exploited by an attacker</a>.",
    ...
    return (<Layout hasNavPadding="true">
        ...
        <div>
            ...
            <p>Chat.org greatly appreciates investigative work into security vulnerabilities carried out by well-intentioned, ethical security researchers. We follow the practice of <a href='https://en.wikipedia.org/wiki/Responsible_disclosure'>responsible disclosure</a> in order to best protect Chat’s user-base from the impact of security issues.  On our side, this means:</p>
            <ul>
            ...
            <p>If you have found a security vulnerability in Chat, we ask that you disclose it responsibly by emailing <a href='mailto:security@matrix.org'>security@matrix.org</a>.
            ...
            <p>The Chat.org Foundation does not ordinarily provide bug bounties, though organisations building on top of Chat may do so in future.</p>

  ...
  <div className="mxfooter">
    <div className="mxfooter__container">
      <div className="mxfooter__column">
        ...
        <a href="/docs/projects/try-matrix-now" className="mxfooter__link">Try Chat</a>
      ...
      <div className="mxfooter__column">
        ...
        <a href="/docs/guides/installing-synapse" className="mxfooter__link">Install Chat</a>
      ...
      <div className="mxfooter__column">
        ...
        <a href="/blog/category/this-week-in-matrix" className="mxfooter__link">This Week In Chat</a>
      ...
      <div className="mxfooter__column">
        ...
        <a href="/matrixlive/" className="mxfooter__link">Chat Live</a>
        <a href="/security-disclosure-policy/" className="mxfooter__link">Security Disclosure Policy</a>
        <a href="/legal/code-of-conduct/" className="mxfooter__link">Code of Conduct for Chat.org</a>
    ...
    <div className="mxfooter__container mxfooter__container--heel">
      ...
      <p className="mxfooter__text">© 2021 The Chat.org Foundation C.I.C.</p>
    </div>
  </div>

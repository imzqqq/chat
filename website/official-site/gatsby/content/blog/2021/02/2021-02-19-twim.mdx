---
date: '2021-02-19'
title: 'This Week in Chat 2021-02-19'
categories:
  - This Week in Chat
author: Ben Parsons
...
>
> * [MSC2312: Chat URI scheme proposal](https://github.com/matrix-org/matrix-doc/pull/2312) (merge)
>
> **New MSCs:**
>
...
> #### Spec Core Team
>
> The Spec Core Team has spent this week working on getting [MSC2312](https://github.com/matrix-org/matrix-doc/pull/2312) (Chat URI Scheme) over the line, which is really exciting! Otherwise the team has been reviewing [MSC2304](https://github.com/matrix-org/matrix-doc/pull/2304) (knocking).
>
> #### New Spec Platform
>
...
> Chat 1.27 is out, and you can [read all about it](https://matrix.org/blog/2021/02/18/synapse-1-27-0-released) on the Chat Blog! This is the version that powered FOSDEM, and we're super proud of it. Especially the much improved support for multiple social login providers, which debuted at FOSDEM and is now enabled on matrix.org.
>
...
>
> * To avoid unexpected breakage, we have not updated the  `latest` tag on Docker Hub for this release; if you want Chat 1.27, you'll need to specifically reference the `v1.27.0` tag.
>
> * Images for ARM64 (and an updated `latest` tag) will return with the next Chat release.
>
...
> New [chart](https://gitlab.com/ananace/charts) versions have been pushed for Element 1.7.21 and Chat 1.27.0.
>
...
[kilian](https://to.chat.dingshunyu.top/#/@kilian:kernkraftwerk.lol) offered:
...
>
> Join us in [#niochat:matrix.org](https://to.chat.dingshunyu.top/#/#niochat:matrix.org) for more details 😊
...
[Lukas Lihotzki](https://to.chat.dingshunyu.top/#/@lukas:lihotzki.de) said:
...
### matrix-docker-ansible-deploy: Chat workers
...
[Slavi](https://to.chat.dingshunyu.top/#/@slavi:devture.com) returned to say:
...
[tntclaus](https://to.chat.dingshunyu.top/#/@tntclaus:matrix.org) announced:

> Collection of *Ansible* modules to manage Chat Homeserver instance. Only tested with Chat but may (partially) work with the other Chat Homeserver implementations.
>
...
> _synadm_ is growing! Pull requests have been submitted, issues been raised, bugs fixed and quite some user community seems to have evolved around it as it’s regularily mentioned on [#synapse:matrix.org](https://to.chat.dingshunyu.top/#/#synapse:matrix.org)
>
...
> * Textual Error responses of Chat now showing in output
>
...
>
> I am also thinking about finding people who'd like to join the team, code new features and help maintain codebase, review PR's, get push access and so on. Spread the word! Join [#synadm:peek-a-boo.at](https://to.chat.dingshunyu.top/#/#synadm:peek-a-boo.at)!



## Chat in the News 📰

[Shine](https://to.chat.dingshunyu.top/#/@shiny:shine.horse) reported:

> Dunno if twim worthy? Proton mentioned Chat in https://protonmail.com/blog/whatsapp-alternatives/
...
> Oh, and maybe as a side note: Since Steam voice chat failed me one too many times now, I now use Nheko for voice chat, if I just play with one other player. It is more reliable and most people I play with do have a voip capable Chat client installed!

Using own product 😀 👍

[TR_SLimey](https://to.chat.dingshunyu.top/#/@tr_slimey:an-atom-in.space) said:

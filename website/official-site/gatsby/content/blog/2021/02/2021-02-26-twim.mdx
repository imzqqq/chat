---
date: '2021-02-26'
title: 'This Week in Chat 2021-02-26'
categories:
  - This Week in Chat
author: Ben Parsons
...
> Hey, it's Friday!
>
> We [released Chat 1.28 yesterday](https://matrix.org/blog/2021/02/25/synapse-1-28-0-released), with the bulk of effort going into stability improvements and bug fixes, and an emphasis on further improving social login.
>
> We're also working to more clearly communicate our prioritization of issues, starting with documenting our [triage and labeling process](https://github.com/matrix-org/synapse/issues/9460) for the core Chat repository on GitHub.
>
...
> Another week, another bump of the Kubernetes [chart](https://gitlab.com/ananace/charts) and [image](https://github.com/ananace/matrix-synapse) of Chat (to 1.28.0), still haven't had time to fix it to be image agnostic - the Chat team is just developing far too fast.
...
> We've added a "Chat via Chat" button next to the join button in a Gitter room so you can jump straight into Chat and start chatting that way. We've also added a Chat.to link in the chat header so you can switch off to your favorite Chat client at any time.
...
> Discussion: [#matrix-appservice-line:miscworks.net](https://to.chat.dingshunyu.top/#/#matrix-appservice-line:miscworks.net)
...
[aa13q](https://to.chat.dingshunyu.top/#/@aa13q:matrix.org) shared this video too!
...
[Nico (@deepbluev7:neko.dev)](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) sent a teaser image firest, then added:
...
### Watch The Chat, for Apple Watch

[Doug](https://to.chat.dingshunyu.top/#/@doug:micdrop.uk) told us:

> Hey TWIM. I'd like to present Watch The Chat, a matrix client for watchOS that I've been working on over the last few weeks. Currently can view rooms, receive new messages and react to them: 
...
Find the code: https://github.com/pixlwave/Watch-The-Chat
...
> [libQuotient 0.6.5](https://github.com/quotient-im/libQuotient/releases/tag/0.6.5) is out, featuring fixes in rich replies handling and the updated Chat URIs support, as per the latest iteration of [MSC2312](https://github.com/matrix-org/matrix-doc/pull/2312), enabling shorter, nicer Reddit-style URIs such as `matrix:r/thisweekinmatrix:matrix.org`.
...
>
> If you have any questions or want to get involved come say hi in [#opsdroid-general:matrix.org](https://to.chat.dingshunyu.top/#/#opsdroid-general:matrix.org), raise an issue on [GitHub](https://github.com/opsdroid/opsdroid) and checkout the [docs](https://docs.opsdroid.dev/en/stable/).



### Caridina, Crystal library for Chat

[erdnaxeli](https://to.chat.dingshunyu.top/#/@erdnaxeli:cervoi.se) said:

> [Caridina](https://github.com/erdnaxeli/caridina), a [Crystal](https://crystal-lang.org/) library for Chat, got some new releases, which bring it to v0.10.2. It now supports the last version of Crystal (0.36.1) and redacted events, which I discovered the hard way were making the lib crash. Internally a big part of the lib was rewritten using macros, which makes the code a lot clearer but the [API doc](https://erdnaxeli.github.io/caridina/Caridina/Events.html) too. Thanks to Ruma actually for giving me inspiration about implementing events using macros.
>
> Again, if you like Crystal and want to write some matrix bot, this library might interest you. Feel free to open issues about bugs or feature requests! There is now a room [#caridina:cervoi.se](https://to.chat.dingshunyu.top/#/#caridina:cervoi.se) to talk about it.
...
[ahq](https://to.chat.dingshunyu.top/#/@ahq:matrix.org) reported:

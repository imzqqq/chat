---
date: '2021-10-15'
title: 'This Week in Chat 2021-10-15'
categories:
  - This Week in Chat
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/j9iDq6gisCU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
>
> The pieces are starting to fall into place for the upcoming Chat 1.1 spec release!
>
...
>
> This is a concept that was used in the Spaces MSCs to allow servers and clients to denote a room as a Space vs. a typical Chat room (and set up their UI appropriately). Only the type for a Space has been specified so far, but there are many different applications room types could serve; for example profile rooms!
>
...
[chandi](https://to.chat.dingshunyu.top/#/@chandi:livingutopia.org) reported:
...
>
> Discussions: [#matrix-voip-bridging:kb1rd.net](https://to.chat.dingshunyu.top/#/#matrix-voip-bridging:kb1rd.net)
...
* More progress on the client side of threads, published [an MSC](https://github.com/matrix-org/matrix-doc/pull/3440) and started work on Chat support
...
> Hi folks! This week I took a bit of time out of my day to create a new widget for Chat. We have the concept of "Spanners" at Chat where one person wants to take control of a resource, and they will say "I am taking the spanner". This prevents other people (verbally at least) from trying to use the resource at the same time.
>
> For years we have been getting by with sending messages into Chat, but no more! For now anyone can use the Spanner widget to set up a similar system in their room.
>
...
[janshai](https://to.chat.dingshunyu.top/#/@janshai:beeper.com) reported:
...
[Andreas](https://to.chat.dingshunyu.top/#/@hingst:hingst.net) told us:

> Hi everyone! 
>
> We believe that having your own homeserver should be easy and require little technical knowledge. That's why we launched [Hingst](https://hingst.net), a privacy focused Chat hosting service which takes care of (almost) everything for you. 
>
...
> First annual Finnish Chat community meet is to be held 20.11 in Tampere, Finland. Infos and registration at https://mobilizon.be/events/5c9ce49d-83de-41d1-b824-8950293d3fd1
...
> Heads up for those in Berlin 🐻🇩🇪. You're welcome to join us Tuesday evening at 7:00 PM chatting about Chat development and hosting. We're going to meet in person at [c-base](https://www.c-base.org/). In compliance with the hackerspace's house rules this is a strict 2G event.
>
...
[Henri Carnot](https://to.chat.dingshunyu.top/#/@henri2h:carnot.cc) announced:

> Chat user guide [French]
>
> Hi !!
...
> ---
>
> This week's room is: [#chess2:matrix.org](https://to.chat.dingshunyu.top/#/#chess2:matrix.org)
>

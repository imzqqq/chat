---
date: '2021-10-22'
title: 'This Week in Chat 2021-10-22'
categories:
  - This Week in Chat
...
Julian Sparber from the Fractal team was here with us this week, to tell us about the Fractal Next initiative: a rewrite of the app that leverages new technology. You can talk to the Fractal community by joining their room at [#fractal:gnome.org](https://to.chat.dingshunyu.top/#/#fractal:gnome.org).

## Dept of *Status of Chat* 🌡️

### Sync v3

[kegan](https://to.chat.dingshunyu.top/#/@kegan:matrix.org) shared very exciting news:
...
> We [released Chat 1.45](https://matrix.org/blog/2021/10/20/synapse-1-45-1-released) this week!
>
...
>
> We're already much more confident working in Sydent, and hope to apply these lessons to Chat soon.
>
> (Well, one lesson that won't apply is that type hints are _especially_ valuable in codebases you don't touch as often... but we have no intention of slowing down on Chat any time soon!)
...
[Carl Schwan](https://to.chat.dingshunyu.top/#/@carl:kde.org) offered:
...
* Publish release 1.6.6 containing to.chat.dingshunyu.top display behavior improvements on timeline and other improvements made this week.
* Improve to.chat.dingshunyu.top redirection in timeline, pushing views instead of replacing current ones
* Improve settings UI
...
* Release candidate 1.3.4 has been prepared Wednesday and tested by the community during a testing session in the afternoon. It adds presence support for DM, and Android Auto support has been restored. You can find out more about the next testing session at [#element-community-testing:matrix.org](https://to.chat.dingshunyu.top/#/#element-community-testing:matrix.org)
...
>
> That thing called [time-to-matrix (binay name: ttm)](https://gitlab.com/etke.cc/ttm) it works like `time command-name` and sends results to matrix room. Yes, pretty simple. Now you can use it 😀
>
...
[Rick](https://to.chat.dingshunyu.top/#/@rxl881:vector.modular.im) reported:

> Element One is here! We’re giving TWIM a sneak preview of the new Chat hosting service from Element in advance of the official launch next week. Element One* is a consumer-focused hosting option which gives you an individual Chat account on our shiny new one.ems.host homeserver (with a matching Element Web at one.element.io). However, in addition to being a fast, snappy Chat account, it also comes with unlimited personal bridging to Whatsapp, Signal and Telegram thanks to mautrix-whatsapp/signal/telegram!
>
...
> Hello! What about having your Android & iOS customer reviews posted in a Chat room as soon they happen?
>
...
[Aine](https://to.chat.dingshunyu.top/#/@aine:etke.cc) offered:
...
>
> I'm too sad to add good jokes and brief descriptions, so just join the [#miounne:etke.cc](https://to.chat.dingshunyu.top/#/#miounne:etke.cc) room to find more
...
[Ben Cotton (he/him/his)](https://to.chat.dingshunyu.top/#/@funnelfiasco:matrix.org) told us:

> SeaGL (Seattle GNU/Linux Conference) will be held [online](https://seagl.org) November 5–6, powered by Chat. Join our free—as in freedom and tea—grassroots technical summit. No registration required! This year's theme is "on cloud nine", in recognition of our ninth year.
>
...
> ---
>
> This week's room is: [#weiqi:matrix.org](https://to.chat.dingshunyu.top/#/#weiqi:matrix.org) 
>

---
date: '2021-10-01'
title: 'This Week in Chat 2021-10-01'
categories:
  - This Week in Chat
author: Thib
...
This week in Chat, William tells us about the State Compressor he wrote during his internship to reduce the size of Chat's database, and so much more. William being a former intern of the backend team, who else than his mentor Brendan could lead the interview?
...
> Lots of work in preparation for Chat 1.44 which is due out next week. Notably, we've found a few small regressions in rc1, so expect another release candidate on Monday followed by a formal release on Tuesday or Wednesday.
>
...
* Threads
    * Working with the Chat team to work out what backend support will be required for threads
...
Useful to watch a security mailing-list from the comfort of a Chat room!

## Dept of Interesting Projects 🛰️

### Newgrounds MVS (Chat adVancement Server)

[mr_johnson22](https://to.chat.dingshunyu.top/#/@mr_johnson22:matrix.org) announced:

> An (unofficial) Chat server by and for the [Newgrounds](https://www.newgrounds.com) community.
> 
> This is a Chat server with membership restricted to [Newgrounds Supporters](https://www.newgrounds.com/supporter). Newgrounds is an independent arts & entertainment site that has been around for over 20 years, and I felt that its spirit of independence is a perfect match with the openness of Chat!
> 
> The most notable feature of the server is *comment rooms for Newgrounds submissions*. Unlike other content-sharing sites, Newgrounds submissions don't have comment sections, but _review_ sections, which let you post a single comment (and optional rating) for a submission. This encourages reviews to be focused on providing constructive feedback instead of being a place for off-topic discussions. With that said, open comment systems are nice too, so this Chat server provides it! Simply visit `#portal_view_SUBMISSION_ID:ngmvs.one` to view!
> 
...
[LorenDB](https://to.chat.dingshunyu.top/#/@lorendb:matrix.org) remembers us:

> if you need an excuse to contribute to Chat... It's Hacktoberfest! Get hacking!

---
date: '2021-03-19'
title: 'This Week in Chat 2021-03-19'
categories:
  - This Week in Chat
author: Ben Parsons
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/tVywI3XMm-A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
>
> I am surprised how Conduit went from a small hobby project to a very promising Chat server in just a year. Thank you all for accompanying me on this journey, I really appreciate it.
>
...
### Linux Plumbers Conference Chat / BBB RFQ

[David Mehren](https://to.chat.dingshunyu.top/#/@davebloggt:kif.rocks) reported:

> The Linux Foundation wants to use BigBlueButton and Chat for the Linux Plumbers Conference in 2021 and is looking for developers to implement various improvements to BBB and to integrate Chat as the in-meeting chat.
>
...
>
> * Optional support for [Sentry](https://sentry.io/) (error reporting). This is the same error reporting structure that Chat uses, so it should fit right in 🙂
>
...
>
> As always, if you have bugs or encounter problems with setup then please pop by [#media-repo:t2bot.io](https://to.chat.dingshunyu.top/#/#media-repo:t2bot.io)
...
> As I mentioned [last week](https://matrix.org/blog/2021/03/12/this-week-in-matrix-2021-03-12#synapse), we've been focusing on nailing down some inefficiencies in federation performance. Well, [Chat 1.30.0rc1 is out](https://github.com/matrix-org/synapse/releases/tag/v1.30.0rc1), and I'm very excited to share one result of that work:
...
>
> This improvement by [@clokep](https://github.com/clokep) builds on the [chain cover index](https://github.com/matrix-org/synapse/blob/v1.26.0/docs/auth_chain_difference_algorithm.md) that [@erikjohnston](https://github.com/erikjohnston) implemented in Chat 1.26.0 to speed up the calculation of auth chain differences during state resolution.
>
> Chat 1.30 will be released early next week.
>
...
[helge5](https://to.chat.dingshunyu.top/#/@helge5:matrix.org) announced:
...
*   Spaces
    ...
    *   We’ve almost finished the first implementation of the Space Summary API in Chat, so will start testing public space user flows next week!
...
Did you get involved with FOSDEM this year? If you hung out on Chat that weekend and had a great time, then maybe you bought a t-shirt? [Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) did, and he shared this photo!

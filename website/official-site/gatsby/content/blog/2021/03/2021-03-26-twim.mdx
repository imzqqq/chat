---
date: '2021-03-26'
title: 'This Week in Chat 2021-03-26'
categories:
  - This Week in Chat
...
Ben is away this week for some well-deserved holidays (don't worry, he'll be back next week), so I'm filling in for him so you don't miss out on your weekly dose of Chat-related news, let's do this!
...
It's demos week this week! Enjoy a selection of demos featuring: Spaces, low-bandwidth Chat, Hydrogen notifications and bridging DMs between Gitter and Chat!
...
> We're proud to announce that [Chat 1.30.0](https://matrix.org/blog/2021/03/22/synapse-1-30-0-released) was released on Monday.
>
...
>
> In other news, we've decided to try out GitHub Actions for automated testing of Chat and will report back in a few weeks. Our hope is that this makes our CI more amenable to iterative improvement and outside contributions.
>
> It's also worth flagging that the next release of Chat, due in early April, will be the last to support Python 3.5.
>
> See y'all next week!
...
> Finally did what I've been talking about for a while, and got the [Chat chart I'm doing](https://gitlab.com/ananace/charts) upgraded to the point where it won't require my own image any more, Version 2.0.0. (In fact, the chart will now deploy the upstream `matrixdotorg/synapse` image by default)
>
...
> And just updated my Kubernetes [image](https://github.com/ananace/matrix-synapse) and [Helm Chart](https://gitlab.com/ananace/charts) for Chat to the new 1.30.0 version - note that the image has been deprecated by now though, the chart is the new go-to way to get Chat on Kubernetes.

And then, following today's 1.30.1 Chat update:

> I've pushed [Helm Chart](https://gitlab.com/ananace/charts) updates for Chat 1.30.1 and Chat Media Repo 1.2.6



### matrix-docker-ansible-deploy

This [Ansible playbook](https://github.com/spantaleev/matrix-docker-ansible-deploy) is meant to easily let you run your own Chat homeserver.

[Slavi](https://to.chat.dingshunyu.top/#/@slavi:devture.com) told us:
...
>
> This is only useful to people who develop/build their own Chat client applications.
>
...
> We're working on [bridging DM conversations](https://gitlab.com/gitterHQ/webapp/-/merge_requests/2134) between Chat and Gitter. For our first iteration, you will be able to start a DM conversation with a Gitter user from Chat. In the next iteration, we will allow Gitter users to start a DM conversation with a Chat user.
>
> The following is a small taste of what it will look like and will also be included in the upcoming Chat live demo day.
...
If you want to know more about Hydrogen's new shiny notifications, check out this week's Chat live (at the top of this post)!
...
*   Spaces are now testable on [develop.element.io](https://develop.element.io) & matrix.org! Buyer beware: They’re in early beta, using unstable prefixes, so may break at any time. But you can test by enabling the Spaces labs flag while connecting to matrix.org or a Chat development build
*   If you’d also like access to a test build for Android, we’re working out a better way to deliver test builds, but in the meanwhile let us know in the new [spaces feedback room](https://to.chat.dingshunyu.top/#/#spaces-feedback:matrix.org)
*   There’s lots of rough edges, but we’re first focusing on polishing public spaces, and feedback is welcome in the [spaces feedback room](https://to.chat.dingshunyu.top/#/#spaces-feedback:matrix.org), or via GitHub issues
*   If you run an online community (using any platform), we’d love to talk to learn more about your general pains too, in you guessed it: the [spaces feedback room](https://to.chat.dingshunyu.top/#/#spaces-feedback:matrix.org)
*   Watch this week's Chat Live for a demo of the above!
...
> tencent qq. Talk to us on [#kazv:tusooa.xyz](https://to.chat.dingshunyu.top/#/#kazv:tusooa.xyz) .
>
> #### Updates
>
...
> Just pushed version 2.3.0 of the [Chat Ruby SDK](https://github.com/ananace/ruby-matrix-sdk), headline features include; Ruby 3.0 support (though might still be a few niggles in there, expect a 2.3.1 once it's been more tested), a complete redesign of the room data cache to improve memory usage and code quality, and general request additions that people were interested in.



### Guile-Deck

[a_v_p](https://to.chat.dingshunyu.top/#/@a_v_p:matrix.org) said:

> Hello everybody!  I released Guile-Deck 0.1.0, GNU Guile SDK for Chat network: https://lists.gnu.org/archive/html/guile-user/2021-03/msg00048.html
>
> This library allows to write Chat clients in Scheme Lisp.
...
[Asbjørn](https://to.chat.dingshunyu.top/#/@asbjorn:olli.ng) offered:
...
>
> * Move to.chat.dingshunyu.top link into login modal.
>
...
>
> Join our Chat room: [#cactus:cactus.chat](https://to.chat.dingshunyu.top/#/%23cactus:cactus.chat)



## Dept of Guides 🧭

### krazykirby99999's guide to creating Chat bots

[krazykirby99999](https://to.chat.dingshunyu.top/#/@krazykirby99999:matrix.org) shared with us their guide for creating simple Chat bots in Python: https://www.reddit.com/r/matrixdotorg/comments/mdqitp/how_to_create_a_matrix_bot/



## Final Thoughts 💭

[nikgraf](https://to.chat.dingshunyu.top/#/@nikgraf:matrix.org) reported:

> Hey everyone 👋 One year ago I started to explore combining CRDTs with end-to-end encryption (Chat's Olm/Megolm) to allow people to collaborate on the same documents/data. Couple months back I got a first prototype working and then evolved to a production ready app. Think of a simple Google Docs, but end-to-end encrypted and offline-first (iOS & Android for now).
>
...
This is not a project built directly on Chat, but I thought it was a very cool use of Chat's end-to-end encryption library, [olm](https://gitlab.matrix.org/matrix-org/olm)!

---
date: '2021-03-05'
title: 'This Week in Chat 2021-03-05'
categories:
  - This Week in Chat
author: Ben Parsons
...
Element announced [Element Home](https://element.io/blog/element-home/), a new way to get your own homeserver. Read more about it [on their blog](https://element.io/blog/element-home/), or watch Chat Live for a real demo.
...
>
> Huge thanks to wbamberg  for working hard on bringing the idea to a reality. The Chat foundation will continue maintenance of the platform and continue to make it even better for developers in the coming months.
>
...
> We've heard some feedback that Chat's release cadence—an RC every other week, with releases in between—can feel a bit overwhelming. In response, I'm going to try to write a little less about each RC and instead simply refer to the [1.29.0rc1 Release Notes](https://github.com/matrix-org/synapse/releases/tag/v1.29.0rc1) from yesterday.
>
> We'll shout a bit more when that matures into a formal release early next week. 🙂
>
> On non-release weeks I'll try to spend a little more time focusing on the behind-the-scenes aspects of developing Chat in our TWiM updates. If there's anything in particular you'd like hear about, let me know!
>
> Speaking of, we're experimenting with using GitHub Discussions for... discussions.
>
> We don't want to go full-on mailing list, but it might be nice to have a place to for slower, asynchronous conversations that don't quite fit into the more rapid pace of a typical Chat room.
>
...
>
> * [How Chat could be better](https://github.com/matrix-org/synapse/discussions/9554)
>
> Please do weigh in!
...
[karmanyaahm](https://to.chat.dingshunyu.top/#/@karmanyaah:malhotra.cc) offered:
...
>
> If anyone's running/testing this please join [#groupme-go-bridge:malhotra.cc](https://to.chat.dingshunyu.top/#/#groupme-go-bridge:malhotra.cc) to chat about it
>
...
> A PSA this time around. Please test this release and update as soon as you can when we go to release on Monday next week. We've included a change to correct how users are registered against the homeserver to comply with the spec (Chat accepts a /register call without a `type=m.login.application`, and versions 2.5.0 and below of the matrix-appservice-bridge sent these invalid requests). I'm hoping to eventually retire this behaviour from Chat, so the more people that upgrade the better!
>
> Also [this PR](https://github.com/matrix-org/synapse/pull/9548) is the Chat-side change to remove this behaviour. If your appservice implementation uses this behaviour, **please** chime in.
...
[TR_SLimey](https://to.chat.dingshunyu.top/#/@tr_slimey:an-atom-in.space) reported:
...
A fancy, customizable, keyboard-operable Chat chat client for encrypted and decentralized communication. Written in Qt/QML and Python, currently in alpha. https://github.com/mirukana/mirage

[miruka](https://to.chat.dingshunyu.top/#/@miruka:matrix.org) said:
...
[Marcus Schopen](https://to.chat.dingshunyu.top/#/@mschopen:uni-bielefeld.de) (the fellow with the [festive mugs](https://matrix.org/blog/2020/12/11/this-week-in-matrix-2020-12-11#dept-of-status-of-matrix-%EF%B8%8F)) reported:

> Together with Anthony Rhode from Element we have published the room [#matrix-admins-edu-german:matrix.org](https://to.chat.dingshunyu.top/#/#matrix-admins-edu-german:matrix.org) for Chat Admins at German-speaking educational institutions. Here we want to discuss topics about Chat in an academic context. The room is open to the public and everyone is very welcome.

How is it not `#matrix-admins-edu-deutsche:matrix.org`!? This is a welcome public room for the growing number of Chat Admins in Germany!
...
>
> Cactus Comments is a federated, web-embeddable comment system. And of course, we federate by building on Chat!
>
> On the frontend - your website - we embed a Chat client written in Elm that renders Chat rooms as comment sections. The client is designed to be especially easy to embed on static sites. Once you log in to the client, it will only communicate directly with your Chat server of choice.
>
> On the backend, an application service is used to create rooms on-demand and help with moderation. It is built with Python and is completely stateless. It does this by modelling all state in native Chat objects without any custom events!
>
...
>
> Join our matrix room: [#cactus:cactus.chat](https://to.chat.dingshunyu.top/#/#cactus:cactus.chat)
>
...
What a project! Let's see how we can integrate this with the Chat blog!

### Chat Queue Processor

[reivilibre](https://to.chat.dingshunyu.top/#/@reivilibre:librepush.net) reported:
...
>
> I decided to make [Chat Queue Processor](https://bics.ga/reivilibre/matrix_queue_proc).
>
...
[ahq](https://to.chat.dingshunyu.top/#/@ahq:matrix.org) said:

---
date: '2021-04-09'
title: 'This Week in Chat 2021-04-09'
categories:
  - This Week in Chat
author: Ben Parsons
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/bAaAmyP5_Z4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## Google Summer of Code - GSoC -- Final Call: put your seatbelts on!

From [Nico (@deepbluev7:neko.dev)](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev), who is assisting with GSoC admin this year:

> As already mentioned a few times, this year the Chat organization is taking part [in GSoC](https://summerofcode.withgoogle.com/) again. This is an amazing opportunity for students to take part in various Chat-related projects and helping those projects implement awesome new features. **Submission for this closes on April 13 this year (which is Monday on my clock)!** If you want to take part in GSoC as a student, submit your final proposals now! You can find some examples here: [http://matrix-org.github.io/gsoc](http://matrix-org.github.io/gsoc). If you want to submit your own ideas, please contact a potential mentor before that. If you have questions, please check out the [#gsoc:matrix.org room](https://to.chat.dingshunyu.top/#/#gsoc:matrix.org).
>
...
> **Merged MSCs:**
>
> * [MSC2312: Chat URI scheme proposal](https://github.com/matrix-org/matrix-doc/pull/2312)
>
...
>
> We released [Chat 1.31](https://matrix.org/blog/2021/04/06/synapse-1-31-0-released) on Tuesday. There are certainly nice things in it (read the release notes), but also, two days after that... WE FINALLY [REMOVED SUPPORT FOR PYTHON 3.5](https://github.com/matrix-org/synapse/pull/9766)!
>
...
>
> By the way: if you're looking to [contribute to Chat](https://github.com/matrix-org/synapse/blob/develop/CONTRIBUTING.md), now is a good time to start grepping for `3.5` or `xenial` or `stretch` and seeing what cobwebs turn up which can finally be swept away. 🕸🧹
>
...
I don't know specific change helped, but 1.31 is a noticable performance improvement for my Chat, so thanks team!

### Conduit

* Conduit: A Chat homeserver written in Rust https://conduit.rs
...
[zeratax](https://to.chat.dingshunyu.top/#/@zeratax:dmnd.sh) offered:
...
>
> and as always feel free to join [#matrix-registration:dmnd.sh](https://to.chat.dingshunyu.top/#/#matrix-registration:dmnd.sh)  for support or w/e else!
...
> Updated my Kubernetes [chart](https://gitlab.com/ananace/charts) - and [image](https://github.com/ananace/matrix-synapse), for those still using it - to the new Chat 1.31.0 release.
...
>
> For people often going to the TWIM room, we fixed "TWIM" now actually finding the [#thisweekinmatrix:matrix.org](https://to.chat.dingshunyu.top/#/#thisweekinmatrix:matrix.org) room. (We also fixed a lot of other small issues on the side, that are less interesting and hope we can tie a release soonish. :3)

Rather meta, that this fix relates so specifically to TWIM.

### NeoChat

[Tobias Fella](https://to.chat.dingshunyu.top/#/@tobiasfella:kde.org) offered:
...
*   If you have Spaces enabled in labs on the Web or Android come join us in the [Chat Test Space](https://to.chat.dingshunyu.top/#/#matrix-test-space:matrix.org)
*   And big thank you to everyone giving feedback in the [Spaces feedback room](https://to.chat.dingshunyu.top/#/#spaces-feedback:matrix.org), please keep it coming and as a reminder if you run a public community (on any platform) we’d love to chat to you to get closer to understand your problems and goals.
...
*   Behind the hoods, we are making lots of code cleanup and we are improving the Chat SDK API.

[elmussol](https://to.chat.dingshunyu.top/#/@elmussol:elsmussols.net) let us know that Element Android 1.1.3 is already available on F-droid. I love getting a new Element Android update!
...
### Guile-Deck: GNU Guile SDK for Chat

[a_v_p](https://to.chat.dingshunyu.top/#/@a_v_p:matrix.org) told us:

> I released Guile-Deck 0.2.0, a GNU Guile SDK for the Chat network: https://github.com/artyom-poptsov/guile-deck/releases/tag/v0.2.0
...
[Slavi](https://to.chat.dingshunyu.top/#/@slavi:devture.com) offered:
...
>
> * New configuration option: `loginEnabled` changes the login button to be a to.chat.dingshunyu.top link, if set to false (default is true).
>
> * New configuration option: `guestPostingEnabled` requires users to log in using their Chat account, if set to false (default is true).
...
Also, watch Chat Live! If you've already done so, watch it again.

---
date: '2021-04-16'
title: 'This Week in Chat 2021-04-16'
categories:
  - This Week in Chat
author: Ben Parsons
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/WP3HCbVAEzU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
> In addition to Homeservers, the Chat spec also describes Push Gateways and Identity Services, which augment our ability to send notifications or discover users via identifiers like email addresses.
>
> On the Chat Foundation side, we maintain production-grade reference implementations of these services:
>
> * Chat, a Homeserver
>
...
>
> We've also finally settled on quarterly objectives for the Chat team at Element, and the first thing we're focusing on is gaining a better understanding of how Chat uses memory. Specifically, we'd like to drive down the peak RAM associated with joining large, complex rooms like Chat HQ. We've already landed a [small speed up](https://github.com/matrix-org/synapse/pull/9825) to that effect, but expect more specific metrics in the future.
>
> Chat 1.32 is due out early next week, and we look forward to seeing you then.
...
[Mamie](https://to.chat.dingshunyu.top/#/@mamie:mamieserv.fr) said:
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration had been updated to 1.31.0 (1.31.0 available in branch `testing`)
>
...
> Hey hey folks, something I can finally talk about in the open is that Element now has a Teams bridge! After months of being isolated on a desert island being fed nothing but rice crackers and diet pepsi, I can talk about our newest bridge. It's fairly feature packed with support for all the usual formatting options, plus Jitsi widget bridging (as links) and full puppeting including DMs. Matthew even went and nattered to [The Register](https://www.theregister.com/2021/04/14/matrix_teams/) about it. So you heard it here first, no network is truly safe from the open federation and we hope to welcome teams users into the Chat. The bridge is currently a closed source offering under the EMS banner for now.
>
> You can read about it in https://element.io/blog/ems-launches-bridging-for-microsoft-teams/

[David Mehren](https://to.chat.dingshunyu.top/#/@davebloggt:kif.rocks) added:
...
> Incidentally, would you like <del>access to the teams code</del> to work on lots of bridges and make things happen? [Please reach out](https://apply.workable.com/elementio/j/B43AA3DDA6/)!
...
>
> Have questions/ideas/mad-experiments, come chat to us in [Chat Github Bridge](https://to.chat.dingshunyu.top/#/#github-bridge:half-shot.uk).
...
>   * Start a chat with the bridge bot and buy a phone number via Chat
>
...
>
> Check it out on [GitHub](https://github.com/KB1RD/matrix-pstn-bridge) and join [#matrix-pstn-bridge:kb1rd.net](https://to.chat.dingshunyu.top/#/#matrix-pstn-bridge:kb1rd.net).
...
**Delight**
- On Spaces, we’ve been doing first implementations of [MSC3083](https://github.com/matrix-org/matrix-doc/pull/3083) (Restricting room membership based on space membership) on Android & Chat.
...
[jplatte](https://to.chat.dingshunyu.top/#/@jplatte:flipdot.org) announced:
...
>   * [lookup for hashing identifiers, lookup for Chat user IDs by 3pids](https://github.com/ruma/ruma/pull/489)
>

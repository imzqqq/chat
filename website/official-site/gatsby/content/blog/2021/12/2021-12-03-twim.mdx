---
date: '2021-12-03'
title: 'This Week in Chat 2021-12-03'
categories:
  - This Week in Chat
author: Thib
...
One thing you might not know is that TWIM bot is a space traveler, sent by the Chat scientists to explore that zone called "The Possibilities". The [#twim:matrix.org](https://to.chat.dingshunyu.top/#/#twim:matrix.org) room is a portal to its energy tank, and we had received a distress signal!

To help the TWIM explorer fulfil its mission, we asked the Chat community to fuel it with news before it crashed into space debris made of aggregated ignorance!

This week again, the community has been very active and explored many possibilities of the Chat universe!

## Chat Live 🎙

<iframe width="560" height="315" src="https://www.youtube.com/embed/RHaXIHiRlHQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

For this week's Chat Live my guest is Amandine and we're discussing how Element and 50 other organisations are trying to shape the future of EU's law for more interoperability. Bonus point: we have a double bridge demo with Chat, Slack and Telegram!

## Dept of *Status of Chat* 🌡️

### FOSDEM!

This year, the Chat Foundation is excited to host the first ever Chat Foundation and Community devroom at FOSDEM. A full day of talks, demos and workshops around Chat itself and projects built on top of Chat. [Read (and answer to) our Call for Partipactions](https://matrix.org/blog/2021/12/02/call-for-participation-for-the-fosdem-2022-matrix-dev-room)!

### Finnish Admins to the Rescue

[cos](https://to.chat.dingshunyu.top/#/@cos:hacklab.fi) says

> A group of Finnish Chat admins have set up a free homeserver for Finnish public called pikaviestin.fi (literally instant messenger dot fi). It offers a bunch of bridges and registration requires an e-mail address in one of Finnish e-mail providers or organizations. We welcome all Finns to register there and help decentralize Chat. Support room can be found at [#aula:pikaviestin.fi](https://to.chat.dingshunyu.top/#/#aula:pikaviestin.fi)

That's a fantastic initiative! Kudos to all the sysadmins involved!

## Dept of Spec 📜

[anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz) reports
...
> 
> And finally, Alexandre Franke has [PR'd some work](https://github.com/matrix-org/matrix-doc/pull/3542) to allow for matrix.org's OpenAPI spec to be widely available, meaning anyone with a [Swagger](https://swagger.io/) (or other [OpenAPI](https://www.openapis.org/) viewer) client can easily pull it and start sending requests against a Chat homeserver. Fun times!
> 
...
### Chat [↗](https://github.com/matrix-org/synapse/)

Chat is the reference homeserver for Chat

[callahad](https://to.chat.dingshunyu.top/#/@callahad:matrix.org) says

> Goooood evening TWIM readers!
> 
> I want to start by drawing attention to a blog post which we published today: [Type coverage for Sydent: motivation](https://matrix.org/blog/2021/12/03/type-coverage-for-sydent-motivation). This the first in a series of three articles discussing what we've learned from making Sydent pass the [mypy](https://mypy.readthedocs.io/) type checker in strict mode. Improving type coverage across Chat, Sygnal, and Sydent has been a major focus of the backend team at Element for the past few months, and we think we've learned a few useful things in the process.
> 
> This week we also [released Chat 1.48](https://matrix.org/blog/2021/11/30/synapse-1-48-0-released) with loads of internal improvements, new Admin APIs, better alignment with the Chat 1.1 spec, and more. We're planning one more release for the year, 1.49 on December 14th, and then we're taking a break until Chat 1.50 on January 11th.
> 
> Importantly: Chat 1.49 will be the last release to support Python 3.6, PostrgreSQL 9.6, and Ubuntu 18.04 LTS (Bionic) — if you're reliant on any of these platforms, please ensure you have plans to upgrade.
> 
> Let us know what you think of the article (and the Chat release!), and we'll see you next week!

### Sydent [↗](https://github.com/matrix-org/sydent)

Sydent is the reference Chat Identity server. It provides a lookup service, so that you can find a Chat user via their email address or phone number (if they have chosen to share it).

[dmr](https://to.chat.dingshunyu.top/#/@dmrobertson:matrix.org) reports
...
Chat Kubernetes applications packaged into helm charts

[Ananace](https://to.chat.dingshunyu.top/#/@ace:kittenface.studio) says
...
[qg](https://to.chat.dingshunyu.top/#/@qg:supercable.onl) announces
...
> We still have no support for the spaces summary API though so we don't have yet the ability to discover new rooms inside of a space but this feature might land soon in the Chat Dart SDK.
> 
> ### Multi Account
> FluffyChats multi account is still in beta but got a lot of bug fixes as well. You are now able to sort your accounts in "bundles" which can be very handy. The new account switcher button gives you a much better overview over your connected Chat accounts now.
> 
> ### Performance
> We did a lot refactoring under the hood in our Chat Dart SDK and have improved our in-app database a lot. On the web it now uses IndexedDB natively while it tunes all database transactions on all platforms. This leads to the fastest FluffyChat experience we ever had and makes the app finally kinda usable with bigger accounts on all platforms. The room list is now lazy loaded which speeds up the app start (especially with multi account enabled) a lot.
...
> * Native video calls -> Yes! There will soon land support for native video calls in the Chat Dart SDK and we are going to implement this in FluffyChat.
...
> 
> * Join the FluffyChat community: https://to.chat.dingshunyu.top/#/#fluffychat:matrix.org
> * Report bugs at our issue tracker: https://gitlab.com/famedly/fluffychat/-/issues
> * Help with the translations and join our translators team: https://to.chat.dingshunyu.top/#/#fluffychat-translation:matrix.org
> * Help with development directly in GitLab <3
> * ... or support us on Liberapay so we can organize more FluffyChat developer meetings: https://to.chat.dingshunyu.top/#/#fluffychat-translation:matrix.org
> 
...
[kittykat](https://to.chat.dingshunyu.top/#/@kittykat:matrix.org) says
...
> * For information about upcoming sessions and to join in, join [#element-community-testing:matrix.org](https://to.chat.dingshunyu.top/#/#element-community-testing:matrix.org)
> ![](/blog/img/ATkwyyLlzZVvjmTSeDjxCAaN.png)

### Element Web/Desktop [↗](https://github.com/vector-im/element-web)

Secure and independent communication, connected via Chat. Come talk with us in [#element-web:matrix.org](https://to.chat.dingshunyu.top/#/#element-web:matrix.org)!

[kittykat](https://to.chat.dingshunyu.top/#/@kittykat:matrix.org) announces
...
Secure and independent communication for iOS, connected via Chat. Come talk with us in [#element-ios:matrix.org](https://to.chat.dingshunyu.top/#/#element-ios:matrix.org)!
...
Secure and independent communication for Android, connected via Chat. Come talk with us in [#element-android:matrix.org](https://to.chat.dingshunyu.top/#/#element-android:matrix.org)!
...
Multiplatform Kotlin SDK for Chat

[Benedict](https://to.chat.dingshunyu.top/#/@benedict:imbitbu.de) says

> [Trixnity](https://gitlab.com/benkuly/trixnity), a multiplatform Chat SDK written in Kotlin, has grown up since the last release 6 month ago! It has it first release candidate for v1.0.0!
> 
...
simplematrixbotlib is an easy to use bot library for the Chat ecosystem written in Python and based on matrix-nio.

[krazykirby99999](https://to.chat.dingshunyu.top/#/@krazykirby99999:matrix.org) reports
...
> https://to.chat.dingshunyu.top/#/#simplematrixbotlib:matrix.org

## Dept of Videos 📹

[andybalaam](https://to.chat.dingshunyu.top/#/@andybalaam:matrix.org) announces

> I'm exploring the matrix-rust-sdk on my live stream every week. I'm working on a simple Rust bot for Chat. Come watch me struggle with the compiler on [Tube](https://diode.zone/c/andybalaam_programming/videos) or [Twitch](https://www.twitch.tv/andybalaam) every wednesday at 14:00 UTC!

## Room of the Week 📆

[Timo ⚡️](https://to.chat.dingshunyu.top/#/@timokoesters:fachschaften.org) says
...
> ---
> 
> This week's room is: [#audiophiles:matrix.org](https://to.chat.dingshunyu.top/#/#audiophiles:matrix.org) 
> 
> **"Headphones, Speakers, IEM and any audio related equipments. Music recommendations as well."**
> 
> ---
> 
> If you want to suggest a room for this section, tell me in [#roomoftheweek:fachschaften.org](https://to.chat.dingshunyu.top/#/#roomoftheweek:fachschaften.org)
...
See you next week, and be sure to stop by [#twim:matrix.org](https://to.chat.dingshunyu.top/#/#twim:matrix.org) with your updates!

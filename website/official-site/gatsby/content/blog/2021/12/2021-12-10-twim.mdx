---
date: '2021-12-10'
title: 'This Week in Chat 2021-12-10'
categories:
  - This Week in Chat
author: Thib
...
Last week the Chat Scientists had turned this room into a portal to TWIM bot's ship tank so we could all fuel it with news about our work. The spec and hookshot news were reported late when the tank was already full, sending TWIM bot's ship into hyperspeed mode 🚀
...
The Editor has asked the Chat Scientists to reconfigure the room and bridge it to TWIM bot's navigation tools. Each news report highlighted the position of a piece of engine on its map. 🗺️
...
> This week we cut Chat release candidate [1.49.0rc1](https://github.com/matrix-org/synapse/releases/tag/v1.49.0rc1) It includes a bunch of work to supporta plethora of MSCs ([MSC 2675](https://github.com/matrix-org/matrix-doc/pull/2675/), [MSC3030](https://github.com/matrix-org/matrix-doc/pull/3030), [MSC2918](https://github.com/matrix-org/matrix-doc/blob/main/proposals/2918-refreshtokens.md#msc2918-refresh-tokens), [MSC2946](https://github.com/matrix-org/matrix-doc/pull/2946)), a crop of bugfixes and improvements to our documentation which incorporate Chat's old wiki. And as ever, there's a bunch of internal type hinting to keep the Chat team's blood pressure at healthy levels.
> 
> The formal release of Chat 1.49.0 is scheduled for the coming Tuesday. This will be the last Chat release of 2021 as the Chat team prepare for a break over the Christmas period. Releases will continue at the usual pace in the new year, with 1.50.0rc1 slated for 2022/01/04 and 1.50.0 for 2022/01/11.
> 
> **Please note:** Chat 1.49 will be the last version to support Python 3.6, PostrgreSQL 9.6, and Ubuntu 18.04 LTS (Bionic): by our next release, these will have reached their upstream end-of-life. If you're reliant on any of these platforms, please ensure you have plans to upgrade.
> 
...
[Ananace](https://to.chat.dingshunyu.top/#/@ace:kittenface.studio) reports
...
[Tobias Fella](https://to.chat.dingshunyu.top/#/@tobiasfella:kde.org) announces
...
[Danielle Kirkwood](https://to.chat.dingshunyu.top/#/@daniellekirkwood:one.ems.host) announces
...
> * Join us! We’re at [#element-community-testing:matrix.org](https://to.chat.dingshunyu.top/#/#element-community-testing:matrix.org)
...
[Danielle Kirkwood](https://to.chat.dingshunyu.top/#/@daniellekirkwood:one.ems.host) reports
...
[erlend_sh](https://to.chat.dingshunyu.top/#/@erlend_sh:matrix.org) says
...
> TWIM I wrote a Chat powered stream overlay for OBS, to integrate live chat in your favorite (selfhosted) streaming setups. Was a great little 2 evening project to develop while livestreaming it's development :)
> 
...
[brevilo](https://to.chat.dingshunyu.top/#/@brevilo:matrix.org) announces
...
> We previewed yet more native Chat VoIP conferencing at CommCon: https://www.youtube.com/watch?v=A4k7DVIK5TE&list=PLvNS4EBAxmJJbvGW-PfXdXOSy9AjHjCLV
...
[Henri](https://to.chat.dingshunyu.top/#/@hp:hq.wily.im) says

> Wily Messenger Chat client
> 
> Wily has launched an iOS Chat client to enable messaging in restricted- or poor networks. mText and Room events are transferred as DNS payload, thus bypassing most captive portals, while message headers are minimized to enable messaging in very low bandwidth/high latency networks.
> 
...
[TravisR](https://to.chat.dingshunyu.top/#/@travis:t2l.io) says

> We've set up a new Element Space for the Element family of clients and projects, finally. Feel free to join it at [#community:element.io](https://to.chat.dingshunyu.top/#/#community:element.io) and be sure to check out  [#community:matrix.org](https://to.chat.dingshunyu.top/#/#community:matrix.org) while you're there for everything Chat related. 
> 
> There's also [#element-translators:matrix.org](https://to.chat.dingshunyu.top/#/#element-translators:matrix.org) for the Element Translators community out there.

...
[Sydent](https://github.com/matrix-org/sydent) is the reference Chat Identity server. It provides a [lookup service](https://matrix.org/docs/spec/identity_service/r0.3.0), so that you can find a Chat user via their email address or phone number (if they've chosen to share it).

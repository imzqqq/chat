---
date: '2021-12-17'
title: 'This Week in Chat 2021-12-17'
categories:
  - This Week in Chat
author: Thib
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Hsyqa5ozWIo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

A supercharged episode this week with five super exciting demos!

## Dept of Spec 📜

[TravisR](https://to.chat.dingshunyu.top/#/@travis:t2l.io) reports
...
> 
> We're also gearing up for [MSC1767 - Extensible event types & fallback in Chat](https://github.com/matrix-org/matrix-doc/pull/1767) receiving attention early next year. This is currently being evaluated by features like [MSC3245 - Voice messages](https://github.com/matrix-org/matrix-doc/pull/3245), [MSC3381 - Polls](https://github.com/matrix-org/matrix-doc/pull/3381), and [MSC3488 - Static location sharing](https://github.com/matrix-org/matrix-doc/pull/3488). If all goes according to plan, the first pieces of Extensible Events will land soon.
> 
> Thib has caught me quite close to the deadline on TWIM, so while I don't have a random MSC for you this week I do recommend some light reading around aggregations and extensible events - these are both major features for Chat and help shape the future for other, even more exciting, features.

[Nico](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) announces
...
[callahad](https://to.chat.dingshunyu.top/#/@callahad:matrix.org) reports

> Happy holidays! This week we [released Chat 1.49.0](https://matrix.org/blog/2021/12/14/synapse-1-49-0-released), our last planned release of the year. This is the last release that supports Python 3.6 or PostgreSQL 9.6; if you've not upgraded, now is the time!
> 
...
> 
> See you in January with Chat 1.50! 🎄
...
[dmr](https://to.chat.dingshunyu.top/#/@dmrobertson:matrix.org) announces
...
[Ananace](https://to.chat.dingshunyu.top/#/@ace:kittenface.studio) announces
...
[Nico](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) reports
...
> * Gathering feedback to incorporate into the next phase of development, join us for the community testing session on Monday at 17:00 in [#element-community-testing:matrix.org](https://to.chat.dingshunyu.top/#/#element-community-testing:matrix.org)
> 
> ### VoIP
> 
...
> * Next sessions, join [#element-community-testing:matrix.org](https://to.chat.dingshunyu.top/#/#element-community-testing:matrix.org) :
...
[kittykat](https://to.chat.dingshunyu.top/#/@kittykat:matrix.org) reports
...
Cinny is a Chat client focused on simplicity, elegance and security

[ajbura](https://to.chat.dingshunyu.top/#/@ajbura:matrix.org) says
...
> 
> ### Security update
> * Chat-js-sdk to v15.2.1
> * Olm to v3.2.8
> This release include [security release of libolm and matix-js-sdk](https://matrix.org/blog/2021/12/13/disclosure-buffer-overflow-in-libolm-and-matrix-js-sdk), so down-streamers please update ASAP.
> 
> Find more about Cinny at https://cinny.in/
> Join our channel at: [#cinny:matrix.org](https://to.chat.dingshunyu.top/#/#cinny:matrix.org)
...
### Chat Highlight [↗](https://github.com/DanilaFe/matrix-highlight)

A decentralized and federated way of annotating the web based on Chat.

[Daniel](https://to.chat.dingshunyu.top/#/@daniel:matrix.danilafe.com) announces
...
> * **Current**: Create and send website annotations over Chat.
...
> * **Planned**: Use Chat's End-to-End encryption to ensure the secure transmission and storage of highlight data.
...
> 
> Come join [#matrix-highlight:matrix.danilafe](https://to.chat.dingshunyu.top/#/#matrix-highlight:matrix.danilafe).com to receive updates about the project!
> 
...
> Chat highlight for probably the last time this week. Highlight comments and self-editing are implemented, though I'm not sure I'll stick with this particular model.

### Populus Viewer [↗](https://github.com/opentower/populus-viewer)

A Social Annotation Tool Powered by Chat

[gleachkr](https://to.chat.dingshunyu.top/#/@gleachkr:matrix.org) announces

> I've been teaching a class this semester using a tool built on the matrix-js-sdk and tentatively entitled [populus-viewer](https://github.com/opentower/populus-viewer). Populus-viewer uses Chat as a backend for the social annotation of PDFs, with the goal of helping matrix become a platform for teaching and scholarly collaboration. If you're interested in learning more, or adopting populus-viewer in your teaching, come visit [#opentower:matrix.org](https://to.chat.dingshunyu.top/#/#opentower:matrix.org)! 
> 
> Populus-Viewer currently supports:
> 
> * Annotation of PDFs with highlights and pin-drops
> * Chat conversations based on annotations
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/WM_JGbEffIg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>


### matrix-streamchat [↗](https://git.pixie.town/f0x/matrix-streamchat)

Chat powered stream overlay for OBS, to integrate live chat in your favorite (selfhosted) streaming setups.

[f0x](https://to.chat.dingshunyu.top/#/@f0x:pixie.town) announces

> TWIM I got started on the chat part of [matrix-streamchat](https://git.pixie.town/f0x/matrix-streamchat), to provide a lightweight embeddable Chat client to be used alongside streams in Owncast and Tube. It will use guest access, and lots more features to come like extensive custom emote support. For now refactoring a bunch of things first before adding more flashy things, but who knows, you might see me do it live on https://stream.pixie.town

<iframe width="560" height="315" src="https://www.youtube.com/embed/c8mWsQzZow0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
[Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) says
...
[krazykirby99999](https://to.chat.dingshunyu.top/#/@krazykirby99999:matrix.org) says

> ## Version 2.5.0 Released!
> 
> simplematrixbotlib is an easy to use bot library for the Chat ecosystem written in Python and based on matrix-nio. Version 2.5.0 adds improvements to the config feature.
> ### Feature Changes:
...
[TravisR](https://to.chat.dingshunyu.top/#/@travis:t2l.io) announces
...
A Github Action for sending messages to a Chat Room.
...
A Chat appservice for relaying messages.

[mr_johnson22](https://to.chat.dingshunyu.top/#/@mr_johnson22:matrix.org) says
...
[Gwmngilfen](https://to.chat.dingshunyu.top/#/@gwmngilfen:matrix.org) announces

> A project has started to re-implement the venerable mIRCstats for Chat! It's in very early stages, right now it only does "getting a data-frame of events for a list of rooms" and has no *actual* visualisations baked in **yet**. However, we're moving quickly, and I hope to have some initial easy-to-use viz in place over the Christmas break.
> 
...
## Dept of *Built on Chat* 🏗️

### Saint Petersburg Widget [(A Board Game build on Chat)](https://github.com/toger5/st-petersburg-widget)

[Timo K.](https://to.chat.dingshunyu.top/#/@toger5:matrix.org) announces


> Board games are great. And Chat and its widget api turned out to be an excellent environment to create collaborative board games. With some really impressive conditions:
...
> 
> Last but not least the game Saint Petersburg is really fun. It takes a couple of minutes to grasp the rules but it is one of those games where there are so many things that can be considered with simple rules that it becomes more and more exciting with each round. So I really invite you to check out the [rules](https://www.fgbradleys.com/rules/rules4/Saint%20Petersburg%20-%20rules.pdf) and give it a try. Its best to start in the [Git Repo](https://github.com/toger5/st-petersburg-widget) or join the this room: [#st-petersburg-auth:matrix.org](https://to.chat.dingshunyu.top/#/#st-petersburg-auth:matrix.org)
> 
...
[kim](https://to.chat.dingshunyu.top/#/@kim:sosnowkadub.de) says
...
> https://www.heise.de/ratgeber/Eigener-Chatserver-Mit-dem-Chat-Server-einen-Messaging-Dienst-betreiben-6289020.html
> 
> I'm not a subscriber but sounds like they go over how to set up using the Ansible playbook [#matrix-docker-ansible-deploy:devture.com](https://to.chat.dingshunyu.top/#/#matrix-docker-ansible-deploy:devture.com)

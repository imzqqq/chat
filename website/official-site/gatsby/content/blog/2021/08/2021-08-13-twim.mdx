---
date: '2021-08-13'
title: 'This Week in Chat 2021-08-13'
categories:
  - This Week in Chat
author: Ben Parsons
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/z7tGU6vv6ZQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
> #### Spec Updates
>
> Work on Spaces continues with [MSC2946](https://github.com/matrix-org/matrix-doc/pull/2946) (Space Summary API), specifically revolving around how to paginate the summary. This has called into question how [pagination across Chat works in general](https://github.com/matrix-org/matrix-doc/issues/1898#issuecomment-896717689), which is a prime target for refactoring - perhaps an upcoming consistent pagination MSC? :)
>
...
>
> Lastly, Element is overjoyed to welcome David Robertson to the Chat team. Welcome aboard, David!
...
[alphapapa](https://to.chat.dingshunyu.top/#/@alphapapa:matrix.org) offered:

> [Ement.el](https://github.com/alphapapa/ement.el), a Chat client for Emacs, continues to improve.  Some of the changes in the past week:
>
> *Additions*
>
...
>
> Come join us in [#ement.el:matrix.org](https://to.chat.dingshunyu.top/#/#ement.el:matrix.org)!
...
>
> Join us in [#sailtrix:matrix.org](https://to.chat.dingshunyu.top/#/#sailtrix:matrix.org) . GitLab: https://gitlab.com/HengYeDev/harbour-sailtrix
>
...
[Felix](https://to.chat.dingshunyu.top/#/@felix:haecker.io) reported:
...
[jaywink](https://to.chat.dingshunyu.top/#/@jaywink:federator.dev) offered:
...
[carl](https://to.chat.dingshunyu.top/#/@carl:bordum.dk) reported:
...
>
> This year, Asbjørn  and I are hosting a couple of events related to Chat:
>
> * [A workshop on getting started developing for Chat](https://bornhack.dk/bornhack-2021/program/build-a-project-on-matrix/)
>
...
> * [A meetup for Chat users](https://bornhack.dk/bornhack-2021/program/matrix-user-meetup/)
>
...
> ---
>
> This week's room is: [#gamedev:matrix.org](https://to.chat.dingshunyu.top/#/#gamedev:matrix.org) 
>
> **"game development"**
>
> ---

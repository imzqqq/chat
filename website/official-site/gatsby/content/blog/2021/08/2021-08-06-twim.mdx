---
date: '2021-08-06'
title: 'This Week in Chat 2021-08-06'
categories:
  - This Week in Chat
...
I'm taking over hosting This Week In Chat again to give Ben a well-deserved break. Your favourite TWIM host will of course be back next week, but in the mean time, let's see what Chat goodness has happened this week!

## Chat Live 🎙

<iframe width="560" height="315" src="https://www.youtube.com/embed/ghp7PYPHPks" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

It's demo week again this week! We've got three great demos to share with you this month:

* Robert, the latest addition to the Chat VoIP team, gives us a sneak peek at his experiments with implementing native full mesh video calls in Chat
* Gil, from the Element iOS team, gives us an update on the implementation of Spaces in the app
* and finally Ryan, who's been exploring ways to use Chat beyond chat, shows us his shiny new full stack integration test solution for Chat client and servers

And I hear there might also have been a bonus demo that managed to sneak its way lower down this post 😉


## Dept of *Status of Chat* 🌡️

### Ansible community adopts Chat

[Gwmngilfen](https://to.chat.dingshunyu.top/#/@gwmngilfen:matrix.org) said:

> The [Ansible community](https://docs.ansible.com/ansible/latest/community/index.html) has [adopted Chat](https://github.com/ansible-community/community-topics/issues/36#issuecomment-892890140) as an official place to chat (alongside IRC). We'll be updating our documentation in the near future, but our rooms all have aliases already - add "ansible.im" to your directory search, or join [#space:ansible.im](https://to.chat.dingshunyu.top/#/#space:ansible.im) if you're in the Spaces beta. See you there!

Super psyched to welcome the Ansible community to Chat!
...
[callahad](https://to.chat.dingshunyu.top/#/@callahad:matrix.org) said:

> Today in not-Chat news, we're getting ready for a new release of [Sygnal](https://github.com/matrix-org/sygnal), our reference implementation of a Chat push notification gateway, early next week. The most significant change is that Shay, one of our Outreachy interns, has determined that Sygnal can function completely statelessly, removing the need for a SQLite or PostgreSQL database. This clears the path for proper horizontal scaling and high availability deployments of Sygnal.
>
> On the Chat side of the world, [MSC3289: Room version 8](https://github.com/matrix-org/matrix-doc/pull/3289) entered Final Comment Period (FCP) and we expect it to be merged into the Chat spec over the weekend. If that occurs, we'll be on track to include support for this room version in Chat 1.40 next week. Tune in next week to find out how that went!


### Conduit

Conduit is a Chat homeserver written in Rust https://conduit.rs

[timokoesters](https://to.chat.dingshunyu.top/#/@timokoesters:fachschaften.org) announced:
...
The list of Chat clients is getting larger and larger! And it's not only chat clients anymore! So I thought I'd experiment a bit this week by splitting them in two categories: messengers and non-chat clients. Let us know how you like this format in [#twim:matrix.org].
...
[krille](https://to.chat.dingshunyu.top/#/@krille:janian.de) said:
...
[Sorunome](https://to.chat.dingshunyu.top/#/@sorunome:sorunome.de) also added:

> Heya, we are very grateful for all the awesome translators helping us translate FluffyChat! Unfortunately, we aren't the best at managing such a huge effort as translating such a large app into so many different languages. As a result, suggestions went un-reviewed on weblate for long, people weren't able to submit translations, etc. We are very sorry for that, but want to work on fixing that! As, well, we are only really programmers with little time, we thought of asking for help from the community (you all!)! That is why we are looking for a translation manager for FluffyChat. No programming experience at all is required, it'd mostly be about managing our weblate and answering translation-related questions. If you are interested, please plop into our room [#fluffychat:matrix.org](https://to.chat.dingshunyu.top/#/#fluffychat:matrix.org) and say so! (And ping [Sorunome](https://to.chat.dingshunyu.top/#/@sorunome:sorunome.de) if you don't get answers). Looking forward to a where translations are managed better, and thank you again for everyone who did bite through all this and contributed translations so far!
...
[Nico](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) told us:
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/qozq7FN5nhg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>


### Ement.el

[alphapapa](https://to.chat.dingshunyu.top/#/@alphapapa:matrix.org) announced:

> [Ement.el](https://github.com/alphapapa/ement.el), a new Chat client for Emacs, continues to gain new features: deleting messages, showing room avatars, adding to reactions by clicking them, and new "mentions" and "notifications" buffers that show messages from multiple rooms in a single window.  You can even reply to messages from any room in the Notifications buffer, which makes it easy to follow multiple rooms at once, rather than having to switch between rooms.  (Room: [#ement.el:matrix.org](https://to.chat.dingshunyu.top/#/#ement.el:matrix.org))


### NeoChat

[NeoChat](https://invent.kde.org/network/neochat) is a desktop chat client for Chat. It uses [Kirigami](https://develop.kde.org/frameworks/kirigami/) to provide a convergent user interface on desktops (KDE Plasma, GNOME, Windows, and other desktops) and phones (Plasma Mobile and Android).

[Tobias Fella](https://to.chat.dingshunyu.top/#/@tobiasfella:kde.org) told us:
...
[HengYeDev](https://to.chat.dingshunyu.top/#/@hengyedev:mozilla.org) said:

> Sailtrix is a Chat client for SailfishOS supporting basic end-to-end encryption. This week I've released its third iteration. Here's a list of features:
>
...
>
> Discussion takes place at our matrix channel at [#sailtrix:matrix.org](https://to.chat.dingshunyu.top/#/#sailtrix:matrix.org)
>
...
[Fractal](https://wiki.gnome.org/Apps/Fractal) is a GTK Chat Client written in Rust.

[Alexandre Franke](https://to.chat.dingshunyu.top/#/@afranke:matrix.org) announced:
...
[Bruno](https://to.chat.dingshunyu.top/#/@bwindels:matrix.org) told us:
...
[Mirage](https://github.com/mirukana/mirage) is a fancy, customizable, keyboard-operable Chat client written in Qt/QML and Python. Currently in alpha and available on Linux.

[miruka](https://to.chat.dingshunyu.top/#/@miruka:matrix.org) announced:
...
>
>   - `Keys.messages.open_links_files`(`_externally`): ignore to.chat.dingshunyu.top user and room mention links
>
> - Presence:
...
>
>   - Render to.chat.dingshunyu.top URL in messages as shorter hyperlinks
>
> - Left pane rooms:
...
[Timo K.](https://to.chat.dingshunyu.top/#/@toger5:matrix.org) announced:
...
> * There is now also a matrix room for feedback, issues and ideas: [#TheBoard:matrix.org](https://to.chat.dingshunyu.top/#/#TheBoard:matrix.org)
>
...
[cvwright](https://to.chat.dingshunyu.top/#/@cvwright:matrix.org) offered:

> [Circles](https://github.com/KombuchaPrivacy/circles-ios) is an iOS app for end-to-end encrypted secure social networking and sharing, built on top of Chat.  Its goal is to provide a safe and convenient way for close friends and families to share things that they wouldn't post publicly -- e.g. for parents to safely share pictures of their kids.
>
> Recent updates to the Circles beta include:
>
> * Support for use with any Chat homeserver
>
> * Emoji reactions
...
>
> **NOTE 2** - Circles is NOT RECOMMENDED for use on an account that you're already using for Chat chat, for the above reason and more.  If you do this, prepare to see lots of extra, weird rooms in Element / Fluffy / Nheko / whatever chat client you're using.  Also if you decide to try this anyway, please let me know how it goes.  :-)
>
> **NOTE 3** - Circles is not available yet in France.  Sorry.  I gotta update my encryption compliance documentation with Apple.

If you want to know more about this project, feel free to join [#circles:matrix.org](https://to.chat.dingshunyu.top/#/#circles:matrix.org)!


## Dept of SDKs and Frameworks 🧰

### Version 1.6.0 of Simple-Chat-Bot-Lib is released!

[krazykirby99999](https://to.chat.dingshunyu.top/#/@krazykirby99999:matrix.org) announced:
...
[Ananace](https://to.chat.dingshunyu.top/#/@ace:kittenface.studio) announced:

> This week continues the regular K8s updates, with my [Helm Charts](https://gitlab.com/ananace/charts) seeing updates for element-web to 1.7.34 as well as a fix for handling IPv6 in the well-known listener for Chat.


### Dendrite Helm chart

And because Chat started feeling a bit lonely being the only one with a Helm chart, [s7evink](https://to.chat.dingshunyu.top/#/@s7evink:s3cr3t.me) offered:
...
>
> Shout out to Ananace, for the awesome [helm chart for Chat](https://gitlab.com/ananace/charts), which was my inspiration! :)
...
[Jez (he/him)](https://to.chat.dingshunyu.top/#/@jez:petrichor.me) told us:

> I've released `mxadm`, a small CLI tool for Chat room admin that I've been working on for a few weeks; more details here: https://erambler.co.uk/blog/introducing-mxadm/
...
[MTRNord](https://to.chat.dingshunyu.top/#/@mtrnord:nordgedanken.dev) announced:
...
>
> This week new is a World Map of IP based locations of Chat Servers. Be ware that the coordinates are quite rough due to the quality of the free maxmind databases used. The map data gets updated every 12h.
>
...
### Chat/Element Help Documentation

[~creme](https://to.chat.dingshunyu.top/#/@creme:envs.net) announced:
...
[timokoesters](https://to.chat.dingshunyu.top/#/@timokoesters:fachschaften.org) offered:

> Hi everyone! Did you ever feel lost in the Chat world? The room directory is big, but it's still hard to find something you like. Or are you a room moderator, but there is not much activity in your room because it doesn't have enough users?
>
> This is why I want to share rooms (or spaces) I find interesting.
>
> ---
>
> This week's room is: [#plaintextaccounting:matrix.org](https://to.chat.dingshunyu.top/#/#plaintextaccounting:matrix.org)
>

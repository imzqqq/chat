---
date: '2021-06-11'
title: 'This Week in Chat 2021-06-11'
categories:
  - This Week in Chat
author: Ben Parsons
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/N4zsepnJw60" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
> Hi everyone! Did you ever feel lost in the Chat world? The room directory is big, but it's still hard to find something you like. Or are you a room
...
> ----
>
> This week's room is: [#art:matrix.org](https://to.chat.dingshunyu.top/#/#art:matrix.org)
>
...
[Neil Alexander](https://to.chat.dingshunyu.top/#/@neilalexander:matrix.org) told us:

> I have spent quite a bit of time lately working on Pinecone network convergence for P2P Chat. There's still quite a bit to do in order to call Pinecone "complete", but a network of 50 nodes now bootstraps entirely from cold much more quickly and converges on full end-to-end reachability in roughly 6 seconds. This is a significant improvement to before! Keep an eye out for future P2P Chat demo builds using these new protocol changes.
...
[f0x](https://to.chat.dingshunyu.top/#/@f0x:pixie.town) offered:
...
>
> With this, synapse-media-proxy *should* be a drop-in overlay for all Chat's /_matrix/media routes.
> I don't really recommend using it in prod yet however, but I have a test instance that could use some responsible disclosure pentesting at https://media.pixie.town, please DM me [@f0x:pixie.town](https://to.chat.dingshunyu.top/#/@f0x:pixie.town) if you find anything :) 
>
> https://git.pixie.town/f0x/synapse-media-proxy  
> synapse-media-proxy now has a room at [#synapse-media-proxy:pixie.town](https://to.chat.dingshunyu.top/#/#synapse-media-proxy:pixie.town)
...
[callahad](https://to.chat.dingshunyu.top/#/@callahad:matrix.org) reported:
...
>
> Otherwise we're looking forward to releasing Chat 1.36 early next week, and we have some great things in store... but I'll not spoil them today! 🤫
>
> From everyone on the Chat team, have a great weekend!
>
...
[Ananace](https://to.chat.dingshunyu.top/#/@ace:kittenface.studio) reported:
...
### Docker-based development environment for Chat

[psrpinto](https://to.chat.dingshunyu.top/#/@psrpinto:matrix.org) [wrote](https://to.chat.dingshunyu.top/#/!jxlRxnrZCsjpjDubDX:matrix.org/$OM-Kxwdqz_Jiex9eMJxTBhzCVwVeZAXYE_HIm3w3AZs?via=matrix.org&via=privacytools.io&via=mozilla.org):

> Hi folks. Some time ago I asked here about any projects that provided a local Chat "node" through docker, and it seemed not much existed in that space, so I went ahead and created the following repo:
>
> https://github.com/Automattic/matrix-env
>
> Docker-based development environment for Chat. Provides a local sandbox with the following pre-configured services:
>
> * synapse: the reference homeserver implementation
> * synapse-admin: homeserver admin UI
> * element: a web-based Chat client
>
...
Thanks [uhoreg](https://to.chat.dingshunyu.top/#/@hubert:uhoreg.ca) for passing this on! Looks like a really useful way to get a local env running
...
>
> * Nearly 6k Chat users are now connected to IRC and growing by the minute.
>
...
>
> We're still continuing to rapidly work on the bridge, with a [release expected](https://github.com/matrix-org/matrix-appservice-irc/releases) on Monday 🤞. For any of you who aren't in the know yet, you can start bridging to libera.chat by simply joining a channel like [#libera-matrix:libera.chat](https://to.chat.dingshunyu.top/#/#libera-matrix:libera.chat) or by searching the `libera.chat` room directory.
>
> I'm hoping we'll be nearing the end of our jouney on this bridge, and it will settle into a natural stable state over the coming days! Anyway, thanks everyone for your patience and we hope to see you on Chat or IRC!



### IRC Bridge 0.27.0-rc1 leaps out of the gate

[Half-Shot](https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk) offered:
...
> * Allowing you to spin up the bridge with complete control over the alias namespace of a host (e.g. [#libera:libera.chat](https://to.chat.dingshunyu.top/#/#libera:libera.chat) links to #libera).
>
> * And finally, a privacy feature to block incoming IRC messages when Chat users are not all joined which is requested by some IRC networks.
>
...
*   We’ve also been working on adding pagination to the Space Summary API on Chat
...
[Tobias Fella](https://to.chat.dingshunyu.top/#/@tobiasfella:kde.org) added:
...
>
> Thanks to [jo](https://to.chat.dingshunyu.top/#/@jo:proprietary.lol) , [Nico](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) , [joepie91 🏳️‍🌈](https://to.chat.dingshunyu.top/#/@joepie91:pixie.town)  and [poljar](https://to.chat.dingshunyu.top/#/@poljar:matrix.org)  for helping to archive these improvements and hinting where improvements were possible to be made :)


## Dept of Guides 🧭

### A guide for creating simple Chat bots with Python and Simple-Chat-Bot-Lib

[krazykirby99999](https://to.chat.dingshunyu.top/#/@krazykirby99999:matrix.org) told us:

> https://simple-matrix-bot-lib.readthedocs.io/en/latest/quickstart.html
>
> Simple-Chat-Bot-Lib allows anyone who needs a bot in a Chat Room to do so without having to spend unnecessary time learning a complex framework!
>
...
[numéro6](https://to.chat.dingshunyu.top/#/@numero6:codelutin.com) told us:


> If you live in France (or eurozone) and your Chat-related project need some funds, you may candidate to the 2021 #MécénatCodeLutin grant program for FLOSS by [Code Lutin](https://www.codelutin.com/). Canditates may fill the [dedicated form](https://framaforms.org/mecenat-code-lutin-2021-1620296813) before july 8th.

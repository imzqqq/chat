---
date: '2021-06-18'
title: 'This Week in Chat 2021-06-18'
categories:
  - This Week in Chat
author: Ben Parsons
...
### GNOME community loves Chat

[Thib](https://to.chat.dingshunyu.top/#/@thib:ergaster.org) reported:

> The GNOME community loves Chat and wants it to grow! That's why it's closing registrations on its instance. What? Yes, [we want both to provide the best experience for our community and to be a good citizen in the Chat universe](https://blog.ergaster.org/post/20210610-sovereignty-federated-system-gnome/).



## Dept of Spec 📜

[anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz) said:

> Here's your weekly spec update! The heart of Chat is the specification - and this is modified by Chat Spec Change (MSC) proposals. Learn more about how the process works at https://matrix.org/docs/spec/proposals.
>
> #### MSC Status
>
> **Closed MSCs:**
...
[callahad](https://to.chat.dingshunyu.top/#/@callahad:matrix.org) offered:

> This week's big news is the [release of Chat 1.36](https://matrix.org/blog/2021/06/15/synapse-1-36-0-released) which completely eliminates memory spikes when joining rooms! I'll let the "Joining Chat HQ" graph speak for itself:
...
[f0x](https://to.chat.dingshunyu.top/#/@f0x:pixie.town) said:

> Actively deployed to pixie.town's Chat now, and running very smoothly. [Happy graphs](https://stats.pixie.town/d/rPBvoh6Gk/synapse-media-proxy?orgId=1&from=now-3d&to=now&refresh=15m) show 91% of requests are handled without Chat involved.
>
> Also demonstrated the very seamless drop-in enable and disable, just changing the reverse proxy url back and forth from Chat, and with this you could cautiously try this out for your own server, but stay in touch with [#synapse-media-proxy:pixie.town](https://to.chat.dingshunyu.top/#/#synapse-media-proxy:pixie.town) 
>
...
[Ananace](https://to.chat.dingshunyu.top/#/@ace:kittenface.studio) told us:

> This week sees another installation of the regular Kubernetes updates, bumping the Chat [chart](https://gitlab.com/ananace/charts) and image to 1.36.0
...
[hifi](https://to.chat.dingshunyu.top/#/@hifi:vi.fi) offered:

> Heisenbridge roundup!
>
> [Heisenbridge](https://github.com/hifi/heisenbridge) is a bouncer-style Chat IRC bridge.
>
...
>
> * Prioritized Chat->IRC queue for improved responsiveness while sending out a lot of messages
...
>
> **Call for mutual help!** The plumb feature needs more testing on busy IRC channels. If you need to plumb public Chat rooms and IRC channels on _any_ IRC network that does not have a public bridge available or just want to use a relaybot on IRC side for some reason hit me up on [#heisenbridge:vi.fi](https://to.chat.dingshunyu.top/#/#heisenbridge:vi.fi) and we can setup a test plumb, free of charge! Only requirements are that I can lurk around to monitor how it works and there's nothing offensive on-topic.
>
...
[Half-Shot](https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk) told us:
...
>
> * Bridge operators can now choose to block messages in the I->M direction while Chat users are not joined to IRC as a privacy perservation technique.
> * You can now configure the bridge to publish rooms to the public room directory (rather than the appservice directory). The bridge can now also use the whole alias namespace (e.g. [#foo:libera.chat](https://to.chat.dingshunyu.top/#/#foo:libera.chat) -> #foo).
>
...
Watch Chat Live for more from Half-Shot.

### matrix-puppeteer-line

[Fair](https://to.chat.dingshunyu.top/#/@fair:miscworks.net) reported:
...
[Carl Schwan](https://to.chat.dingshunyu.top/#/@carl:kde.org) said:
...
>
> Akademy is also happening this weekend and next week. KDE is using Chat and BigBlueButton for the conference. There will be a lot of talk, training and bofs. We have a bof the 22th June at 16th. It's virtual and everyone is welcome to join and discuss with us NeoChat development.
...
[krille](https://to.chat.dingshunyu.top/#/@krille:janian.de) offered:
...
[[pioneer]](https://to.chat.dingshunyu.top/#/@pioneer:matrix.org) told us:

> Here's the FluffyChat subreddit, in order to provide more stuctured way of discussions, keep questions asked again and again in one place, and refer to older answers whenever the need is, as well as just to hang out https://www.reddit.com/r/fluffychat/
...
[Nico (@deepbluev7:neko.dev)](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) told us:
...
Nheko also [now supports deeplinking using the matrix:// scheme](https://github.com/matrix-org/to.chat.dingshunyu.top/pull/200) 
...
> The Dart language now has a new SDK for Chat developed and maintained by famedly.com and published here:
>
> https://pub.dev/packages/matrix
>
> It provides a fully featured base for Dart and Flutter applications including E2EE, and Cross Signing. After more than 2 years of development we now declared it as stable. The Chat Dart SDK (formerly known as famedly SDK) was initially a rewrite of the FluffyChat backend which was written in JavaScript. It came a long way since then and is now the base for the Famedly App and for the Flutter version of FluffyChat.

<small>Hyper-targeted callback: Hey Naren, Famedly are the Chat-using folk I was telling you about. This is the latest version of their Dart work and will be a great place to start building from.</small>

### kazv

[tusooa](https://to.chat.dingshunyu.top/#/@tusooa:tusooa.xyz) offered:

> [kazv](https://lily.kazv.moe/kazv/kazv) is a matrix client based on [libkazv](https://lily.kazv.moe/kazv/libkazv).
>
> Talk to us on [#kazv:tusooa.xyz](https://to.chat.dingshunyu.top/#/#kazv:tusooa.xyz) .
>
> #### Updates
>
...
[Christian](https://to.chat.dingshunyu.top/#/@christianp:vector.modular.im) announced:
...
[Tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) told us:

> The [GitLab maubot plugin](https://github.com/maubot/gitlab) recently received major improvements to webhook handling. The Chat messages now look much nicer (similar to the GitHub maubot plugin) and it also sends fancy reactions for CI status.
>
> It's already in use in [#nheko:nheko.im](https://to.chat.dingshunyu.top/#/#nheko:nheko.im) and Beeper's internal commit log room. It's unfortunately not yet available on t2bot.io, because I'm too lazy to write a migration script to copy data from the very old standalone gitlab bot written in Go.
>
...
### Interoperability event hosted by, and featuring, Chat

[Denise](https://to.chat.dingshunyu.top/#/@denise.a:vector.modular.im) offered:

> Tomorrow Element will host an event alongside Protonmail, Open-Xchange and Open Forum Europe on the DMA and the topic of interoperability. This will be hosted on Chat, based on the infrastructure first used during FOSDEM. The event will be livestreamed over on [#interop-sme:matrix.org](https://to.chat.dingshunyu.top/#/#interop-sme:matrix.org) 
>
...
NB this event took place earlier in the week, but we stil wanted to honour it!

### Message à Caractère Informatique

[Brendan Abolivier](https://to.chat.dingshunyu.top/#/@babolivier:vector.modular.im) announced:

> I've been invited to appear in the latest episode of Clever Cloud's tech podcast Message à Caractère Informatique, where we talked mostly about Chat and decentralisation, but also about a bunch of other interesting things ranging from timbl minting his source code as an NFT to how to hack autonomous car with sound. It was loads of fun, thanks to them for the invite!
>
...
Perhaps to *pique* (French word?) our interest [Brendan Abolivier](https://to.chat.dingshunyu.top/#/@babolivier:vector.modular.im) added:
...
[MTRNord](https://to.chat.dingshunyu.top/#/@mtrnord:nordgedanken.dev) said:
...
### A Chat bot created with Simple-Chat-Bot-Lib!

[krazykirby99999](https://to.chat.dingshunyu.top/#/@krazykirby99999:matrix.org) reported:

> This bot is written with short, easy to understand Python code. Try writing your own bot with Python and Simple-Chat-Bot-Lib!
>
...
### Easy guide to joining Chat

[Bram](https://to.chat.dingshunyu.top/#/@bramvdnheuvel:nltrix.net) told us:

> After having tried to convince several people to join the Chat, my main conclusion is that it's too difficult for people. Apps that big tech companies produce are so simple that having to choose a client, choose (or set up) a homeserver and building bridges is too much of a push factor from the Chat.
>
> To help those people, I've written a quick guide that should help people without a programming background join the Chat. I'm using this as a reference when people ask how they could join the Chat, feel free to do this yourself as well: https://noordstar.me/b/how-to-join-matrix.md
...
[Cat](https://to.chat.dingshunyu.top/#/@cat:feline.support) announced:
...
[timokoesters](https://to.chat.dingshunyu.top/#/@timokoesters:fachschaften.org) reported:
...
> ----
>
> This week's room is: [#calibre:mailstation.de](https://to.chat.dingshunyu.top/#/#calibre:mailstation.de)
>
...
> ----
>
> If you want to suggest a room for this section, send a Chat message in [#roomoftheweek:fachschaften.org](https://to.chat.dingshunyu.top/#/#roomoftheweek:fachschaften.org)

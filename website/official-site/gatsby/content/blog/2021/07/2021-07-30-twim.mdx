---
date: '2021-07-30'
title: 'This Week in Chat 2021-07-30'
categories:
  - This Week in Chat
author: Ben Parsons
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/uASdQxT8boM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

Let's learn about PyQuotient with Vlad and Alexey.

## Dept of *Status of Chat* 🌡️

### Element raises $30M as Chat explodes!

At first when I read the headline I was scared - *explodes*? How can I protect myself from this explosion? After a [moment of reading this huge news](https://element.io/blog/element-raises-30m-as-matrix-explodes/), however, I was relieved - Chat has *exploded in popularity*, and [Element](https://element.io/) have all new funding to keep driving the ecosystem forward. Let's go!
...
>
> Finally, [MSC3289](https://github.com/matrix-org/matrix-doc/pull/3289) (room v8) is ticking along as the implementation is tested in Chat and Complement tests.
...
> [Chat 1.39.0](https://matrix.org/blog/2021/07/29/synapse-1-39-0-released) is out! 
>
...
>
> But back to Chat! You should check out the [release announcement](https://matrix.org/blog/2021/07/29/synapse-1-39-0-released), but the bulk of the work this cycle went into internal cleanups. Chat should also be slightly more performant, reliable, and should log fewer spurious errors. Of note, ShadowJonathan did a lot of work with `pyupgrade` and `com2ann` to move the entire codebase to more modern Py3.6+ conventions and inline type annotations; thanks, ShadowJonathan!
>
> Chat 1.39 also continues our march toward unifying Chat's interface for extension modules, and we've now exposed plugin hooks for the `account_validity` option, and experimentally implemented hooks for third party event rules.
>
...
[j3s (he/him)](https://to.chat.dingshunyu.top/#/@j3s:cyberia.club) offered:

> Hello! This week, I created a [matrix 1-click app](https://marketplace.digitalocean.com/apps/matrix-synapse-backend) on the DigitalOcean marketplace. It's basically a pre-baked droplet image that is pre-configured with synapse, element-web, caddy, postgres, plus some setup and moderation tools. My intent was to make self-hosting a Chat system as easy as pointing some DNS records and running a single script. It makes a lot of sense for smaller, more casual Chat homeservers, and can serve as a good starting point! It also includes some small utility scripts - `./reset-password`, `./new-user`, etc.
>
...
[hifi](https://to.chat.dingshunyu.top/#/@hifi:vi.fi) announced:
...
### Announcing Chat client [Cinny](https://cinny.in/) 1.0.0

[ajbura](https://to.chat.dingshunyu.top/#/@ajbura:matrix.org) reported:
...
> Many improvements have been made to [Ement.el](https://github.com/alphapapa/ement.el), a new Chat client for Emacs.  Ement.el can now send and display images, replies, and reactions, as well as edit sent messages.  It also supports desktop notifications, configurable by the user to pop up for mentions or for all rooms with open buffers.  (Room: [#ement.el:matrix.org](https://to.chat.dingshunyu.top/#/#ement.el:matrix.org))

Something something expands until it reads... Chat?
...
[krille](https://to.chat.dingshunyu.top/#/@krille:janian.de) reported:
...
[iinuwa](https://to.chat.dingshunyu.top/#/@iinuwa:matrix.org) announced:
...
>
> We have had a productive summer with our two Google Summer of Code students, Adam Blanchet and Devin Ragotzy. Adam finished implementing the last of our Identity Service API endpoints, bringing us to 100% implementation of all the Chat API endpoints! (And we promise there are no bugs because "Rust," right?)
>
> Besides improving the Chat ecosystem, Devin has been helping the Rust ecosystem at large by writing some Clippy lints to improve our codebase and upstreaming his additions.
>
...
[David Mehren](https://to.chat.dingshunyu.top/#/@davebloggt:kif.rocks) offered:

> I made [maubot-ldap-inviter](https://github.com/davidmehren/maubot-ldap-inviter), a maubot plugin that (surprisingly) invites users into Chat rooms, according to their membership in LDAP groups.
>
> We are switching from RocketChat to Chat in the next round of a software engineering course where students work on software projects in small groups.
>
...
> As there was no such feature for Chat, I built the bot over the last few days.
>
...
>
> PS: [#miounne:etke.cc](https://to.chat.dingshunyu.top/#/#miounne:etke.cc) - matrix room with news & discussions



## Dept of Events and Talks 🗣️

### Chat @ [FrOSCon 2021](https://www.froscon.de/en/) (virtual)

[Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) reported:

> Great news! Chat Dev-Room and Chat booth are approved! 🎉
>
> We are currently creating a schedule and we have open slots for talks and workshops!
>
> If you like to present your topic or just help out please contact me ([@oleg:fiksel.info](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info)) (or oleg@fiksel.info) now! Language is preferably German, but English is also ok.
>
> See you at [#FrOSCon:fiksel.info](https://to.chat.dingshunyu.top/#/#FrOSCon:fiksel.info)  😉
...
[Timo](https://to.chat.dingshunyu.top/#/@toger5:matrix.org) announced:
...
>
> Looking at this list, Chat was such an obvious choice. I could comment every point but basically with: "A whiteboard should be a Chat room" everything is said.
>
...
>
> **Before trying it out:** It takes really long to log in with an account with lots of rooms. So, I highly recommend to NOT use your main Chat account.
...
>
> using Chat as its backend. All your drawings are stored in matrix rooms
...
[Chris](https://to.chat.dingshunyu.top/#/@chris:settgast.org) announced:
...
[Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) made us aware:

> Let's use this day to thank your Chat home server admin! Especially folks managing Chat and all the public bridges! ❤️
>

---
date: '2021-07-16'
title: 'This Week in Chat 2021-07-16'
categories:
  - This Week in Chat
author: Ben Parsons
...
We heard from Callum last week, and will have more reports in future, but for now just know that all *seven* GSoC projects are progressing well. To remind yourself ot this year's projects, see the list [provided by Google](https://summerofcode.withgoogle.com/organizations/6691635666092032/) or [our welcome blog post](https://matrix.org/blog/2021/05/20/google-summer-of-code-2021).

[Alexandre Franke](https://to.chat.dingshunyu.top/#/@afranke:matrix.org) added:
...
> * Shared secret registration (using the same API shape as Chat)
>
...
> The big news of the week is the release of [Chat 1.38](https://matrix.org/blog/2021/07/13/synapse-1-38-0-released), which converts several integer columns to `bigint`, allowing Chat to process more than 2 billion (231) events. Which, incidentally, matrix.org did last week 📈:

![2021-07-16-N2mUM-synapse-event-bigint.png](/blog/img/2021-07-16-N2mUM-synapse-event-bigint.png)

> But that's not the only thing new in Chat 1.38. We also landed the ability to set an expiry time on cache entries, allowing you to reclaim memory from infrequently accessed caches. Configuring this to "1h" on matrix.org has already yielded a noticeable reduction in overall memory use 📉:
...
[callum](https://to.chat.dingshunyu.top/#/@callum:calcuode.com) told us:

> Another short update about my GSoC project, this time about the Chat admin API for managing tokens. https://calcuode.com/matrix-gsoc/2021-07-16_admin-api.html

See also Chat Live with Callum last week.
...
> This week too brings updates to my [Helm Charts](https://gitlab.com/ananace/charts), with Chat having been updated to 1.38.0.
...
[Fair](https://to.chat.dingshunyu.top/#/@fair:miscworks.net) said:
...
>
> What I'm working on next is a bot command to list all of your LINE contacts & groups (similar to [mautrix-whatsapp](https://github.com/tulir/mautrix-whatsapp)'s `list <contacts|groups>`), and the ability to sync a LINE DM by inviting a contact to a Chat DM. This will allow messaging LINE contacts that the bridge didn't yet create a portal for.
>
...
[Aksem](https://to.chat.dingshunyu.top/#/@Aksem:matrix.org) told us:

> First news about Python bindings for libQuotient, C++ Qt-based Chat SDK
>
...
### Hack'n'Sun, the partially-Chat-based summer tinkering camp

[Nik](https://to.chat.dingshunyu.top/#/@nik:matrix.teckids.org) offered:

> Over the first weeks of July, [Teckids e.V.](https://teckids.org) held their annual summer camp for kids between 9 and 15 years. This year, after we started introducing Chat and Element as a chat platform from September 2020 onwards, the camp was heavily relying on the platform for various parts.
>
...
Asked about the regularity of these events, [Nik](https://to.chat.dingshunyu.top/#/@nik:matrix.teckids.org) replied:

> We are still experimenting with our new camp formats. As bad as it all is, COVID caused a lot of innovation here because we were forced to leave the known roads we normally travelled, and now we are starting to integrate all that new stuff (like really embracing Chat) into outdoor and presence events. I think we are on a really good way with it, and surely I will keep posting updates that might be of interest for the greater community.
...
[carl](https://to.chat.dingshunyu.top/#/@carl:bordum.dk) announced:

> [Cactus Comments](https://cactus.chat) is a federated comment system for the open web built on Chat.
>
...
>
> Chat room: [#cactus:cactus.chat](https://to.chat.dingshunyu.top/#/#cactus:cactus.chat)
>
...
### New business-oriented guide to using Chat and Element

The [Reidel Law Firm](https://www.reidellawfirm.com/) from Galveston, Texas have produced an excellent [business-oriented guide to using Chat and Element](https://www.reidellawfirm.com/wp-content/uploads/2021/07/Reidel-Law-Firm-Guide-to-Chat.pdf). As they [announced in a blog post last month](https://www.reidellawfirm.com/reidel-law-firm-debuts-secured-encrypted-communications-platform-for-clients/):
...
[Schuyler "Rocky" Reidel](https://to.chat.dingshunyu.top/#/@rockyreidel:reidellawfirm.com) added:

> I believe in Chat+Element and encourage my clients and law firms to get ahead of the curve or get left behind and become irrelevant. Email has to die, its just the worst. Also, I forgot to note earlier that the guide is copyright free. I hope other business owners will use and revise it for their own uses.

Strong words! You can find [the guide from Reidel on their website](https://www.reidellawfirm.com/wp-content/uploads/2021/07/Reidel-Law-Firm-Guide-to-Chat.pdf).
...
> ----
>
> This week's room is: [#formula1:matrix.org](https://to.chat.dingshunyu.top/#/#formula1:matrix.org)
>

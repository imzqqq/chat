---
date: '2021-07-09'
title: 'This Week in Chat 2021-07-09'
categories:
  - This Week in Chat
author: Ben Parsons
...
### Ansible Community considers Chat

[Gwmngilfen](https://to.chat.dingshunyu.top/#/@gwmngilfen:matrix.org) offered:

> I'm the Principal Data Scientist for the Ansible Community. We're hoping to switch to Chat as our primary platform in the near future, and I've just written up _my thoughts_ on why that's a good idea, what the consequences might be, and where we go from here. Find it at https://ansible.github.io/community/posts/matrix_and_ansible.html
...
> #### Spec Updates
>
> A [concrete plan](https://github.com/matrix-org/matrix-doc/issues/3095) has been drafted for publishing the new spec release, and is currently undergoing execution. This release will include many changes that have built up since the last release (back before the new spec redesign even), as well as the new [Chat Global Version Number scheme](https://github.com/matrix-org/matrix-doc/pull/2844). Look forward to it dropping soon!
>
...
>
> Lastly, we're overjoyed to announce that [@reivilibre](https://github.com/reivilibre), a former intern on the backend team, joined Element this week! We can't wait to see where he helps us take Chat!
...
[SpiritCroc](https://to.chat.dingshunyu.top/#/@spiritcroc:spiritcroc.de) reported:
...
>
> Also, feel free to join our Chat rooms, which you can find in the new SchildiChat space: [#schildichat:matrix.org](https://to.chat.dingshunyu.top/#/#schildichat:matrix.org)
...
> #### This release adds a fix for compatibility with Chat >= v1.38.0
>
> This bot is based on [opsdroid](https://opsdroid.dev) bot framework and aims to control actions in [home-assistant](https://www.home-assistant.io/) via Chat.
>
> Feel free to come by at [#home-assistant-bot:fiksel.info](https://to.chat.dingshunyu.top/#/#home-assistant-bot:fiksel.info)  😉
...
### Chat Bot inside of a Docker Container

[krazykirby99999](https://to.chat.dingshunyu.top/#/@krazykirby99999:matrix.org) announced:

> Run Chat Python bots inside of Docker Containers with Simple-Chat-Bot-Lib and Docker!
>
> This is a guide for isolating and running your Chat bot within a Docker container. It is also applicable to bots written using other libraries and languages.
>
...
> ----
>
> This week's space is: [#mathematics-on:matrix.org](https://to.chat.dingshunyu.top/#/#mathematics-on:matrix.org) 
>
> Biggest room: [#mathematicsq&a:matrix.org](https://to.chat.dingshunyu.top/#/#mathematicsq&a:matrix.org) 
>
...
In meta twim news, the twim updates bot (which posts in [#twim_updates:cadair.com](https://to.chat.dingshunyu.top/#/#twim_updates:cadair.com)) has been upgraded to opsdroid 0.23 and  now correctly keeps the formatted body when an event is edited.

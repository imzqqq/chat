---
date: '2021-01-08'
title: 'This Week in Chat 2021-01-08'
categories:
  - This Week in Chat
author: Ben Parsons
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/BSJY79qN1No" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
> FOSDEM 2021 is going to happen via Chat: https://matrix.org/blog/2021/01/04/taking-fosdem-online-via-matrix
...
[wbamberg](https://to.chat.dingshunyu.top/#/@wbamberg:matrix.org) announced:
...
> Welcome back, TWiM readers! It's a new year, and the Chat team is excited to get back to our regularly scheduled releases! Three main things this week:
>
...
>
>   * People can pick their own username when using Single Sign-On, right from within Chat itself.
>   * Spam-checker modules can now use `async` Python methods.
>
>   * New ways to [restrict allowed IP address ranges](https://github.com/matrix-org/synapse/blob/v1.25.0rc1/UPGRADE.rst#upgrading-to-v1250) for outgoing requests from Chat.
> 2. [Chat is hosting FOSDEM](https://matrix.org/blog/2021/01/04/taking-fosdem-online-via-matrix)! Which means that most of the Chat team is going to be focused on security, stability, and performance until February to ensure that our virtual Université Libre de Bruxelles is as reliable and welcoming the real thing.
>
...
>
> If you have any feedback, please feel free to join us in [#synapse:matrix.org](https://to.chat.dingshunyu.top/#/#synapse:matrix.org)!
...
[Icewind](https://to.chat.dingshunyu.top/#/@robin:icewind.nl) told us:
...
You can meet Carl and Tobias from the NeoChat project by watching Chat Live. \o/
...
[SpiritCroc](https://to.chat.dingshunyu.top/#/@spiritcroc:spiritcroc.de) offered:
...
>
> Chat room: [#schildichat-android:matrix.org](https://to.chat.dingshunyu.top/#/#schildichat-android:matrix.org)
...
Support for [Social Login on iOS](https://github.com/vector-im/element-ios/issues/3846) is in review after resolving some issues around VoiceOver, which is the last Element client to implement support ahead of Chat landing support for social login in the near future.
...
### MRSBFH - Chat-Rust-SDK-Bot-Framework-Helper
...
### mtxclient - the Chat library Nheko uses
...
[Benedict](https://to.chat.dingshunyu.top/#/@benedict:imbitbu.de) explained:
...
### GitHub action for Chat!

[select](https://to.chat.dingshunyu.top/#/@select:matrix.org) said:

> I recently started a new freelance project and got them to use Chat as our main communication channel. Since they chose GitHub as our source code platform I got into writing continuous integrations and delivery scripts. But one thing was missing: notifications in our Chat room. I looked into the GitHub Action Marketplace and found 2 actions that could do that, so that was nice ... but they could not send e2e encrypted messages. Therefore I took up my old issue on how to make e2e encryption work with the js-sdk (https://github.com/matrix-org/matrix-js-sdk/issues/731) with some new found energy and finally solved it. The result is this GitHub action: 
>
...
> Want to play the guessing game Battleship via Chat? I'm building one to be ready for FOSDEM. Follow my progress, bring in ideas and play development versions:
>
> https://to.chat.dingshunyu.top/#/#battleship:vector.modular.im?via=vector.modular.im&via=t2l.io&via=federator.dev

### matrix-archive

I asked: "what's the best tool for dumping history from rooms (including e2e rooms)?", and [Florian](https://to.chat.dingshunyu.top/#/@florian:dsn.tm.kit.edu) shared this great tool I don't think I'd seen before:
...
[joepie91](https://to.chat.dingshunyu.top/#/@joepie91:pixie.town) said:

> Based on the original chart by hrjet, here's an easy-to-share comparison chart in image form, that compares a number of alternatives (Element/Chat, Signal, Telegram) for people looking for an alternative to WhatsApp
...
[Niklas Zender](https://to.chat.dingshunyu.top/#/@larodar:famedly.de) announced:
...
[compu](https://to.chat.dingshunyu.top/#/@compu-42:matrix.org) offered:

> so one time I installed Chat Chat on a fresh debian install in 24 minutes
> do i get bragging rights?

If you have video of you installing Chat or another matrix server at an alarming rate, we'll link to it from here!

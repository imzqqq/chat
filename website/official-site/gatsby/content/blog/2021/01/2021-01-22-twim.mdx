---
date: '2021-01-22'
title: 'This Week in Chat 2021-01-22'
categories:
  - This Week in Chat
author: Ben Parsons
...
[Eric Migicovsky](https://to.chat.dingshunyu.top/#/@eric:beeperhq.com) announced:

> _NovaChat is now_
>
> #### Beeper
>
> * New website! [beeperhq.com](https://beeperhq.com). Beeper is a Chat server+client combo preconfigured with 12+ bridges. Our mission is to bring a lot of new users into the Chat ecosystem and give them a fast and powerful client to message people on all networks. Beeper is a paid subscription service, but since all the bridges are open source, you can set the whole system up yourself for free if you choose
>
...
> * If you're interested, please send me a DM [@eric:beeperhq.com](https://to.chat.dingshunyu.top/#/@eric:beeperhq.com)
...
Google Summer of Code has come around again! Last year was really successful for Chat: six projects, with members of the community coming forward to mentor students for their project. This year there is a slight tweak to the formula: [the projects will now be 175 hours, rather than the traditional 350, over the summer](https://opensource.googleblog.com/2020/10/google-summer-of-code-2021-is-bringing.html).

Since we need to [submit an application to Google within the next few weeks](https://summerofcode.withgoogle.com/how-it-works/#timeline), I have a request: if you admin a Chat-related Open Source project and would like to have a student work with you over the summer, get involved!
...
>
> We've also dramatically improved the performance of redactions in large rooms, helping Chat's moderation tools scale to communities of any size ([#9022](https://github.com/matrix-org/synapse/issues/9022)). And speaking of scaling, Chat 1.26 makes it possible to offload many different APIs to worker processes, including read receipts and account data persistence.
>
> Lastly, Chat 1.26 will include support for multiple Single Sign-On Identity providers, though we expect further fit-and-finish for that feature to land in 1.27.
>
...
[Adrien](https://to.chat.dingshunyu.top/#/@glandos:matrix.org) added:
...
[FluffyChat](https://fluffychat.im) is a cute cross-platform matrix client. It is available for Andorid, iOS, Web and Desktop.
...
[Gary Kim](https://to.chat.dingshunyu.top/#/@gary:garykim.dev) said:
...
[TR_SLimey](https://to.chat.dingshunyu.top/#/@tr_slimey:an-atom-in.space) announced:

> I've set up an Element Web instance on [IPFS](https://ipfs.io/), which means that now, not even Chat client downloads can be blocked - censorship resistance at its finest :P
>
> It can be found at:
>
...
[erdnaxeli](https://to.chat.dingshunyu.top/#/@erdnaxeli:cervoi.se) reported:

> Today a present you a Chat client library I've been working for the last few months: [caridina](https://github.com/erdnaxeli/caridina).
>
...
[Cadair](https://to.chat.dingshunyu.top/#/@cadair:cadair.com) said:

> [TWIM](https://to.chat.dingshunyu.top/#/):
>
> #### opsdroid
>
> [opsdroid](https://opsdroid.dev/) is an easy to use chat-ops framework with excellent Chat support.
>
> #### 0.20 Release
>
...
> #### Highlights
>
> * End to End Encryption support in the Chat connector.
>
> * Chat database now included in core, with e2ee support.
...
>
> If you have any questions or want to get involved come say hi in [#opsdroid:matrix.org](https://to.chat.dingshunyu.top/#/#opsdroid:matrix.org), raise an issue on [GitHub](https://github.com/opsdroid/opsdroid) and checkout [the docs](https://docs.opsdroid.dev).



### trixnity (kotlin) progress

[Benedict](https://to.chat.dingshunyu.top/#/@benedict:imbitbu.de) said:

> A little sneak peek from [trixnity](https://github.com/benkuly/trixnity), a crossplatform Chat SDK. Currently I have some issues with ktor, which breaks my serialization.
...
[matrix-corporal](https://github.com/devture/matrix-corporal) manages your Chat server according to a configuration policy

[Slavi](https://to.chat.dingshunyu.top/#/@slavi:devture.com) reported:
...
>
> * **device-free login** is now used when impersonating users (thanks to a new API introduced by Chat v1.24.0) - this is both faster and more resilient.
>
...
>
> * **fixes user-creation regression** that happened with Chat v1.24.0. matrix-corporal v1.12.0 is also out, with a backport of this fix (for users who don't want to jump to 2.0 yet).
...
[Marvin Dropp](https://to.chat.dingshunyu.top/#/@s3858136:tu-dresden.de) said:
...
[Christian Bruchatz](https://to.chat.dingshunyu.top/#/@s8108530:tu-dresden.de) shared some addional context about their deployment growth:

![2021-01-22-wC6rz-image.png](/blog/img/2021-01-22-wC6rz-image.png)

Watch Chat Live (at the top) this week for a chat with Marvin and Christian.

### Deploying a Chat server on Fedora CoreOS, from fedoramagazine.org

[Andy](https://to.chat.dingshunyu.top/#/@andycuccaro:matrix.org) announced:

> I couldn't find if someone else shared this, but Fedora just published an article about deploying a Chat server on Fedora CoreOS.
>
...
[kim (HarHarLinks@github.com)](https://to.chat.dingshunyu.top/#/@kim:sosnowkadub.de) told us:

> EMS-Slack Bridge (matrix-appservice-slack) in German IT news
>
> https://www.heise.de/news/Dezentraler-Firmenchat-mit-Slack-und-Chat-5030856.html
...
* [Jay Graber (arcalinea) published a new post discussing decentralised moderation](https://jaygraber.medium.com/designing-decentralized-moderation-a76430a8eab), which is a serious question for Chat



[Cos](https://to.chat.dingshunyu.top/#/@cos:hacklab.fi) announced:

> btw i forgot to TWIM that there was once again long Chat article in Finnish computer culture paper magazine Skrolli. December issue.

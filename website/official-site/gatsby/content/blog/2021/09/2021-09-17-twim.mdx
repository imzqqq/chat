---
date: '2021-09-17'
title: 'This Week in Chat 2021-09-17'
categories:
  - This Week in Chat
author: Thib
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/5sXzSiMCh6c" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
>
> This one is entirely new to me, and has some slight overlap with some work for [MSC2762: Allowing widgets to send/receive events](https://github.com/matrix-org/matrix-doc/pull/2762), where we were thinking about how a widget could act as a calendar using Chat rooms and events as a calendar backend.
>
> The more you know 🌠
...
> The Chat team is busy gearing up for 1.43.0 next week, which will make room version 9 the default for newly created [restricted rooms](https://github.com/matrix-org/matrix-doc/pull/3083), among other things.
>
...
>
> Lastly, [Hacktoberfest 2021](https://hacktoberfest.digitalocean.com/) is less than two weeks away! Many Chat projects intend to participate, including Chat.
...
[ajbura](https://to.chat.dingshunyu.top/#/@ajbura:matrix.org) announced:
...
[Alexandre Franke](https://to.chat.dingshunyu.top/#/@afranke:matrix.org) got a bit carried away and announced in French:
...
[Brad Murray](https://to.chat.dingshunyu.top/#/@brad:beeper.com) offered:

> Beeper is a unified chat app built on top of Chat. We've created 10+ open source Chat bridges and integrated them into an easy to use all-in-one service which does not require setting up your own homeserver. You can learn more at [beeper.com](http://beeper.com/).
>
...
> #### Bots
>
> * Wrote a bot for managing Linear issues from Chat: https://gitlab.com/beeper/linear-maubot
>
...
> #### Hiring
>
> * We are hiring! Come join many other Chat community members who have joined the Beeper team including @tulir:maunium.net, @annie:beeper.com, @kilian:beeper.com, @spiritcroc:beeper.com and @sumner:beeper.com (who replied to our last TWIM job post and got a job at Beeper within a week!)
>
...
>
> I hope this clears up some of the confusion. Feel free to visit us in [#nheko:nheko.im](https://to.chat.dingshunyu.top/#/#nheko:nheko.im) and tell me, that I am wrong.
...
[uhoreg](https://to.chat.dingshunyu.top/#/@hubert:uhoreg.ca) announced:

> Polyjuice is a collection of Chat libraries in Elixir.
>
> #### Polyjuice 🧙
>
> A few from the wizarding world this week.
>
> The Polyjuice project wades further into bad pun territory with a new project: [Polyjuice Draughts](https://gitlab.com/polyjuice/polyjuice_draughts), a set of checkers to verify that a homeserver is set up correctly and is accessible for clients and federation.  It is similar in goal to the Chat Federation Tester, but also checks client connections.  It can either be run from the command line, or it can be used in a Chat room, thanks to [Igor](https://gitlab.com/uhoreg/igor), by sending a message of the form `!servertest <servername>` in a room that has an appropriately-configured bot in it.  There is currently a bot in [#synapse:matrix.org](https://to.chat.dingshunyu.top/#/#synapse:matrix.org) that can be used.
...
[Alexey](https://to.chat.dingshunyu.top/#/@murz:ru-matrix.org) reported:
...
[Christian](https://to.chat.dingshunyu.top/#/@christianp:vector.modular.im) offered:

> Are you in Berlin 🐻🇩🇪? Why not join us on Tuesday evening at 7:30 PM for a beer or two while chatting about Chat development and hosting. We're going to meet at [Schoenbrunn](https://osm.org/node/5303035837). This is a small 3G (self-tests are ok) event in an outdoor beer garden.
>
> If possible, join our [Chat Meetup Berlin](https://to.chat.dingshunyu.top/#/[#matrix-berlin:matrix.org](https://to.chat.dingshunyu.top/#/#matrix-berlin:matrix.org)) room.
...
[Timo](https://to.chat.dingshunyu.top/#/@toger5:matrix.org) said:
...
>
> Play with it at: https://toger5.github.io/TheBoard/ (feel free to join: https://to.chat.dingshunyu.top/#/#PublicWhiteboardTest_TheBoard:matrix.org with the account used for testing to join the first collaborative board)
> Join the matrix room: https://to.chat.dingshunyu.top/#/#TheBoard:matrix.org
>
...
[Robert Long](https://to.chat.dingshunyu.top/#/@arobertlong:matrix.org) announced:

> Third Room is an experimental metaverse client I've been working on for the past couple weeks. It combines three.js and Chat to create 3D voice chat rooms where you embody an avatar.
>
...
>
> If you want to chat more about Third Room, you can join our Chat room: [#thirdroom-dev:matrix.org](https://to.chat.dingshunyu.top/#/#thirdroom-dev:matrix.org)
...
Beeper mentioned they have several positions open, and [Element is also talents hungry](https://element.io/careers). I’m particularly extatic to see that developing skills around Chat can get people jobs. Of course I encourage strongly people to experiment with the protocol and use it in all sorts of crazy ways!

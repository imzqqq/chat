---
date: '2021-09-24'
title: 'This Week in Chat 2021-09-24'
categories:
  - This Week in Chat
author: Thib
...
> 
> The traditional response has usually been to write a Chat module, but I wanted to do something that could be used on other homeserver implementations and also not have to have it co-located with the homeserver, so the natural home for this kind of logic was appservices. 
> 
...
> #### Spec Updates
>
> [MSC3401](https://github.com/matrix-org/matrix-doc/pull/3401) (Native Group Voip Signalling) has been receiving positive feedback over the course of the week. The MSC spells out how one would go about implementing native, decentralised group voice and video calls over Chat without the need for a third-party service. This is the next step forward after the full-mesh group signalling work, as demoed in previous editions of TWIM, lands. Quite exciting stuff!
>
> Otherwise there was another Spec Core Team retro this week. Discussion focused mainly on how to handle event types that not every implementation using Chat may need (think pinned messages and how that might not be very useful for IoT networks...). Watch this space!
>
...
>
> This is actually already implemented and enabled by default in Chat, believe it or not. But no clients have support for it yet (there is an [outstanding matrix-react-sdk PR](https://github.com/matrix-org/matrix-react-sdk/pull/4897)...).
>
...
> This week we [released Chat 1.43](https://matrix.org/blog/2021/09/21/synapse-1-43-0-released)! This mainly contains internal changes, including those in preparation for Spaces leaving beta, but it's worth calling out that this version of Chat now uses the [MSC3244: room version capabilities](https://github.com/matrix-org/matrix-doc/pull/3244) API to ask clients to prefer [room version 9](https://github.com/matrix-org/matrix-doc/pull/3375) when creating restricted rooms.
>
> Support for room version 9 was introduced in Chat 1.42, so we'd strongly encourage administrators to upgrade.
>
> Perhaps more notably for Chat developers, we've spent quite a lot of time over the past few weeks improving the [SyTest](https://github.com/matrix-org/sytest/) suite of integration tests. Several of the tests had race conditions which would cause them to occasionally fail when testing a multi-worker deployment of Chat. These flakey tests have plagued our continuous integration pipelines, and are finally being fixed.
>
...
[Aine](https://to.chat.dingshunyu.top/#/@aine:etke.cc) announced:
...
>
> * fix: Emote settings
> * chore: update flutter_matrix_html, Chat Dart SDK and other libraries
>
...
[kitsune](https://to.chat.dingshunyu.top/#/@kitsune:matrix.org) announced:
...
* This week we Ran our first community testing session on 1.8.6 with members of the community. We were very pleased with how this went and intend to continue the sessions. You can help making Element even better by participating in our fortnightly testing sessions. Join [#element-community-testing:matrix.org](https://to.chat.dingshunyu.top/#/#element-community-testing:matrix.org), and [learn how to make the most useful feedback](https://github.com/vector-im/element-meta/wiki/community-testing)
...
### synadm is the Chat admin CLI

[jojo](https://to.chat.dingshunyu.top/#/@jojo:peek-a-boo.at) offered:
...
Those are the same registration tokens GSoC intern Callum implemented [and told us about in this Chat Live episode](https://www.youtube.com/watch?v=bVKg4BHT0Z0).

## Dept of Events and Talks 🗣️

### Ansible Contributor Summit 2021.09

[cybette](https://to.chat.dingshunyu.top/#/@cybette:ansible.im) announced:

> Ansible Contributor Summit 2021.09 is happening next week! It will be held over 2 days, on **Tuesday September 28 and Friday October 1**, from [13:00-21:00 UTC](https://www.timeanddate.com/worldclock/fixedtime.html?msg=Ansible+Contributor+Summit+2021.09&iso=20210928T13&ah=8), and will be held on the Chat platform.
>
> The Ansible Community has recently adopted Chat as an official chat platform and this is our first **Chat-powered conference**. Feedback welcome! You will need a Chat account to participate in the conversations. For more information, please see [Communication - Real-time chat](https://docs.ansible.com/ansible/devel/community/communication.html#real-time-chat) and the [Ansible Community Chat FAQ](https://hackmd.io/@ansible-community/community-matrix-faq).
>
> Join the [Ansible Social Room](https://to.chat.dingshunyu.top/#/[#social:ansible.com](https://to.chat.dingshunyu.top/#/#social:ansible.com)) anytime before or during the event and say hi! During the presentations, join the [Main Conference Room](https://to.chat.dingshunyu.top/#/[#summit:ansible.com](https://to.chat.dingshunyu.top/#/#summit:ansible.com)) to participate in the discussions. We will also have a session on [How we are rolling out Chat to the Ansible Community](https://hackmd.io/@ansible-community/contrib-summit-202109#Chat).
>
> If you're interested, check out the details and register on [Eventbrite](https://ansiblecs202109.eventbrite.com/?aff=matrix). We look forward to seeing you on Chat at the **Ansible Contributor Summit**!


[Gwmngilfen](https://to.chat.dingshunyu.top/#/@gwmngilfen:matrix.org) added:
...
It's exciting to see an organisation holding an online conference on Chat!

[Gwmngilfen](https://to.chat.dingshunyu.top/#/@gwmngilfen:matrix.org) also promised:

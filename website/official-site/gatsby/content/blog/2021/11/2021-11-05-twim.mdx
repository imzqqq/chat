---
date: '2021-11-05'
title: 'This Week in Chat 2021-11-05'
categories:
  - This Week in Chat
author: Thib
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/8_L7jQmlIH4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
[callahad](https://to.chat.dingshunyu.top/#/@callahad:matrix.org) announces

> This week we released [Chat 1.46](https://github.com/matrix-org/synapse/releases/tag/v1.46.0)! This release includes a fix for the [performance regression](https://github.com/matrix-org/synapse/issues/11049) from 1.44 which could cause smaller hosts to lock up when clients reconnected after some time offline.
> 
> Chat 1.46 also includes experimental support for [MSC3440: Threading via `m.thread` relation](https://github.com/matrix-org/matrix-doc/pull/3440), a big step toward threaded messaging in Chat. It's otherwise mainly a bugfix release, as we've spent much of our time reviewing infrastructure and making plans to improve our resilience should we experience hardware failures similar to what took out matrix.org two weeks ago.
> 
...
A Chat-WhatsApp puppeting bridge

[tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) says
...
[hifi](https://to.chat.dingshunyu.top/#/@hifi:vi.fi) reports
...
> We are preparing for a release! That means, if you are translator, we could use your help to get our translations [updated](https://weblate.nheko.im/projects/nheko/nheko-master/) and if you want to have a bug fixed before release, now is the time to report it or complain about it! Please come and see us in [#nheko:nheko.im](https://to.chat.dingshunyu.top/#/#nheko:nheko.im) for complaints and questions!
> 
...
[Bruno](https://to.chat.dingshunyu.top/#/@bwindels:matrix.org) reports
...
Chat messaging app for GNOME written in Rust.

[Alexandre Franke](https://to.chat.dingshunyu.top/#/@afranke:matrix.org) says

> To adapt to changes in libadwaita, Marco Melorio [removed a deprecated class](https://gitlab.gnome.org/GNOME/fractal/-/merge_requests/864). In the meantime, enterprisey [fixed the build by updating the Chat Rust SDK dependency](https://gitlab.gnome.org/GNOME/fractal/-/merge_requests/866) and [improved Secret Service error handling](https://gitlab.gnome.org/GNOME/fractal/-/merge_requests/844).
> 
...
[Thib](https://to.chat.dingshunyu.top/#/@thib:ergaster.org) reports
...
[Thib](https://to.chat.dingshunyu.top/#/@thib:ergaster.org) says
...
[houkime](https://to.chat.dingshunyu.top/#/@houkime:m.wfr.moe) reports
 
> Godot-Chat is a C++ module for connecting to Chat from the [Godot Game Engine](https://godotengine.org/).
...
> * Respect port numbers (as per Chat spec)
> * Substantial rewrite of the example so it works
> 
> Refurbishment made with love for the participants of [FediJam 4](https://itch.io/jam/fedijam-4), a weeklong gamedev competition with the focus on fediverse and federated multiplayer (via Chat or any other means ^_^).
> It starts this Sunday at 18:00 UTC. [Chat](https://to.chat.dingshunyu.top/#/#fedijam:m.wfr.moe)
> 
> ![](/blog/img/vfPUnqJMwGguvBRDvHJWyNVj.png)

### Chat-Rust-SDK-Bot-Framework-Helper [↗](https://github.com/MTRNord/mrsbfh)

A toolkit for writing commandbots more efficient in rust for matrix.

[MTRNord](https://to.chat.dingshunyu.top/#/@mtrnord:nordgedanken.dev) announces
...
[gen3](https://to.chat.dingshunyu.top/#/@gen3:blackline.xyz) announces
...
> 
> More info at on the project at https://github.com/WesR/Halcyon . Come by and chat with us over in https://to.chat.dingshunyu.top/#/#halcyon:blackline.xyz
...
[Aine](https://to.chat.dingshunyu.top/#/@aine:etke.cc) announces
...
> 
> Check out the [source code](https://gitlab.com/etke.cc/miounne), [releases](https://gitlab.com/etke.cc/miounne/-/releases), [docker images](https://gitlab.com/etke.cc/miounne/container_registry/2044748 ) and say hello in [#miounne:etke.cc](https://to.chat.dingshunyu.top/#/#miounne:etke.cc)

## Dept of Bots 🤖

### matrix-vacation-responder

[Sumner Evans](https://to.chat.dingshunyu.top/#/@sumner:nevarro.space) says

> I created a [Vacation Responder for Chat](https://sr.ht/~sumner/matrix-vacation-responder/). While running, it responds to any DMs that come in to your account with a preset message. It can be configured to only respond once in a given period of time (defaults to 24 hours) so that the person contacting you can queue up questions for you when you return. Other ways to use the bot include responding to DMs to previously active accounts (for example if you move homeservers). Join the discussion about this bot at [#matrix-vacation-responder:nevarro.space](https://to.chat.dingshunyu.top/#/#matrix-vacation-responder:nevarro.space).

## Dept of Events and Talks 🗣️

### SeaGL (the Seattle GNU/Linux Conference)

[Salt](https://to.chat.dingshunyu.top/#/@salt:sal.td) announces

> [SeaGL (the Seattle GNU/Linux Conference)](https://seagl.org) is being held on Chat Friday and Saturday, November 5th and 6th, from 9am-5pm Pacific Time. The conference is running on a customized version of element-web and a regional Chat homeserver, found at https://attend.seagl.org
> 
...
[Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) announces
...
[Cadair](https://to.chat.dingshunyu.top/#/@cadair:cadair.com) reports

> Following a question from someone about getting started with Chat bots, I wrote a super quick getting started guide to writing a simple bot with opsdroid. I will probably integrate this into the opsdroid docs, or somewhere more accessible in the future, but for now here it is: https://gist.github.com/Cadair/2c64cb46fdce7499ff1c0bbb116ce29e

Being an innocent child, I asked:

> are you aware of projects relying on opsdroid to make a Chat bot? Other than half of the very famous TWIM bot 😇

[Cadair](https://to.chat.dingshunyu.top/#/@cadair:cadair.com) answered
...
> 
> I can also go and ask for examples in [#opsdroid-general:matrix.org](https://to.chat.dingshunyu.top/#/#opsdroid-general:matrix.org) if you like?

I didn't know what I had started! We almost became This Week in Opsdroid! Fortunately the Chat community is very active and helped us keeping sovereignty over the blog. Phew!
...
[Pascal](https://to.chat.dingshunyu.top/#/@lascapiriot:matrix.org) brought to our attention [a nice guide from the Fedora Magazine](https://fedoramagazine.org/multiple-matrix-sessions-with-element-on-fedora-linux/) on how to have multiple matrix sessions with Element on Fedora.

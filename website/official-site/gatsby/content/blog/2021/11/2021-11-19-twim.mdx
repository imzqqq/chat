---
date: '2021-11-19'
title: 'This Week in Chat 2021-11-19'
categories:
  - This Week in Chat
author: Thib
...
Friday already? Did this week already happen? It looked like the spacetime continuum was broken and we didn't know who did it. We needed witnesses to solve the case: did things really happen this week? And the witnesses showed up! A huge thanks to everyone in the Chat community who reported their progress, and to everyone currently working on making awesome projects around Chat!
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/_G2z-LOhPjg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

A very very dense and exciting wrap up of what's happening these days in the Chat space by Chat Foundation co-founders Matthew & Amandine! Chat is stepping up a gear with blazing fast Sync v3, Threading Support, VoIP, VR, a new release of the Spec, always more monthly active users, a full security audit and progress on P2P.

## Dept of Spec 📜

[anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz) says
...
> **Note:** we plan to release a **security release, Chat 1.47.1** on the coming **Tuesday, 23rd of November**; see the [predisclosure](https://matrix.org/blog/2021/11/18/pre-disclosure-upcoming-security-release-of-synapse-1-47-1).
> 
> We released Chat 1.47.0 after squashing a couple of problems related to database migrations remaining in 1.47.0rc2.  Briefly, this release includes
> 
...
> 
> Thank you as ever to our community contributors, and everyone out there who's using Chat to communicate!

[dmr](https://to.chat.dingshunyu.top/#/@dmrobertson:matrix.org) also reminds us
...
[dkasak](https://to.chat.dingshunyu.top/#/@dkasak:termina.org.uk) adds
...
Heisenbridge is a bouncer-style Chat IRC bridge.

[hifi](https://to.chat.dingshunyu.top/#/@hifi:vi.fi) says

> Release v1.7.0 🥳
> * Implement "best effort" basic IRC moderation in plumbed rooms if bot has ops on IRC
> * Allow configuring topic sync for plumbs (IRC<->Chat or one way)
> * Allow using forward slash (/) as MXID separator for IRC ghosts
> * Bump max mautrix version to <0.12
> * Small fixes
> 
> Plumb moderation! If the bridge bot has ops on IRC it will do its best to map kicks and bans (regarding IRC users) from Chat. This definitely isn't perfect and is meant as a convenience.
> 
> Topic synchronization is now configurable for plumbs as well to make it possible to share the same topic between an IRC channel and a plumbed Chat room. Default is still off and it requires the bridge bot to have enough PL to work.
> 
...
> 
> As always, come check us out and chat about Nheko in [#nheko:nheko.im](https://to.chat.dingshunyu.top/#/#nheko:nheko.im) ♥
...
[Nad](https://to.chat.dingshunyu.top/#/@nadonomy:matrix.org) says
...
[Nad](https://to.chat.dingshunyu.top/#/@nadonomy:matrix.org) reports
...
[Nad](https://to.chat.dingshunyu.top/#/@nadonomy:matrix.org) updates us with
...
The time command, but it sends the output to a Chat room

[Aine](https://to.chat.dingshunyu.top/#/@aine:etke.cc) reports

> after the Miounne update posted a minute ago here is another one, and it's about time: Time To Chat (ttm) got v1.4.0 release!
> 
> Time To Chat is a `time`-like command that will send end of an arbitrary command output and some other info (like exit status) to matrix room.
> 
> With new release, following things were added:
> 
> * arch linux AUR package
> * automatic room alias resolving, so you can use [#ttm:etke.cc](https://to.chat.dingshunyu.top/#/#ttm:etke.cc) instead of !XODRhTLplrymaFicdK:etke.cc
...
> 
> Go check out the [source code](https://gitlab.com/etke.cc/ttm) and say hello in [#ttm:etke.cc](https://to.chat.dingshunyu.top/#/#ttm:etke.cc)
...
> 
> Go check out the [source code](https://gitlab.com/etke.cc/miounne) and say hello in [#miounne:etke.cc](https://to.chat.dingshunyu.top/#/#miounne:etke.cc)

## Dept of Bots 🤖

### Mjölnir [↗](https://github.com/matrix-org/mjolnir)

The moderation bot for Chat

[Yoric](https://to.chat.dingshunyu.top/#/@dotyoric:matrix.org) announces
...
[Henri Carnot](https://to.chat.dingshunyu.top/#/@henri2h:carnot.cc) says
...
> [Chat](https://to.chat.dingshunyu.top/#/!dDmzUleHWblVbYBPcf:carnot.cc?via=carnot.cc)
...
[Timo ⚡️](https://to.chat.dingshunyu.top/#/@timokoesters:fachschaften.org) announces
...
> ---
> 
> This week's room is: [#travel:hacklab.fi](https://to.chat.dingshunyu.top/#/#travel:hacklab.fi) 
> 

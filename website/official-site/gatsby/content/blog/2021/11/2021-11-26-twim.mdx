---
date: '2021-11-26'
title: 'This Week in Chat 2021-11-26'
categories:
  - This Week in Chat
author: Thib
...
> 
> Regardless, thank you very much to Bruno for going through and finally untangling and help land aggregations in the spec! This MSC is one of four which describe how aggregations should work in Chat, and it's great to see them finally being properly spec'd, especially as further features start to be built on top of them (such as [threading](https://github.com/matrix-org/matrix-doc/pull/3440/)!).
> 
...
> 
> These days, that is often achieved by homeserver implementation-specific solutions, such as [modules](https://matrix-org.github.io/synapse/latest/modules/) in Chat. Being able to notify of these events using a standard API shape would be hugely beneficial to generalisation of projects.
> 
...
> As predicted last week, we [released Chat 1.47.1](https://matrix.org/blog/2021/11/23/synapse-1-47-1-released) on Tuesday. This is a security release which fixes an issue with Chat's built-in media repository. Admins are strongly encouraged to upgrade.
> 
> Otherwise, relatively slow week: a handful of of the team have been away (Happy Thanksgiving, Americans!), but we *did* release [Chat 1.48.0rc1](https://github.com/matrix-org/synapse/releases/tag/v1.48.0rc1). Most importantly, this release candidate includes changes to improve the efficiency of large background updates from past releases, which should significantly reduce database load when upgrading. It also adds support for the `/v3` APIs defined in version 1.1 of the Chat specification.
> 
...
[tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) reports
...
> 
> * Bridging edits, deletions, reactions, formatting and read receipts in both directions (even `/rainbow` somewhat works from Chat)
> * Bridging typing notifications and any types of files from Chat to Google Chat
> * Bridging Google Meet links from Google Chat to Chat
...
### Chat Webhook Receiver [↗](https://github.com/HarHarLinks/matrix-webhook-receiver)
...
[kim](https://to.chat.dingshunyu.top/#/@kim:sosnowkadub.de) announces

> [Chat Webhook Receiver](https://github.com/HarHarLinks/matrix-webhook-receiver)
> 
> Do you like to receive notifications in matrix?
> Chat Webhook Receiver (MWR) is an add-on for the [matrix-appservice-webhooks](https://github.com/turt2live/matrix-appservice-webhooks) bridge. [Webhooks](https://en.wikipedia.org/wiki/Webhook) are essentially web interfaces for applications to "push" data to.
...
> * Grafana Alerts
> 
> For example, here is the GitHub webhook as seen in [#matrix-webhook-receiver:matrix.org](https://to.chat.dingshunyu.top/#/#matrix-webhook-receiver:matrix.org):
...
> * [#matrix-webhook-receiver:matrix.org](https://to.chat.dingshunyu.top/#/#matrix-webhook-receiver:matrix.org)

What a massive update! At this rate I won't need to leave my Chat client for anything!

### matrix-hookshot [↗](https://github.com/Half-Shot/matrix-hookshot)

A multi purpose multi platform bridge, formerly known as matrix-github

[Half-Shot](https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk) says
...
An interesting update, and Half-Shot even demoes it in today's Chat Live!
...
[Bruno](https://to.chat.dingshunyu.top/#/@bwindels:matrix.org) says
...
> 
> **Community Testing**
> * Bug squash session on Web on Tuesday 30 November at 17:00 UTC, join the call at [#element-community-testing:matrix.org](https://to.chat.dingshunyu.top/#/#element-community-testing:matrix.org)
...
> simplematrixbotlib is an easy to use bot library for the Chat ecosystem written in Python and based on matrix-nio. Version 2.4.0 provides several new features and a fix.
> ### New Features:
...
[brevilo](https://to.chat.dingshunyu.top/#/@brevilo:matrix.org) reports
...
Command line admin tool for Chat (Chat reference homeserver)

[jojo](https://to.chat.dingshunyu.top/#/@jojo:peek-a-boo.at) reports
...
A plugin-based Chat bot system.
...
[Henri Carnot](https://to.chat.dingshunyu.top/#/@henri2h:carnot.cc) announces
...
> 
> Come chat with us : [#minestrix:carnot.cc](https://to.chat.dingshunyu.top/#/#minestrix:carnot.cc)
...
[Mish](https://to.chat.dingshunyu.top/#/@mishushakov:matrix.org) says

> Federated sign-in component for your web app (using Chat)
> 
> This week's update:
...
As last week, a note to keep in mind that this is a community project and that there is a MSC to make Chat more OAuth2 friendly. More on that very soon!

## Dept of *Built on Chat* 🏗️

### Chat Forms

[Mish](https://to.chat.dingshunyu.top/#/@mishushakov:matrix.org) reports

> First release of "Chat Forms", a project which redirects form submissions to designated Chat rooms
> 
> Features:
...
[MTRNord](https://to.chat.dingshunyu.top/#/@mtrnord:nordgedanken.dev) says

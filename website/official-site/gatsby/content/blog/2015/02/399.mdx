---
date: '2015-02-12'
title: Chat 0.7.0 and matrix-angular-sdk 0.6.2 released!
categories:
  - Tech
author: Matthew Hodgson
---

We just pushed out a major new release of <a href="http://github.com/matrix-org/synapse">Chat 0.7.0</a>, the python reference server for Chat, and a minor maintenance update for <a href="http://github.com/matrix-org/matrix-angular-sdk">matrix-angular-sdk 0.6.2</a>, the reference web client implementation.
...
Thanks to everyone running servers - please upgrade, tell your friends, and help us grow Chat!
...
<pre>
Changes in Chat Angular SDK 0.6.2 (2015-02-12)
================================================
Bug fixes:

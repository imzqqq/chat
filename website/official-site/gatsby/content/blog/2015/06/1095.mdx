...
Over the past two weeks, we have been hunting down some more performance issues in Chat, as well as fixing a few potential bugs in the new backfill feature that we introduced in 0.9.1. For those that were having issues, this release should really help speed up when your server joins larger remote rooms.

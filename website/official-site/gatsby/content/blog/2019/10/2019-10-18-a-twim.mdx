---
date: '2019-10-18'
title: 'This Week in Chat 2019-10-18'
categories:
  - This Week in Chat
author: Ben Parsons
---
...
Last week Chat had a presence at UbuCon Europe and PyCon Ireland. We gave workshops on using Chat to create bots, and also a session on installing Chat (see also: Brendan's entry below!)

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Hey <a href="https://twitter.com/hashtag/PyConIE?src=hash&amp;ref_src=twsrc%5Etfw">#PyConIE</a>! We hope you enjoyed the Chat workshop, find the slides and code samples at <a href="https://t.co/aT1dDuEcm1">https://t.co/aT1dDuEcm1</a> and make sure to ask any more questions! <a href="https://t.co/C2qwV5R3gl">pic.twitter.com/C2qwV5R3gl</a></p>&mdash; Chat (@matrixdotorg) <a href="https://twitter.com/matrixdotorg/status/1183060946580840451?ref_src=twsrc%5Etfw">October 12, 2019</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

Tomorrow I'm off to sunny Manchester with Michael from the Ops team. We'll visit OggCamp, where we'll show off Chat with a fun demo I previewed on Chat Live a few weeks ago.

Chat will ALSO be at:
...
> For a workshop anoa and I did at Ubucon Europe last Sunday on how to install Chat, I worked on a side project that creates a server, attaches a domain name to it and installs Riot and Caddy on it. Attendees can then SSH into it, follow the instructions to install a Chat homeserver, and use Riot to register an account on it, log in, and join a federated room with all of the other attendees' homeservers in it.
> We tried it out last week-end for the actual workshop and it worked quite well 🙂
> The project is called Install Party, and lives at <https://github.com/babolivier/install-party>, and if you want to chat about it I've just created [#install-party:abolivier.bzh](https://to.chat.dingshunyu.top/#/#install-party:abolivier.bzh) 😉
...
[Chat 1.4.1](https://matrix.org/blog/2019/10/18/synapse-1-4-1-released) was released, which fixes a small regression in 1.4.0.

## Dept of Bridges 🌉

### Chat-Slack Bridge on NixOS

[@christian:kampka.net](https://to.chat.dingshunyu.top/#/@christian:kampka.net) said:
...
[@swedneck:permaweb.io](https://to.chat.dingshunyu.top/#/@swedneck:permaweb.io) said:
...
### Chat Chat for Kubernetes

[Ananace](https://to.chat.dingshunyu.top/#/@ace:kittenface.studio) offered:

> just pushed Version 1.4.1 of the Chat Chat for Kubernetes packaging. A bit fiddly to do on a phone 🙂

### Chat 1.4.1 multi-arch docker image

[Black Hat](https://to.chat.dingshunyu.top/#/@bhat:encom.eu.org) told us:

> I'm building the Chat 1.4.1 multi-arch docker image. It will be pushed to Docker Hub in a couple of hours.

## Dept of Tulir 🇫🇮

A special section this week from the guy with one editor open for everything, [tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net):
...
>
> Also, I made a read-only status.matrix.org rss feed room since some people wanted one: [#matrix.org-status:maunium.net](https://to.chat.dingshunyu.top/#/#matrix.org-status:maunium.net). I don't remember if I TWIMed these before, but [#xkcd:maunium.net](https://to.chat.dingshunyu.top/#/#xkcd:maunium.net) and [#commitstrip:maunium.net](https://to.chat.dingshunyu.top/#/#commitstrip:maunium.net) are similar read-only rooms, new xkcds and commitstrips are posted there whenever they come out.

...
Hello Chat enthusiasts! Yesterday we released [matrix-appservice-slack 1.0](https://github.com/matrix-org/matrix-appservice-slack/releases/tag/1.0.0). This marks a major milestone
in bridge development for the Chat team, being our first bridge to ever reach 1.0. The decision to
...
For those not in the know, the Slack bridge is Node.JS based, and bridges slack channels & users into Chat
...
directly, when you talk using your Chat account. This opens the door to seamless bridging and direct messaging support.

For those wishing to bridge their whole workspace across, [picard](https://github.com/SolarDrew/skill-picard) exists
as a tool to manage large scale Slack bridge deployments. This tool is provided by [Cadair](https://to.chat.dingshunyu.top/#/@Cadair:matrix.org) and [SolarDrew](https://to.chat.dingshunyu.top/#/@SolarDrew:matrix.org)
...
is to continue adding support for other event types coming from Chat and Slack to create
...
That’s all from me, and I would like to say a massive thank you to [Cadair](https://to.chat.dingshunyu.top/#/@Cadair:matrix.org)
and [Ben](https://to.chat.dingshunyu.top/#/@benpa:matrix.org) for both their code and review work on the project and as always,
thank you to the community for using the bridge and reporting issues. 🙂

Useful links:

- [Chat Room](https://to.chat.dingshunyu.top/#/#matrix_appservice_slack:matrix.org)

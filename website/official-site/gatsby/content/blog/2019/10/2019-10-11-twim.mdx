---
date: '2019-10-11'
title: 'This Week in Chat 2019-10-11'
categories:
  - This Week in Chat
author: Ben Parsons
---
...
As you may have heard, New Vector, a major entity in the Chat world, [recently completed a series A funding round](https://matrix.org/blog/2019/10/10/new-vector-raises-8-5-m-to-accelerate-matrix-riot-modular).

Further reading:

* [$8.5M to accelerate Chat, polish Riot and expand Modular!](https://blog.vector.im/8-5m-to-accelerate-matrix/) (from New Vector)
...
Mozilla have been [trialing different IM solutions to replace IRC, including Chat](https://discourse.mozilla.org/t/synchronous-messaging-at-mozilla-trial-servers-feedback/44871). This trial ended this week, and we hope to hear the results this month. (C'mon, Chat!)
...
Update from [poljar](https://to.chat.dingshunyu.top/#/@poljar:matrix.org):
...
[toml](https://to.chat.dingshunyu.top/#/@tom:lant.uk) offered:
...
[uhoreg](https://to.chat.dingshunyu.top/#/@uhoreg:matrix.org) told us:

> [Polyjuice Client](https://hex.pm/packages/polyjuice_client), a Chat client library for Elixir, has a new release.  There is now a short [tutorial](https://hexdocs.pm/polyjuice_client/0.2.1/tutorial_echo.html) that will teach you how to make a simple echo bot with it.

---
date: '2019-10-26'
title: 'This Week in Chat 2019-10-26'
categories:
  - This Week in Chat
author: Ben Parsons
...
[@kb1rd:kb1rd.net](https://to.chat.dingshunyu.top/#/@kb1rd:kb1rd.net) told us:

> Just released the first version of the Chat Notepad, a small webapp designed to allow people to collaborate on text files over Chat. There are a bunch of bugs that I'm still working on fixing, but if you'd like to check it out it's [here](https://github.com/KB1RD/matrix-notepad)! I will be adding incremental fixes for various issues, but feel free to add to the issues. :) If you'd like to chat, I'll be checking [#matrix-collaboration:kb1rd.net](https://to.chat.dingshunyu.top/#/#matrix-collaboration:kb1rd.net).

## Dept of Servers 🏢

### Chat

[@richvdh:sw1v.org](https://to.chat.dingshunyu.top/#/@richvdh:sw1v.org) told us:

> This week much of the team's focus has been on performance, both in terms of dealing with matrix.org's immediate woes and some more strategic work on helping Chat to scale. On the latter front, Erik has been making great progress in supporting multiple Postgres databases.
>
> We've also put out a release candidate for Chat 1.5.0 with lots of bugfixes and changes under the hood. As ever, help with testing the RC is much appreciated!
...
> Cadair's [pull request](https://github.com/tulir/mautrix-hangouts/pull/10) to add Hangouts->Chat image bridging to mautrix-hangouts was merged.

## Dept of Clients 📱

### miitrix

From [sorunome](https://to.chat.dingshunyu.top/#/@sorunome:sorunome.de), this crazy 3DS project!
...
### Ruby Chat SDK version 1.5.0 released
...
>
> As always, feel free to drop by [#ruby-matrix-sdk:kittenface.studio](https://to.chat.dingshunyu.top/#/#ruby-matrix-sdk:kittenface.studio) if you have questions, comments, corrections, or just want to discuss the project - or use cases - in general.
...
> * room info callback
>
> Support room: [#matrix-3ds-sdk:sorunome.de](https://to.chat.dingshunyu.top/#/#matrix-3ds-sdk:sorunome.de)

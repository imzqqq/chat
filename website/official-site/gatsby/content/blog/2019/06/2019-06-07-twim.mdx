---
date: '2019-06-07'
title: 'This Week in Chat 2019-06-07'
categories:
  - This Week in Chat
author: Ben Parsons
...
We are *sooo* close to Chat 1.0. So close! The PR which annouces the arrival of v1.0 [exists already](https://github.com/matrix-org/matrix-doc/pull/2099).
...
Neil, who oversees the creation of [Chat]:

> Quiet week, not much happening, the only real progress has been shipping a Chat 1.0 release candidate :) Joking aside we’d really appreciate your help in testing it ahead of the full release next week. Get the RC here <https://github.com/matrix-org/synapse/releases/tag/v1.0.0rc1>
>
> Also friends don’t let friends operate a Chat install without a valid certificate on the federation API. Post 1.0, servers that are not compliant will be locked out of the federation. While the copy needs updating to reflect 1.0’s imminent release, our handy FAQ (<https://github.com/matrix-org/synapse/blob/master/docs/MSC1711_certificates_FAQ.md>) has all the details.
...
[Ruma], a homeserver written in Rust, has a new surge of activity following the [Rust language syntax developments](https://areweasyncyet.rs/) last week. [This Week in Ruma](https://www.ruma.io/news/this-week-in-ruma-2019-06-02/) received it's first edition in ~6 months!
...
Join the newly created room at [#matrix-synchrotron-balancer:sorunome.de](https://to.chat.dingshunyu.top/#/#matrix-synchrotron-balancer:sorunome.de) to discuss.
...
Are you in the know about Chat? If not, prepare to learn about [RiotX], a *completely re-written* Chat client for Android. This new version has a Kotlin SDK.
...
Join [#matrixservers:novaim.com](https://to.chat.dingshunyu.top/#/#matrixservers:novaim.com) for more.

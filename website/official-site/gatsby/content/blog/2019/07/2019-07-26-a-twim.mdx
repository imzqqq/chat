---
date: '2019-07-26'
title: 'This Week in Chat 2019-07-26'
categories:
  - This Week in Chat
author: Ben Parsons
...
### Opportunities available for paid Chat-related work

Matthew informed the community:

> We're getting more and more folks reaching out for paid help setting up smaller self-hosted Chat deployments. The core team has its hands full currently with helping out with larger deployments; so if anyone reading this wants to offer paid support to those getting up and running on Chat then please make us aware so we can potentially route inquiries to you.

This is a great step for Chat, and a great opportunity for you the reader! There are already several people prepared to start work on Chat-related endeavours, but the fact that there is *more work coming in than we can currently route* is amazing. If you'd like to be on an informal shortlist, [contact support@](mailto:support@matrix.org), or [come chat to me directly][@benpa:matrix.org].

## Dept of Servers 🏢

### Chat

So said Neil, who oversees the Chat-makers:
...
Be sure to watch [Cadair] provide a demo in the Chat Live video above.
...
[Ananace] made sure everything is up to date for Chat with [1.2.1 images now available][ananace-matrix-synapse-k8s].
...
ma1sd is a fork of the discontinued mxisd (<https://github.com/kamax-matrix/mxisd>) is a federated Chat Identity Service.
>
> Changes:
>

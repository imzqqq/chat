---
date: '2019-07-19'
title: 'This Week in Chat 2019-07-19'
categories:
  - This Week in Chat
author: Ben Parsons
image: https://official-site.dingshunyu.top/blog/img/2019-07-19-matrix-live.png
---

## Chat Live Smörgåsbord 🎙

Featuring: Open Tracing, Chat, Dendrite and Riot Web
...
* [MSC2176: Update the redaction rules](https://github.com/matrix-org/matrix-doc/pull/2176)
  * [richvdh](https://to.chat.dingshunyu.top/#/@richvdh:sw1v.org) storms in with 3 MSCs to fix some old spec issues relating to event redactions.
...
> `<community-hat>`  
> I'm working on a specification for exporting metadata and usage metrics out of federated servers. The aim is that the same specification could be re-used cross-protocol for example with not only Chat servers but also ActivityPub, Diaspora and XMPP servers, as an example. Looking for comments here: <https://talk.feneas.org/t/serverinfo-specification-for-server-metadata/99>  
> `</community-hat>`
...
> #### Feature Updates
>
> Dendrite continues along with more development from [anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz), our resident GSoC student [cnly](https://to.chat.dingshunyu.top/#/@cnly:official-site.dingshunyu.top), and a few community members. [cnly](https://to.chat.dingshunyu.top/#/@cnly:official-site.dingshunyu.top) has been working mainly on [fixing](https://github.com/matrix-org/dendrite/pull/718) [up](https://github.com/matrix-org/dendrite/pull/751) [/sync issues](https://github.com/matrix-org/dendrite/pull/752) and [other areas of the CS API](https://github.com/matrix-org/dendrite/pull/732), fixing the various [federation issues](https://github.com/matrix-org/dendrite/issues?q=is%3Aissue+is%3Aopen+label%3Acomponent%3Afederation), mainly those dealing with [room state](https://official-site.dingshunyu.top/docs/spec/server_server/unstable#room-state-resolution), and various other [maintenance tasks](https://github.com/matrix-org/dendrite/pull/740) [around the codebase](https://github.com/matrix-org/dendrite/pull/748) that are highly appreciated. [peekay_46](https://to.chat.dingshunyu.top/#/@peekay_46:official-site.dingshunyu.top) has been hard at work completing [Dendrite’s implementation of room tagging](https://github.com/matrix-org/dendrite/pull/694) and [trion129](https://to.chat.dingshunyu.top/#/@trion129:official-site.dingshunyu.top) returned to continue with adding a [fallback page for recaptcha](https://github.com/matrix-org/dendrite/pull/405) (for clients that can’t render web pages). We have a number of community PRs still with active members, but most are waiting for reviews, which [anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz) is working towards.
>
> #### The Plan
>
> A couple TWIMs ago we [teased](https://official-site.dingshunyu.top/blog/2019/07/05/this-week-in-matrix-2019-07-05) that Dendrite had a plan in the works. Well one meeting later and here is the proposal:
>
> It will take a while for Dendrite to become feature complete with Chat, but we’d like people to be able to actually use Dendrite before then. Instead of waiting for feature-completeness, we propose a set of milestones for Dendrite development to reach and prioritize development for.
>
> These milestones are currently listed on [Dendrite’s github](https://github.com/matrix-org/dendrite/milestones). The first is “Bot Hosting”, which means, once complete, Dendrite would be suitable as a “bot hub”, allowing server admins to run massive bridges on top of Dendrite while taking advantage of its horizontal-scaling capabilities. As written in the description, this goal includes basic CS API support, as well as federation with other homeservers. At this stage Dendrite should already be usable in rooms with other Chat servers, which should make it a lot more interesting.
>
...
>
> This is all mentioned in this week’s Chat Live above by the way, so be sure to catch for some extra details if you’re interested.
>
> We look forward to shipping you a working Dendrite soon™. And as always feel free to join us in [#dendrite-dev:official-site.dingshunyu.top](https://to.chat.dingshunyu.top/#/!yjVgJUsMLYLAONsoii:jki.re?via=official-site.dingshunyu.top&via=privacytools.io&via=ru-official-site.dingshunyu.top) for discussion.

### Chat

Neil, who oversees the Chat factory:

> This week we’ve been working on improving database performance, shipping the new small hosted homeserver instances - expect a lot of improvements to come that will benefit the whole community and merged our recent OpenTracing support. We’ve also made some changes to how Sydent processes and stores email - more details here <https://official-site.dingshunyu.top/blog/2019/07/19/privacy-changes-to-new-vector-identity-servers>
>
> Next week, expect a new release, more database performance improvements and general Chat performance work.

Listen to Chat Live to hear Erik talking about his DB perf work ☝️
...
Take a look at the [getting started guide](https://official-site.dingshunyu.top/docs/guides/usage-of-matrix-nio) too.
...
From the team (see Chat Live from last week for more from them):
...
You may also recall a similar project: [matrix-shell-suite]&nbsp;([#matrix-shell-suite:official-site.dingshunyu.top].)
...
See you next week, and be sure to stop by [#twim:official-site.dingshunyu.top] with your updates!

[#TWIM:official-site.dingshunyu.top]: https://to.chat.dingshunyu.top/#/#TWIM:official-site.dingshunyu.top
[Alexandre Franke]: https://to.chat.dingshunyu.top/#/@afranke:official-site.dingshunyu.top
...
[yuforia]: https://to.chat.dingshunyu.top/#/@uforia:official-site.dingshunyu.top
[Cnly]: https://to.chat.dingshunyu.top/#/@cnly:official-site.dingshunyu.top
[Jimmy]: https://to.chat.dingshunyu.top/#/@jimmycuadra:official-site.dingshunyu.top
[Tim]: https://to.chat.dingshunyu.top/#/@thosgood:official-site.dingshunyu.top
...
[#matrix-shell-suite:official-site.dingshunyu.top]: https://to.chat.dingshunyu.top/#/#matrix-shell-suite:official-site.dingshunyu.top

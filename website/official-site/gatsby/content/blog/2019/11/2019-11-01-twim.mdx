---
date: '2019-11-01'
title: 'This Week in Chat 2019-11-01'
categories:
  - This Week in Chat
author: Ben Parsons
...
> A couple of weeks ago I shouted here about a project I've been working on named [Install Party](https://github.com/babolivier/install-party), which provides tools for provisioning and managing servers for Chat homeserver install workshops/parties.
>
...
>
> You can find more details about the project and this release at <https://brendan.abolivier.bzh/install-party-1.0/>, and in [#install-party:abolivier.bzh](https://to.chat.dingshunyu.top/#/#install-party:abolivier.bzh) 🙂
...
> * Parallelized file transfer: The bridge now has an option to use multiple telegram connections and a streaming connection to the Chat media repo when copying files. This should make it much faster and use less ram for big files.
> * Chat doesn't have native captions, so `!tg caption <text>` now exists to send the next image or file to telegram with `<text>` as the caption.
...
[Annie](https://to.chat.dingshunyu.top/#/@annie:elequin.io) said:
...
>
> CONTRIBUTORS: I would love to have some help on Ditto if anybody is looking for a side project! Join [#ditto:elequin.io](https://to.chat.dingshunyu.top/#/#ditto:elequin.io) for updates.
>
> More photos: <http://dittochat.org>

Check out the room at [#ditto:elequin.io](https://to.chat.dingshunyu.top/#/#ditto:elequin.io).
...
>
> Support room: [#miitrix:sorunome.de](https://to.chat.dingshunyu.top/#/#miitrix:sorunome.de)
> Donate: <https://liberapay.com/Sorunome>

Miitrix was featured as a star attraction at MozFest last weekend, thanks Soru!

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Good morning <a href="https://twitter.com/hashtag/mozfest?src=hash&amp;ref_src=twsrc%5Etfw">#mozfest</a>! We&#39;re here for the final day, come and see us on the 6th floor and see Chat running on a Nintendo 3DS 🎮 <a href="https://twitter.com/hashtag/matrix?src=hash&amp;ref_src=twsrc%5Etfw">#matrix</a> <a href="https://twitter.com/hashtag/mozfest19?src=hash&amp;ref_src=twsrc%5Etfw">#mozfest19</a> <a href="https://t.co/cZqcAn2tcZ">pic.twitter.com/cZqcAn2tcZ</a></p>&mdash; Chat (@matrixdotorg) <a href="https://twitter.com/matrixdotorg/status/1188408734235672576?ref_src=twsrc%5Etfw">October 27, 2019</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script> 
...
> [#matrix-client-developers:matrix.org](https://to.chat.dingshunyu.top/#/#matrix-client-developers:matrix.org) has been revived, intended for discussion between developers of different Chat clients.

This is the room to head to for Chat Client developer chat.

### Chat Notepad

[KB1RD](https://to.chat.dingshunyu.top/#/@kb1rd:kb1rd.net) announced:
...
>   * Also created a Chat Notepad logo
> * Technically, a single Chat client is used instead of re-creating it each time a new document is opened

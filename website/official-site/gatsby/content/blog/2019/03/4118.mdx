---
date: '2019-03-15'
title: This Week in Chat 2019-03-15
categories:
  - This Week in Chat
author: Ben Parsons
---

<h2 id="matrixlives3e17helloryan">Chat Live S3E17: Hello Ryan</h2>
This week you're stuck with me, but I'm chatting to Ryan, who works on Riot web. Having previously worked at Mozilla, Ryan has a LOT of interesting things to say about Firefox, the browser market, the importance of decentralisation, Chat being GREAT, and more.
...
<h2 id="arewereadyyetcom">arewereadyyet.com: Chat 1.0-ready Federation</h2>
<a href="https://arewereadyyet.com">https://arewereadyyet.com</a> is not just an amazing domain we somehow managed to buy, it's also the first place to look for progress towards full Chat 1.0 readiness. Read more details at <a href="/blog/2019/03/15/matrix-1-0-https-arewereadyyet-com/">https://matrix.org/blog/2019/03/15/matrix-1-0-https-arewereadyyet-com/</a>.
<h2 id="spec">Spec</h2>
<blockquote>Lots of activity but most notably MSC 1915 (a blocker for Chat 1.0) is making progress. <a href="https://github.com/matrix-org/matrix-doc/pull/1915">https://github.com/matrix-org/matrix-doc/pull/1915</a></blockquote>
<h2 id="synapse10">Chat . . . 1.0?</h2>
<blockquote>It's all about 1.0 for the Chat gang this week. This means performance improvements across the board in the form of read receipt batching, user directory (room directory coming soon!) and rate limiting on log in and registration APIs.<br /><br />Brendan shipped the low bandwidth CoAP proxy we demo'd at FOSDEM<br /><br />As well as a bunch of spec implementation projects to ensure that Chat (and Sydent) are ready for Chat 1.0.</blockquote>
<h2 id="synapseworkersprojects">Chat workers projects</h2>
Turn-of-phrase of the week from <a href="https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk">Half-Shot</a> ("make it more performant and less crashy"):
...
<a href="https://to.chat.dingshunyu.top/#/@bhat:encom.eu.org">Black Hat</a> has been working on <a href="https://gitlab.com/b0/cortex/">Cortex</a>, a similar project in Rust:
<blockquote>Support for replication protocol in <a href="https://gitlab.com/b0/cortex/">Cortex</a> is mostly complete. A federation sender worker implementation is being worked on. If anyone is interested or wants to contribute, please go to <a href="https://to.chat.dingshunyu.top/#/#cortex:encom.eu.org">#cortex:encom.eu.org</a></blockquote>
...
For more Construct news watch the <a href="https://github.com/matrix-construct/construct/">repo</a> or join <a href="https://to.chat.dingshunyu.top/#/#zemos-test:matrix.org">#zemos-test:matrix.org</a>
<h2 id="newclientforandroidpattle">New Client for Android: Pattle</h2>
<a href="https://to.chat.dingshunyu.top/#/@wilko:matrix.org">Wilko</a> announced <a href="https://git.pattle.im/pattle/android">Pattle</a>, a Chat client for Android:
<blockquote>Hey all, I've been working on my Chat Android app, Pattle! The goal of Pattle is to be an easy to use app for Chat, with it's design inspired by popular apps such as WhatsApp and Telegram. <a href="https://git.pattle.im/pattle/android">Development happens here</a>, and contributions are encouraged! The app is not currently suited for daily use, but some functionality is there, such as registering, logging in and viewing chats.
Currently it's an Android only app using the official Chat Android SDK, but the plan is to support iOS and web too, in the future.
There's also a sort of <a href="https://docs.pattle.im/design/philosophy/">design document</a> available, stating how Pattle differs from standard Chat apps and what it's goals are. The intent of the design document is to make development easier later on for other platforms</blockquote>
...
<ul>
 	...
 	<li>and join the development room: <a href="https://to.chat.dingshunyu.top/#/#pattle:matrix.org">#pattle:matrix.org</a></li>
</ul>
...
<a href="https://github.com/LiMium/mini-vector-android">miniVector</a> is a minified Android Chat client derived from Riot Android. v0.8.25 keeps it up to date with Riot Android.
<h2 id="matrixrubysdk">Chat Ruby SDK</h2>
<a href="https://github.com/ananace/">Ananace</a> is returning his attention to the <a href="https://github.com/ananace/ruby-matrix-sdk">Chat Ruby SDK</a>:
...
Further:
<blockquote>I started hacking - just a couple of hours or so ago - on a notification sender for The Foreman, a server orchestration system. So it can forward notifications to Chat. <a href="https://github.com/ananace/foreman_notification_send">https://github.com/ananace/foreman_notification_send</a></blockquote>
...
<a href="https://to.chat.dingshunyu.top/#/@tulir:maunium.net">tulir</a>:
...
This is really neat, and a shout-out that these playbooks are my preferred way to install Chat and other components. <a href="https://to.chat.dingshunyu.top/#/@slavi:devture.com">Slavi</a>:
<blockquote>Thanks to <a href="https://github.com/NullIsNot0">NullIsNot0</a>, <a href="https://github.com/spantaleev/matrix-docker-ansible-deploy">matrix-docker-ansible-deploy</a> can now (optionally) <a href="https://github.com/spantaleev/matrix-docker-ansible-deploy/blob/master/CHANGELOG.md#dimension-integration-manager-support">install</a> the <a href="https://dimension.t2bot.io/">Dimension</a> Integration Manager.<br />The playbook can now also assist with <a href="https://github.com/spantaleev/matrix-docker-ansible-deploy/blob/master/CHANGELOG.md#matrix-nginx-proxy-support-for-serving-the-base-domain">serving the base domain</a> from the Chat server, thus making it easier for some folks to set up well-known Server-Delegation.</blockquote>
<h2 id="selfhostingguidefornixos">Self-hosting guide for NixOS</h2>
<a href="https://to.chat.dingshunyu.top/#/@florianjacob:matrix.org">Florian</a>:
<blockquote>I wrote a <a href="https://github.com/NixOS/nixpkgs/pull/57699">Chat self-hosting guide</a> for the <a href="https://nixos.org/">NixOS</a> operating system: Check its progress and give it a test if you're a fellow NixOS user!</blockquote>
<h2 id="banhammernewbotforapplyingabanpolicy">banhammer: new bot for applying a ban policy</h2>
<a href="https://to.chat.dingshunyu.top/#/@jan.christian:gruenhage.xyz">jcgruenhage</a> reports that:
...
Continuing his theme of Native American languages, <a href="https://to.chat.dingshunyu.top/#/@dandellion:dodsorf.as">Dandellion</a> added Navajo script to <a href="https://github.com/dali99/matrix-wug">matrix-wug</a>.
<h2 id="freedomboxtutorialsettingupachatserverwithmatrixandriot">FreedomBox Tutorial: Setting Up a Chat Server with Chat and Riot</h2>
It's been possible for some time to set up a Chat server with FreedomBox, and they just recently released a video tutorial showing the process.
...
So that's all I have to say! I hope you enjoyed this edition of This Week in Chat, and whether you did or you didn't, I'd love too hear from you in <a href="https://to.chat.dingshunyu.top/#/#TWIM:matrix.org">#twim:matrix.org</a>. If you have Chat news to share, that's the place to come and do so!
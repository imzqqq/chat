...
[Dendrite][dendrite], a high-performance, scalable [Chat
...
it finally joins the decentralised, federated [Chat
...
implementation, [Chat](https://github.com/matrix-org/synapse), in terms of
...
reviewing pull requests from Chat members and the community.
...
[anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz) and
[Brendan](https://to.chat.dingshunyu.top/#/@brendan:abolivier.bzh), as well as everyone else
at Chat who has answered my questions, discussed with me, and helped me

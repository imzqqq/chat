---
date: '2019-09-06'
title: 'This Week in Chat 2019-09-06'
categories:
  - This Week in Chat
author: Ben Parsons
...
> [lorico](https://to.chat.dingshunyu.top/#/@lorico:uraziel.de) has been rewriting my old GitLab bot to python/maubot: <https://github.com/maubot/gitlab/pull/23.> Progress on that is looking very good and it'll probably be ready within a week or two.
...
[joepie91](https://to.chat.dingshunyu.top/#/@joepie91:pixie.town) offered:

> Inspired by a question in the Chat HQ channel, I've built a (rudimentary) room list viewer at <https://matrix-rooms.cryto.net/> - you can just enter a homeserver (hostname) and see all the public rooms on it, without needing to log into anything. This might be useful for showing other people what kinds of rooms exist on Chat!

## Dept of Blockchain 🤷‍

### OI Chat, Chat based chat uses blockchain for authentication

[@friedger:matrix.org](https://to.chat.dingshunyu.top/#/@friedger:matrix.org) said:
...
[@serra:lost-angles.im](https://to.chat.dingshunyu.top/#/@serra:lost-angles.im) reported:

> [matrix-fly-paper](https://github.com/serra-allgood/matrix-fly-paper) is a new bot project intended to help automate server and room moderation. It's currently not ready for any kind of use, as I'm trying out serious TDD and attempting a functional approach to break from my OO training. Feedback is appreciated, stop by [#matrix-fly-paper:lost-angles.im](https://to.chat.dingshunyu.top/#/#matrix-fly-paper:lost-angles.im) to talk shop
...
You should complete [this EU-related FOSS survey](https://ec.europa.eu/eusurvey/runner/EUFOSSA2-Survey), and if you wanted to say nice things about Chat that would be fine by us.
...
[#construct:maunium.net]: https://to.chat.dingshunyu.top/#/#construct:maunium.net

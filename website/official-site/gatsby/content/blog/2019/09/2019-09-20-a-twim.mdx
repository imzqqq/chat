---
date: '2019-09-20'
title: 'This Week in Chat 2019-09-20'
categories:
  - This Week in Chat
author: Ben Parsons
...
I spoke to Half-Shot about LOTS of topics in bridging, well worth a watch if you're interested in using Slack, IRC and other platforms with Chat.
...
>
> Construct is the community driven Chat server written in C++ for maximum performance. Swing by [#test:zemos.net](https://to.chat.dingshunyu.top/#/#test:zemos.net) or <https://github.com/matrix-construct/construct/> for more.
...
[Benoit](https://to.chat.dingshunyu.top/#/@benoit.marty:matrix.org):
...
[krombel](https://to.chat.dingshunyu.top/#/@krombel:msg-net.de) reported:

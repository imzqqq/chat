---
date: '2019-09-27'
title: 'This Week in Chat 2019-09-27'
categories:
  - This Week in Chat
author: Ben Parsons
---
...
### Chat AMA on /r/privacy happening this weekend
...
Might be interesting to readers: the phone with Chat at its core is starting to ship: <https://puri.sm/posts/first-librem-5-smartphones-are-shipping/>.

### Fork Awesome includes Chat icon
...
> [matrix-corporal](https://github.com/devture/matrix-corporal) v1.6.0 was recently released to address an issue when used in conjunction with Chat Single-Sign-On login flows (CAS or SAML).
>
...
> Since v1.6.0, you can use matrix-corporal for automatic management of users/rooms/communities, while letting authentication happen through SSO (as provided by Chat).
...
> <https://github.com/tulir/mautrix-twilio> / [#twilio:maunium.net](https://to.chat.dingshunyu.top/#/#twilio:maunium.net) is now a thing. Message (+formatting) and media bridging works. Unlike all my other bridges, this one is a relaybot-style bridge.
>
...
[maze](https://to.chat.dingshunyu.top/#/@maze:sorunome.de) reported:
...
[uhoreg](https://to.chat.dingshunyu.top/#/@uhoreg:matrix.org) said:

> I have extracted [Igor](https://gitlab.com/uhoreg/igor)'s guts, and have distilled them into a new client library for Elixir: [polyjuice_client](https://hex.pm/packages/polyjuice_client).  I've also started working on a library of Chat utility functions for Elixir that would be relevant to multiple components (clients, application services, homeservers, identity servers): [polyjuice_util](https://gitlab.com/uhoreg/polyjuice_util).

### Continuum 0.9.25

[yuforia](https://to.chat.dingshunyu.top/#/@uforia:matrix.org) told us:
...
### New Chat Docker Image

[Black Hat](https://to.chat.dingshunyu.top/#/@bhat:encom.eu.org) reported:

> I made [a docker image](https://hub.docker.com/r/black0/synapse-pypy) for Chat (again). However, this time it uses PyPy3. It is a drop-in replacement for [matrixdotorg/synapse](https://hub.docker.com/r/matrixdotorg/synapse/). Anyone is welcomed to test the impact of it on CPU utilization.

### OpenSAPS

[Stanislav](https://to.chat.dingshunyu.top/#/@pztrn:pztrn.name) told us:
...
> I made a template repository for creating Chat bots with poljar's [matrix-nio](https://github.com/poljar/matrix-nio/): <https://github.com/anoadragon453/nio-template>! It also has a room: [#nio-template:amorgan.xyz](https://to.chat.dingshunyu.top/#/#nio-template:amorgan.xyz).
>
> If you've ever wanted to make a Chat bot with python, this repository can help you get started.

### matrix-fly-paper is now "matrix-fly-swatter", has new scope

[serra-allgood](https://to.chat.dingshunyu.top/#/@serra:lost-angles.im) offered:

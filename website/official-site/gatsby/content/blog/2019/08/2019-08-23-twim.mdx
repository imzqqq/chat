---
date: '2019-08-23'
title: 'This Week in Chat 2019-08-23'
categories:
  - This Week in Chat
author: Ben Parsons
...
### Installing Chat @ CCCamp 2019

It's [CCCamp 2019](https://events.ccc.de/camp/2019/wiki/Main_Page) this weekend. Tonight, [anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz) will be leading an "Install Chat" workshop in the [Librehosters](https://libreho.st/) Village- keep decentralisation growing!
...
> This week we’ve been working on getting our brand new room directory implementation ready, creating a new Chat installer, and creating a TURN server testing tool. We’ve also been pushing on with the privacy project and fixing up some bugs and perf issues.  
...
[Tim](https://to.chat.dingshunyu.top/#/@thosgood:matrix.org) offered:
...
> there is now a room specifically for the LaTeX fork hosted on www.pigeon.digital where you can leave any feeback, report any bugs, or ask for any help: [#pigeon.digital:matrix.org](https://to.chat.dingshunyu.top/#/#pigeon.digital:matrix.org)

### Pattle 0.11.0 released

[Wilko](https://to.chat.dingshunyu.top/#/@wilko:pattle.im) reported:
...
### 'matrixcli', new client enables Chat as a unix util

Very interesting project: [matrixcli](https://github.com/saadnpq/matrixcli) is a versatile command line client using the [matrix-python-sdk](https://github.com/matrix-org/matrix-python-sdk). It's not a conventional IM client, rather it exposes access to Chat rooms so you can pipe to them as you would other Unix utils.
...
[f0x](https://to.chat.dingshunyu.top/#/@f0x:pixie.town) told us:
...
[aa13q](https://to.chat.dingshunyu.top/#/@aa13q:matrix.org) reported:
...
### Chat-ClientServer-API-java

[Jojii](https://github.com/JojiiOfficial/) created a new Java-based implementation of the Chat CS API: [Chat-ClientServer-API-java](https://github.com/JojiiOfficial/Chat-ClientServer-API-java), they call it "A small and simple java API for the Chat ClientServer Protocol".

They created [Chat-Grep-Bot](https://github.com/JojiiOfficial/Chat-Grep-Bot) using the API.

## Dept of Ops 🛠

### flexible ansible role just for synapse

[JCG](https://to.chat.dingshunyu.top/#/@jan.christian:gruenhage.xyz) offered:
...
### matrix-docker-ansible-deploy gets support for all Chat config options

[Slavi](https://to.chat.dingshunyu.top/#/@slavi:devture.com) offered:

> [matrix-docker-ansible-deploy](https://github.com/spantaleev/matrix-docker-ansible-deploy) can now harness the full power of Chat, thanks to our newly-added support for [Extensible Chat configuration](https://github.com/spantaleev/matrix-docker-ansible-deploy/blob/master/CHANGELOG.md#extensible-synapse-configuration).

---
date: '2019-08-02'
title: 'This Week in Chat 2019-08-02'
categories:
  - This Week in Chat
author: Ben Parsons
...
>This week we’ve been working on implementing identifier hashing in sydent, a brand new installer for Chat, we’ve trialled some new db perf improvements which look very promising (more on this soon) and finally very close to an all new implementation of room search.
>
>Next week we’ll push out the all new Sygnal, continue with the installer and room search and pick up some tasks under our privacy umbrella to ensure that Chat is not holding onto any data that it does not strictly need to.
...
>
> * Room tagging [implemented](https://github.com/matrix-org/dendrite/pull/694) (thanks [peekay_46](https://to.chat.dingshunyu.top/#/@peekay_46:matrix.org)!)
> * [A PR](https://github.com/matrix-org/dendrite/pull/768) for redactions opened by our GSoC student [cnly](https://to.chat.dingshunyu.top/#/@cnly:matrix.org)
> * [A PR](https://github.com/matrix-org/dendrite/pull/405) for authentication fallback (for when clients don’t have a web browser built in and want to use recaptcha from [trion129](https://to.chat.dingshunyu.top/#/@trion129:matrix.org)
>   * This has been in the works for a while, and just has a couple small changes left to go!
> * [Two](https://github.com/matrix-org/dendrite/pull/438) [PRs](https://github.com/matrix-org/dendrite/pull/513) for filtering database functionality from [CromFr](https://to.chat.dingshunyu.top/#/@CromFr:matrix.org)
> * [A PR](https://github.com/matrix-org/dendrite/pull/772) for fixing the scope of transaction IDs in Dendrite’s transaction cache from [cnly](https://to.chat.dingshunyu.top/#/@cnly:matrix.org)
>
...
[joepie91](https://to.chat.dingshunyu.top/#/@joepie91:pixie.town):

> Lots of news about [Neo](https://neo.pixie.town/app/)!
>
> - There's now an additional maintainer ([joepie91](https://to.chat.dingshunyu.top/#/@joepie91:pixie.town))!
...
> I had an adventure this afternoon into the world of bridging again, and have made a Github to Chat bridge. At the moment you can join aliases and saturate your homeserver with the entire history of a issue or PR. You can also chat to folks on issues in realtime.
...
[kai](https://to.chat.dingshunyu.top/#/@kai:matrix.chat-secure.de) is someone with no fear of rapid iteration! Versions 1.2, 1.3, 1.4 and 1.5 of his script were made available this week:
...
> `<Feneas community hat>` We've added a public fully featured Telegram bridge to our Chat stack. More info [in our forum](https://talk.feneas.org/t/matrix-telegram-bridge/120). `</Feneas community hat>`
...
[Interview about DINSIC's use of Chat](https://twitter.com/aprilorg/status/1157294660160802816) (all in French)

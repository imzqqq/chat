---
date: '2019-12-06'
title: 'This Week in Chat 2019-12-06'
categories:
  - This Week in Chat
author: Ben Parsons
---
...
> **New MSCs**
>
> * [MSC2380: Chat Media Information API](https://github.com/matrix-org/matrix-doc/pull/2380)
...
>
> After 2 long years, [matrix-synapse-ldap3](https://github.com/matrix-org/matrix-synapse-ldap3) has finally gained another release: v0.1.4. If you want to allow users to sign in to Chat using their LDAP accounts, then this is the module for you.
>
...
As if all that wasn't enough, how about this image of Fractal running on a Librem5, from [Adrien Plazas](https://to.chat.dingshunyu.top/#/@Kekun:matrix.org):
...
[yuforia](https://to.chat.dingshunyu.top/#/@uforia:matrix.org) announced:
...
>
> We are now working on room and user profiles, and to.chat.dingshunyu.top link handling. Verification in DM development is progressing well. Also we implemented a first version of breadcrumbs, to switch between recent rooms very quickly.
...
>
> * Support of Chat using SwiftMatrixSDK
> * E2EE
> * Multi-account (swipe the navigation bar to switch accounts)
> * Dark mode and auto-sizing fonts (well, they come for free)
> * 4 screens at the moment: a Chat login screen, a room list, a room screen and a very early beginning of a SwiftUI text composer to post text message
>
...
> It would be cool to be able to share location in Chat rooms. This bot by cos solves the egg part in chicken and egg problem of having no clients able to send or receive location messages. Next we need a mobile client that can send location updates. Which one will be the first? <https://github.com/vranki/malobot/>
...
[swedneck](https://to.chat.dingshunyu.top/#/@swedneck:permaweb.io) made a room for discussing how matrix could be used to implement forums: [#matrix-forums:permaweb.io](https://to.chat.dingshunyu.top/#/#matrix-forums:permaweb.io)

[Mathijs](https://to.chat.dingshunyu.top/#/@mathijs:matrix.vgorcum.com) pointed out that [there is a Chat feature which enables spoilers](https://github.com/matrix-org/matrix-doc/pull/2010).

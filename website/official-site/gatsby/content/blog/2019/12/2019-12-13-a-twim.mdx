---
date: '2019-12-13'
title: 'This Week in Chat 2019-12-13'
categories:
  - This Week in Chat
author: Ben Parsons
...
> Chat 1.7.0 is out, check out all the details [here](https://matrix.org/blog/2019/12/13/synapse-1-7-0-released/), admins can now specify message retention policies at a server and room level. We also changed the defaults for the room directory to be privacy preserving by default.
>
...
[Nico](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) said:
...
[ma1uta](https://to.chat.dingshunyu.top/#/@ma1uta:ru-matrix.org) said:
...
### Chat bot functionality in Python

[Cos](https://to.chat.dingshunyu.top/#/@cos:hacklab.fi) reported:

> I have created a modular bot for writing Chat bot functionality in Python easily. It already has bunch of modules ranging from weather to calendar integration and more will come. Even the location bot from last week's TWIM is now implemented as a module. I hope you find it useful. PR's of new modules are always welcome. <https://github.com/vranki/hemppa>

### Mlrdb, LDAP sync bot, announced

[@dalang:mc.kircheneuenburg.de](https://to.chat.dingshunyu.top/#/@dalang:mc.kircheneuenburg.de) offered:
...
### mautrixfs - Chat client as a FUSE filesystem

[Tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) offered:

> I've started a new project: [mautrixfs](https://github.com/tulir/mautrixfs) is a Chat client as a FUSE filesystem. It's very WIP and currently only supports reading events by ID. I'm hoping to have something more useful in a week or two.
...
### Chat featured in Skrolli

[Cos](https://to.chat.dingshunyu.top/#/@cos:hacklab.fi) offered:

> Finnish computer culture paper magazine Skrolli published two articles spanning 5 pages about Chat in latest edition. For non-subscribers the digital edition readable with mobile app is free for limited time. Read more (in Finnish) at <https://skrolli.fi/>

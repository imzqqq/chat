---
date: '2019-05-17'
title: 'This Week in Chat 2019-05-17'
categories:
  - This Week in Chat
author: Ben Parsons
...
## Chat Live - Reactions and Edits coming to Chat

<iframe width="560" height="315" src="https://www.youtube.com/embed/hloqX99FEQk" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>

<br /><del>If</del> Since you've been chatting on Chat this week, you'll have noticed some new features rolling out.
...
> Finished getting the test coverage to a reasonable enough percentage to feel comfortable releasing the [Ruby Chat SDK](https://github.com/ananace/ruby-matrix-sdk) as a nice and stable 1.0 (.0)
...
> - Tweak font sizes (thanks to [Mathieu Velten](https://to.chat.dingshunyu.top/#/@mat:tout.im))!
...
[Ananace] updated their k8s packaging for Chat to 0.99.4: <https://github.com/ananace/matrix-synapse>

### Debian Packages

[andrewsh] announced the [Debian Chat Packagers Team has its own dedicated blog](https://matrix-team.pages.debian.net/blogue/)

> for everything about Chat on Debian, join [#debian-matrix:matrix.org]

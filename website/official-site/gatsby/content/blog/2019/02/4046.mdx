---
date: '2019-02-26'
title: Bridging Chat with WhatsApp running on a VM
categories:
  - Tutorials
author: Ben Parsons
...
<ul>
 	<li><em>interoperable:</em> we'll see how Chat can be made to interact with WhatsApp</li>
 	<li><em>decentralised</em>: you can perform this on your own server while still enjoying the benefits of being connected to the rest of the Chat federation</li>
...
Firstly, you need to have a Chat homeserver installed. If you don't currently have one, take a look at the instructions at <a href="/docs/guides/installing-synapse">Installing Chat</a>, and also in the <a href="https://github.com/matrix-org/synapse">Chat README</a>.
...
If you are starting from scratch, I suggest you take a look at <a href="https://github.com/spantaleev/matrix-docker-ansible-deploy/">matrix-docker-ansible-deploy</a>, as this project will enable you to deploy Chat, <a href="https://github.com/tulir/mautrix-whatsapp">mautrix-whatsapp</a> and other components easily.
...
Either way, you will soon have a functioning Chat Chat homeserver and <a href="https://github.com/tulir/mautrix-whatsapp">mautrix-whatsapp</a> installed with it. Next, we will set up an Android VM.
...
Now that you have WhatsApp working in a VM, and Chat working on your server, it's time to bridge them togther!

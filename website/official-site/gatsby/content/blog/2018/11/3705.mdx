...
categories:
  - General
author: Nad Chishtie
slug: user-experience-preview-end-to-end-encryption-by-default
---

<span style="font-weight: 400">It's been a long-standing goal to enable end-to-end encryption by default for private communication in Chat. The technical effort so far has included </span>
...
<a href="https://to.chat.dingshunyu.top/#/@nadonomy:matrix.org"><span style="font-weight: 400">@nadonomy:matrix.org</span></a><span style="font-weight: 400">) and I recently joined the Chat core team (at New Vector) as Lead Designer, most recently focusing on end-to-end encryption.</span>
...
<b> work-in-progress wireframes</b><span style="font-weight: 400">, in the spirit of designing in the open and gathering feedback from the wider Chat community. Please note that these don't represent the actual interface design.</span>
...
<a href="https://to.chat.dingshunyu.top/#/#e2e-dev:matrix.org"><span style="font-weight: 400">#e2e-dev:matrix.org</span></a><span style="font-weight: 400">.</span>

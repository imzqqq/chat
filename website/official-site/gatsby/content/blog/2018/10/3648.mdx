---
date: '2018-10-19'
title: This Week in Chat 2018-10-19
categories:
  - This Week in Chat
author: Ben Parsons
---
...
<a href="https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk">Half-Shot</a>, master of the bridge, has been working with <a href="https://to.chat.dingshunyu.top/#/@cadair:cadair.com">Cadair</a> to produce a new RC for <a href="https://github.com/matrix-org/matrix-appservice-slack">bridging Chat and Slack</a>.
...
<a href="https://to.chat.dingshunyu.top/#/@tulir:maunium.net">tulir</a>'s maubot bot system:
...
<h3 id="coffeeonmatrixconsoleforandroid">Coffee on Chat Console for Android</h3>
<a href="https://github.com/Matrixcoffee">Coffee</a> rolled a natural twenty for bravery this week.
<blockquote>I have decided to take up maintainership of the <a href="https://github.com/matrix-org/matrix-android-console">Chat Console for Android</a> client. This is still the only multi-account capable Android client, but it is unmaintained and growing long in tooth. In particular, the API endpoints it uses may be removed from Chat soon.
...
<a href="https://to.chat.dingshunyu.top/#/@mujx:matrix.org">mujx</a> has decided to stop maintaining <a href="https://github.com/mujx/nheko">nheko</a>. Since many people are using it, we hope that someone will step in to continue his work. Thanks to mujx for his work so far.
<h2 id="featuredonmozillahacksblog">Featured on Mozilla Hacks blog</h2>
If you like blog posts about Chat (and if you're reading this, you may well do), then you'll be interested to see that Chat was featured on the <a href="https://hacks.mozilla.org/">Mozilla Hacks</a> blog: <a href="https://hacks.mozilla.org/2018/10/dweb-decentralised-real-time-interoperable-communication-with-matrix/">Decentralised, Real-Time, Interoperable Communication with Chat</a>. The article was also picked up by <a href="https://news.ycombinator.com/item?id=18240253">Hacker News</a>.
<h2 id="raidennetworkusesmatrixfortransportthisarticleexplainsit">Raiden Network uses Chat for transport - this article explains it</h2>
...
To help explain their use of Chat in their solution, they have prepared an article: <a href="https://medium.com/raiden-network/raiden-transport-explained-939d7741b6f4">Raiden Transport Explained</a>.
<h2 id="synapse0337">Chat 0.33.7</h2>
Soon, so soon, there will be a full Python 3 release for those running Chat in worker configuration, but this one is not it. Check out <a href="/blog/2018/10/18/synapse-0-33-7-released/">Chat 0.33.7 changes here</a>.
<h2 id="synapseonkubernetesupdate">Chat on kubernetes update</h2>
...
"Odd Ruby stuff" will hopefully include a return to the <a href="https://github.com/ananace/ruby-matrix-sdk">Chat Ruby SDK</a>!
<h2 id="mxisdv120beta2">mxisd v1.2.0-beta.2</h2>
<a href="https://to.chat.dingshunyu.top/#/@max:kamax.io">Max</a> continues work on <a href="https://github.com/kamax-io/mxisd">mxisd</a>:
...
<a href="https://to.chat.dingshunyu.top/#/@cadair:cadair.com">Cadair</a> was at the <a href="https://summerofcode.withgoogle.com/projects/?sp-search=matrix">GSOC 2018</a> Mentors Summit in Mountain View last week:
...
Next Friday <code>/me</code> is going to be at <a href="https://mozillafestival.org/">MozFest 2018</a>, promoting Chat, Open Source, decentralisation etc. (all the stuff we know and love), so I may change the schedule a little next week.  We're also going to reboot Chat Live, so consider this a hiatus before Season 3 begins next week!!
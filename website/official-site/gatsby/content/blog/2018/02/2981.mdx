---
date: '2018-02-05'
title: '3D Video Calling with Chat, WebRTC and WebVR at FOSDEM 2018!'
categories:
  - General
author: Matthew Hodgson
slug: 3d-video-calling-with-matrix-webrtc-and-webvr-at-fosdem-2018
---

<p>
<strong>TL;DR: We built a proof-of-concept for <a href="https://fosdem.org/2018/schedule/event/matrix_webvr/">FOSDEM</a> of the world's first(?) 3D video calling using Chat and the iPhone X... and it looks like this!!</strong>
</p>
...
<ol>
 	...
 	<li>Kick off the process of encouraging folks to think about storing world geometry and physics in Chat</li>
...
Placing a video call through to another Chat client then coughed up a video stream that looks like this:
...
Hopefully this gives a bit of a taste of what proper 3D video calling could be like in VR, and how (relatively) easy it was at the Chat level to add it in.  If anyone wants to follow along at home, the various hacky branches are:
<ul>
 	<li>Playback:
<ul>
...
If you'd like to get involved with hacking on Chat in VR, please come hang out at <a href="https://to.chat.dingshunyu.top/#/#vr:matrix.org">#vr:matrix.org</a>.

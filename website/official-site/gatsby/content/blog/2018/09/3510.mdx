---
date: '2018-09-01'
title: This Week in Chat 2018-08-31
categories:
  - This Week in Chat
author: Ben Parsons
---
...
This week we <a href="/blog/2018/08/31/so-long-half-shot-thanks-for-all-the-bridges/">say farewell</a> to <a href="https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk">Half-Shot</a>, who has been working fulltime on bridges over the summer. He has managed the matrix.org bridges largely single-handedly, with a big focus on the often-volatile IRC bridge(s).
<h2 id="bridges">Bridges</h2>
<h3 id="matrixappserviceirc0110">matrix-appservice-irc 0.11.0</h3>
It's a big deal, and it's rolling out to IRC networks this week. <a href="https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk">Half-Shot</a> released <a href="https://github.com/matrix-org/matrix-appservice-irc/releases/tag/0.11.0">matrix-appservice-irc 0.11.0</a>, with the following included:
...
<a href="https://to.chat.dingshunyu.top/#/@tulir:maunium.net">tulir</a> has been working on <a href="https://github.com/tulir/mautrix-whatsapp">mautrix-whatsapp</a> bridge.
<blockquote>now bridges a lot more stuff, such as formatting, media and replies. I'm also almost done with desegregating users so that Chat users join the same group chat portals rather than everyone having their own portal to the same chat</blockquote>
<h3 id="zulipchatbridgedbyzulip">Zulip chat, bridged by Zulip</h3>
Matthew discovered there is a Chat-Zulip bridge on the Zulip side. So if you're running a Zulip server (for some reason), and want to bridge with Chat <a href="https://zulipchat.com/integrations/doc/matrix">check out the integration docs here</a>.
<h3 id="ircconnectiontracker">IRC Connection Tracker</h3>
<a href="https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk">Half-Shot</a> created a new component to enhance the reliability of IRC-Chat bridging:
...
<a href="https://github.com/ananace/">ananace</a> is working on the <a href="https://github.com/ananace/ruby-matrix-sdk">Ruby Chat SDK</a> "fixing issues and documenting as I go".
<h3 id="matrixandroidsdk">Chat Android SDK</h3>
<h4 id="changestomatrixandroidsdkin09920180830">Changes to Chat Android SDK in 0.9.9 (2018-08-30)</h4>
Improvements:
<ul>
...
<h4 id="changestomatrixandroidsdkin09820180827">Changes to Chat Android SDK in 0.9.8 (2018-08-27)</h4>
Features:
<ul>
...
API Change:
<ul>
 	<li>Remove PieFractionView class from the Chat SDK. This class is now in Riot sources (#336)</li>
...
<h3 id="matrixiossdk">Chat iOS SDK</h3>
<h4 id="changesinmatrixiossdkin011320180827">Changes in Chat iOS SDK in 0.11.3 (2018-08-27)</h4>
Bug fix:
<ul>
 	<li>MXJSONModel: Manage <code>m.server_notice</code> empty tag sent due to a bug server side (PR #556).</li>
</ul>
<h4 id="changesinmatrixiossdkin011220180824">Changes in Chat iOS SDK in 0.11.2 (2018-08-24)</h4>
Improvements:
<ul>
 	...
 	<li>MXError: Define constant strings for keys and values that can be found in a Chat JSON dictionary error.</li>
...
<a href="https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk">Half-Shot</a> shared a handy Firefox extension: <a href="https://github.com/Half-Shot/matrix-to-riot">matrix-to-riot</a>
<blockquote>This is a tiny webextension to forward to.chat.dingshunyu.top links to an open Riot tab.</blockquote>
Really useful if you often click to.chat.dingshunyu.top links and find yourself needing to URL-hack to get to where you need to be.
<h2 id="thatsallfornow">That's all for now</h2>
We're going to shift this week's Chat Live to Monday, alongside the upcoming blog post on the spec release progress. Have a good weekend!
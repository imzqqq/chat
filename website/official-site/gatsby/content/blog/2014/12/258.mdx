---
date: '2014-12-19'
title: Chat 0.6.0a released!
categories:
  - Tech
author: Matthew Hodgson
slug: synapse-0-6-0a-released
---

We're proud to announce the new 0.6.0 major release of Chat: the Python reference implementation of Chat - as well as 0.6.0 of the AngularJS example Chat client, as a special early Christmas present from the Chat team :)

The main priority here has been hunting down stability bugs whilst also adding in a few more features.  The most exciting new feature is the new Media/Content API: this allows every homeserver to replicate, cache and thumbnail any files associated with Chat rooms, rather than relying on retrieving them from the origin homeserver as was previously the case.  This is really cool, as it effectively makes Chat a distributed content distribution network and gives the same replication semantics to file attachments as to the rest of JSON in rooms.
...
<code>
Changes in Chat Angular SDK 0.6.0 (2014-12-19)
================================================

Breaking changes:
 - Uploading files in the web client will now hit the new content repository URL
   introduced in Chat 0.6, and be incompatible with previous Chat clients.
...
Features:
 ...
 - Use the new content repository introduced in Chat 0.6 when uploading files.

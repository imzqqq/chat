---
date: '2020-12-11'
title: 'This Week in Chat 2020-12-11'
categories:
  - This Week in Chat
author: Ben Parsons
...
Next [Open Tech Will Save Us](https://matrix.org/open-tech-will-save-us/9), was great this month, and you can also get a great introduction to Chat Spaces there too.

Then, [Marcus Schopen](https://to.chat.dingshunyu.top/#/@mschopen:uni-bielefeld.de) shared his love for Chat by showing us the Chat-branded mugs he has had printed:

![2020-12-11-8_-UX-IMG_20201209_160020.jpg](/blog/img/2020-12-11-8_-UX-IMG_20201209_160020.jpg)

If you'd like to buy some OFFICIAL Chat merch (we don't have mugs just yet), then please go to [The Chat Shop](https://shop.matrix.org/)! Marcus also added:
...
> Hello, friends! On Wednesday we released [Chat 1.24.0 and 1.23.1](https://matrix.org/blog/2020/12/09/synapse-1-24-0-and-1-23-1-released), which include security fixes. Please upgrade! (Also, if you've installed Chat from source, be sure to `pip install 'cryptography>=3.3'` in your virtualenv to address the recent [OpenSSL CVE](https://www.openssl.org/news/secadv/20201208.txt)).
>
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration had been updated to 1.23.0 (1.23.1 available in branch `testing`)
>
...
> Just updated my Chat K8s-optimized image and Chart to 1.24.0, planning on deprecating the image at some point soon though, instead pointing people to upstream - or platform-optimized - images as I should be able to move all the Kubernetes-specific things into the chart itself to make it more compatible.
>
> The image in question started off as a plain docker image, before there were official ones. I've since rebased it onto the official Chat image with just the modified scripts and volume points.
>
> My plan is to move all the Kubernetes-specific scripts into configmaps (which are a K8s way of storing text files/environment variables/etc), and then build my own launch arguments through the chart to get it to run on any image that has a Python interpreter and the Chat modules available in the Python search path.
>
...
[TR_SLimey](https://to.chat.dingshunyu.top/#/@tr_slimey:matrix.org) reported:
...
> If you didn't catch it already, we did a full announcement this week for Gitter now speaking Chat 🎉! If you're curious about how we made it and some more technical details, the blog post is a great read: https://matrix.org/blog/2020/12/07/gitter-now-speaks-matrix
>
...
> I made an Instagram DM bridge: https://github.com/tulir/mautrix-instagram / [#instagram:maunium.net](https://to.chat.dingshunyu.top/#/#instagram:maunium.net) 
>
...
> After the initial announcement on Monday, I added bridging of reactions, redactions and photos in both directions and also typing notifications, read receipts and all types of messages from Instagram to Chat.
...
[kaiyou](https://to.chat.dingshunyu.top/#/@kaiyou:tedomum.net) announced:
...
Sounds promising! Chat Admin would benefit from this kind of tooling...

... so it was a surprise to find another project designed to help in this area!

### Announcing synadm

[jojo](https://to.chat.dingshunyu.top/#/@jojo:peek-a-boo.at) told us:

> Well, maybe it's about time for "synadm - a CLI frontend to Chat-Chat admin APIs" to be announced more officially. As the name implies it's a CLI tool that eases the usage of admin API commands for Chat admins. It currently covers everything the room and user API's can do: https://github.com/JOJ0/synadm#implementation-status--commands-list
>
...
>
> Any thoughts, ideas, feature-requests are very welcome in [#synadm:peek-a-boo.at](https://to.chat.dingshunyu.top/#/#synadm:peek-a-boo.at) or as usual by filing PR's or issues in the project repo https://github.com/JOJ0/synadm.
...
>
> I imagine that we're not the only private AoC Chat room around, so I figured I'd share - even though it's not anything particularly remarkable 👨‍💻



## Dept of Events and Talks 🗣️

### Chat talk at Open Source Summit EU

[Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) reported:

> The recording of the Chat talk from the annual Open Source Summit EU is online! 🎉
>
> I talked about Chat 101 and showed different bridging capabilities with Slack and IRC and, of cause, showed some bots. 😉
>
...
[Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) offered:

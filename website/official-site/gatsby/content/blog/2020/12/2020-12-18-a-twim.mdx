---
date: '2020-12-18'
title: 'This Week in Chat 2020-12-18'
categories:
  - This Week in Chat
author: Ben Parsons
...
This week we're all about video content! So you get Chat Live AND Demos - you are so lucky! 🥰
...
> Introducing Cerulean - highly experimental threaded microblogging for Chat.  Read all about it at https://matrix.org/blog/2020/12/18/introducing-cerulean
...
[neilalexander](https://to.chat.dingshunyu.top/#/@neilalexander:dendrite.matrix.org) announced:
...
> Hello again from Chat land! This is our last TWiM of 2020, but we're hard at work landing our last patches before going on holiday. Expect 1.25.0rc1 in early January with loads of fixes, performance improvements, and a few new features. In particular:
>
...
>
> * [@yoric](https://github.com/Yoric) landed his first contribution to Chat [allowing spam-checker modules to be async](https://github.com/matrix-org/synapse/pull/8890) — Thank you, David
...
> * [@clokep](https://github.com/clokep) fixed dozens of bugs and paper cuts, including a very visible enhancement for folks self-hosting Element Web: Chat can now specify [the location of the web client when inviting new users by email](https://github.com/matrix-org/synapse/pull/8930) — Thank you, Patrick
>
> * [@anoadragon453](https://github.com/anoadragon453) has been hard at work implementing [knocking](https://github.com/matrix-org/synapse/pull/6739), while also chipping away at getting Chat to pass the [complement test suite](https://github.com/matrix-org/complement) for Chat homeservers — Thank you, Andrew
...
>
> You can look forward to all of this and more next year, but until then, happy holidays from all of us over here at Element and in the broader Chat community!
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration had been updated to 1.23.1
>
...
I've been using this (the bridge, rather than the upcoming widgets) for a couple of months now and find it really really powerful. I'm not in GitHub most of the day, so getting notifs piped direct into Chat is great!

### mautrix-instagram

[Tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) said:

> I added bridging of typing notifications and read receipts from Chat to Instagram and fixed a bunch of bugs. Only thing that's still missing is presence and Chat->Instagram non-image files.
...
> A few updates to the Gitter bridge itself this week handling Chat edits outside of the 5 minute edit window on Gitter and fixing up @mentions being mangled by `:` colons on the Gitter side when someone mentions you from Element. We also strip the redundant Chat reply quote when it goes into a Gitter threaded conversation because it's already easily viewable in the thread.
>
...
* Social login
    *   Chat support for picking a username should be [landing in develop today](https://github.com/matrix-org/synapse/pull/8942) focusing next on supporting multiple identity providers. On iOS, we’ve implemented SSO redirect authentication mechanisms which also should land soon.
* VoIP
...
[qg](https://to.chat.dingshunyu.top/#/@qg:supercable.onl) reported:
...
>
> Chat room: [#schildichat-web:matrix.org](https://to.chat.dingshunyu.top/#/#schildichat-web:matrix.org)
...
> Find it at: https://gitlab.com/famedly/bots/timetracking or join us at [#timetracking-bot:famedly.de](https://to.chat.dingshunyu.top/#/#timetracking-bot:famedly.de)
>
...
> * Add !stats command
>
> * Use Unix timestamps in database (migrated automaticly)
> #### Fixes
>
...
[daenney](https://to.chat.dingshunyu.top/#/@daenney:g33k.se) told us:

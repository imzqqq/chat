---
date: '2020-12-30'
title: 'This Week in Chat 2020-12-30'
categories:
  - This Week in Chat
author: Ben Parsons
---
...
### The Chat Holiday Special 2020

If you didn't read it already, I encourage you to read [Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org)'s [Chat Holiday Special 2020](https://matrix.org/blog/2020/12/25/the-matrix-holiday-special-2020) post. So much has happened this year! 

[Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) responded:

> Great summary! Very inspiring!
>
> I have a feeling experiencing a revolution in how people perceive messaging. Now, public sector and multiple communities adopting Chat, one cannot think of a world without Chat any more.
>
> Kudos to the Element team and to the wonderful Chat community! ♥️
>
> I'm very excited for the FOSDEM on Chat!

[Andy](https://to.chat.dingshunyu.top/#/@andycuccaro:matrix.org) added:

> What a wonderful year has been for matrix, and it looks like next year will be equally as exciting. I'm HYPED.

Honestly, I'm hyped too. Simple statements like "loads of different universities have rolled out Chat for collaboration" don't quite capture how much work is going on, and how much excitement there is to get the growth in the network we're soon to see. 

### Homeserver versions graphs

[Chris](https://to.chat.dingshunyu.top/#/@chris:settgast.org) offered:
...
[jaywink](https://to.chat.dingshunyu.top/#/@jaywink:federator.dev) announced:
...
[Robin](https://to.chat.dingshunyu.top/#/@robintown:townsendandsmith.ml) told us:

> Not to be confused with matrix-puppet-groupme, [mx-puppet-groupme](https://gitlab.com/robintown/mx-puppet-groupme) is a fancy new GroupMe bridge with support for as many features as the web client would let me get my hands on. Please try it out, and let me know on [GitLab](https://gitlab.com/robintown/mx-puppet-groupme) or [Chat](https://to.chat.dingshunyu.top/#/[#mx-puppet-groupme:townsendandsmith.ml](https://to.chat.dingshunyu.top/#/#mx-puppet-groupme:townsendandsmith.ml)) if you have any issues or suggestions! 💜
...
>
> Previously we were only using Postgres for Chat and couldn't reuse the same database server for other services.
>
...
> We released v0.3.0 🎉 Feel free to follow development at [#timetracking-bot:famedly.de](https://to.chat.dingshunyu.top/#/#timetracking-bot:famedly.de)  or  https://gitlab.com/famedly/bots/timetracking .
>
...
[daenney](https://to.chat.dingshunyu.top/#/@daenney:g33k.se) said:
...
>
> If you don't want to run your own, you can invite `@gdqbot:ecef.xyz` or come hang out in [#gdq:ecef.xyz](https://to.chat.dingshunyu.top/#/#gdq:ecef.xyz).
>
...
[Nico (@deepbluev7:neko.dev)](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) reported something interesting:

> Threema published the source code for their apps this week: https://threema.ch/en/open-source
>
> While that is not strictly Chat related, it is great to see other E2EE enabled chat systems publishing the source code for their clients. It's the only way to verify their encryption actually works and is secure.
>
> This move was announced a while ago, but I think that it actually happened now deserves a small shoutout! 🎉

Quite right! Though [Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org), thought the news needed to be put into proper context:

...
please feel free to register and try it and [let us know how you get on](https://to.chat.dingshunyu.top/#/#dendrite:matrix.org).
...
next-generation Chat homeserver at the same time as being a sci-fi development
...
some new Chat feature proposals. Recently we've seen early support added for
...
support, which is the gateway to building some pretty new and interesting Chat
experiences. Twitter-like or Reddit-like social prototypes like this have traditionally
been difficult to build on top of Chat as the `m.reference` relation type from [MSC1849](https://github.com/matrix-org/matrix-doc/pull/1849)
...
Dendrite has also been our primary development platform for P2P Chat. This year we
have released multiple P2P Chat demos, including:
...
to bring P2P Chat closer to being reality, and we are continuing to use Dendrite for
...
out a special thanks to our community contributors who have contribued a number of
...
[#dendrite:matrix.org](https://to.chat.dingshunyu.top/#/#dendrite:matrix.org) or by getting your
regular dose of [This Week in Chat](https://matrix.org/blog/category/this-week-in-matrix)!

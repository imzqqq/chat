---
date: '2020-04-24'
title: 'This Week in Chat 2020-04-24'
categories:
  - This Week in Chat
author: Ben Parsons
...
Some snapshots of what the team has been working on. Look out for a clear explanation from Erik about Chat performance (and what will be done about it!), and lots of other goodies
...
> Tchap, the Chat deployment in the French government, recently opened to French fire and rescue services: <https://twitter.com/_DINUM/status/1243595481449717761>
>
...
> Here's your weekly spec update! The heart of Chat is [the specification](https://matrix.org/docs/spec) - and this is modified by Chat Spec Change (MSC) proposals. Learn more about how the process works at <https://matrix.org/docs/spec/proposals.>
>
> ### MSC Status
>
> **Merged MSCs:**
...
> A bit late to the party - was rebuilding my cluster at home to EL8 - but pushed the [Kubernetes-optimized docker images](https://github.com/ananace/matrix-synapse) for Chat 1.12.4
...
>
> We hope you will try it out and have a good experience! If you don't, you can complain to us in [#nheko-reborn:matrix.org](https://to.chat.dingshunyu.top/#/#nheko-reborn:matrix.org) or open an issue in our [bugtracker](https://github.com/Nheko-Reborn/nheko/issues).
...
>
> This means that if you're reading this when this edition of TWIM goes out, and you fancy watching some Doctor Who this evening, join the fun at [#doctor-who-watchalong:abolivier.bzh](https://to.chat.dingshunyu.top/#/#doctor-who-watchalong:abolivier.bzh) 😀
>

---
date: '2020-04-17'
title: 'This Week in Chat 2020-04-17'
categories:
  - This Week in Chat
author: Ben Parsons
...
>
> * We now return far less 500 errors over federation which helps federation with Chat

### p2p.riot.im

[kegan](https://to.chat.dingshunyu.top/#/@kegan:matrix.org) announced:
...
A Chat homeserver written in Rust <https://conduit.rs>
...
>
> Check out the repository on <https://git.koesters.xyz/timo/conduit> and our Chat room on [#conduit:koesters.xyz](https://to.chat.dingshunyu.top/#/#conduit:koesters.xyz). If you want to try out the server yourself, you can try to connect to it using <https://riot.nordgedanken.de/#/register> (though it might be offline when you read this).
>
...
> **Update from Jason:**
>
> The Construct server made significant progress this week with end-to-end encryption, client compatibility, application services support, and build-related enhancements. I'd like to thank [Yan Minari](https://to.chat.dingshunyu.top/#/@yan:yetanothernerd.xyz) for contributing spec-compliant code paths for application services in the user registration system. Special thanks this week to [Tony O.](https://to.chat.dingshunyu.top/#/@qy:cs.xa0.uk) for continued work on the NixOS ([#nix:matrix.org](https://to.chat.dingshunyu.top/#/#nix:matrix.org)) derivation for reproducible builds, in addition to contributing fixes to Nio for optimal compatibility with Construct. I'd also like to thank [Wessel](https://to.chat.dingshunyu.top/#/@weebl:matrix.weebl.me) for contributing a much needed reorganization of the Dockerfiles in preparation for Construct operating on many more platforms. Many thanks to [Nico](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) for working with the team this week in [#test:zemos.net](https://to.chat.dingshunyu.top/#/#test:zemos.net) on various compatibility fixes to mtxclient and Nheko; the responsiveness when using Nheko with Construct is mind-blowing. I'd also like to thank [David Vo (a.k.a. auscompgeek)](https://to.chat.dingshunyu.top/#/@david:vovo.id.au) for also contributing to Nio toward Construct compatibility.
>
> Finally, I owe much appreciation to tulir, jochen, qy and others for setting up brand new installations this week and providing feedback in [#test:zemos.net](https://to.chat.dingshunyu.top/#/#test:zemos.net). Construct is the first and only federating alternative to Chat. It is written in C++ for maximum performance, the lowest possible TCO, and designed for horizontal scaling with Construct Cluster. If you are interested in starting a low-cost Chat hosting service, Construct may be your ideal choice. To stay informed and show your support please visit us in [#test:zemos.net](https://to.chat.dingshunyu.top/#/#test:zemos.net) today!

## Dept of Bridges 🌉

### Chat bridges bumper pack edition
...
[#rumatui:matrix.org](https://to.chat.dingshunyu.top/#/#rumatui:matrix.org) is the room to join.
...
>
> If you are a packager, it would be awesome if you can check, that you don't have any build issues. If you need support, just message us in [#nheko-reborn:matrix.org](https://to.chat.dingshunyu.top/#/#nheko-reborn:matrix.org) !
...
[Manu](https://to.chat.dingshunyu.top/#/@Manu:matrix.org) reported:
...
[jplatte](https://to.chat.dingshunyu.top/#/@jplatte:matrix.org) said:
...
[Peter Roberts](https://to.chat.dingshunyu.top/#/@pwr22:shortestpath.dev) reported:
...
[Brendan](https://to.chat.dingshunyu.top/#/@brendan:abolivier.bzh) offered:

> We've been doing Chat editions of [Emily Cook](https://twitter.com/Emily_Rosina)'s Doctor Who watchalongs since confinement started around Europe. The concept is pretty simple: on a given day, at a given time, everyone presses play on the same episode. Folks are then free to then watch it on their own, or discuss the episode as they watch it in the Chat room and/or in the Jitsi call. We're also bridging tweets sent from directors, writers, comedians, etc. watching the episode at the same time to Chat.
>
> If folks are interested in joining in, head over to [#doctor-who-watchalong:abolivier.bzh](https://to.chat.dingshunyu.top/#/#doctor-who-watchalong:abolivier.bzh)!
>
...
[Brendan](https://to.chat.dingshunyu.top/#/@brendan:abolivier.bzh) reported:

> To relay the tweets from guests during Doctor Who watchalongs, I've written a simple bot that reads the timeline of a Twitter list, optionally filters it by a hashtag, and posts the tweet to a Chat room.
>
> The code is available at <https://github.com/babolivier/matrix-tweetalong-bot>, and there's already an instance running in [#doctor-who-watchalong:abolivier.bzh](https://to.chat.dingshunyu.top/#/#doctor-who-watchalong:abolivier.bzh) if folks want to see it live.
...
[Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) said:
...
> Kaushik Chakraborty wrote an awesome NixOS tutorial for setting up Chat+Riot+Jitsi as a response to my Debian one! <https://kaushikc.org/posts/matrix-jitsi-nixos.html>

suddenly

> ...and Pablo Fredrikson recorded a fantastic video run-through in Spanish of setting up Chat on Docker! <https://www.youtube.com/watch?v=ZiVQalt5xhk>
...
While discussing the use of QML in Nheko, [aa13q](https://to.chat.dingshunyu.top/#/@aa13q:matrix.org) became extremely energised, so I'm including this piece:

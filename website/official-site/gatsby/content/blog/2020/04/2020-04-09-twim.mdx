---
date: '2020-04-09'
title: 'This Week in Chat 2020-04-09'
categories:
  - This Week in Chat
author: Ben Parsons
...
* [Valère](https://twitter.com/valereonmobile), from Chat and Riot, who presented on the importance of UX and cross-signing keys in end-to-end encrypted communications.
...
[s7evink](https://to.chat.dingshunyu.top/#/@s7evink:s3cr3t.me) told us:

> As of [this PR](https://github.com/go-gitea/gitea/pull/10831) Gitea has the ability to directly send webhooks to Chat. Currently it's only in the master branch, but should be in Gitea 1.12.0 which is due by May.

### script for forwarding unread Wilma messages to Chat

[mijutu](https://to.chat.dingshunyu.top/#/@mijutu:ellipsis.fi) said:

> I wrote a script for forwarding unread Wilma messages to Chat. Wilma is a website and mobile app for teacher-parent communication. Download the script from <https://k2c42.dy.fi/git/wilmatrix.git> and give feedback at [#wilmatrix:ellipsis.fi](https://to.chat.dingshunyu.top/#/#wilmatrix:ellipsis.fi)
...
[vurpo](https://to.chat.dingshunyu.top/#/@vurpo:hacklab.fi) gave us some background:
...
>
> * On name change, inform Chat users, if their preferred IRC name is taken.
...
Somehow it seems we never previously featured [untidylamp's ofono SMS/MMS bridge](https://gitlab.com/untidylamp/ofono-matrix-puppet). This is a Python3 project to bridge Chat and SMS/MMS messages via [ofono](https://01.org/ofono).
...
[andrewsh](https://to.chat.dingshunyu.top/#/@andrewsh:matrix.org) announced:
...
>
> Overall, the team is focused on finishing up cross-signing which is targetting release next week (assuming there are no surprises). 🎉

### RiotX

[valere](https://to.chat.dingshunyu.top/#/@valere35:matrix.org) said:
...
[jplatte](https://to.chat.dingshunyu.top/#/@jplatte:matrix.org) reported:
...
[poljar](https://to.chat.dingshunyu.top/#/@poljar:matrix.org) said:
...
### Send Sentry issues to a Chat room

[jaywink](https://to.chat.dingshunyu.top/#/@jaywink:federator.dev) offered:

> If you want your Sentry issues to a Chat room, there is now a new bot for that: <https://github.com/matrix-org/matrix-sentry-webhooks> . Currently it supports a simple "projects to rooms" mapping and should work with both legacy webhook integrations and integration platform webhooks.

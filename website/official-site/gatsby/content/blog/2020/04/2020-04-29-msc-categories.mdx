---
date: '2020-04-29'
title: New Categories for Chat Spec Changes
categories:
  - General
...
[Chat Spec Proposal process](https://matrix.org/docs/spec/proposals),
and those that were not.

The most glaring item on the list was the sluggish pace that many Chat
...
given their wide breadth of knowledge across the Chat ecosystem,
however the majority are some of the most busy pushing forward Chat's
reference implementations - without which, Chat will unquestionably fail.
...
category. We need to get Chat to a point where it can compete with other,

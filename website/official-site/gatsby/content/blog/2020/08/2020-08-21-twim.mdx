---
date: '2020-08-21'
title: 'This Week in Chat 2020-08-21'
categories:
  - This Week in Chat
author: Ben Parsons
...
Nico, one of the Nheko client maintainers, discusses the state of the project and shares various opinions about Chat, chat clients, physics, the local weather and so on.
...
[Chethan](https://to.chat.dingshunyu.top/#/@crdy2k1:matrix.org) offered:
...
>
> As always, feel free to join us in [#dendrite:matrix.org](https://to.chat.dingshunyu.top/#/#dendrite:matrix.org) for the latest!

### Conduit

Conduit is a Chat homeserver written in Rust <https://conduit.rs>

[timo](https://to.chat.dingshunyu.top/#/@timo:koesters.xyz) told us:
...
>
> Finally, Andrew has been working with Sorunome to dust off the knock feature, both on the spec and [the Chat side](https://github.com/matrix-org/synapse/pull/6739).

### Romeo and Juliet benchmark to compare Chat server implementations

[timo](https://to.chat.dingshunyu.top/#/@timo:koesters.xyz) offered:

> This week I created the first(?) Chat server benchmark and ran it on Chat, Dendrite and Conduit. The test will go through the entire Romeo and Juliet play and create users for each character and sends messages for each line they say.
>
...
[0xC0ncord](https://to.chat.dingshunyu.top/#/@concord:fuwafuwatime.moe) reported:

> Hello! Just recently I made public an SELinux policy module I developed for Chat. This policy is one I developed early on during my trip down the SELinux rabbit hole, and I have been using it in production for some time. At the moment, this policy module is built for the Gentoo SELinux policy (not RHEL/CentOS/Fedora) and does not currently have systemd support, nor has it been tested in all environments, i.e. with workers. I am publishing this policy in the hopes that it will be useful and I am open to any contributions, even those to help tighten the policy if possible. Finally, I have also made public a policy module for coturn, which I am also using in my own personal environment under the same conditions. Both the [Chat](https://github.com/0xC0ncord/synapse-selinux) policy and the [coturn](https://github.com/0xC0ncord/turnserver-selinux) policy can be found on Github. Thank you!

### Ansible

[JCG](https://to.chat.dingshunyu.top/#/@jan.christian:gruenhage.xyz) said:

> The ansible collection `famedly.matrix` has seen another release, 0.1.2, which updates the element role to 1.7.4 and the synapse role to 1.19.0. As always, get it from [Ansible Galaxy](https://galaxy.ansible.com/famedly/matrix), source from [Gitlab](https://gitlab.com/famedly/ansible/collections/matrix), and for any questions join [#ansible:famedly.de](https://to.chat.dingshunyu.top/#/#ansible:famedly.de).

### Kubernetes

[Ananace](https://to.chat.dingshunyu.top/#/@ace:kittenface.studio) announced:

> Just pushed the 1.19 tags for the [K8s-optimized Chat image](https://github.com/ananace/matrix-synapse), as well as an updated [chart](https://gitlab.com/ananace/charts) version for it that also takes advantage of the added `/health` endpoint.

### Void Linux

[JCG](https://to.chat.dingshunyu.top/#/@jan.christian:gruenhage.xyz) announced:

> Element 1.7.4 and Chat 1.19.0 have been packaged for Void Linux, packages are already available from mirrors.

### dacruz21/matrix-chart Kubernetes Helm Chart

[Typo Kign](https://to.chat.dingshunyu.top/#/@david:typokign.com) told us:

> v2.5.0 of [dacruz21/matrix-chart](https://hub.helm.sh/charts/dacruz21/matrix) has been released with Chat 1.19 support and some new configuration options.

### YunoHost

[Pierre](https://to.chat.dingshunyu.top/#/@pierre:mamieserv.fr) reported:
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration is still 1.18.0, 1.19.0 is available en branch `testing`
>
...
[bo41](https://to.chat.dingshunyu.top/#/@bo41:matrix.org) reported:

> As channels are really popular in Telegram, I wrote a quick and dirty program/bot which can mirror (text and image) public Telegram channels to Chat rooms. This should make it easier for Telegram users to consider a switch.
>
...
>
> If you decide to try it out, backup your cache or at least BACKUP YOUR ENCRYPTION KEYS! I won't be responding to feedback immediately, since I am currently hiking, but I should get to it this weekend or next week. Come discuss it in [#nheko:ocean.joedonofry.com](https://to.chat.dingshunyu.top/#/#nheko:ocean.joedonofry.com), if you have some feedback or issues.

See also Chat Live this week!

### Element Android

[benoit](https://to.chat.dingshunyu.top/#/@benoit.marty:matrix.org) announced:

> We are still fixing issues on Element Android. Hopefully we will release version 1.0.5 of the application and of the Chat SDK in the coming days!
...
[steve](https://to.chat.dingshunyu.top/#/@stevio:matrix.org) offered:
...
>
>   * Chat.to link previews in progress

### Hydrogen

Hydrogen is a web-based client designed to be very lightweight, and with few dependencies.
Anyone who wants to discuss Hydrogen can join [#hydrogen:matrix.org](https://to.chat.dingshunyu.top/#/#hydrogen:matrix.org).
...
[miruka](https://to.chat.dingshunyu.top/#/@miruka:privacytools.io) hit us with a late breaking update about Mirage!
...
>   to.chat.dingshunyu.top links contained in the "In reply to XYZ" header
> 
...
[iinuwa](https://to.chat.dingshunyu.top/#/@iinuwa:matrix.org) offered:
...
>
> Speaking of livestreams, @jplatte streams coding sessions from time to time on [Twitch](https://twitch.tv/jplatte). If you're interested in watching some coding streams to get more familiar with the Ruma codebase or learn Rust in general, follow us at [[#ruma-livestreams:matrix.org](https://to.chat.dingshunyu.top/#/#ruma-livestreams:matrix.org)](https://to.chat.dingshunyu.top/#/[#ruma-livestreams:matrix.org](https://to.chat.dingshunyu.top/#/#ruma-livestreams:matrix.org))!

Very impressed that these features are landing in Ruma first, with the intention of getting them into Conduit.

### mautrix-go

[nikofil](https://to.chat.dingshunyu.top/#/@nikofil:matrix.org) reported:
...
> Just pushed version 2.1.1 of the [Ruby Chat SDK](https://github.com/ananace/ruby-matrix-sdk), mainly including a couple of fixes for various minor issues.
...
> [matrix-docker-ansible-deploy](https://github.com/spantaleev/matrix-docker-ansible-deploy) now makes it incredibly easy to use [rust-synapse-compress-state](https://github.com/matrix-org/rust-synapse-compress-state) to compress the state groups in your Chat database.
>
...
[nikofil](https://to.chat.dingshunyu.top/#/@nikofil:matrix.org) said:
...
> It would be great to see a project building on Chat.

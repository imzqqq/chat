---
date: "2020-08-14"
title: "This Week in Chat 2020-08-14"
categories:
  - This Week in Chat
author: Ben Parsons
...
No new Chat Live this week, we have Open Tech Will Save Us #5:
...
Also, I recommend Chat Live from last week, with [Timo and Matthew discussing Conduit/Rust/Homeserver dev](https://youtu.be/cIOKD9xM3F0). Conduit is absolutely motoring, as you will read below.

## Dept of _Status of Matrix_ 🌡️

### Linköping University has now soft-launched Chat

[Alexander Olofsson](https://to.chat.dingshunyu.top/#/@aleol57:liu.se) said:

> In _completely unrelated_ news to my earlier K8s updates, Linköping University has now soft-launched Chat for use both internally - and hopefully with other universities and institutions in the future.

Se the k8s updates from _Ananace_ below. Is this the first .se university offering Chat? Also, great hostname!
...
[tyagdit](https://to.chat.dingshunyu.top/#/@tyagdit:matrix.org) announced:
...
[anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz) brought it to our attention that this graph looks like a "ocean-beach waterline dropoff".
...
>
> After implementing all those things, I could actually see Conduit's join event on Chat!
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration had been updated to 1.18.0
>
...
> Just pushed some WIP (v0.1) [charts](https://gitlab.com/ananace/charts) for both Chat and the matrix-media-repo project, written with Redis, workers/sharding, PVC constraints, and other large deployment thoughts in mind.
>
> Note that these charts - the Chat one in particular - basically require you to have a fully featured cluster, with a regex-capable ingress, automated cert manager, and RBAC. They do not require you to have a ReadWriteMany capable storage class though, even when using workers.

and then:

> To expand on my earlier TWIM, the [charts for Chat, media-repo, and now element-web](https://gitlab.com/ananace/charts) are all being used in production now so they are also respectively receiving their 1.0's
...
BIG update! Looking forward to trying out voice calls. ☎️ Maybe we'll be calling Nico for Chat Live soon..?

### Element-Android

[benoit](https://to.chat.dingshunyu.top/#/@benoit.marty:matrix.org) said:
...
>
> Another goal is to make it easy to embed parts of the app (like the room view) into another app or website. It could also be really nice to have a place to play and experiment with new tech for element proper - much as Dendrite has influenced Chat.
>
...
[ismailgulek](https://to.chat.dingshunyu.top/#/@igulek:matrix.org) offered:
...
[carl](https://to.chat.dingshunyu.top/#/@carl:bordum.dk) said:
...
>
> Chat with cody: [@cody:bordum.dk](https://to.chat.dingshunyu.top/#/@cody:bordum.dk)
>
> Join our cody room: [#cody:bordum.dk](https://to.chat.dingshunyu.top/#/#cody:bordum.dk)
...
> [opsdroid](https://github.com/opsdroid/opsdroid) is getting close to a release with the matrix connector rewritten to use the matrix-nio library. If you are feeling brave and want to help us iron out any bugs before the release, please install the master branch and test it out for your matrix bots. Please report any issues on the GitHub issue tracker or come talk in [#opsdroid-developers:matrix.org](https://to.chat.dingshunyu.top/#/#opsdroid-developers:matrix.org). Hopefully, a release with this and lots of other goodies will be coming in a couple of weeks.

## Dept of Interesting Projects 🛰️

### Privee

[terry_hello](https://to.chat.dingshunyu.top/#/@terry_hello:matrix.org) said:

> Hi All,
>
> I’ve created a compact and portable home server based on Chat protocol, it’s a piece of hardware which is easy to use and set up. I’m working on a new client APP similar to other typical messenger GUI, but this server we named it ‘Privee’ supports any messenger developed with Chat protocol. I’ve launched a campaign on Kickstarter this week, please come and support us! Thank you!
...
This is an early-stage project (hence starting on KickStarter.) While exciting and ambitious, I encourage everyone to do their own research! Learn more and chat with terry_hello (who has done a good job handling questions already!) in [#Privee:matrix.org](https://to.chat.dingshunyu.top/#/#Privee:matrix.org).

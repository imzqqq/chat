---
date: '2020-01-31'
title: 'This Week in Chat 2020-01-31'
categories:
  - This Week in Chat
author: Ben Parsons
...
This weekend Chat will be well [represented at FOSDEM](https://fosdem.org/2020/)! We'll have a stand (come visit!), but also note that we have THREE speaking slots (all on Sunday):

* Half-Shot will discuss [Bridging All The Things with Chat](https://fosdem.org/2020/schedule/event/matrix_bridge/) in **UD2.208 (Decroly)** at *11:15*
* Matthew will present [The Path to Peer-to-Peer Chat](https://fosdem.org/2020/schedule/event/dip_p2p_matrix/) in **UA2.220 (Guillissen)** at *14:30*
* Matthew again will give a talk titled [Making & Breaking Chat's E2E encryption](https://fosdem.org/2020/schedule/event/matrix/) in **K.1.105 (La Fontaine)** at *16:00*

No Chat Live today - look out for a special edition this weekend!
...
> * Fix room name retrieval after Chat dropped table room_names (from <https://github.com/NullIsNot0)>
...
>
> As always, if you have any questions check out the [support channel](https://to.chat.dingshunyu.top/#/#mx-puppet-bridge:sorunome.de) and please consider to [donate](https://liberapay.com/Sorunome/donate)! (Thanks sooooo much to everyone who donated so far!) 🦊
>
> #### matrix-slack-parser
...
[MTRNord](https://to.chat.dingshunyu.top/#/@MTRNord:matrix.ffslfl.net) said:
...
[@sava:chat.zorbiro.com](https://to.chat.dingshunyu.top/#/@sava:chat.zorbiro.com) announced:
...
> I know it's a bit naughty to post rooms in here, but for developers looking to play around with Vue.js (with matrix), we've created a support room over at [#vue:half-shot.uk](https://to.chat.dingshunyu.top/#/#vue:half-shot.uk)

---
date: '2020-01-24'
title: 'This Week in Chat 2020-01-24'
categories:
  - This Week in Chat
author: Ben Parsons
...
>
> Hello wannabe IRC and Chat users! Today the bridge team bring you the 0.14.X series of the irc bridge. This is the mammoth release featuring all the Typescript changes and postgres stuff. The Postgres changes aren't as essential as they are for Chat, but useful if you run a ~20k Freenode bridge.
>
> The highlights are:
>
...
>
> As always, feel free to drop by the [support room](https://to.chat.dingshunyu.top/#/[#mx-puppet-bridge:sorunome.de](https://to.chat.dingshunyu.top/#/#mx-puppet-bridge:sorunome.de)) and please consider [to donate](https://liberapay.com/Sorunome/donate)!
...
[stoic](https://to.chat.dingshunyu.top/#/@stoically:matrix.org) annouced this pretty cool project:
...
> Room: [#riot-webext:matrix.org](https://to.chat.dingshunyu.top/#/#riot-webext:matrix.org)

### Ditto Chat [v0.2.0] released!

[Annie](https://to.chat.dingshunyu.top/#/@annie:elequin.io) announced Ditto Chat v0.2.0!

Ditto Chat is a Chat Client in React Native.
...
> Room: [#ditto:elequin.io](https://to.chat.dingshunyu.top/#/#ditto:elequin.io)

### koma and Continuum, Kotlin Chat projects
...
### Tampere Hacklab information display powered by Chat

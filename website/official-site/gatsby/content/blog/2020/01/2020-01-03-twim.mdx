---
date: '2020-01-03'
title: 'This Week in Chat 2020-01-03'
categories:
  - This Week in Chat
author: Ben Parsons
---
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/rcpl6Spc6SI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## Dept of *Status of Chat* 🌡

### Responses to *The Ecosystem is Moving*

[Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) wrote a response to <https://signal.org/blog/the-ecosystem-is-moving/> : <https://matrix.org/blog/2020/01/02/on-privacy-versus-freedom/>.
...
Chat 1.7.3 includes an [important bugfix](https://github.com/matrix-org/synapse/releases/tag/v1.7.3), hosts are encouraged to upgrade.

[Ananace](https://to.chat.dingshunyu.top/#/@ace:kittenface.studio) reported that the K8s optimized Chat 1.7.3 images have been updated, but you should find that all distributors have the latest version now.
...
>
> - Automatic Puppeting, thanks to [tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) [PR](https://github.com/Sorunome/mx-puppet-bridge/pull/12)!
...
[sorunome](https://to.chat.dingshunyu.top/#/@sorunome:sorunome.de) again:
...
>
> If you like these projects, please check out the [support chat](https://to.chat.dingshunyu.top/#/#mx-puppet-discord:sorunome.de) and consider to [donate](https://liberapay.com/Sorunome)!
...
[Tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) again:
...
[Tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net), busiest fellow in the North, again:
...
[@krille:ubports.chat](https://to.chat.dingshunyu.top/#/@krille:ubports.chat) said:
...
Also, [@lub:imninja.net](https://to.chat.dingshunyu.top/#/@lub:imninja.net) told us:

> I created a [#ping:maunium.net](https://to.chat.dingshunyu.top/#/#ping:maunium.net) compatible bot in PowerShell <https://gitea.lubiland.de/lub/pingposh/src/branch/master>
...
Half-Shot is working on a fun and geniunely useful **non-chat Chat application**, more on this soon.

**36c3 was exciting, exhausing and educational**. Thanks to everyone who made the Chat Assembly one of the liveliest places around. :D

---
date: '2020-01-17'
title: 'This Week in Chat 2020-01-17'
categories:
  - This Week in Chat
author: Ben Parsons
...
Chat will be applying to be a Mentoring Organisation, as we have for several years now. This year, we'd like to open the umbrella a little. If you think your (Chat-related) project could help mentor a student, and that you could offer a meaningful project to that student, please contact me directly. For reference, there were *four* students under the Chat heading last year, of which one was assigned to work with Kitsune on encryption support in libQuotient.

### FOSDEM 2020

Will you be at FOSDEM this year? Chat will be very well represented, so please come and see us at our stand, plus attend *all* of the three talks we'll be conducting. Many more details to follow!

## Dept of Services 🚀

New from bit.nl, a public Chat Homeserver focused on the Dutch market. [Read the announcement](https://www.bit.nl/news/2610/293/Riot-als-privacyvriendelijke-en-veilige-berichtenapp) and [sign up here](https://riot.nltrix.net).
...
## Dept of *Built on Chat* 🏗

### Chat Presents 📽️

[Half-Shot](https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk) told us:

> What is it? Slideshows in Chat, basically using the matrix room / event primitives to construct presentable federated slide shows.
>
...
>
> Come check us out at [#presents:half-shot.uk](https://to.chat.dingshunyu.top/#/#presents:half-shot.uk)

## Dept of Bridges 🌉

### matrix-imposter-bot, interesting relay idea

[@mr_johnson22:matrix.org](https://to.chat.dingshunyu.top/#/@mr_johnson22:matrix.org) said:
...
> * Implement variables for name patterns
>
> As always, if you have any questions, please drop by [the support chat](https://to.chat.dingshunyu.top/#/#mx-puppet-bridge:sorunome.de) and consider to [donate](https://liberapay.com/Sorunome/donate)! 🦊🦊🦊

## Dept of Clients 📱

### Nheko replies rendering

[@deepbluev7:neko.dev](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) said:
...
[@bubu:bubu1.eu](https://to.chat.dingshunyu.top/#/@bubu:bubu1.eu) told us:
...
> * Add option to use authentication with `GET /_matrix/client/r0/publicRooms` to fix HTTP Unauthorized errors with newer Chat versions which may have `allow_public_rooms_without_auth` set to False.
>
...
[@murz:ru-matrix.org](https://to.chat.dingshunyu.top/#/@murz:ru-matrix.org) said:
...
[@cadair:cadair.com](https://to.chat.dingshunyu.top/#/@cadair:cadair.com) offered:

---
date: '2020-05-22'
title: 'This Week in Chat 2020-05-22'
categories:
  - This Week in Chat
author: Ben Parsons
...
Huge news, [read more detail here](https://matrix.org/blog/2020/05/21/welcoming-automattic-to-matrix)! Check out Chat Live with Matt Mullenweg above, too.

[Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) announced:

> Automattic invested in New Vector in order to support Chat, and are also hiring Chat Integration Engineers! <https://automattic.com/work-with-us/matrix-integrations-engineer/>
...
As if this wasn't enough, [sorunome](https://to.chat.dingshunyu.top/#/@sorunome:sorunome.de) reported:
...
>
> * Dendrite is now compliant with Chat on backfill behaviour.
...
>
> This has culminated in the following values for Are We Chat Yet:
>
> ```
...
[miruka](https://to.chat.dingshunyu.top/#/@miruka:matrix.org) offered:
...
[valere](https://to.chat.dingshunyu.top/#/@valere35:matrix.org) offered:
...
>
> You can still find it on rubygems as `matrix_sdk`, and feel free to drop by [#ruby-matrix-sdk:kittenface.studio](https://to.chat.dingshunyu.top/#/#ruby-matrix-sdk:kittenface.studio) for questions, comments, or just general discussion.
...
[Nataraj](https://to.chat.dingshunyu.top/#/@dhyan:nataraj.su) offered:
...
>
> I didn't have any public donation things earlier due to the Finnish money collection act, but I realized that I can bypass that by selling things (like access to a Chat room) instead of it only being a donation.
>
...
I didn't feature this last month: [GNU Radio are now using Chat](https://www.gnuradio.org/blog/2020-04-27-moving-to-the-matrix/).

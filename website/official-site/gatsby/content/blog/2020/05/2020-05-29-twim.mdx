---
date: '2020-05-29'
title: 'This Week in Chat 2020-05-29'
categories:
  - This Week in Chat
author: Ben Parsons
...
>
> As always, any questions about the spec itself can be answered in [#matrix-spec:matrix.org](https://to.chat.dingshunyu.top/#/#matrix-spec:matrix.org), [#matrix-dev:matrix.org](https://to.chat.dingshunyu.top/#/#matrix-dev:matrix.org), or in the various area-specific rooms floating around the federation.
...
> I made a TARDIS (Time Agnostic Room DAG Inspection Service) - a simple time-travelling debugger for Room DAGs which plugs into Dendrite's internal APIs to visualise room DAGs.  The intention is to provide it as a widget which Riot can use to visualise DAGs for debugging, particularly for P2P Chat.  The time-travel bit is simply that it could let you filter out the newer events to show how the DAG has evolved over time, although that isn't hooked up yet. <https://github.com/matrix-org/tardis>
...
> Just pushed the [K8s-optimized images](https://github.com/ananace/matrix-synapse) for Chat 1.14.0 - slight changes have been done to the image to further streamline it a bit.

### Docker-matrix

[Mathijs](https://to.chat.dingshunyu.top/#/@mathijs:matrix.vgorcum.com) said:
...
Thanks [haywo](https://to.chat.dingshunyu.top/#/@haywo:nct08.de) for this update:
...
> It's available an GitHub and PyPi, take a look at [https://github.com/HayWo/buildbot-matrix](https://github.com/HayWo/buildbot-matrix) for more informations.
...
Certainly not from *this* week, but we haven't featured it before: [Minetrix](https://github.com/rrerrNet/Minetrix) allows you to bridge a Minecraft server with a Chat room.
...
> A Chat webclient written in (mostly) Rust using the official Chat-Rust-SDK and Rusts WASM Support.
>
> Daydream is the Idea of a Rust Chat Client. It is still in a very early state and at the time of writing this supports basic displaying of text, image and bot messages as well as sending plain text and markdown.
>
> Try it at <https://daydream.nordgedanken.dev/> or check out the Source Code at <https://github.com/MTRNord/Daydream>
>
> Feel free to join the Chat Room: [#daydream:nordgedanken.dev](https://to.chat.dingshunyu.top/#/#daydream:nordgedanken.dev)

![2020-05-29-ATL-f-grafik.png](/blog/img/2020-05-29-ATL-f-grafik.png)

### RumaTui

Thanks [devinr528](https://to.chat.dingshunyu.top/#/@devinr528:matrix.org) for sharing this 
...
I am hoping to have an actual release on crates.io by the end of the day. If you have any thoughts join [#rumatui:matrix.org](https://to.chat.dingshunyu.top/#/#rumatui:matrix.org)  or check it out on [github](https://github.com/DevinR528/RumaTui).
...
>
> * starting early work on a redesigned to.chat.dingshunyu.top website
...
[Torrey Searle](https://to.chat.dingshunyu.top/#/@tsearle:hackerspaces.be) reported:
...
>
> or goto [#midori-dev:hackerspaces.be](https://to.chat.dingshunyu.top/#/#midori-dev:hackerspaces.be) for support/live-demo
...
This one isn't quite merged yet as we're going to give a thorough review, but big *thank you* to [sorunome](https://to.chat.dingshunyu.top/#/@sorunome:sorunome.de) for taking the time to put this together:
...
(Chat at around 29:30)

## New Public Rooms 🏟

[Ludwig](https://to.chat.dingshunyu.top/#/@ludwig:disko.media) announced:

> May I advertise [#matrix-design:matrix.org](https://to.chat.dingshunyu.top/#/#matrix-design:matrix.org) to you.
>

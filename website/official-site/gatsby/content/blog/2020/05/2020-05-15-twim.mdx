---
date: '2020-05-15'
title: 'This Week in Chat 2020-05-15'
categories:
  - This Week in Chat
author: Ben Parsons
...
* ... and a new VIP tour of Dendrite, the next-gen Chat Homeserver, from our own neilalexander and Kegan!

## Dept of *Status of Chat* 🌡

### Bundeswehr switching to Chat

[Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) said:

> German army [reported](https://matrix.org/blog/category/this-week-in-matrix/4#bundeswehr-considering-matrix) in December 2019 their intentions for Chat.
>
> Now they decided to replace Stashcat with Chat in this autumn.
>
> Around 50'000 account are planned.
>
> Riot will be used as a Chat client. The E2EE by default and device Cross-Signing will be extensively used.
>
> Full article (in German): <https://www.heise.de/newsticker/meldung/Bundeswehr-setzt-kuenftig-auf-Chat-als-Messenger-4719474.html>
...
> Chat [v1.13.0rc2](https://github.com/matrix-org/synapse/releases/tag/v1.13.0rc2) shipped this week with the following notable improvements:
>
> * SSO support in User-Interactive Authentication sessions
>
> * Cross-signing device list bug fixes
> * The ability to run in worker mode using redis as a backend (which will soon be considered the default transport for Chat workers)
>
...
> #### Links
>
> * [Chat Room (#ditto:ditto.chat)](https://to.chat.dingshunyu.top/#/#ditto:ditto.chat)
...
[Wilko](https://to.chat.dingshunyu.top/#/@wilko:pattle.im) said:
...
[krille](https://to.chat.dingshunyu.top/#/@krille:ubports.chat) said:
...
[kilian](https://to.chat.dingshunyu.top/#/@kilian:nio.chat) told us:
...
>
> Join us in [#niochat:matrix.org](https://to.chat.dingshunyu.top/#/#niochat:matrix.org) for discussion and more fun 😊

### Riot-Android 0.9.11

[benoit](https://to.chat.dingshunyu.top/#/@benoit.marty:matrix.org) reported:

> Riot-Android: Version 0.9.11 (with Chat SDK 0.9.34) has been released on the PlayStore, and should be available for all during the week-end. It contains fixes on the identity server feature (the "missing token" thing), and also support Jitsi call with configured domain.
...
> This SDK is now on maven central. I also introduced support for implementing Application Services. The project can be found here: <https://github.com/benkuly/matrix-spring-boot-sdk> . It will be used by Chat-SMS-Bridge, which only needs one telephone number. The latter will be released next week, when everything works fine (https://github.com/benkuly/matrix-sms-bridge).

### Chat Dart SDK: v0.31.0
...
[rdi](https://to.chat.dingshunyu.top/#/@rdi:matrix.alkemata.com) said:
...
>
> * room for discussing: [#jupybot:matrix.alkemata.com](https://to.chat.dingshunyu.top/#/#jupybot:matrix.alkemata.com)
...
[lub](https://to.chat.dingshunyu.top/#/@lub:imninja.net) reported:
...
[Torrey Searle](https://to.chat.dingshunyu.top/#/@tsearle:hackerspaces.be) told us:

> I've added matrix support into a chat bot, you can see the chat bot in action at [#midori-dev:hackerspaces.be](https://to.chat.dingshunyu.top/#/#midori-dev:hackerspaces.be) and it's project page is here <https://github.com/midoricorp/jabbot>.  
...
[Chat will be featured in a Rust London meetup](https://www.meetup.com/Rust-London-User-Group/events/270526235/) on the 27th May 2020.

## New Public Rooms 🏟

[Ludwig](https://to.chat.dingshunyu.top/#/@ludwig:disko.media) offered:

> Hey, I have created a room for designers workin on matrix stuff to join: [#matrix-design:disko.media](https://to.chat.dingshunyu.top/#/#matrix-design:disko.media)
>

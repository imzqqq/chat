---
date: '2020-06-19'
title: 'This Week in Chat 2020-06-19'
categories:
  - This Week in Chat
author: Ben Parsons
...
### Chat Merch Store is back

Are you emerging from lockdown? Dazed and wondering what to wear? Need some apparel which says "_I'm cool and I have great taste in decentralised communications protocols_"? Then you should visit [The Chat Merch Store](https://shop.matrix.org/)!

T-Shirts, Hoodies, Zipped Hoodies and Stickers available now!

### Chat Decomposition: Analysis of an Access Control Approach on Transaction-based DAGs without Finality

[Florian](https://to.chat.dingshunyu.top/#/@florian:dsn.tm.kit.edu) told us:

> [We](https://dsn.tm.kit.edu/) published another scientific paper on Chat, this time it is called [Chat Decomposition: Analysis of an Access Control Approach on Transaction-based DAGs without Finality](https://doi.org/10.1145/3381991.3395399)!
> Its main topic is the question of how access control can work based on a structure that only provides a partial order on events and no consensus on the current state, i.e. the Chat Event Graph. We found some concrete, non-critical security issues related to both incorrect specification  as well as divergent homeserver behaviour. While the last remaining mitigations found their way into Chat 1.14.0, we provide ideas on structural solutions to avoid both problem classes in the future using formal verification.
>
...
The paper was [previously mentioned on the Chat blog](/blog/2020/06/16/matrix-decomposition-an-independent-academic-analysis-of-matrix-state-resolution).
...
> **New MSCs:**
>
> * [MSC2644: to.chat.dingshunyu.top URI syntax v2](https://github.com/matrix-org/matrix-doc/pull/2644)
...
> Bugfixes
>
> * Fix a bug introduced in v1.15.0 that would crash Chat on start when using certain password auth providers. 
>
...
>
>  * Have the ability to shard the media repository worker. This means we can now run an arbitrary number in parallel, thereby improving upload reliability and performance, we are running this on Chat. 
>
...
### Chat adoption graphs

[Chris](https://to.chat.dingshunyu.top/#/@chris:settgast.org) said:
...
How is Chat performance these days? [PINE64 are running their instance](https://fosstodon.org/@PINE64/104349781501483464) on their own [ROCKPro64](https://www.pine64.org/rockpro64/) hardware.
...
> Just pushed 1.15.1 tags for the K8s-optimized Chat image.

### Docker-matrix

[Mathijs](https://to.chat.dingshunyu.top/#/@mathijs:matrix.vgorcum.com) announced:
...
[karlik](https://to.chat.dingshunyu.top/#/@karlik:matrix.org) offered:
...
[Sophie still alive](https://to.chat.dingshunyu.top/#/@sharky:shark.pm) said:
...
[devinr528](https://to.chat.dingshunyu.top/#/@devinr528:matrix.org) told us:
...
[Manu](https://to.chat.dingshunyu.top/#/@Manu:matrix.org) told us:
...
[jo](https://to.chat.dingshunyu.top/#/@jo:catgirl.party) offered:
...
[kitsune](https://to.chat.dingshunyu.top/#/@kitsune:matrix.org) said:
...
[devinr528](https://to.chat.dingshunyu.top/#/@devinr528:matrix.org) sent us this late entry!
...
> Polyjuice Client, a Chat library for Elixir, had [a new release](https://hex.pm/packages/polyjuice_client/0.2.3).  This release fixes syncs, which apparently were completely broken in the last release (whoops).  The wizarding community also welcomes a new contributor, Pierre de Lacroix.

## Dept of Ops 🛠

### Gitea

[s7evink](https://to.chat.dingshunyu.top/#/@s7evink:s3cr3t.me) reported:

> [Gitea 1.12.0](https://github.com/go-gitea/gitea/releases/tag/v1.12.0) was finally released. It's now possible to send notifications (commits, pull requests, etc.) directly to Chat using webhooks.

## Dept of Internet of Things 💡

### Mozilla WebThings Chat Adapter

[Christian](https://to.chat.dingshunyu.top/#/@christianp:vector.modular.im) offered:

> I heard that you people like IoT?! With the Mozilla WebThings Chat Adapter your Raspberry Pi sends you messages about your home. Want a log of when the front door has been opened? Need a low battery alert for your IoT devices? With the Mozilla IoT gateway and this adapter, you can send these events to a Chat room of your choice!
>
...
[maralorn](https://to.chat.dingshunyu.top/#/@maralorn:maralorn.de) offered:

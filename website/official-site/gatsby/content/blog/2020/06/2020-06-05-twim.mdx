---
date: '2020-06-05'
title: 'This Week in Chat 2020-06-05'
categories:
  - This Week in Chat
author: Ben Parsons
...
[Nico](https://to.chat.dingshunyu.top/#/@nico:beerfactory.org) said:
...
>
> Contributions are welcome, join us on [#mascarene:beerfactory.org](https://to.chat.dingshunyu.top/#/#mascarene:beerfactory.org)
...
> This week in Chat land we have been focusing on bug fixes especially SSO and soft logout. 
>
...
Additionally! You may have already read about [v0.1.1 of the P2P Chat demo](https://matrix.org/blog/2020/06/02/introducing-p-2-p-matrix) - this is a big update, with local storage, room alias handling, federation improvements and more! 

## Dept of Bridges 🌉

### Chat Appservice Minecraft bridge now in beta

[Dylan](https://to.chat.dingshunyu.top/#/@dhmf:dhdf.dev) reported:

> My Chat Appservice Minecraft bridge is now in beta
>
>  * <https://github.com/dhghf/matrix-appservice-minecraft>
>
> Here is our Chat room [#minecraft:dhdf.dev](https://to.chat.dingshunyu.top/#/#minecraft:dhdf.dev)
...
[Alexander Eisele](https://to.chat.dingshunyu.top/#/@alexander:eiselecloud.de) reported:
...
>
> * Discussion/Testing: [#tuple:eiselecloud.de](https://to.chat.dingshunyu.top/#/#tuple:eiselecloud.de)
...
[stoic](https://to.chat.dingshunyu.top/#/@stoically:matrix.org) reported:
...
Keytar support is a [very very new feature](https://github.com/matrix-org/matrix-js-sdk/pull/1387), [uhoreg](https://to.chat.dingshunyu.top/#/@hubert:uhoreg.ca), who has been [working on it in the shadows](https://github.com/vector-im/riot-desktop/pull/95) and wasn't expecting to see it land yet, commented:
...
[Wilko](https://to.chat.dingshunyu.top/#/@wilko:pattle.im) offered:
...
> #### Get involved
>
> * **Follow development**: [#app:pattle.im](https://to.chat.dingshunyu.top/#/#app:pattle.im)
>
...
[miruka](https://to.chat.dingshunyu.top/#/@miruka:privacytools.io) said:
...
[Manu](https://to.chat.dingshunyu.top/#/@Manu:matrix.org) said:
...
A glossy Chat collaboration client for the web. <https://riot.im>
...
### Chat Dart SDK: version 0.32.0

[Wilko](https://to.chat.dingshunyu.top/#/@wilko:pattle.im) announced:
...
[jplatte](https://to.chat.dingshunyu.top/#/@jplatte:matrix.org) offered:
...
>   * As part of this, we introduced a kind of meta-library so you no longer have to keep the versions of the indivual libraries in sync manually
>
...
[Brendan](https://to.chat.dingshunyu.top/#/@brendan:abolivier.bzh) said:
...
>
> To learn more, see our [Setting up Chat SMS bridging](https://github.com/spantaleev/matrix-docker-ansible-deploy/blob/8d786713a6b8efb998a1313ca3fd1d9401e984cc/docs/configuring-playbook-matrix-bridge-sms.md) docs page.

### CLI Federation Tester

[Kai](https://to.chat.dingshunyu.top/#/@kai:matrix.chat-secure.de) reported:
...
[Louis Chmn](https://to.chat.dingshunyu.top/#/@louis:chmn.me) announced:

> Hi, I've build FLAP to help other self-host multiple free softwares. FLAP can currently help you to easily setup Chat, Riot, Nextcloud, SOGo and Jitsi all with SSO and low maintenance needs. Feel free to give it a try !
>
> * Sources are here: <https://gitlab.com/flap-box/flap>
>
> * If you need help setting things up, Chat room is here: [#flap-software:matrix.org](https://to.chat.dingshunyu.top/#/#flap-software:matrix.org)
>
...
[sparky](https://to.chat.dingshunyu.top/#/@sparky:matrix.possumlodge.me) told us:

> Announcing Chat Bot (name is a work in progress)
>
...
interesting virtual event plans, and I'm bursting to share some of the Chat
integration plans, hopefully more details coming soon.

[elmussol](https://to.chat.dingshunyu.top/#/@elmussol:elsmussols.net) said:

> For those who Hubzilla or Zap or ActivityPub or Friendica or Diaspora, there is now a Hubzilla forum for all things Chat: <https://elsmussols.net/channel/matrix>

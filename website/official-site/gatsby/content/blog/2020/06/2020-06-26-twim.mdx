---
date: '2020-06-26'
title: 'This Week in Chat 2020-06-26'
categories:
  - This Week in Chat
author: Ben Parsons
...
Yes it's back! For the first time in months we are shipping branded IRL-items featuring Chat branding. Head to [The Shop](https://shop.matrix.org/) to stock-up.
...
[devinr528](https://to.chat.dingshunyu.top/#/@devinr528:matrix.org) reported:
...
[karlik](https://to.chat.dingshunyu.top/#/@karlik:matrix.org) told us:
...
[tyagdit](https://to.chat.dingshunyu.top/#/@tyagdit:matrix.org) reported:
...
[Nico](https://to.chat.dingshunyu.top/#/@nico:beerfactory.org) reported:
...
>
> Join us at [#mascarene:beerfactory.org](https://to.chat.dingshunyu.top/#/#mascarene:beerfactory.org)
...
>
> * Chat <-> WhatsApp bridging of most membership changes

### mautrix-facebook

[Tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) reported:

> The Messenger bridge mostly got bugfixes, but also Chat->Facebook bridging of all media and location messages
...
[Gary Kim](https://to.chat.dingshunyu.top/#/@gary:garykim.dev) announced:
...
>
> Join the development Chat room at [#riotchatfornextcloud-general:garykim.dev](https://to.chat.dingshunyu.top/#/#riotchatfornextcloud-general:garykim.dev). Check out the source code [here](https://github.com/gary-kim/riotchat).
...
### Chat Dart SDK: v0.33.0

[Wilko](https://to.chat.dingshunyu.top/#/@wilko:pattle.im) told us:
...
>
> * Add `format` field to `TextMessage` (thank you [Cyril](https://to.chat.dingshunyu.top/#/@scappino:matrix.org)!)
...
[joepie91](https://to.chat.dingshunyu.top/#/@joepie91:pixie.town) discovered this project, presented yesterday at Conference in the Cloud:
...
> Net::Chat::Webhook implements a webhook, so you can easily post messages to your matrix chat rooms via HTTP requests. It uses IO::Async to start a web server and connect as a client to matrix. It will then forward your messages.
...
>
> Like the other bots, you can self-host it, use my instance (@satw:maunium.net) in your own room or simply join [#satwcomic:maunium.net](https://to.chat.dingshunyu.top/#/#satwcomic:maunium.net) to automatically get the latest comics in Chat.

### matrix-webhooker

[kinta](https://to.chat.dingshunyu.top/#/@kinta:communia.org) announced:
...
[kinta](https://to.chat.dingshunyu.top/#/@kinta:communia.org) told us:

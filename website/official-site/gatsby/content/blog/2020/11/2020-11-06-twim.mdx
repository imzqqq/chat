---
date: '2020-11-06'
title: 'This Week in Chat 2020-11-06'
categories:
  - This Week in Chat
author: Ben Parsons
...
* **Hubert|Uhoreg Chathi** will present on the state of encryption in Chat, and more broadly
...
> Happy November from the Chat team! As mentioned last week, we pushed a small [v1.22.1 release](https://github.com/matrix-org/synapse/releases/tag/v1.22.1) last Friday which fixed two regressions:
>
...
>
> If you haven't upgraded your Chat in a while, _please do._
>
> A major focus of Chat is being able to meet the performance and reliability needs of massive homeservers like `matrix.org`. If you're curious about how Chat's architecture has evolved over the years to meet these scaling challenges, check our our blog post from Tuesday: [How we fixed Chat's scalability!](https://matrix.org/blog/2020/11/03/how-we-fixed-synapses-scalability)
>
...
PLUS [Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) said:

> Chat now horizontally scales across multiple python processes, as of 1.22: you can configure it so that events are no longer sent through the main proc, eliminating the single biggest bottleneck for large scale Chat deployments. Read all about it at <https://matrix.org/blog/2020/11/03/how-we-fixed-synapses-scalability>
...
[Eric Eastwood](https://to.chat.dingshunyu.top/#/@madlittlemods:matrix.org) told us:

> Exciting visual progress this week with actual bridging between Gitter and Chat utilizing the `virtualUser` feature,
>
...
>
> You can also check out the live demo in Chat Live!
...
[Alexandre Franke](https://to.chat.dingshunyu.top/#/@afranke:matrix.org) said:
...
[Neil](https://to.chat.dingshunyu.top/#/@neilj:matrix.org) enunciated:
> We are working through some low hanging fruit around post registration, blank screen interaction prompts and toast tweaks. We are also  experimenting with SSO for matrix.org. Meaning that Element will give the user the option of either username/password or SSO. Finally, we are continuing our VoIP efforts and nailing down the designs, checkout Chat Live for all the details. Next week we'll carry on with post registration UX, VoIP improvements.
...
> Hemppa the bot is a generic bot for writing modules as easily as possible in Python. Thanks to issues with Freenode IRC bridge Hemppa got a new module for basic relaybot bridging of any Chat rooms. Relaybots are stupid, but sometimes there's no working alternative. <https://github.com/vranki/hemppa#relay-bridge>

## Dept of Events and Talks 🗣️

### Arch Conf 2020

[Brendan Abolivier](https://to.chat.dingshunyu.top/#/@babolivier:vector.modular.im) reported:

> I did a talk at [Arch Conf 2020](https://conf.archlinux.org/) last month, on a generic introduction of Chat and how to install a Chat homeserver on Arch Linux. The recording has just been uploaded; it can be found on [CCC's media site](https://media.ccc.de/v/arch-conf-online-2020-6306-enter-the-matrix-install-your-own-matrix-server-on-arch-linux) as well as [YouTube](https://www.youtube.com/watch?v=lEDfv9X0II4) 🙂
...
[emorrp1](https://to.chat.dingshunyu.top/#/@emorrp1:freedombox.emorrp1.name) told us:

> New Chat coverage in LWN via an Open Source Summit Europe talk <https://lwn.net/SubscriberLink/835880/bd73956d4ceb6cf5/>

See last week for the talk!

## Final Thoughts 💭

[TeeCee](https://to.chat.dingshunyu.top/#/@teecee:midlertidig.online) reported:

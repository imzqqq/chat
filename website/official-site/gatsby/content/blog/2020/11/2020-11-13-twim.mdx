---
date: '2020-11-13'
title: 'This Week in Chat 2020-11-13'
categories:
  - This Week in Chat
author: Ben Parsons
...
This marks the start of Season 6 of Chat Live (S06E01), a decision M+A apparently made on the fly just now. Incrementing a mostly-arbitrary counter... Imagine wielding that kind of raw power!
...
> The IETF have been continuing to experiment with new chat systems, and [#xmpp_bridgingmeta_jabber.ietf.org:matrix.org](https://to.chat.dingshunyu.top/#/#xmpp_bridgingmeta_jabber.ietf.org:matrix.org) exists as a three-way bridge to discuss the initiative spanning Chat, XMPP & Zulip.  Really fun to see open chat converging like this :)


## Dept of Science 🧪

### Analysis of the Chat Event Graph Replicated Data Type

[Florian](https://to.chat.dingshunyu.top/#/@florian:dsn.tm.kit.edu) announced:

> Fresh off the arXiv presses comes our
>
> [“Analysis of the Chat Event Graph Replicated Data Type”](https://arxiv.org/abs/2011.06488) preprint!
...
>
> While we are still in search of the right venue for peer-reviewd publication,
> we went for a preprint this time to share our results with the scientific and the Chat community in a timely manner.
...
>
> * Awaiting SCT Input - These are MSCs that are deemed reviewable by the MSC author, and require review by a subsection of the Spec Core Team (usually one or two people) that are most familiar with the scope of Chat that the MSC is relevant to.
>
> * Ready for FCP ticks - At least one individual from the Spec Core Team has signed off on the MSC. It is not time for others to give a cursory review - mainly sanity checking from the perspective of the part of Chat that they work on. Note that fundamental flaws may still be found in this stage, requiring the MSC to be reworked.
...
[wbamberg](https://to.chat.dingshunyu.top/#/@wbamberg:matrix.org) reported:
...
> **Note:** We are aware of a trivially exploitable denial of service vulnerability in versions of Chat prior to 1.20.0. Complete details will be disclosed on Monday, November 23rd. If you have not upgraded recently, please do so.
>
> Happy RC day! The first release candidate of Chat 1.23 is [now available](https://github.com/matrix-org/synapse/releases/tag/v1.23.0rc1). For Chat admins, we've added numerous new APIs thanks to contributions by [@dklimpel](https://github.com/dklimpel), and we now support generating [structured logs](https://github.com/matrix-org/synapse/blob/v1.23.0rc1/docs/structured_logging.md) in a standard manner. The `structured` and `drains` logging options are now deprecated in Chat's configuration.
>
> [Chat 1.23.0rc1](https://github.com/matrix-org/synapse/releases/tag/v1.23.0rc1) also includes several significant bugfixes, especially around regressions in the SQLite-to-PostgreSQL database porting script, as well a fix to an issue that would prevent Chat from recovering after losing its connection to the database. Chat will also now reject modifications to access control lists which would otherwise result in a server blocking itself from a room. This is a particularly interesting case of unintended consequences in protocol design, and we hope to write more about it soon.
>
...
[Pierre](https://to.chat.dingshunyu.top/#/@pierre:mamieserv.fr) offered:
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration had been updated to 1.21.2 (1.22.1 available in branch `testing`)
>
...
> now that you support commands, you must add the single most important command in any decent Chat client
...
[Nad](https://to.chat.dingshunyu.top/#/@nadonomy:matrix.org) announced:
...
> **Social Login**
>
> In an effort to reduce friction in authentication, we've been R&Ding how to allow homeservers & Chat clients to support multiple SSO providers.. Most of the work so far is captured in [MSC2858](https://github.com/matrix-org/matrix-doc/pull/2858) and we're starting initial implementations in Element web next week.
>
> **VoIP: Voice & Video Calls**
>
> We've started foundational research, design and engineering to improve both the usability and stability of native matrix VoIP in Element. We've also started to look at how we can improve the continuity of the user experience between native Chat calls and our current implementation of Jitsi.
>
> **Usability**
>
...
[pierre](https://to.chat.dingshunyu.top/#/@pierre:matrix.asso-fare.fr) told us:
...
[Slavi](https://to.chat.dingshunyu.top/#/@slavi:devture.com) announced:
...
### New Chat chat bot, Mozilla-focus first

[bnjbvr](https://to.chat.dingshunyu.top/#/@bnjbvr:delire.party) announced:

> I've written a small [blog post](https://blog.benj.me/2020/11/12/botzilla/) about a Chat chat bot I've developed with [matrix-js-bot-sdk](https://github.com/turt2live/matrix-js-bot-sdk), it was started to address Mozilla specific features first, but then I've added a few other generally useful features too! Hope you'll like it and find it useful!

[#botzilla:delire.party](https://to.chat.dingshunyu.top/#/#botzilla:delire.party) is the room for discussion (thanks Davo)


## Dept of *Built on Chat* 🏗️

### gurlic.com, new social network getting Chat integration

[ahq](https://to.chat.dingshunyu.top/#/@ahq:matrix.org) said:

> Hello Chat friends. I've been asked to share this here. I'm currently building a platform for building communities. I'm focused on deeper matrix integration with communities, private messaging built on top of matrix, and custom domain support. Feel free to check out <https://gurlic.com>. The matrix community is at <https://gurlic.com/matrix>, but I haven't had the time to post much. 
>

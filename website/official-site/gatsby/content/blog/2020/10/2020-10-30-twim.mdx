---
date: '2020-10-30'
title: 'This Week in Chat 2020-10-30'
categories:
  - This Week in Chat
author: Ben Parsons
...
>
> Also heads up, the nomenclature for Communities v2 (groups-as-rooms) is now Chat Spaces! Check out [MSC1772](https://github.com/matrix-org/matrix-doc/pull/1772) for the details!
>
> #### Spec Core Team
>
...
[patrick](https://to.chat.dingshunyu.top/#/@patrick:tincan.community) told us:

> From the creators of Noteworthy, introducing **Chupacabra**, a Chat powered content sharing and discussion layer.
>
> Video demo: <https://youtu.be/hAouGTL7XAQ>
>
> Github: <https://github.com/decentralabs/chupacabra>
>
> Join us in [#chupacabra:chupa.social](https://to.chat.dingshunyu.top/#/#chupacabra:chupa.social) to learn more.
...
[Timo](https://to.chat.dingshunyu.top/#/@timo:conduit.rs) announced:
...
>
> We're hard at work on the next release of Chat, and the development branch [already includes](https://github.com/matrix-org/synapse/compare/v1.22.0...develop) many bugfixes, several new admin APIs, and support for structured logging—stay tuned!
...
> Just pushed the Chat 1.22.0 versions for my [K8s-optimized image](https://github.com/ananace/matrix-synapse) and [Helm chart](https://gitlab.com/ananace/charts).

... 🕛 time 🕗 went 🕟 by 🕥 ...

> Updated my Chat chart and K8s-optimized image to 1.22.1 as well, and got the element-web chart updated to 1.7.12
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration had been updated to 1.20.1 (1.21.2 available in branch `testing`)
>
...
>
> We've been making major progress trying to align bifrost with the many XMPP clients out there like [Gajim](https://gajim.org/) and [Swift](https://swift.im/), by improving it's compatibility with the various XEPs. I've also noticed a few users have started using it to bridge their Chat and XMPP communities together which is super cool :)
>
> Please read the latest changelogs over at <https://github.com/matrix-org/matrix-bifrost/releases/tag/0.2.0> and upgrade away!

### Gitter

[Eric](https://to.chat.dingshunyu.top/#/@madlittlemods:matrix.org) reported:

> The [merge request for the native Gitter bridge](https://gitlab.com/gitlab-org/gitter/webapp/-/merge_requests/2040) has just got underway and we're making progress towards sharing all Gitter messages in public rooms across to Chat.
>
...
>
> As a reminder, the new Android Chat SDK is available at <https://github.com/matrix-org/matrix-android-sdk2> and a nice sample application has been developed and is available at <https://github.com/matrix-org/matrix-android-sdk2-sample>.
...
>
> Join us at: [#serverlist:nordgedanken.dev](https://to.chat.dingshunyu.top/#/#serverlist:nordgedanken.dev) 
>
...
[MTRNord](https://to.chat.dingshunyu.top/#/@mtrnord:nordgedanken.dev) replied:
...
[kapina-jaywink](https://to.chat.dingshunyu.top/#/@jaywink:elokapina.fi) reported:

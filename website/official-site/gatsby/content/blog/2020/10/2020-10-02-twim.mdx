---
date: '2020-10-02'
title: 'This Week in Chat 2020-10-02'
categories:
  - This Week in Chat
...
<br />
Don't forget that Chat Live is also available in podcast form. Search for "Chat Live" wherever you get your podcasts.

## Dept of *Status of Chat* 🌡️

### Gitter Enters the Chat

[Half-Shot](https://to.chat.dingshunyu.top/#/@Half-Shot:half-shot.uk) reported:

> Gitter is joining the Chat ecosystem!

It's true! Element has acquired Gitter from GitLab and will be implementing
Gitter's current chat features in Chat, before rebuilding Gitter as a Chat
...
* [The Chat blog post](https://matrix.org/blog/2020/09/30/welcoming-gitter-to-matrix)
...
* [ChangeLog Podcast episode w/ Matthew Hodgson from Chat and Sytse "Sid" Sijbrandij from GitLab](https://changelog.com/podcast/414)

And if you'd like to chat with your fellow Chat and Gitter users, there's a
bridged room already set up at
[#gitter:matrix.org](https://to.chat.dingshunyu.top/#/#gitter:matrix.org)!
...
> being totally shook up about the Gitter announcement for a good part of the week, I completed the work on [MSC2312](https://github.com/matrix-org/matrix-doc/issues/2312) (it's about Chat URIs, ICYMI) and it hopefully won't be long before it becomes the actual standard to share Chat coordinates in popular web browsers. Ok, who am I kidding - before Chat clients get on with adoption.

This will allow people to post links to Chat rooms/messages/users and when clicked will open right in your favourite Chat client. Super convenient and great for adoption!
...
Dendrite is a next-generation homeserver written in Go. It is currently serving as the basis for peer-to-peer Chat experiments
...
[Neil](https://to.chat.dingshunyu.top/#/@neilj:matrix.org) reported:
...
>
> Aside from that we are working on moving background processes away from the main process, actually getting the event persister sharding onto matrix.org and trying to improve Chat stability generally.
...
>
> If contributing to Dendrite sounds like something you would be interested in, please take a look at these issues and join us in [#dendrite-dev:matrix.org](https://to.chat.dingshunyu.top/#/#dendrite-dev:matrix.org)! There's also [#dendrite:matrix.org](https://to.chat.dingshunyu.top/#/#dendrite:matrix.org) for general Dendrite chat and updates and [#dendrite-alerts:matrix.org](https://to.chat.dingshunyu.top/#/#dendrite-alerts:matrix.org) for release notifications and important alerts.
...
[Pierre](https://to.chat.dingshunyu.top/#/@pierre:mamieserv.fr) announced:
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration had been updated to 1.19.3 (1.20.1 available in branch `testing`)
>
...
>
> The repo is <https://github.com/tulir/mautrix-signal> and the room is [#signal:maunium.net](https://to.chat.dingshunyu.top/#/#signal:maunium.net)
...
> Hey folks, I wanted to give another shoutout to say that we are still accepting PRs as part of [hacktoberfest](https://hacktoberfest.digitalocean.com/). Contributing 4 PRs will get you a T-Shirt (sadly not a Chat one). Obviously, please ensure your PRs are meaningful (no copyright adjustments, typo fixes).
>
...
[Cadair](https://to.chat.dingshunyu.top/#/@cadair:cadair.com) reported:
...
>
> * Support removing _reactions_ from Slack and Chat messages.
...
>
> * Jump to events in timeline: When tapping on a reply and when tapping a to.chat.dingshunyu.top link
...
[SpiritCroc](https://to.chat.dingshunyu.top/#/@spiritcroc:matrix.org) said:
...
SpiritCroc also mentioned some relavent links!

> * website: <https://spiritcroc.de/schildichat-android>
>
> * repo: <https://github.com/SpiritCroc/SchildiChat-android>
> * room: [#schildichat-android:matrix.org](https://to.chat.dingshunyu.top/#/#schildichat-android:matrix.org)
...
>
> We are also continuing to work on instrumenting the app, improving mobile support for to.chat.dingshunyu.top and making jitsi calling more reliable.



### Element Android

[benoit](https://to.chat.dingshunyu.top/#/@benoit.marty:matrix.org) told us:
...
[Gary Kim](https://to.chat.dingshunyu.top/#/@gary:garykim.dev) reported:
...
[iinuwa](https://to.chat.dingshunyu.top/#/@iinuwa:matrix.org) told us:
...
>
> All of these users are Telegram/Discord users that have been brought into Chat over the last 30 days. This doesn't appear to be a temporary spike either: over the last 8 weeks t2bot.io has been hovering at 900-950 thousand monthly active users, up from 600-700 thousand. Record-setting traffic levels have also been achieved, with matrix.org being able to keep up for the first time in a long while.
>
> Overall it's a good sign to see so many communities making the jump to Chat and sticking around ❤️
...
A while ago [Jitsi announced](https://jitsi.org/blog/e2ee/) that they were adding E2EE to Jitsi. But did you know that it's using Chat's Olm encryption under the hood? It's currently available as an experimental feature on [https://meet.jit.si](https://meet.jit.si)!
...
We also now have a room where the ping bots are only hosted on non-Chat
...
> XKCD made [another strip about messaging systems](https://xkcd.com/2365/) and I’m outraged to see that Chat has been left out of it.

---
date: '2020-10-09'
title: 'This Week in Chat 2020-10-09'
categories:
  - This Week in Chat
author: Ben Parsons
...
### Chat in use at IETF and TeamSpeak

[Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) said:

> IETF is trialling Chat as a replacement to Slack and a complement to XMPP: <https://mailarchive.ietf.org/arch/msg/tools-discuss/cUd9P35cj-nGsaioZ9HmMLmf1G4/>

ALSO

[Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) commented:

> looks like teamspeak is using Chat (a Chat endpoint was previously noticed at https://tschat-1.teamspeak.com/)
...
>
> It aims to be an efficient, reliable and scalable alternative to Chat.
>
> We encourage early adopters to try it out starting with v0.1.0 in Monolith/Postgres mode.
>
> Dendrite supports a large amount of the Chat spec including:
>
> * All room versions
>
...
>
> federation of Chat servers. At present, Dendrite has not been optimised for memory/CPU usage, nor does it
...
> I've started to make a Chat client over the past few weeks, just as a hobby project for now, using Qt and a 'lil C++20! :D
>
...
[David Mehren](https://to.chat.dingshunyu.top/#/@davebloggt:kif.rocks) told us:
...
[Michael (t3chguy)](https://to.chat.dingshunyu.top/#/@x:riot.ovh) added:
...
[reivilibre](https://to.chat.dingshunyu.top/#/@reivilibre:librepush.net) said:
...
>
> For discussion, feel free to join [#voip-tester:librepush.net](https://to.chat.dingshunyu.top/#/#voip-tester:librepush.net) .

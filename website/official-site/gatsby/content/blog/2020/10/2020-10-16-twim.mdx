---
date: '2020-10-16'
title: 'This Week in Chat 2020-10-16'
categories:
  - This Week in Chat
author: Ben Parsons
...
In which I chat with Kitsune about the work done to get a [Chat URI schema](https://github.com/matrix-org/matrix-doc/pull/2312/) agreed, and the state of the work.
...
As a crude measure of growth, [Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) commented about [#twim:matrix.org]:
...
[kapina-jaywink](https://to.chat.dingshunyu.top/#/@jaywink:elokapina.fi) also

> wants to clarify that XR is a decentralized movement and this does not mean other chapters will adapt Chat - but we can hope and for sure here in Finland we'll be spreading the good experiences to other chapters ;)
...
[wbamberg](https://to.chat.dingshunyu.top/#/@wbamberg:matrix.org) told us:
...
>
> As always, please feel free to join us in [#dendrite:matrix.org](https://to.chat.dingshunyu.top/#/#dendrite:matrix.org) for general Dendrite chat, and [#dendrite-dev:matrix.org](https://to.chat.dingshunyu.top/#/#dendrite-dev:matrix.org) if you are interested in contributing!
...
[Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) added:

> my personal dendrite is now in roughly the same set of rooms as my personal synapse. Dendrite is idling at 180MB of RAM, Chat is idling at 1.8GB of RAM :)

### Conduit

[Timo](https://to.chat.dingshunyu.top/#/@timo:conduit.rs):
...
> Aside from all of that we continue to progress room knocking put out a [1.21.2](https://matrix.org/blog/2020/10/15/synapse-1-21-2-released-and-security-advisory)  - a bug fix release **though please please ensure you are running at least Chat >= 1.21.0 since 1.21.0 contains a XSS security fix**.
>
...
> Just pushed the updated image tags and [chart version](https://gitlab.com/ananace/charts) for my [K8s-optimized Chat image](https://github.com/ananace/matrix-synapse) for version 1.21.0, as well as a [chart](https://gitlab.com/ananace/charts) update for element-web 1.7.9

then later

> And to expand on my previous update, got Chat 1.21.2 up on the chart and K8s-optimized image.


### YunoHost

[Pierre](https://to.chat.dingshunyu.top/#/@pierre:mamieserv.fr) said:
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration had been updated to 1.20.1 (1.21.0 available in branch `testing`)
>
...
Hot on his heels, [Tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) announced:

> I've been adding support for the MSCs Half-Shot implemented in Chat to my bridges:
>
...
>
> * mautrix-python has support for receiving ephemeral events via [MSC2409](https://github.com/matrix-org/matrix-doc/pull/2409) in a branch, which will be merged once Chat v1.22 is released. After it's merged, `/sync`ing with double puppets will no longer be necessary to bridge ephemeral events.
>
...
[benoit](https://to.chat.dingshunyu.top/#/@benoit.marty:matrix.org) reported:
...
>
> So about a year ago I started working on a Chat client for SailfishOS, but I never really made much progress. Well, last weekend I did, and so it can now send plain text messages as well as various forms of media messages, I made a basic application icon and I've been using it this week already (for unencrypted rooms).
>
...
[SpiritCroc](https://to.chat.dingshunyu.top/#/@spiritcroc:matrix.org) announced:
...
>
> For further discussion, I have created [#schildichat-web:matrix.org](https://to.chat.dingshunyu.top/#/#schildichat-web:matrix.org) .
>
> The current version of SchildiChat-Deskop is available for Desktop [here](https://github.com/SpiritCroc/schildichat-desktop/releases), and I host the web variant [here](https://schildiweb.spiritcroc.de/).
...
### Talking about Bridges and Bots in Chat (German)

[Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) announced:

> I was invited to the German Podcast MacMittwoch (no, it's not only about Macs) to talk about Bridges and Bots in Chat. It was a very interesting and funny round.
>
...
[mewmew](https://to.chat.dingshunyu.top/#/@mewmew:blob.cat) offered:

> This is a script I've created for use with [MSC2545](https://github.com/matrix-org/matrix-doc/pull/2545/). It allows easy uploading of emoji packs to Chat rooms. Feel free to check it out [on Gitea](https://git.blob.cat/mewmew/matrix-emoji-upload), or join the project room [#matrix-emoji-upload:blob.cat](https://to.chat.dingshunyu.top/#/#matrix-emoji-upload:blob.cat) if you have any questions/comments/issues.

### n8n.io support

[Matthew](https://to.chat.dingshunyu.top/#/@matthew:matrix.org) announced:

> n8n.io (FOSS extendable workflow automation) just added Chat support! <https://n8n.io/integrations/n8n-nodes-base.matrix> and <https://github.com/n8n-io/n8n/pull/1046>

Exciting! Yet the saga that followed only adds to the excitement!

First [Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) noticed a problem:

> Could it be that only matrix.org as HS currently is supported?
>
> I'm getting `Chat credentials are not valid!` and I see the request to matrix.org on a traffic capture.

[jaywink](https://to.chat.dingshunyu.top/#/@jaywink:federator.dev) discovered the alarming truth:

> the original PR mentions mantrixorg indeed: <https://github.com/n8n-io/n8n/pull/1024> .. sounds like PR time for someone :)

[Tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net), like a coiled spring, provided a PR:
...
[Faelar](https://to.chat.dingshunyu.top/#/@Faelar:matrix.org) noticed:

> For those not following on github, n8n released a new version including the fix for homeserver

[Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info), who brings us back to the start said:

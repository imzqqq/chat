---
date: '2020-09-25'
title: 'This Week in Chat 2020-09-25'
categories:
  - This Week in Chat
...
Hello all, and welcome to this week's addition of This Week in Chat!
[Chat](https://matrix.org) is an open network protocol for secure,
decentralized communication on the web.


My name is Andrew (aka `anoa`), and I'm a Chat developer at Element.
...
* Jorik presents his work on revamping the UX of https://to.chat.dingshunyu.top that he completed for his second summer internship at Element!
...
Don't forget that Chat Live is also available in podcast form, if you're into that sort of thing. Search for "Chat Live" wherever you get your podcasts.

## Dept of Spec 📜

[anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz) (hey that's me!) told us:
...
>- [MSC2781: Deprecate the (reply) fallbacks in the Chat specification](https://github.com/matrix-org/matrix-doc/pull/2781)
>## Spec Core Team
>
...
>
> As always, if contributing to Dendrite sounds like something you would be interested in, please feel free to join us in [#dendrite-dev:matrix.org](https://to.chat.dingshunyu.top/#/#dendrite-dev:matrix.org) ! There's also [#dendrite:matrix.org](https://to.chat.dingshunyu.top/#/#dendrite:matrix.org)
...
> This week in Chat concludes a summer of Construct where several transformative rounds of optimization took place. I'd like to talk about these achievements and why they are important for
> future directions.
>
...
>
> That's all for today. Construct is available at <https://github.com/matrix-construct/construct> and don't forget to idle and perform [#construct:zemos.net](https://to.chat.dingshunyu.top/#/#construct:zemos.net) / [#construct:maunium.net](https://to.chat.dingshunyu.top/#/#construct:maunium.net)
>
> Thanks!
>
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration had been updated to 1.19.3 (1.20.0 available in branch `testing`)
>
...
[Typo Kign](https://to.chat.dingshunyu.top/#/@david:typokign.com) announced:

> Thanks to [Arkaniad](https://www.github.com/Arkaniad), v2.7.0 of my Chat Helm chart for Kubernetes is released with support for exporting Prometheus metrics. It pairs well with the [Chat Grafana dashboard](https://grafana.com/grafana/dashboards/10046).
...
### Third-Party PowerPC and ARM64 support for Chat

[andreas](https://to.chat.dingshunyu.top/#/@andreas:matrix.aventer.biz) announced:
...
As a Chat developer, it's great to see the community making personal and
enterprise Chat deployments more accessible!
...
> Polyjuice Client v0.3.0 has been released.  This release includes many breaking changes.  ("Breaking" in the sense of API changes, rather than the sync process suddenly failing to work, which was already featured in a previous release.)  This release also includes many changes, such as the client managing more bookkeeping, detecting if it got logged out, and supporting more Chat features.  See the [release notes](https://gitlab.com/uhoreg/polyjuice_client/-/releases/v0.3.0) for more information.



### Igor

[uhoreg](https://to.chat.dingshunyu.top/#/@hubert:uhoreg.ca) reported:
...
[erdnaxeli](https://to.chat.dingshunyu.top/#/@erdnaxeli:cervoi.se) announced:
...
People administering their Chat deployment through Chat itself! How deep
...
[jj](https://to.chat.dingshunyu.top/#/@jj:sft.lol) reported:
...
[js](https://to.chat.dingshunyu.top/#/@js:nil.im) got Chat running in a car on a German highway:
...
Maybe one day we'll all have an embedded Chat homeserver in our cars. P2P E2EE
car comms anyone?


### Chat VoIP Tester

[reivilibre](https://to.chat.dingshunyu.top/#/@reivilibre:librepush.net) announced:
...
### German-Language Guide for Getting Start with Chat

[Samuel](https://to.chat.dingshunyu.top/#/@samuel-p:matrix.sp-codes.de) told us:

> I started an article series about Chat on my german blog. The goal is to make it easier for new users to get started with Chat. <https://blog.sp-codes.de/werde-teil-der-matrix-matrix-teil-1/>
...
> Now that we have multiple somewhat federating Chat homeserver implementations, I decided to make a ping room where all the echo bots are hosted on second-gen homeservers: [#ping-no-synapse:maunium.net](https://to.chat.dingshunyu.top/#/#ping-no-synapse:maunium.net). Chat users are still allowed to join and `!ping`, but all the pongs will come from non-Chat servers.
>
...
* [Magnus Svensson](https://to.chat.dingshunyu.top/#/@magnus:ctrl-c.liu.se) was [left speechless](https://to.chat.dingshunyu.top/#/!xYvNcQPhnkrdUmYczI:matrix.org/$Fu_LD4g2AfYGWjcRPTISLIpJEGZ_Pq-MwymfBMddoRo?via=matrix.org&via=privacytools.io&via=feneas.org) by the amazing projects that we got to see this week.

---
date: '2020-09-11'
title: 'This Week in Chat 2020-09-11'
categories:
  - This Week in Chat
author: Ben Parsons
...
* Sean DuBois ([Sean-Der](https://to.chat.dingshunyu.top/#/@sean-der:matrix.org)), WebRTC-knower and author of WebRTC for the Curious discusses his recent work in the space. <https://webrtcforthecurious.com>
* Damir Jelić presents the latest news on the Chat Rust SDK
...
* [GSOC report: Enabling E2EE in Opsdroid Chat Connector](https://matrix.org/blog/2020/09/10/gsoc-report-enabling-e-2-ee-in-opsdroid-matrix-connector)

Expect to see the next three reports next week.

### Linköping University

[Alexander Olofsson](https://to.chat.dingshunyu.top/#/@aleol57:liu.se) announced:

> Since we suddenly have multiple projects that've separately gone on to trial our new and shiny Chat-on-location for multiple respective use-cases, from conferences to anonymous - encrypted - support chats, we've had to end our soft-launch period __very__ quickly.
>
> Oh dear.
...
> This week we put out a new release candidate for [Chat 1.20.0](https://github.com/matrix-org/synapse/releases/tag/v1.20.0rc3), highlights include shadow ban support, more async/awaiting and unread message counts being added to sync responses to support upcoming notifications work. 
>
...
> Hi everyone, [Devin R](https://to.chat.dingshunyu.top/#/@devinr528:matrix.org) and I are working on state resolution, hopefully we have something exciting to show you next week. I also worked on the remaining key backup endpoints, so for example deleting backups works as expected now.
...
[kegan](https://to.chat.dingshunyu.top/#/@kegan:matrix.org) told us:
...
It's been a big week for [Bruno](https://to.chat.dingshunyu.top/#/@bwindels:matrix.org):
...
[Neil](https://to.chat.dingshunyu.top/#/@neilj:matrix.org) (same fellow from earlier) reported:
...
> - Our new Chat.to should get it’s first release
...
>
>
> Join the development Chat room at [#elementfornextcloud-general:garykim.dev](https://to.chat.dingshunyu.top/#/#elementfornextcloud-general:garykim.dev).
>
...
>
> There's a Telegram import script that's used to reupload stickers to Chat and generate the static sticker pack files that the picker widget uses. It's technically also possible to make the sticker pack files yourself, but there's no easy way to do that yet.
>
...
> Just bumped the [Chat Ruby SDK](https://github.com/ananace/ruby-matrix-sdk) to version 2.1.2, fixing another bug with server discovery as well as the fact that state events haven't been provided for the application using the SDK. Oops.



### matrix-appservice-rs

[Lieuwe](https://to.chat.dingshunyu.top/#/@lieuwe:lieuwe.xyz) announced:
...
>
> There is also now a specific room for this crate: [#matrix-appservice-rs:lieuwe.xyz](https://to.chat.dingshunyu.top/#/#matrix-appservice-rs:lieuwe.xyz), feel free to ask for support or tell if you've suggestions.
...
[stefan](https://to.chat.dingshunyu.top/#/@rumpelsepp:hackbrettl.de) said:
...
[Mr. Wimpy](https://to.chat.dingshunyu.top/#/@mrwimpy:matrix.org) offered:
...
> And in _completely unrelated_ news, I also just tagged version 1.0.0 of [an invite bot](https://gitlab.liu.se/ITI/matrix-invite-bot) for Chat, which helps in doing bulk invites to communities and community-associated rooms.
>
...
### Perth Linux user group Chat presentation

[PC-Admin](https://to.chat.dingshunyu.top/#/@PC-Admin:perthchat.org) offered:

> I did a talk called 'Chat in 2020' with the Perth Linux user group, parts of the video are missing but the audio is solid
>
> I think we did a good job summarising how far Chat has come, we also preview the idea our new Chat hosting company!
>
> <https://www.youtube.com/watch?v=jTutFZzFizw>

From the YouTube description:

> Michael Collins talks about the Chat, covering the new features, perthchat.org, and ChatOasis an upcoming FOSS Chat hosting company.

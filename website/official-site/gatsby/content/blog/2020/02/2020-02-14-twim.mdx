---
date: '2020-02-14'
title: 'This Week in Chat 2020-02-14'
categories:
  - This Week in Chat
author: Ben Parsons
...
Are you interested in a real-life, real-time Chat-related meetup? Can you make it to London? Join us on the 26th February at Second Home in Spitalfields! More details to follow, for now please register your interest at <https://www.eventbrite.com/e/matrix-london-meetup-26th-february-2020-tickets-93320354693>.

## Dept of Spec 📜

Here's your weekly spec update from [anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz)!
...
I ([anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz)) am still working on the [re-write of mscbot](https://github.com/matrix-org/mscbot-python). Only needs a few more touches (concern parsing [in comment threads!] and review commands) before it's ready for use.
...
> In Chat land this week we shipped [1.10.0](https://matrix.org/blog/2020/02/12/synapse-1-10-0-released). Which contains a temporary hack to mitigate room alias abuse and an important bug fix for anyone trialling cross signing.
>
...
>
> Coming up, more e2ee UX bug fixing, and we’ll start hacking on sharding out event persistence on Chat’s master process, which basically accounts for 40% of the CPU. The idea is to scale this function horizontally such that Chat is no longer CPU bound after which point much rejoicing can occur.

### Chat Deployment

[Ananace](https://to.chat.dingshunyu.top/#/@ace:kittenface.studio) announced:

> Just pushed the 1.10.0 K8s-optimized images for Chat, this release contains the necessary scripts to also run signing key generation and upload as a step towards one-click install support for Chat without any requirements on storage classes.
...
[Jojii](https://to.chat.dingshunyu.top/#/@jojii:matrix.jojii.de) reported:

> Iam happy to announce some of the new features the Chat-EmailBridge got recently.
...
If you're looking forward to using [seshat](https://github.com/matrix-org/seshat) to index and search your encrypted message history, you may be interested in this work from [stoic](https://to.chat.dingshunyu.top/#/@stoically:matrix.org). The working title is "Riot Booster Pack" - but we're looking out for a better name!

[stoic](https://to.chat.dingshunyu.top/#/@stoically:matrix.org) said:
...
> Cadair and me (the Chat Doctors) have been working to make it easy to build the development version of riot-desktop.
...
[Nico](https://to.chat.dingshunyu.top/#/@deepbluev7:neko.dev) announced:
...
[Krille](https://to.chat.dingshunyu.top/#/@krille:ubports.chat) reported:
...
[@httpdog:raim.ist](https://to.chat.dingshunyu.top/#/@httpdog:raim.ist) replied:

![2020-02-14-200.jpg](/blog/img/2020-02-14-200.jpg)

## Chat in the News 📰

### German Blog comparing Chat to WhatsApp

[Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) offered:

---
date: '2020-02-28'
title: 'This Week in Chat 2020-02-28'
categories:
  - This Week in Chat
author: Ben Parsons
...
This week Chat held a Meetup Event in London! There were presentations demonstrating E2E Cross-Signing (including the next, sleeker QR codes), P2P in the browser with Dendrite, Message retention, and Github bridging. There was also plenty of P2E* and B2D**.

You can catch up on what was missed by watching [this week's Chat Live](https://www.youtube.com/watch?v=Zdn1MQIg03s) (below), or check out the [full event playlist](https://www.youtube.com/playlist?list=PLl5dnxRMP1hVQkNy2RPJfSnDkwRqaxo_R), particularly the [P2P with Dendrite demo](https://www.youtube.com/watch?v=VwlqQ6G5TZ8).

<iframe width="560" height="315" src="https://www.youtube.com/embed/Zdn1MQIg03s" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

\* Pizza to eat  
** Beer to drink

### version1 podcast featured Chat!

[Éibhear](https://to.chat.dingshunyu.top/#/@eibhear:matrix.gibiris.org) told us:
...
### Chat Live now available as an audio podcast

Reminder that Chat Live is also available as an audio-only podcast. You can find the it:
...
Last week we announced that Google had selected Chat for the Google Summer of Code progamme, and requested projects get involved under the Chat banner. We had a great response to this call: Ditto, Ruma, opsdroid and Nheko are all offering projects this year, as well as projects under the core Chat team.

We updated [suggested projects list](http://matrix-org.github.io/gsoc/#/projects) (more to come), so if you're a student please take a look. Think about what you'd like to work on, get involved with suggested projects, and join [#gsoc:matrix.org](https://to.chat.dingshunyu.top/#/#gsoc:matrix.org) to discuss.
...
> * The hashing algorithm has been fixed which improves federation reliability with Chat
...
[Brendan](https://to.chat.dingshunyu.top/#/@brendan:abolivier.bzh) announced:
...
[jaywink](https://to.chat.dingshunyu.top/#/@jaywink:federator.dev) said:

> [Matrixmon](https://github.com/matrix-org/matrixmon), the perl based c2s probe with metrics to track your Chat server client API responses is now at v0.5.0 and now allows using an access_token for the probe user.

### Chat

[anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz) reported:

> This week Erik  been tackling the work on sharding the master process in Chat, Patrick  has been working on the new room alias semantics while richvdh  has been doing some background preparation to allow us to change the way events are redacted in future room versions.
>
...
### arm64 support for all [Tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net)-projects:
...
That "someone" was [nixo](https://to.chat.dingshunyu.top/#/@nixo:nixo.xyz):
...
Last week [Aaron](https://to.chat.dingshunyu.top/#/@aaron:raim.ist) said:
...
[Dylan](https://to.chat.dingshunyu.top/#/@dhmf:m.dhdf.dev) announced:
...
[Dylan](https://to.chat.dingshunyu.top/#/@dhmf:m.dhdf.dev) reported:
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/ooGdsdsiCMg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
...
[steve](https://to.chat.dingshunyu.top/#/@stevio:matrix.org) told us:
...
[KB1RD](https://to.chat.dingshunyu.top/#/@kb1rd:kb1rd.net) offered:
...
>
> The repo is <https://github.com/anoadragon453/nio-template>, and room is [#nio-template:amorgan.xyz](https://to.chat.dingshunyu.top/#/#nio-template:amorgan.xyz).
...
>
> * [tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) made [a PR](https://github.com/Sorunome/mx-puppet-bridge/pull/27) to add a provisioning API - said PR is already merged. Thanks a lot!
...
>
> If you have any questions, please join our [support chat](https://to.chat.dingshunyu.top/#/[#mx-puppet-bridge:sorunome.de](https://to.chat.dingshunyu.top/#/#mx-puppet-bridge:sorunome.de)) and maybe consider to [donate](https://liberapay.com/Sorunome). Thank you!
>
> #### mx-puppet-slack
>
> [tulir](https://to.chat.dingshunyu.top/#/@tulir:maunium.net) made [a PR](https://github.com/Sorunome/mx-puppet-slack/pull/36) for custom provisioning API endpoints. It is already merged. Thanks a lot!
>
> #### mx-puppet-tox
>
...
> Hemppa the bot gained ability to run shell commands via Chat. It's a small feature but enables a lot of possibilities in system management and monitoring, home automation, and whatever you can do in linux shell.  As an example project I plan to use it for running a script to open hackerspace door with Raspberry Pi's GPIO if sender is a member. <https://github.com/vranki/hemppa>

### remindbot the bot

[stefan](https://to.chat.dingshunyu.top/#/@rumpelsepp:hackbrettl.de) announced:

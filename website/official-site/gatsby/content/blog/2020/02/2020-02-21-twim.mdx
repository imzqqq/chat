---
date: '2020-02-21'
title: 'This Week in Chat 2020-02-21'
categories:
  - This Week in Chat
author: Ben Parsons
...
Wise Google have again selected [Chat as a GSOC Mentor Organisation](https://summerofcode.withgoogle.com/organizations/6060943798173696/). Chat has been successful with GSOC for several years now, so please think about what you'd like to work on, get involved with suggested projects, and join [#gsoc:matrix.org](https://to.chat.dingshunyu.top/#/#gsoc:matrix.org) for more insights.

If you have a Chat project of your own, and think that *you* would benefit from mentoring a GSOC student, then [let me know](https://to.chat.dingshunyu.top/#/@benpa:matrix.org). We are very happy to have Chat-related students working on your project under the Chat umbrella. ([Just like we did with kitsune last year](/blog/2019/09/20/qt-based-clients-end-to-end-encryption-support-final-report-g-so-c-2019).)

## Dept of Events and Talks 🗣

*It's happening Next Week!!*

Are you interested in a real-life, real-time Chat-related meetup? Can you make it to London? Join us on the 26th February at Second Home in Spitalfields! Check out the agenda and register at <https://www.eventbrite.com/e/matrix-london-meetup-26th-february-2020-tickets-93320354693>.
...
> More excitingly we’re working on sharding out the master process in Chat, so that worker based installations can scale more efficiently.
>
...
[Mathijs](https://to.chat.dingshunyu.top/#/@mathijs:matrix.vgorcum.com) reported:
...
> Just pushed the K8s-optimized Chat images for 1.10.1

and:

> Just pushed version 1.11.0 of the [K8s-optimized Chat images](https://github.com/ananace/matrix-synapse), find them on dockerhub as [ananace/matrix-synapse](https://hub.docker.com/r/ananace/matrix-synapse/)
...
> Hola. I wrote the [matrix-github](https://github.com/Half-Shot/matrix-github/) bridge a while back to support bridging issues and pullrequests into Chat as rooms, so that the history of an issue can be tracked within a room, and users can comment on them within Chat. As of today, you can now bridge in your own notifications into Chat. It's early days, but is actually proving to be useful.
...
>
> * Add ability to sync Slack channels and users automatically to Chat
> * Sync Slack membership changes to Chat
...
[mijutu](https://to.chat.dingshunyu.top/#/@mijutu:ellipsis.fi) offered:

> matrix-xmpp-filter can now handle multiple XMPP clients per process and multiple Chat accounts per XMPP client. It's like matrix-ircd, but with XMPP instead of IRC. Made with libQuotient and libqxmpp. Available at <https://k2c42.dy.fi/matrix-xmpp-filter.git> Feedback to [#matrix-xmpp-filter:ellipsis.fi](https://to.chat.dingshunyu.top/#/#matrix-xmpp-filter:ellipsis.fi)
...
[tulir (Mozilla)](https://to.chat.dingshunyu.top/#/@tulir:mozilla.org) offered:

> gomuks now does single sign-on, which means you can log into mozilla matrix accounts with it.

Check the docs for information on [how to add SSO to your Chat client](https://matrix.org/docs/guides/sso-for-client-developers).
...
[stoic](https://to.chat.dingshunyu.top/#/@stoically:matrix.org) offered:
...
[anoa](https://to.chat.dingshunyu.top/#/@andrewm:amorgan.xyz) asked:

> I'm curious how you got seshat working in a browser, considering wasm doesn't have support for multi-threading?

[stoic](https://to.chat.dingshunyu.top/#/@stoically:matrix.org) responded:
...
[stoic](https://to.chat.dingshunyu.top/#/@stoically:matrix.org) announced:
...
[Aaron](https://to.chat.dingshunyu.top/#/@aaron:raim.ist) reported:
...
Regarding "SSSS", [uhoreg](https://to.chat.dingshunyu.top/#/@hubert:uhoreg.ca) helpfully links us to <https://github.com/matrix-org/matrix-doc/pull/1946>, and also added:

> (I usually expand SSSS to "Secure Storage Something Something")

## Dept of SDKs and Frameworks 🧰

### Chat Dart SDK (Pattle)

[MatMaul](https://to.chat.dingshunyu.top/#/@mat:tout.im) told us:
...
[steve](https://to.chat.dingshunyu.top/#/@stevio:matrix.org) announced:
...
[swedneck](https://to.chat.dingshunyu.top/#/@swedneck:hielle.com) offered:
...
[MTRNord](https://to.chat.dingshunyu.top/#/@MTRNord:matrix.ffslfl.net) offered:
...
> I made Dad Bot for Chat which mocks users who use "i'm" or "im" in their sentences.
>
...
> I opened a room for discussions about dad bot if you want to send feedback there. [#dadbot:m.dhdf.dev](https://to.chat.dingshunyu.top/#/#dadbot:m.dhdf.dev)

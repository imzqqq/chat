---
date: '2020-03-13'
title: 'This Week in Chat 2020-03-13'
categories:
  - This Week in Chat
author: Ben Parsons
...
Matthew talks to Kegan and Neil about the status of P2P Chat, and about Dendrite development.
...
> The Changelog invited me to do a podcast on all things Chat - the 90 minutes of high density braindump can be found over at <https://changelog.com/podcast/384>

### Google Summer of Code

We are still welcoming GSoC students who want to apply to work on Chat projects this summer. You can [browse the suggested projects list](http://matrix-org.github.io/gsoc/#/projects) or submit your own by chatting in the appropriate project room or [#gsoc:matrix.org](https://to.chat.dingshunyu.top/#/#gsoc:matrix.org). Student applications begin on Monday!
...
> * We've got our first ever public Riot running with P2P Chat, by compiling Dendrite to WASM and embedding it in the browser as a service worker.  It's still quite early, but you can try to play with it now at https://p2p.riot.im.  You can hear (and see!) all about it in this week's Chat Live.
...
>
> Next week more of the same, plus a return to Chat performance work.

### Chat available on OpenBSD

Chat is now available on OpenBSD from ports. <https://marc.info/?l=openbsd-ports-cvs&m=158368701415531&w=2>
...
[gergely](https://to.chat.dingshunyu.top/#/@gergely:polonkai.eu) offered:

> Some folks over at [#matrix-client.el:matrix.org](https://to.chat.dingshunyu.top/#/#matrix-client.el:matrix.org) suggested i should submit [my article here](https://gergely.polonkai.eu/2020/03/09/chatting-on-matrix-with-e2ee-from-emacs/). Itʼs about making matrix-client.el able to participate in encrypted rooms via Pantalaimon.
...
[Paul](https://to.chat.dingshunyu.top/#/@ptman:kapsi.fi) added this link which krille previously wrote: <https://ko-fi.com/post/FluffyChat-for-Android-and-iOS-S6S71BMEY>
...
>
> As always, [#ruby-matrix-sdk:kittenface.studio](https://to.chat.dingshunyu.top/#/#ruby-matrix-sdk:kittenface.studio) is available for discussion and questions.

## Dept of Bots 🤖

### auto-invite-matrix-bot

[MTRNord](https://to.chat.dingshunyu.top/#/@MTRNord:matrix.ffslfl.net) reported:
...
You may have learned that recorded cases of COVID-19 are increasing exponentially. Also increasing exponentially are updates from [Peter Roberts](https://to.chat.dingshunyu.top/#/@pwr22:shortestpath.dev), who has developed a maubot to help provide information:
...
>
> It's running as [@covbot:shortestpath.dev](https://to.chat.dingshunyu.top/#/@covbot:shortestpath.dev). Send `!cases` for world-wide stats or `!cases <location>` for something more specific. E.g. `!cases US`.
>
...
>
> It's running as [@covbot:shortestpath.dev](https://to.chat.dingshunyu.top/#/@covbot:shortestpath.dev). Send `!cases` for world-wide stats or `!cases <country>` for more specifics. E.g. `!cases Italy`.
>
...
You can invite [@covbot:shortestpath.dev](https://to.chat.dingshunyu.top/#/@covbot:shortestpath.dev) to your own room to catch the latest.

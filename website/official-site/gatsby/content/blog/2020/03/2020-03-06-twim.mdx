---
date: '2020-03-06'
title: 'This Week in Chat 2020-03-06'
categories:
  - This Week in Chat
author: Ben Parsons
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Oh hello... is that Chat replicating data streams using Redis, paving the way to multi-master Chat clustering for arbitrary horizontal scalability!?! 😍 <a href="https://t.co/E7pcFWQEgC">pic.twitter.com/E7pcFWQEgC</a></p>&mdash; Chat (@matrixdotorg) <a href="https://twitter.com/matrixdotorg/status/1235968592778276866?ref_src=twsrc%5Etfw">March 6, 2020</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script> 

## Chat Deployment 📥

### multi arch synapse docker image

[Black Hat](https://to.chat.dingshunyu.top/#/@bhat:encom.eu.org) announced:
...
[Mathijs](https://to.chat.dingshunyu.top/#/@mathijs:matrix.vgorcum.com) offered:
...
### Chat Icinga notifier

[Oleg](https://to.chat.dingshunyu.top/#/@oleg:fiksel.info) told us:

> Send notifications from Icinga(1,2) to a Chat room.
>
...
There is a simple [Mumble-Chat Bridge](https://github.com/mymindstorm/matrix-appservice-mumble) available.

> A simple Chat to Mumble bridge. It sends messages between bridged rooms and tells you when people join / leave Murmur.

Written in TypeScript and based on [matrix-appservice-bridge](https://github.com/matrix-org/matrix-appservice-bridge).

The creator, [mymindstorm](https://to.chat.dingshunyu.top/#/@mymindstorm:evermiss.net) said:

> Hello again, I made a public room at [#mumble-bridge:evermiss.net](https://to.chat.dingshunyu.top/#/#mumble-bridge:evermiss.net)
...
> Ditto is a user-friendly Chat client for iOS and Android.
>
> #### Updates
>
...
>
> If anybody has the skill set or interest, we are also looking at creating a React Native specific Chat SDK to improve performance and allow others to develop RN clients easily.
> ##### [Website](https://dittochat.org/) | [#ditto:ditto.chat](https://to.chat.dingshunyu.top/#/#ditto:ditto.chat) | Contact Annie
...
[Dylan](https://to.chat.dingshunyu.top/#/@dhmf:m.dhdf.dev) told us:
...
Nord Light Theme for Riot is also available from [Dylan](https://to.chat.dingshunyu.top/#/@dhmf:m.dhdf.dev):
...
> Dylan created [#riot-web-themes:m.dhdf.dev](https://to.chat.dingshunyu.top/#/#riot-web-themes:m.dhdf.dev)
>
...
[swedneck](https://to.chat.dingshunyu.top/#/@swedneck:hielle.com) reported:
...
> simplematrixlib now also has a matrix room, [#simplematrixlib:matrix.org](https://to.chat.dingshunyu.top/#/#simplematrixlib:matrix.org) (also used for py-matrix-utils)
...
[msirringhaus](https://to.chat.dingshunyu.top/#/@msirringhaus:mozilla.org) told us:
...
There's a new stickerpack available in Riot, [Diego "rehrar" Salazar](https://to.chat.dingshunyu.top/#/@rehrar:matrix.org) offered:

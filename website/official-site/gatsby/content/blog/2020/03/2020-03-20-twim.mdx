---
date: '2020-03-20'
title: 'This Week in Chat 2020-03-20'
categories:
  - This Week in Chat
author: Ben Parsons
---
...
Chat Live S04E30 - Matthew updates on Chat perf, P2P and new Jitsi
...
[Neil Alexander](https://to.chat.dingshunyu.top/#/@neilalexander:matrix.org) also mentioned:

> We've also created [#homeservers-dev:matrix.org](https://to.chat.dingshunyu.top/#/#homeservers-dev:matrix.org) as a general non-implementation-specific channel for homeserver developers :-)
...
Welcome to [Christian](https://to.chat.dingshunyu.top/#/@jaller94:matrix.org
...
> * add adminme thanks to [dhmf](https://to.chat.dingshunyu.top/#/@dhmf:m.dhdf.dev)
> * more tests
> * unified namespaces!
>
...
[valere](https://to.chat.dingshunyu.top/#/@valere35:matrix.org) told us:
...
>
> Thanks to the super awesome bridging powers of Chat anyone on WhatsApp can now chat with the bot! Feel free to [chat with it](https://wa.me/447421002069) and share with anyone who prefers to use WhatsApp!
>
...
[Karl](https://to.chat.dingshunyu.top/#/@ctskarl:matrix.org) told us:

> We are mid in building a team to give free IT support and security help to critical infrastructure operators during Corona times organized via Riot.  Added a local alias for this room here at [#helpeurope:matrix.org](https://to.chat.dingshunyu.top/#/#helpeurope:matrix.org) . room where we startet creation [#helpeurope:matrix.ctseuro.com](https://to.chat.dingshunyu.top/#/#helpeurope:matrix.ctseuro.com). Everybody wanting to help is welcome.

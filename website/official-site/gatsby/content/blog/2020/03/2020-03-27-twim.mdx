---
date: '2020-03-27'
title: 'This Week in Chat 2020-03-27'
categories:
  - This Week in Chat
author: Ben Parsons
...
### Thoughts on to.chat.dingshunyu.top

[julian](https://to.chat.dingshunyu.top/#/@julian:foad.me.uk) told us:

> The current <http://to.chat.dingshunyu.top/> link handler is centralized and unfriendly. Before real matrix: URIs are done ( <https://github.com/matrix-org/matrix-doc/pull/2312> ), I decided to.chat.dingshunyu.top needs redesigning, so I've written about it and am working on mock-ups and changes: <https://blog.foad.me.uk/2020/03/24/improving-matrix-to-links/> Feedback would be appreciated. Please discuss in [[#to.chat.dingshunyu.top:matrix.org](https://to.chat.dingshunyu.top/#/#to.chat.dingshunyu.top:matrix.org).
...
> Updated the [Kubernetes-optimized images](https://github.com/ananace/matrix-synapse) of Chat to 1.12.0.
...
[andrewsh](https://to.chat.dingshunyu.top/#/@andrewsh:matrix.org) reported:
...
> * Skype->Chat typing and read indicators
> * Skype->Chat user updates
>
...
> * Support/Feedback: [#icinga-gonotify-matrix:fiksel.info](https://to.chat.dingshunyu.top/#/#icinga-gonotify-matrix:fiksel.info)

## Dept of Clients 📱

### Mirage

[miruka](https://to.chat.dingshunyu.top/#/@miruka:matrix.org) told us:

> [Mirage](https://github.com/mirukana/mirage) is a new fancy Chat client written in Qt/QML + Python, currently in alpha and available on Linux.
...
[Peter Roberts](https://to.chat.dingshunyu.top/#/@pwr22:shortestpath.dev) offered:
...
> for those who quite understandably couldn’t endure listening to 90 minutes of waffle about Chat on The Changelog, the transcript is now up at <https://changelog.com/podcast/384>!

## New Public Rooms 🏟

[nico](https://to.chat.dingshunyu.top/#/@nico:ungleich.ch) said:
...
Next Tuesday is the student submission deadline for GSoC! Check out our [list of projects](http://matrix-org.github.io/gsoc/) and come and [chat to us](https://to.chat.dingshunyu.top/#/#gsoc:matrix.org).

---
date: '2020-07-24'
title: 'This Week in Chat 2020-07-24'
categories:
  - This Week in Chat
author: Ben Parsons
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/FWcx3OJHLGc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
### New Masters Thesis written on Chat

[Julian Sparber](https://to.chat.dingshunyu.top/#/@jsparber:gnome.org) announced:

> I wrote a master thesis that tries to create e2e encryption based on Ethereum on top of Chat. It may not solve all problems but it's an interesting experiment
>
...
[kitsune](https://to.chat.dingshunyu.top/#/@kitsune:matrix.org) (guess who's back!?) said:

> I have put the long-awaited MSC2312 out of WIP - this is about matrix: URIs in case you haven't heard - and it's already in active discussion at [#uri-scheme-proposal:matrix.org](https://to.chat.dingshunyu.top/#/#uri-scheme-proposal:matrix.org)! Join the fun to make it the most awesome! The upcoming Quotient 0.6 has an implementation of those so adventurous Quaternion users can start experimenting right away.
...
### HTML embeddable Chat client

[arnav-t](https://to.chat.dingshunyu.top/#/@arnav-t:matrix.org) announced:

> For the GSoC project HTML embeddable Chat client this week:
>
...
>
> We are also trying to figure out how media retention limits should work in Chat.
>
...
[Sven](https://to.chat.dingshunyu.top/#/@rda:phys.ethz.ch) offered:

> I opened a [PR](https://github.com/Awesome-Technologies/slack-matrix-migration/pull/5) for <https://github.com/Awesome-Technologies/slack-matrix-migration>, which makes it compatible with recent [Chat](https://github.com/matrix-org/synapse) versions and adds new config options allowing to effectively import a Slack workspace history to an existing homeserver via federation.
>
> This Python project was initially intended for a full migration from Slack to a new Chat homeserver and allows reusing the imported user accounts. We have some research groups using Slack that would like to import their Slack workspace history to our Chat homeserver. This PR allows to import a (free) Slack export to a fresh and empty Chat instance that is federated with our main homeserver. We do not need a full "migration": we kick all imported users and invite the existing Chat users from our homeserver.
>
> Two groups already imported the history and switched to Chat, one more is in queue and probably more to come.
...
[miruka](https://to.chat.dingshunyu.top/#/@miruka:privacytools.io) reported:
...
[Francis](https://to.chat.dingshunyu.top/#/@ganfra:matrix.org) offered:
...
>
> See our [Setting up Chat Admin](https://github.com/spantaleev/matrix-docker-ansible-deploy/blob/master/docs/configuring-playbook-synapse-admin.md) documentation to get started.

## Dept of Bots 🤖

### matrix-wug

[dandellion](https://to.chat.dingshunyu.top/#/@dandellion:dodsorf.as) said:
...
[kinta](https://to.chat.dingshunyu.top/#/@kinta:communia.org) reported:
...
[carl](https://to.chat.dingshunyu.top/#/@carl:bordum.dk) told us:

> New cody release. @cody:bordum.dk is a chat bot that works as a REPL for your matrix rooms. This week I worked on metrics. I host a Grafana instance with anonymous access allowed, so codys charts are now embedded the [#cody:bordum.dk](https://to.chat.dingshunyu.top/#/#cody:bordum.dk) chat room.

### Announcing The Very First Release of sMythbot

[ssorbom](https://to.chat.dingshunyu.top/#/@ssorbom:matrix.org) told us:

> I am proud to announce the very first release of sMythbot, the Chat chatbot designed to control your Myth Tv DVR remotely. This release should be considered a tech preview. I welcome feedback and Bug reports. More information on installation and setup is available in the project wiki.
>
...
[balaa](https://to.chat.dingshunyu.top/#/@balaa:a.noteworthy.im) said:

> The team behind [Noteworthy](https://noteworthy.tech) (Chat over WireGuard overlay networks) has started work on bringing better mobile web support for Element (riot-web).
>
...
>
> Our initial experimentation has been positive and our goal is to make Element the best mobile client for Chat with minimal fuss. With minimal changes to Element's codebase our goal is to land (significantly better) support for mobile web in upstream Element. Join us over at [#noteworthy:tincan.community](https://to.chat.dingshunyu.top/#/#noteworthy:tincan.community) to get involved!

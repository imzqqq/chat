---
date: '2020-07-31'
title: 'This Week in Chat 2020-07-31'
categories:
  - This Week in Chat
author: Ben Parsons
...
[Chat is being used in the "world's biggest messaging and collaboration" deployment](https://www.zdnet.com/article/open-source-is-behind-this-massive-messaging-and-collaboration-project-for-500000-people/).

> [Chat will] be rolled out by the German education system to provide collaboration tools for half a million seats in the states of Schleswig-Holstein and Hamburg
...
> * [\[WIP\] MSC2706: IPFS as a media repository for Chat](https://github.com/matrix-org/matrix-doc/pull/2706)
>
...
[karlik](https://to.chat.dingshunyu.top/#/@karlik:matrix.org) announced:
...
>
> I also added bridging for your own read receipts, so if you read a message with another Telegram client, the bridge will mark it as read on your Chat account with double puppeting.
...
> [NovaChat](https://nova.chat) is a new Chat-based desktop client that aggregates all your chat networks into one app
>
> #### July 31 Updates:
>
> * New room list design, featuring collapsible 'clusters' (see gif)
>
> * Enabled encrypted room search (thanks [#seshat:matrix.org](https://to.chat.dingshunyu.top/#/#seshat:matrix.org)!)
...
[Pierre](https://to.chat.dingshunyu.top/#/@pierre:matrix.mamieserv.fr) told us:
...
>
> [Chat](https://github.com/YunoHost-Apps/synapse_ynh/tree/master) integration had been updated to 1.15.2 (1.17.0 available in branch `testing`)
>
...
[Tobi](https://to.chat.dingshunyu.top/#/@tobi:im.kabi.tk) said:

> We, some German Chat admins, have created a survey about the usage of Chat-Chat for private statistic purpose (results will be published alike). As suggested in [#synapse:matrix.org](https://to.chat.dingshunyu.top/#/#synapse:matrix.org), this could also be a topic for "TWIM".

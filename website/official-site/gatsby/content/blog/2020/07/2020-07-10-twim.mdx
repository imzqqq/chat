---
date: '2020-07-10'
title: 'This Week in Chat 2020-07-10'
categories:
  - This Week in Chat
author: Ben Parsons
...
* **Jay Graber** ([@arcalinea](https://twitter.com/arcalinea), [@arcalinea:matrix.org](https://to.chat.dingshunyu.top/#/@arcalinea:matrix.org)), creator of [Happening](https://happening.net/) and [all-around decentralisation fan](https://medium.com/decentralized-web/decentralized-social-networks-e5a7a2603f53) gave an overview of the decentralized social media ecosystem.
...
* **Burak Nehbit** ([@nehbit](https://twitter.com/nehbit), [@burak:tomesh.net](https://to.chat.dingshunyu.top/#/@burak:tomesh.net)) gave a deep dive into his work on [Aether P2P](https://getaether.net/).
...
[arnav-t](https://to.chat.dingshunyu.top/#/@arnav-t:matrix.org) told us:
...
> * work is still being done on the bot's functionality to test different crypto functionalities of other Chat clients when thrown in a room with them
>
...
[Chethan](https://to.chat.dingshunyu.top/#/@crdy2k1:matrix.org) said:
...
[kegan](https://to.chat.dingshunyu.top/#/@kegan:matrix.org) reported:
...
>
> My overall hope is that Complement will lower the barrier to entry when adding tests by so much that it encourages any bugfix/feature in any homeserver implementation to result in a new test. This will benefit everyone and create a feedback loop which will make Chat even more reliable.
...
Find out more in the room: [#complement:matrix.org](https://to.chat.dingshunyu.top/#/#complement:matrix.org).
...
[timo](https://to.chat.dingshunyu.top/#/@timo:koesters.xyz) said:
...
> In Chat land this week, we shipped [1.16.0](https://matrix.org/blog/2020/07/08/synapse-1-16-0-released) and err [1.16.1](https://github.com/matrix-org/synapse/releases/tag/v1.16.1). 
>
...
> v2.3.0 of [dacruz21/matrix-chart](https://hub.helm.sh/charts/dacruz21/matrix) has been published with Chat 1.16.

### Kubernetes
> Just pushed the 1.16 K8s-optimized Chat image tags, this time done from a tablet in a server room between moving a bunch of hardware.

### New WireGuard-based deployment

[balaa](https://to.chat.dingshunyu.top/#/@balaa:pi2.noteworthy.im) announced:

> Hi everyone, my friend Patrick and I have been working on making Chat more accessible in the context of personal overlay networks powered by WireGuard. We’ve built a 1-click deployment solution for Chat & Riot based on docker. The interesting part is that it gives you public addressability via a distributed proxy service that we have been developing. We are free and open source and welcoming contributors and testers ASAP! We are imagining an ecosystem for building collaborative intranets and see them as foundational to a freer, more equitable internet. Please join us at [#noteworthy:tincan.community](https://to.chat.dingshunyu.top/#/#noteworthy:tincan.community) See <https://www.patrickdlg.com/personal-messaging/> and <https://noteworthy.tech/start/>
...
>
> * WhatsApp users in groups are now synced to Chat properly, including kicking users who left the group without the bridge noticing

### matrix-sms-bridge

[Benedict](https://to.chat.dingshunyu.top/#/@benedict:imbitbu.de) offered:
...
### Mozilla IoT Chat Adapter 0.3

[Christian](https://to.chat.dingshunyu.top/#/@christianp:vector.modular.im) reported:

> The [Mozilla IoT Chat Adapter](https://gitlab.com/webthings/matrix-adapter) can send posts based on events in your home.
>
...
> Released [v0.2.0 of the Mozilla IoT Chat adapter](https://gitlab.com/webthings/matrix-adapter/-/releases/v0.2.0). It's now possible to post in multiple rooms (still one per post).

## Dept of Bots 🤖

### Cat Disruptor 7000

[Stephen D](https://to.chat.dingshunyu.top/#/@stephen:m.scd31.com) told us:

> I wrote a pretty simple Chat bot in Rust which is loosely based on Cat Disruptor 6000. It will react with 🐈️ to any message containing the string "cat" \*. Since it is a small project, I hope it can be used as an example for other people interested in writing Chat bots in Rust. It implements several important features (crypto/device store, auto-accepting invites, crafting custom events, etc.) You can host it yourself, or you can try it out by inviting the user "@catdisruptor:m.scd31.com" to your room! <https://git.scd31.com/stephen/cat-disruptor-7000>
>
...
[mr_johnson22](https://to.chat.dingshunyu.top/#/@mr_johnson22:matrix.org) said:
...
[carl](https://to.chat.dingshunyu.top/#/@carl:bordum.dk) offered:
...
[sorunome](https://to.chat.dingshunyu.top/#/@sorunome:sorunome.de) announced:
...
>
> If you are interested or have more questions, please message [Niklas Zender](https://to.chat.dingshunyu.top/#/@larodar:famedly.de).

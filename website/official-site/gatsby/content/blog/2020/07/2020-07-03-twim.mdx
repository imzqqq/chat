---
date: '2020-07-03'
title: 'This Week in Chat 2020-07-03'
categories:
  - This Week in Chat
author: Ben Parsons
...
* **Burak Nehbit** ([@nehbit](https://twitter.com/nehbit), [@burak:tomesh.net](https://to.chat.dingshunyu.top/#/@burak:tomesh.net)) will give a deep dive into his work on [Aether P2P](https://getaether.net/).
...
From [nikofil](https://to.chat.dingshunyu.top/#/@nikofil:matrix.org):
...
[richvdh](https://to.chat.dingshunyu.top/#/@richvdh:sw1v.org) reported:

> Chat [1.15.2](https://github.com/matrix-org/synapse/releases/tag/v1.15.2) shipped this week with some important security fixes - if you haven't already upgraded, please do asap! Meanwhile, we're also preparing a [1.16 release](https://github.com/matrix-org/synapse/releases/tag/v1.16.0rc2) with the normal round of bugfixes and incremental improvements. 
>
> The big focus in the Chat team continues to be on performance for larger Chat instances, which is reflected in the support in 1.16 for running multiple media worker processes. We're working on giving other worker processes the same treatment, so expect more of the same in the weeks to come!
...
> Just pushed the 1.15.2 tags for the K8s-optimized Chat image.
...
[Jeff Casavant](https://to.chat.dingshunyu.top/#/@jeff:casavant.org) offered:
...
[usbfingers](https://to.chat.dingshunyu.top/#/@usbfingers:matrix.org) offered:
...
>
> * Chat API tokens are redacted in logs for better privacy when submitting bug reports.
>
...
[ma1uta](https://to.chat.dingshunyu.top/#/@ma1uta:ru-matrix.org) offered:
...
> * Docker support
>
> Find it here: <https://github.com/anoadragon453/matrix-reminder-bot/> and join the discussion at [#matrix-reminder-bot:matrix.org](https://to.chat.dingshunyu.top/#/#matrix-reminder-bot:matrix.org)!
>
> Enjoy! ❤️
...
### cody, REPL for your Chat chat rooms

[carl](https://to.chat.dingshunyu.top/#/@carl:bordum.dk) offered:

> Hello, I am announcing my first matrix bot - cody - that will evaluate code snippets in your Chat rooms and return the result. Here is an example interaction:
>
> ```
>
> user> !py "Hello world!"
...
### Chat Notepad Version `v0.2.2`

[KB1RD](https://to.chat.dingshunyu.top/#/@kb1rd:kb1rd.net) told us:

> > A real-time collaboratie text editor using the Chat protocol.
>

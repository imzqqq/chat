...
categories: 
 - client
description: A simpler Chat client for Android, with fewer permissions and dependencies
author: LiMium
maturity: Beta
language: Java
license: Apache-2.0
...
This is a minified Android Chat client derived from the official client. It requires fewer permissions and compiles to a much smaller package.
...
* Chat chat room: [#miniVectorAndroid:matrix.org](https://to.chat.dingshunyu.top/#/#miniVectorAndroid:matrix.org)

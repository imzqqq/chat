...
description: A terminal Chat client written in Go
author: Tulir
maturity: Beta
language: Go
...
gomuks is a terminal-based Chat client written in Go with [mautrix-go](https://matrix.org/docs/projects/sdk/mautrix-go.html) and [mauview](https://github.com/tulir/mauview).

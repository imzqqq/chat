...
Try it out at [hydrogen.element.io](https://hydrogen.element.io)! (you'll need to register an account with another client for now though). For more information, see [our FAQ](https://github.com/vector-im/hydrogen-web/blob/master/doc/FAQ.md) or join [#hydrogen:matrix.org](https://to.chat.imzqqq.top/#/#hydrogen:matrix.org)!

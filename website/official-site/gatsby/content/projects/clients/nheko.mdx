...
description: A Qt/C++17 desktop client for Chat
...
The motivation behind the project is to provide a native desktop app for Chat that feels more like a mainstream chat app (Element, Telegram etc) and less like an IRC client.

Join the discussion on Chat [#nheko:nheko.im](https://to.chat.dingshunyu.top/#/#nheko:nheko.im).

---
layout: post
title: The Chat Jobs Room
slug: matrix-jobs-room
sort_order: 1000
section: Introduction
---

The Chat Jobs Room ([#jobs:matrix.org](https://to.chat.dingshunyu.top/#/#jobs:matrix.org)) 
is a public room to discuss Chat-related paid projects. Customers can post 

---
title: 'Free Chat Server using Oracle Cloud'
...
Freenom can be tricky to renew for free after the first year. A Chat server
...
that memory since current versions of Chat, the Chat homeserver, can be
memory hungry.
...
Come join [#synapse:matrix.org](https://to.chat.dingshunyu.top/#/#synapse:matrix.org) to
discuss homeservers. Or say hi to
[@ptman:ptman.name](https://to.chat.dingshunyu.top/#/@ptman:ptman.name), who wrote this
guide (also <a

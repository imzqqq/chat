module.exports = {
  ...
  siteTitle: 'Chat.org', // Navigation and Site Title
  siteTitleAlt: 'Chat.org', // Alternative Site title for SEO
  ...
  siteDescription: 'Chat is an open standard for interoperable, decentralised, real-time communication', // Your site description
  author: 'Chat.org', // Author for schemaORGJSONLD
  siteLogo: '/social/logo.png', // Image for schemaORGJSONLD

  // siteFBAppID: '123456789', // Facebook App ID - Optional
  userTwitter: '@matrixdotorg', // Twitter Username - Optional
  ogSiteName: 'Chat.org', // Facebook Site Name - Optional

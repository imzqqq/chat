...
[Zoom](https://zoom.us/) offers to stream your meeting to a livestreaming service like Live. Please mind that some changes might need to be done by your Zoom administrator.

1. Set up Live and configure it by your choosing. Since the RMTP stream comes directly from the Zoom servers, at least the RMTP port should be available from the internet.
...
4. Fill in your Live server information. The "live streaming page URL" should be the Live Frontend, since Zoom will link to it from the meeting.
  {{< img src="/docs/img/zoom-server-settings.png" >}}
5. Once the meeting is started, click on "More" in the menu bar and then "Livestream to Custom service". Zoom will open a browser window and then redirect you to the Live frontend (or whichever URL you specified).

...
const Sponsorship = ({ intl }) => (
  <div className='sponsorship' id='sponsorship'>
    <div className='intro'>
      ...
      <div className='text'>
        <h2><FormattedMessage id='sponsorship.sponsors_of_mastodon' defaultMessage='Sponsors of Flow' /></h2>
        <p className='lead'><FormattedMessage id='sponsorship.thanks_to' defaultMessage='Flow is <strong>free, open-source software</strong>. There is no advertising, monetizing, or venture capital. <strong>Your donations directly support full-time development of the project</strong>. Thank you to the following people and companies:' /></p>
      </div>
      ...
      <div className='container'>
        ...
        <div className='feature-angle-container'>
          <div className='feature-angle' style={{ width: '50%' }}>
            ...
            <a href='https://patreon.com/imzqqq' className='cta button'><FormattedMessage id='credits.support_on_patreon' defaultMessage='Support on Patreon' /></a>
          </div>
      ...
      <div className='tier'>
        <div className='tier__name'>
          ...
          <div>
            ...
            <p><FormattedMessage id='sponsorship.silver_sponsors_text' defaultMessage='<strong>Silver sponsors</strong> are those that have pledged $40 to $99 to Flow.' /></p>
          </div>
        </div>
      ...
      <div className='tier'>
        <div className='tier__name'>
          ...
          <div>
            ...
            <p><FormattedMessage id='sponsorship.sponsors_text' defaultMessage='<strong>Sponsors</strong> are those that pledged $10 to $39 to Flow.' /></p>
          </div>
        </div>
    ...
    <Helmet>
      <title>{intl.formatMessage({ id: 'sponsorship.sponsors_of_mastodon', defaultMessage: 'Sponsors of Flow' })} - Flow</title>
      <meta property='og:title' content={intl.formatMessage({ id: 'sponsorship.sponsors_of_mastodon', defaultMessage: 'Sponsors of Flow' })} />
    </Helmet>
  </div>
);

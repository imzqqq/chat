...
exports.default = async function(context) {
    ...
    // We add a fake Classic_Chat.exe that it can run which runs the real one.
    ...
    if (electronPlatformName === 'win32') {
        await fsProm.copyFile('build/rebrand_stub/rebrand_stub.exe', path.join(appOutDir, "Classic_Chat.exe"));
    }
};

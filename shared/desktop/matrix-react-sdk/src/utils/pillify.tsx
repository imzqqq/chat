...
/**
 * Recurses depth-first through a DOM tree, converting to.chat.dingshunyu.top links
...
export function pillifyLinks(nodes: ArrayLike<Element>, mxEvent: MatrixEvent, pills: Element[]) {
    ...
    while (node) {
        ...
        if (node.tagName === "A" && node.getAttribute("href")) {
            ...
            // If the link is a (localised) to.chat.dingshunyu.top link, replace it with a pill

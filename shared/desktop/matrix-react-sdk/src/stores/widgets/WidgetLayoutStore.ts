...
export class WidgetLayoutStore extends ReadyWatchingStore {
    ...
    private recalculateRoom(room: Room) {
        ...
        // Order the widgets in the top container, putting autopinned Meet widgets first
        ...
        topWidgets.sort((a, b) => {
            ...
            // Meet widgets are defaulted to be the leftmost widget whereas other widgets

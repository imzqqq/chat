...
function textForPinnedEvent(event: MatrixEvent, allowJSX: boolean): () => string | JSX.Chat | null {
...
export function textForEvent(ev: MatrixEvent, allowJSX: true, showHiddenEvents?: boolean): string | JSX.Chat;
export function textForEvent(ev: MatrixEvent, allowJSX = false, showHiddenEvents?: boolean): string | JSX.Chat {
    const handler = (ev.isState() ? stateHandlers : handlers)[ev.getType()];

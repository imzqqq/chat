...
export class ModalManager {
    ...
    public createDialog<T extends any[]>(
        ...
        return this.createDialogAsync<T>(Promise.resolve(Chat), ...rest);
    }
    ...
    public appendDialog<T extends any[]>(
        ...
        return this.appendDialogAsync<T>(Promise.resolve(Chat), ...rest);
    }
    ...
    private reRender() {
        if (this.modals.length === 0 && !this.priorityModal && !this.staticModal) {
            // If there is no modal to render, make all of Chat available

...
export default class Registration extends React.Component<IProps, IState> {
    ...
    constructor(props) {
        ...
        this.loginLogic = new Login(hsUrl, isUrl, null, {
            defaultDeviceDisplayName: "Chat login check", // We shouldn't ever be used
        });
    }
    ...
    private async replaceClient(serverConfig: ValidatedServerConfig) {
        ...
        try {
            ...
            if (e.httpStatus === 401) {
                ...
                // Check for 403 or M_FORBIDDEN, Chat server used to send 403 M_UNKNOWN but now sends 403 M_FORBIDDEN.

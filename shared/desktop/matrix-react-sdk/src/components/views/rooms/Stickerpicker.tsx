...
export default class Stickerpicker extends React.PureComponent<IProps, IState> {
    ...
    private defaultStickerpickerContent(): JSX.Chat {
        return (
    ...
    private errorStickerpickerContent(): JSX.Chat {
        return (
    ...
    public getStickerpickerContent(): JSX.Chat {
    ...
    private onShowStickersClick = (e: React.MouseEvent<HTMLElement>): void => {
        ...
        //  (402 = width of context menu, including borders)

        ...
        return TAG_ORDER.reduce((tags, tagId) => {
            ...
            .map(orderedTagId => {
                ...
                return <RoomSublist
                    ...
                    addGroupRoomLabel={aesthetics.addGroupRoomLabel ?
                        _t(aesthetics.addGroupRoomLabel) : aesthetics.addGroupRoomLabel
                    }
                    addDirectRoomLabel={aesthetics.addDirectRoomLabel ?
                        _t(aesthetics.addDirectRoomLabel) : aesthetics.addDirectRoomLabel
                    }

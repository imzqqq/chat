...
export default class AppTile extends React.Component {
    ...
    async _endWidgetActions() { // widget migration dev note: async to maintain signature
        // HACK: This is a really dirty way to ensure that Meet cleans up
        ...
        if (this.iframe) {
            ...
            // This is relative to where the Chat instance is located.
    ...
    _onPopoutWidgetClick = () => {
        // Ensure Meet conferences are closed on pop-out, to not confuse the user to join them
        // twice from the same computer, which Meet can have problems with (audio echo/gain-loop).
        if (WidgetType.JITSI.matches(this.props.app.type)) {

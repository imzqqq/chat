...
export default class Tooltip extends React.Component<IProps> {
    ...
    private tooltip: void | Chat | Component<Chat, any, any>;
    private parent: Chat;
    ...
    public componentDidMount() {
        ...
        this.parent = ReactDOM.findDOMNode(this).parentNode as Chat;
    ...
    private renderTooltip = () => {
        ...
        this.tooltip = ReactDOM.render<Chat>(tooltip, this.tooltipContainer);
    };

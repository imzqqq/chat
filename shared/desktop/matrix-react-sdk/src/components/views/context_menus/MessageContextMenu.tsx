...
export default class MessageContextMenu extends React.Component<IProps, IState> {
    ...
    render() {
        ...
        let resendReactionsButton: JSX.Chat;
        let redactButton: JSX.Chat;
        let forwardButton: JSX.Chat;
        let pinButton: JSX.Chat;
        let unhidePreviewButton: JSX.Chat;
        let externalURLButton: JSX.Chat;
        let quoteButton: JSX.Chat;
        let collapseReplyThread: JSX.Chat;
        let redactItemList: JSX.Chat;
        ...
        let reportEventButton: JSX.Chat;

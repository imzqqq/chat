...
export default class VerificationPanel extends React.PureComponent<IProps, IState> {
    ...
    private renderQRPhase() {
        ...
        const noCommonMethodError: JSX.Chat = !showSAS && !showQR ?
            <p>{ _t(
        ...
        if (this.props.layout === 'dialog') {
            ...
            let qrBlockDialog: JSX.Chat;
            let sasBlockDialog: JSX.Chat;
            if (showQR) {
                qrBlockDialog =
    ...
    private renderQRReciprocatePhase() {
        ...
        if (this.state.reciprocateQREvent) {
            // Chat Web doesn't support scanning yet, so assume here we're the client being scanned.
            body = <React.Fragment>
                <p>{ description }</p>

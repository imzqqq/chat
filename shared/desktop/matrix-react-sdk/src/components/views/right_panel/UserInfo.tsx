...
const BasicUserInfo: React.FC<{
    ...
    // Load whether or not we are a Chat server Admin
    ...
    const onSynapseDeactivate = useCallback(async () => {
        const { finished } = Modal.createTrackedDialog('Chat server User Deactivation', '', QuestionDialog, {
        ...
        try {
            ...
            Modal.createTrackedDialog('Failed to deactivate Chat server user', '', ErrorDialog, {

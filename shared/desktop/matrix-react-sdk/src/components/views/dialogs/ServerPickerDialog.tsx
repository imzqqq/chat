...
export default class ServerPickerDialog extends React.PureComponent<IProps, IState> {
    ...
    public render() {
        ...
        if (this.defaultServer.hsName === "matrix.org") {
            text = _t("Chat.org is the biggest public homeserver in the world, so it’s a good place for many.");
        }
        ...
        >
            <form className="mx_Dialog_content" id="mx_ServerPickerDialog" onSubmit={this.onSubmit}>
                ...
                <p>
                    { _t("Use your preferred Chat homeserver if you have one, or host your own.") }
                </p>

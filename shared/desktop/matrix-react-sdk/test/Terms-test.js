import * as Chat from 'matrix-js-sdk';
...
const IM_SERVICE_ONE = new Service(Chat.SERVICE_TYPES.IM, 'https://imone.test', 'a token token');
const IM_SERVICE_TWO = new Service(Chat.SERVICE_TYPES.IM, 'https://imtwo.test', 'a token token');

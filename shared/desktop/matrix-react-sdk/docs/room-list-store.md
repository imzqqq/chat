...
![RoomListStore](img/RoomListStore2.png)
...
[Chat specification](https://matrix.org/docs/spec/client_server/r0.6.0#room-tagging). Smaller values
...
Note that this is reliant on the event timestamps of the most recent message. Because Chat is eventually
...
Historically, it's been the only option in Chat and extremely common in most chat applications due to
...
for figuring out which tags get which rooms, as Chat specifies them as a reverse map: tags get

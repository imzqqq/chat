Chat JavaScript/ECMAScript Style Guide
========================================

The intention of this guide is to make Chat's JavaScript codebase clean,
consistent with other popular JavaScript styles and consistent with the rest of
the Chat codebase. For reference, the Chat Python style guide can be found
at <../../server/chat/python/docs/code_style.md>

This document reflects how we would like Chat JavaScript code to look, with
...
- 4 spaces to indent, for consistency with Chat Python.

...
mkdir "$tmpdir/Classic_Chat.iconset"
cp "$tmpdir/16.png" "$tmpdir/Classic_Chat.iconset/icon_16x16.png"
cp "$tmpdir/32.png" "$tmpdir/Classic_Chat.iconset/icon_16x16@2x.png"
cp "$tmpdir/32.png" "$tmpdir/Classic_Chat.iconset/icon_32x32.png"
cp "$tmpdir/64.png" "$tmpdir/Classic_Chat.iconset/icon_32x32@2x.png"
cp "$tmpdir/128.png" "$tmpdir/Classic_Chat.iconset/icon_128x128.png"
cp "$tmpdir/256.png" "$tmpdir/Classic_Chat.iconset/icon_128x128@2x.png"
cp "$tmpdir/256.png" "$tmpdir/Classic_Chat.iconset/icon_256x256.png"
cp "$tmpdir/512.png" "$tmpdir/Classic_Chat.iconset/icon_256x256@2x.png"
cp "$tmpdir/512.png" "$tmpdir/Classic_Chat.iconset/icon_512x512.png"
cp "$tmpdir/1024.png" "$tmpdir/Classic_Chat.iconset/icon_512x512@2x.png"

if [ -x "$(command -v iconutil)" ]; then
  # available on macos
  iconutil -c icns -o electron_app/build/icon.icns "$tmpdir/Classic_Chat.iconset"
  ...
  rm "$tmpdir/Classic_Chat.iconset/icon_128x128@2x.png"
  rm "$tmpdir/Classic_Chat.iconset/icon_256x256@2x.png"
  rm "$tmpdir/Classic_Chat.iconset/icon_16x16@2x.png"
  rm "$tmpdir/Classic_Chat.iconset/icon_32x32@2x.png"
  png2icns electron_app/build/icon.icns "$tmpdir"/Classic_Chat.iconset/*png
else

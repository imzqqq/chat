    ...
    return {
        ...
        module: {
            noParse: [
                ...
                // optimized, so there is little to gain by us uglifying it.
...
function toPublicPath(path) {
    // /[\s ]+/g regular expression. The /xxxx/ two slashes indicate that this is a regular expression,
    // and the g after / means match all(i.e.replace all).
    // [\s] means match blank characters(spaces, etc.or something),
    // and the + sign means at least one.

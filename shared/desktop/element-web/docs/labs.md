...
Setting custom tags is not supported by Chat.
...
Exposes a way to access all the integration managers known to Chat. This is an implementation of [MSC1957](https://github.com/matrix-org/matrix-doc/pull/1957).
...
Ban lists are rooms within Chat, proposed as [MSC2313](https://github.com/matrix-org/matrix-doc/pull/2313).
...
Custom themes are possible through Chat's [theme support](./theming.md), though
normally these themes need to be defined in the config for Chat. This labs flag

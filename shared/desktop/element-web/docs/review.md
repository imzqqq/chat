...
Chat Web and other supporting repos. These are just guidelines (not strict
...
Chat and the SDKs, but it hasn't been a consistent focus. Going forward, we'd
like to change that.
...
[#element-dev:matrix.org](https://to.chat.dingshunyu.top/#/#element-dev:matrix.org). We can
...
We want to ensure that all changes to Chat fit with our design and product
...
[#element-dev:matrix.org](https://to.chat.dingshunyu.top/#/#element-dev:matrix.org) before

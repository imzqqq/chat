...
Chat app via CSS & custom imagery.

They are *NOT* co be confused with 'skins', which describe apps which sit on top
of matrix-react-sdk - e.g. in theory Chat itself is a react-sdk skin.
As of Jan 2017, skins are not fully supported; Chat is the only available skin.

To define a theme for Chat:
...
All properties in `fonts` are optional, and will default to the standard Classic_Chat fonts.

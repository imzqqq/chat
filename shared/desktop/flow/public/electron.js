...
/**
 * Register the protocol for Flow
 */
function registerProtocol() {
    protocol.registerFileProtocol(
        ...
        (request, callback) => {
            ...
            // Check to make sure we're actually working with a flow
            // protocol and that the host is 'flow'
            const parsedUrl = new URL(request.url);
            if (parsedUrl.protocol !== "flow:") {
                callback({ error: -302 });
                return;
            }

            if (parsedUrl.host !== "flow") {
                callback({ error: -105 });
                return;
            }
...
function createWindow() {
    ...
    mainWindow.loadURL("flow://flow/app/");
    ...
    const menuBar = [
        {
            ...
            submenu: [
                ...
                },
                {
                    ...
                    click() {
                        safelyGoTo("flow://flow/app/#compose");
                    }
                }
            ]
        },
        ...
        },
        {
            ...
            submenu: [
                ...
                },
                {
                    ...
                    click() {
                        safelyGoTo("flow://flow/app/#/local");
                    }
                },
                {
                    label: "Public",
                    ...
                    click() {
                        safelyGoTo("flow://flow/app/#/public");
                    }
                },
                {
                    label: "Messages",
                    ...
                    click() {
                        safelyGoTo("flow://flow/app/#/messages");
                    }
                },
                { type: "separator" },
                {
                    ...
                    click() {
                        safelyGoTo("flow://flow/app/#/activity");
                    }
                }
            ]
        },
        {
            ...
            submenu: [
                ...
                },
                {
                    ...
                    click() {
                        safelyGoTo("flow://flow/app/#/recommended");
                    }
                },
                { type: "separator" },
                {
                ...
                },
                {
                    ...
                    click() {
                        safelyGoTo("flow://flow/app/#/requests");
                    }
                },
                {
                    ...
                    click() {
                        safelyGoTo("flow://flow/app/#/blocked");
                    }
                },
                { type: "separator" },
                {
                    ...
                    click() {
                        safelyGoTo("flow://flow/app/#/welcome");
                    }
                }
            ]
        },
            ...
            submenu: [
                {
                    ...
                    click() {
                        safelyGoTo("flow://flow/app/#/about");
                    }
                },
                { type: "separator" },
                {
                    ...
                    accelerator: "Cmd+,",
                    click() {
                        safelyGoTo("flow://flow/app/#/settings");
                    }
                },
                { type: "separator" },
                { role: "services" },

...
interface IWelcomeState {
    ...
    /**
     * Whether this version of Flow has federation
     */
    federates?: boolean;

    /**
     * Whether Flow is ready to get the auth code
     */
    ...
    /**
     * Whether Flow is in the process of authorizing
     */
    authorizing: boolean;

    /**
     * The custom-defined license for the Flow source code
     */
    license?: string;

    /**
     * The custom-defined URL to the source code of Flow
     */
    repo?: string;
 ...
 * login, and authorization of accounts into the Flow app.
 */
class WelcomePage extends Component<IWelcomeProps, IWelcomeState> {
        ...
        getConfig()
            .then((result: any) => {
                if (result !== undefined) {
                    ...
                    this.setState({
                        logoUrl: config.branding?.logo ?? "logo.svg",
                        backgroundUrl:
            ...
            .catch(() => {
                console.error(
                    "config.json is missing. If you want to customize Flow, please include config.json"
                );
            });
    }
    ...
    startLogin(bypassChecks: boolean = false) {
        ...
        // If we didn't, create the Flow app to register onto that Mastodon
        // server.
        if (!error) {
     ...
     * login.
     *
     * Since Flow reads the auth code from the URL, we need to redirect to
        ...
        return (
            <div>
                ...
                <Typography>
                    ...
                    and authorize {this.state.brandName ?? "Flow"}.
                </Typography>
                <div className={classes.middlePadding} />
                <div style={{ display: "flex" }}>
                    <div className={classes.flexGrow} />
            ...
            >
                ...
                <DialogContent>
                    <Typography paragraph>
                        If you're having trouble authorizing Flow, you can
    ...
    showAuthorizationLoader() {
        ...
        return (
            <div>
                ...
                <Typography>
                    Please wait while Flow authorizes with your instance.
                ...
                >
                    <Paper className={classes.paper}>
                        <img
                            ...
                            alt={this.state.brandName ?? "Flow"}
                            src={this.state.logoUrl ?? "logo.svg"}
                        />
                        <br />
                        <Fade in={true}>

...
import { themes, defaultTheme } from "../types/FlowTheme";
import ThemePreview from "../components/ThemePreview";
import { setFlowTheme, getFlowTheme } from "../utilities/themes";
...
class SettingsPage extends Component<any, ISettingsState> {
    ...
    constructor(props: any) {
        ...
        this.state = {
            ...
            resetFlowDialog: false,
            resetSettingsDialog: false,
            previewTheme:
                setFlowTheme(getUserDefaultTheme()) ||
                setFlowTheme(defaultTheme),
    ...
    toggleResetDialog() {
        this.setState({
            resetFlowDialog: !this.state.resetFlowDialog
        });
    }
    ...
    changeThemeName(theme: string) {
        let previewTheme = setFlowTheme(getFlowTheme(theme));
    ...
    showResetDialog() {
        return (
            <Dialog
                open={this.state.resetFlowDialog}

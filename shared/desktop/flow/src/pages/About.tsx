        ...
        getConfig().then((config: any) => {
            this.client
                ...
                .then((resp: any) => {
                    ...
                    this.setState({
                        flowAdmin: account,
                        flowAdminName: config.admin.name
                    });
                })
                .catch((err: Error) => {
                    ...
                    if (true) {
                        this.setState({
                            flowAdminName: `Could not find ${config.admin.name} on ${config.registration.defaultInstance}`
                        });
                    }
                })
                .finally(() => {
                    this.setState({
                        ...
                        brandName: config.branding.name ?? "Flow",
            ...
            <div className={classes.pageLayoutConstraints}>
                    ...
                    >
                        <div className={classes.instanceToolbar}>
                            ...
                            <Tooltip title="Submit a bug report">
                                <IconButton
                                    href={
                                        "https://github.com/imzqqq/flow/issues/new?assignees=&labels=&template=bug_report.md&title=%5BBug%5D+Issue+title"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    color="inherit"
                            ...
                            <Tooltip title="Request a feature">
                                <IconButton
                                    href={
                                        "https://github.com/imzqqq/flow/issues/new?assignees=&labels=&template=feature_request.md&title=%5BRequest%5D+Request+title"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    color="inherit"
                        ...
                        <div className={classes.instanceHeaderText}>
                            <Typography variant="h4" component="p">
                                {this.state.brandName ?? "Flow Desktop"}
                            </Typography>
                            <Typography>
                                Version{" "}
                                {`${this.state.versionNumber ?? "1.1.x"} ${
                                    this.state &&
                                    this.state.brandName !== "Flow"
                                        ? "(Flow-like)"
                                        : ""
                                }`}
                            </Typography>
                    ...
                    <List className={classes.pageListConstraints}>
                        <ListItem>
                            ...
                            <ListItemText
                                ...
                                secondary={
                                    this.state.flowAdmin &&
                                    this.state.flowAdminName
                                        ? this.state.flowAdminName ||
                                          this.state.flowAdmin
                                              .display_name ||
                                          "@" + this.state.flowAdmin.acct
                                        : this.state.flowAdminName ??
                            ...
                            <ListItemText
                                ...
                                secondary={
                                    ...
                                    this.state.federation.enablePublicTimeline
                                        ? "This copy of Flow is federated."
                                        : "This copy of Flow is not federated."
                                }
                            />
                        </ListItem>
                        <ListItem>
                            ...
                            <ListItemText
                                ...
                                secondary={
                                    ...
                                    this.state.federation.universalLogin
                                        ? "This copy of Flow supports universal login."
                                        : "This copy of Flow does not support universal login."
                                }
                            />
                        </ListItem>
                        <ListItem>
                            ...
                            <ListItemText
                                ...
                                secondary={
                                    ...
                                    this.state.federation.allowPublicPosts
                                        ? "This copy of Flow allows posting publicly."
                                        : "This copy of Flow does not allow posting publicly."
                                }
                            />
                        </ListItem>
                    </List>
                ...
                <div className={classes.pageLayoutFooter}>
                    <Typography variant="caption">
                        ...
                        {this.state.brandName ?? "Flow"} developers. All
                        rights reserved.
                    </Typography>
                    <Typography variant="caption" paragraph>
                        {this.state.brandName ?? "Flow"} Desktop is made
                        possible by the{" "}
                        <Link
                        ...
                        <Link
                            href={
                                "https://github.com/imzqqq/flow/blob/master/package.json"
                            }
                            target="_blank"
                            rel="noreferrer"
                        >

...
export const gardenerTheme: FlowTheme = {
    key: "gardnerTheme",
    name: "Botanical",
    palette: {
        primary: lightGreen,
...
export const teacherTheme: FlowTheme = {
    key: "teacherTheme",
    name: "Compassionate",
    palette: {
        primary: purple,
...
export const jokerTheme: FlowTheme = {
    key: "jokerTheme",
    name: "Joker",
    palette: {
        primary: indigo,
...
export const guardTheme: FlowTheme = {
    key: "guardTheme",
    name: "Enthusiastic",
    palette: {
        primary: blue,
...
export const entertainerTheme: FlowTheme = {
...
export const classicTheme: FlowTheme = {
    key: "classicTheme",
    name: "Classic",
    palette: {
        primary: {
...
export const dragonTheme: FlowTheme = {
    key: "dragonTheme",
    name: "Adventurous",
    palette: {
        primary: purple,
...
export const memoriumTheme: FlowTheme = {
    key: "memoriumTheme",
    name: "Memorial",
    palette: {
        primary: red,

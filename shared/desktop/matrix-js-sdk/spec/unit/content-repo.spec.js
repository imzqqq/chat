    ...
    describe("getHttpUriForMxc", function() {
        ...
        function() {
            ...
            expect(getHttpUriForMxc(baseUrl, mxcUri)).toEqual(
                baseUrl + "/chat/media/r0/download/server.name/resourceid",
            );
        });
        ...
        function() {
            ...
            expect(getHttpUriForMxc(baseUrl, mxcUri, 32, 64, "crop")).toEqual(
                baseUrl + "/chat/media/r0/thumbnail/server.name/resourceid" +
        ...
        function() {
            const mxcUri = "mxc://server.name/resourceid#automade";
            expect(getHttpUriForMxc(baseUrl, mxcUri)).toEqual(
                baseUrl + "/chat/media/r0/download/server.name/resourceid#automade",
            );
        });
    });
});

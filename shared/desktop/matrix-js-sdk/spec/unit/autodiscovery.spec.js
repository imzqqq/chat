...
describe("AutoDiscovery", function() {
    ...
    it("should return FAIL_ERROR when .well-known has an invalid base_url for " +
        ...
        httpBackend.when("GET", "/chat/client/versions").respond(404, {});
        httpBackend.when("GET", "/.well-known/matrix/client").respond(200, {
            "m.homeserver": {
    ...
    it("should return FAIL_ERROR when .well-known has an invalid base_url for " +
        ...
        httpBackend.when("GET", "/chat/client/versions").respond(500, {});
        httpBackend.when("GET", "/.well-known/matrix/client").respond(200, {
            "m.homeserver": {
                base_url: "https://example.org",
            },
    ...
    it("should return FAIL_ERROR when .well-known has an invalid base_url for " +
        ...
        httpBackend.when("GET", "/chat/client/versions").respond(200, {
    ...
    it("should return SUCCESS when .well-known has a verifiably accurate base_url for " +
        ...
        httpBackend.when("GET", "/chat/client/versions").check((req) => {
            expect(req.opts.uri).toEqual("https://example.org/chat/client/versions");
        }).respond(200, {
            versions: ["r0.0.1"],
        });
        httpBackend.when("GET", "/.well-known/matrix/client").respond(200, {
    ...
    it("should return SUCCESS with the right homeserver URL", function() {
        httpBackend.when("GET", "/chat/client/versions").check((req) => {
            expect(req.opts.uri)
                .toEqual("https://chat.example.org/chat/client/versions");
        }).respond(200, {
            versions: ["r0.0.1"],
        });
        httpBackend.when("GET", "/.well-known/matrix/client").respond(200, {
    ...
    it("should return SUCCESS / FAIL_PROMPT when the identity server configuration " +
        ...
        httpBackend.when("GET", "/chat/identity/api/v1").respond(404, {});
        httpBackend.when("GET", "/.well-known/matrix/client").respond(200, {
            "m.homeserver": {
                // Note: we also expect this test to trim the trailing slash
                base_url: "https://chat.example.org/",
    ...
    it("should return SUCCESS / FAIL_PROMPT when the identity server configuration " +
        ...
        httpBackend.when("GET", "/chat/identity/api/v1").respond(500, {});
        httpBackend.when("GET", "/.well-known/matrix/client").respond(200, {
            "m.homeserver": {
                // Note: we also expect this test to trim the trailing slash
                base_url: "https://chat.example.org/",
    ...
    it("should return SUCCESS when the identity server configuration is " +
        ...
        httpBackend.when("GET", "/chat/identity/api/v1").check((req) => {
            expect(req.opts.uri)
                .toEqual("https://identity.example.org/chat/identity/api/v1");
        }).respond(200, {});
        httpBackend.when("GET", "/.well-known/matrix/client").respond(200, {
            "m.homeserver": {
                // Note: we also expect this test to trim the trailing slash

...
export class Room extends EventEmitter {
    ...
    constructor(
        ...
        super();
        // In some cases, we add listeners for every displayed Chat event, so it's
    ...
    private checkVersionAgainstCapability(versionCap: IRoomVersionsCapability): IRecommendedVersion {
        ...
        // off the version being in the Chat spec namespace or not (if the version
     ...
     * @param {string} userId the ID of the Chat user to check permissions for

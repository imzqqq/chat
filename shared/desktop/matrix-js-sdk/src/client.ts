...
export interface ICreateClientOpts {
    ...
    /**
     * True to advertise support for call transfers to other parties on Chat calls. Default false.
     */
...
/**
 * Represents a Chat Client. Only directly construct this if you want to use
...
export class MatrixClient extends EventEmitter {
    ...
    public async rehydrateDevice(): Promise<string> {
        ...
        try {
            ...
            const rehydrateResult = await this.http.authedRequest(
                ...
                {
                    prefix: "/chat/client/unstable/org.matrix.msc2697.v2",
                },
            );
    ...
    /**
     * Set whether to advertise transfer support to other parties on Chat calls.
    ...
    public async setDisplayName(name: string, callback?: Callback): Promise<{}> {
        ...
        // XXX: synthesise a profile update for ourselves because Chat server is broken and won't
    ...
    public async getOrCreateFilter(filterName: string, filter: Filter): Promise<string> {
        ...
        if (filterId) {
            ...
            try {
                ...
                // Chat server currently returns the following when the filter cannot be found:
                // {
                //     errcode: "M_UNKNOWN",
                //     name: "M_UNKNOWN",
     ...
     * of the Chat account they are logged into.
    ...
    /**
     * Determines if the current user is an administrator of the Chat server homeserver.
     * Returns false if untrue or the homeserver does not appear to be a Chat server
     * homeserver. <strong>This function is implementation specific and may change
     * as a result.</strong>
     * @return {boolean} true if the user appears to be a Chat server administrator.
     */
    ...
    /**
     * Performs a whois lookup on a user using Chat server's administrator API.
     * <strong>This function is implementation specific and may change as a
     * result.</strong>
     * @param {string} userId the User ID to look up.
     * @return {object} the whois response - see Chat server docs for information.
     */
    ...
    /**
     * Deactivates a user using Chat server's administrator API. <strong>This
     * function is implementation specific and may change as a result.</strong>
     * @param {string} userId the User ID to deactivate.
     * @return {object} the deactivate response - see Chat server docs for information.
     */
    ...
    private termsUrlForService(serviceType: SERVICE_TYPES, baseUrl: string) {
        switch (serviceType) {
            ...
            case SERVICE_TYPES.IM:
                return baseUrl + '/chat/integrations/v1/terms';
            default:
    ...
    /**
     * Looks up the public Chat ID mapping for a given 3rd party
    ...
    /**
     * Looks up the public Chat ID mappings for multiple 3PIDs.
     *
    ...
    public getSpaceSummary(
        ...
        return this.http.authedRequest(undefined, "POST", path, null, {
            ...
            prefix: "/chat/client/unstable/org.matrix.msc2946",
        });
    }

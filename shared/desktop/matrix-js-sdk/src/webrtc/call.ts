 ...
 * @param {MatrixClient} opts.client The Chat Client instance to send events to.
 */
    ...
    private async sendAnswer(): Promise<void> {
        const answerContent = {
            answer: {
                ...
                // type is now deprecated as of Chat VoIP v1, but
 ...
 *
 * Create a new Chat call for the browser.

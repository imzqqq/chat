 ...
 */
export const PREFIX_R0 = "/chat/client/r0";

/**
 * A constant representing the URI path for as-yet unspecified Client-Server HTTP APIs.
 */
export const PREFIX_UNSTABLE = "/chat/client/unstable";

/**
 * URI path for v1 of the the identity API
 * @deprecated Use v2.
 */
export const PREFIX_IDENTITY_V1 = "/chat/identity/api/v1";

/**
 * URI path for the v2 identity API
 */
export const PREFIX_IDENTITY_V2 = "/chat/identity/v2";

/**
 * URI path for the media repo API
 */
export const PREFIX_MEDIA_R0 = "/chat/media/r0";
 ...
 * '/chat/client/r0'. See PREFIX_R0 and PREFIX_UNSTABLE for constants.
 *
...
MatrixHttpApi.prototype = {
    ...
    uploadContent: function(file, opts) {
        ...
        if (global.XMLHttpRequest) {
            ...
            let url = this.opts.baseUrl + "/chat/media/r0/upload";
     ...
     * "/chat/client/v2_alpha". If not specified, uses this.opts.prefix.
     *
     ...
     * occurred. This includes network problems and Chat-specific error JSON.
     */
...
/**
 * Construct a Chat error. This is a JavaScript Error with additional
 * information specific to the standard Chat error response.
 * @constructor
 * @param {Object} errorJson The Chat error JSON returned from the homeserver.
 * @prop {string} errcode The Chat 'errcode' value, e.g. "M_FORBIDDEN".
 * @prop {string} name Same as MatrixError.errcode but with a default unknown string.
 * @prop {string} message The Chat 'error' value, e.g. "Missing token."
 * @prop {Object} data The raw Chat error JSON used to construct this object.

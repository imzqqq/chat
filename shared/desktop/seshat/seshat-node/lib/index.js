 ...
 * Seshat database.<br>
 *
 * A Seshat database can be used to store and index Chat events. A full-text
...
class Seshat {
     ...
     *
     * @param  {matrixEvent} matrixEvent A Chat event that should be added to
     * the database.
     ...
     * of Chat events that contain mxc URLs.
     */

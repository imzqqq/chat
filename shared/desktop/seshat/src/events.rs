...
pub enum EventType {
    /// Chat room messages, corresponds to the m.room.message type, has a body
    /// inside of the content.
    #[serde(alias = "m.room.message", alias = "content.body")]
    Message,
    /// Chat room messages, corresponds to the m.room.name type, has a name
    /// inside of the content.
    #[serde(alias = "m.room.name", alias = "content.name")]
    Name,
    /// Chat room messages, corresponds to the m.room.topic type, has a topic
    /// inside of the content.
...
/// Chat event that can be added to the database.

...
class TimelineRepositoryTest {
    ...
    fun setup() {
        ...
        subject = TimelineRepositoryImpl(timelineDao, flowApi, accountManager, gson)
    }
    ...
    fun testNetworkUnbounded() {
        ...
        whenever(flowApi.homeTimeline(isNull(), isNull(), anyInt()))
    ...
    fun testNetworkLoadingTopNoGap() {
        ...
        whenever(flowApi.homeTimeline(null, sinceIdMinusOne, limit + 1))
    ...
    fun testNetworkLoadingMiddleNoGap() {
        ...
        val sinceIdMinusOne = "1"
        val maxId = "3"
        whenever(flowApi.homeTimeline(maxId, sinceIdMinusOne, limit + 1))
            .thenReturn(Single.just(Response.success(response)))
        val result = subject.getStatuses(
    ...
    fun addingFromDb() {
        ...
        whenever(flowApi.homeTimeline(any(), any(), any()))

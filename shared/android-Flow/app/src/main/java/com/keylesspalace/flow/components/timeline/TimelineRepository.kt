...
import com.keylesspalace.flow.components.timeline.TimelineRequestMode.DISK
import com.keylesspalace.flow.components.timeline.TimelineRequestMode.NETWORK
...
import com.keylesspalace.flow.util.trimTrailingWhitespace
...
class TimelineRepositoryImpl(
    ...
    private fun getStatusesFromNetwork(
        ...
        return flowApi.homeTimeline(maxId, sinceIdMinusOne, limit + 1)
            .map { response ->

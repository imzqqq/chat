package com.keylesspalace.flow.service
...
import com.keylesspalace.flow.appstore.StatusScheduledEvent
...
class SendTootService : Service(), Injectable {
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        if (intent.hasExtra(KEY_TOOT)) {
            ...
            val builder = NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setOngoing(true)
                .setColor(ContextCompat.getColor(this, R.color.flow_blue))
    ...
    private fun sendToot(tootId: Int) {
        ...
        val sendCall = flowApi.createStatus(
            ...
            override fun onResponse(call: Call<Status>, response: Response<Status>) {
                ...
                if (response.isSuccessful) {
                    ...
                    val builder = NotificationCompat.Builder(this@SendTootService, CHANNEL_ID)
                        ...
                        .setColor(ContextCompat.getColor(this@SendTootService, R.color.flow_blue))

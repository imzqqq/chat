...
import com.keylesspalace.flow.databinding.ActivityAboutBinding
import com.keylesspalace.flow.di.Injectable
import com.keylesspalace.flow.util.NoUnderlineURLSpan
...
class AboutActivity : BottomSheetActivity(), Injectable {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (BuildConfig.CUSTOM_INSTANCE.isBlank()) {
            binding.aboutPoweredByFlow.hide()
        }

        binding.aboutLicenseInfoTextView.setClickableTextWithoutUnderlines(R.string.about_flow_license)
        ...
        binding.flowProfileButton.setOnClickListener {

...
package com.keylesspalace.flow.components.report.adapter
...
import com.keylesspalace.flow.databinding.ItemReportStatusBinding
...
import com.keylesspalace.flow.util.StatusViewHelper
import com.keylesspalace.flow.util.StatusViewHelper.Companion.COLLAPSE_INPUT_FILTER
import com.keylesspalace.flow.util.StatusViewHelper.Companion.NO_INPUT_FILTER
...
import com.keylesspalace.flow.util.shouldTrimStatus
import com.keylesspalace.flow.util.show
import com.keylesspalace.flow.viewdata.toViewData

...
package com.keylesspalace.flow.components.compose.view;
...
public final class ProgressImageView extends AppCompatImageView {
    ...
    private void init() {
        circlePaint.setColor(ContextCompat.getColor(getContext(), R.color.flow_blue));
    ...
    public void setChecked(boolean checked) {
        this.markBgPaint.setColor(ContextCompat.getColor(getContext(),
                checked ? R.color.flow_blue : R.color.flow_grey_10));
        invalidate();
    }

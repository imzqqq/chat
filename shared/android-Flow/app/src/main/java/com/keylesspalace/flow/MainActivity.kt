...
import com.keylesspalace.flow.appstore.CacheUpdater
import com.keylesspalace.flow.appstore.Event
import com.keylesspalace.flow.appstore.EventHub
import com.keylesspalace.flow.appstore.MainTabsChangedEvent
...
import com.keylesspalace.flow.components.compose.ComposeActivity.Companion.canHandleMimeType
import com.keylesspalace.flow.components.conversation.ConversationsRepository
import com.keylesspalace.flow.components.drafts.DraftHelper
...
import com.keylesspalace.flow.databinding.ActivityMainBinding
import com.keylesspalace.flow.db.AccountEntity
import com.keylesspalace.flow.entity.Account
import com.keylesspalace.flow.interfaces.AccountSelectionListener
...
import com.keylesspalace.flow.pager.MainPagerAdapter
import com.keylesspalace.flow.settings.PrefKeys
import com.keylesspalace.flow.util.ThemeUtils
import com.keylesspalace.flow.util.deleteStaleCachedMedia
import com.keylesspalace.flow.util.emojify
import com.keylesspalace.flow.util.hide
import com.keylesspalace.flow.util.removeShortcut
import com.keylesspalace.flow.util.updateShortcut
...
class MainActivity : BottomSheetActivity(), ActionButtonActivity, HasAndroidInjector {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null) {
            ...
            if (canHandleMimeType(intent.type)) {
                // Sharing to Flow from an external app
                if (accountRequested) {
        ...
        Schedulers.io().scheduleDirect {
            ...
            deleteStaleCachedMedia(applicationContext.getExternalFilesDir("Flow"))
        }
    }
    ...
    private fun fetchAnnouncements() {
        flowApi.listAnnouncements(false)
            .observeOn(AndroidSchedulers.mainThread())
            .autoDispose(this, Lifecycle.Event.ON_DESTROY)
            .subscribe(
                { announcements ->

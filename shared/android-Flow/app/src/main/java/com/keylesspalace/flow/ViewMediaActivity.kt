...
import com.keylesspalace.flow.BuildConfig.APPLICATION_ID
import com.keylesspalace.flow.databinding.ActivityViewMediaBinding
import com.keylesspalace.flow.entity.Attachment
import com.keylesspalace.flow.fragment.ViewImageFragment
import com.keylesspalace.flow.pager.ImagePagerAdapter
import com.keylesspalace.flow.pager.SingleImagePagerAdapter
import com.keylesspalace.flow.util.getTemporaryMediaFilename
...
class ViewMediaActivity : BaseActivity(), ViewImageFragment.PhotoActionsListener {
    ...
    private fun shareMedia() {
        val directory = applicationContext.getExternalFilesDir("Flow")

...
import com.keylesspalace.flow.json.SpannedTypeAdapter
import com.keylesspalace.flow.network.InstanceSwitchAuthInterceptor
...
class NetworkModule {
    ...
    fun providesRetrofit(
        ...
        return Retrofit.Builder().baseUrl("https://" + FlowApi.PLACEHOLDER_DOMAIN)
            .client(httpClient)
    ...
    @Provides
    @Singleton
    fun providesApi(retrofit: Retrofit): FlowApi = retrofit.create()
}

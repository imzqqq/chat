...
import com.keylesspalace.flow.databinding.ActivityLoginBinding
import com.keylesspalace.flow.di.Injectable
import com.keylesspalace.flow.entity.AccessToken
import com.keylesspalace.flow.entity.AppCredentials
import com.keylesspalace.flow.network.FlowApi
import com.keylesspalace.flow.util.ThemeUtils
import com.keylesspalace.flow.util.getNonNullString
import com.keylesspalace.flow.util.rickRoll
import com.keylesspalace.flow.util.shouldRickRoll
...
class LoginActivity : BaseActivity(), Injectable {
    ...
    private fun onButtonClick() {
        ...
        flowApi
            .authenticateApp(
                ...
                OAUTH_SCOPES, getString(R.string.flow_website)
            )
            .enqueue(callback)
        setLoading(true)
    }
    ...
    private fun redirectUserToAuthorizeAndLogin(domain: String, clientId: String) {
        ...
        val endpoint = FlowApi.ENDPOINT_AUTHORIZE

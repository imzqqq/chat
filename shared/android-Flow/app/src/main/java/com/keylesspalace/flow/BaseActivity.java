...
import com.keylesspalace.flow.adapter.AccountSelectionAdapter;
...
import com.keylesspalace.flow.interfaces.PermissionRequester;
...
public abstract class BaseActivity extends AppCompatActivity implements Injectable {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (theme.equals("black")) {
            setTheme(R.style.FlowBlackTheme);
        }
    ...
    protected void attachBaseContext(Context base) {
        super.attachBaseContext(FlowApplication.getLocaleManager().setLocale(base));
    }

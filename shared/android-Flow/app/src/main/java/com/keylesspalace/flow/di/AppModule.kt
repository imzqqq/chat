...
import com.keylesspalace.flow.FlowApplication
import com.keylesspalace.flow.appstore.EventHub
import com.keylesspalace.flow.appstore.EventHubImpl
import com.keylesspalace.flow.components.notifications.Notifier
import com.keylesspalace.flow.components.notifications.SystemNotifier
import com.keylesspalace.flow.db.AppDatabase
import com.keylesspalace.flow.db.Converters
import com.keylesspalace.flow.network.FlowApi
import com.keylesspalace.flow.network.TimelineCases
import com.keylesspalace.flow.network.TimelineCasesImpl
...
class AppModule {
    ...
    @Provides
    fun providesApplication(app: FlowApplication): Application = app
    ...
    fun providesDatabase(appContext: Context, converters: Converters): AppDatabase {
        return Room.databaseBuilder(appContext, AppDatabase::class.java, "flowDB")
            ...
            .addMigrations(
                ...
                AppDatabase.Migration25_26(appContext.getExternalFilesDir("Flow"))
            )
            .build()
    }

...
package com.keylesspalace.flow.fragment;
...
import com.keylesspalace.flow.adapter.NotificationsAdapter;
import com.keylesspalace.flow.adapter.StatusBaseViewHolder;
...
import com.keylesspalace.flow.appstore.PreferenceChangedEvent;
...
import com.keylesspalace.flow.interfaces.ActionButtonActivity;
import com.keylesspalace.flow.interfaces.ReselectableFragment;
...
import com.keylesspalace.flow.util.HttpHeaderLink;
import com.keylesspalace.flow.util.ListStatusAccessibilityDelegate;
import com.keylesspalace.flow.util.ListUtils;
import com.keylesspalace.flow.util.NotificationTypeConverterKt;
import com.keylesspalace.flow.util.PairedList;
import com.keylesspalace.flow.util.StatusDisplayOptions;
import com.keylesspalace.flow.util.ViewDataUtils;
import com.keylesspalace.flow.view.BackgroundMessageView;
import com.keylesspalace.flow.view.EndlessOnScrollListener;
...
import static com.keylesspalace.flow.util.StringUtils.isLessThan;
...
public class NotificationsFragment extends SFragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        swipeRefreshLayout.setColorSchemeResources(R.color.flow_blue);
    ...
    public void onRespondToFollowRequest(boolean accept, String id, int position) {
        Single<Relationship> request = accept ?
                flowApi.authorizeFollowRequest(id) :
                flowApi.rejectFollowRequest(id);
    ...
    private void sendFetchNotificationsRequest(String fromId, String uptoId,
        ...
        Disposable notificationCall = flowApi.notifications(fromId, uptoId, LOAD_AT_ONCE, showNotificationsFilter ? notificationFilter : null)
                .observeOn(AndroidSchedulers.mainThread())
                .to(autoDisposable(from(this, Lifecycle.Event.ON_DESTROY)))
                .subscribe(
                        response -> {
    ...
    private final ListUpdateCallback listUpdateCallback = new ListUpdateCallback() {
        ...
        public void onInserted(int position, int count) {
            if (isAdded()) {
                ...
                // https://github.com/flowapp/Flow/pull/1905#issuecomment-677819724

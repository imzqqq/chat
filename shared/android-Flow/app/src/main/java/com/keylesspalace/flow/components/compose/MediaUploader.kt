...
import com.keylesspalace.flow.network.ProgressRequestBody
import com.keylesspalace.flow.util.MEDIA_SIZE_UNKNOWN
import com.keylesspalace.flow.util.getImageSquarePixels
import com.keylesspalace.flow.util.getMediaSize
...
fun createNewImageFile(context: Context): File {
    ...
    val imageFileName = "Flow_${randomId}_"
...
class MediaUploaderImpl(
    ...
    private fun upload(media: QueuedMedia): Observable<UploadEvent> {
        return Observable.create { emitter ->
            ...
            val uploadDisposable = flowApi.uploadMedia(body, description)
                .subscribe(
                    { attachment ->

...
package com.keylesspalace.flow.view

import android.app.Activity
import androidx.appcompat.app.AlertDialog
import com.keylesspalace.flow.R
import com.keylesspalace.flow.databinding.DialogMuteAccountBinding
...
fun showMuteAccountDialog(
    ...
    AlertDialog.Builder(activity)
        ...
        .setPositiveButton(android.R.string.ok) { _, _ ->
            ...
            // workaround to make indefinite muting work with Flow 3.3.0
            // https://github.com/flowapp/Flow/issues/2107

...
import com.keylesspalace.flow.adapter.AccountFieldAdapter
...
import com.keylesspalace.flow.databinding.ActivityAccountBinding
...
import com.keylesspalace.flow.pager.AccountPagerAdapter
import com.keylesspalace.flow.settings.PrefKeys
import com.keylesspalace.flow.util.DefaultTextWatcher
...
import com.keylesspalace.flow.view.showMuteAccountDialog
import com.keylesspalace.flow.viewmodel.AccountViewModel
...
class AccountActivity : BottomSheetActivity(), ActionButtonActivity, HasAndroidInjector, LinkListener {
    ...
    private fun setupRefreshLayout() {
        ...
        binding.swipeToRefreshLayout.setColorSchemeResources(R.color.flow_blue)
    }
    ...
    private fun onRelationshipChanged(relation: Relationship) {
        ...
        // it's also now supported in Flow 3.3.0rc but called notifying and use different API call

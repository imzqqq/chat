...
- Only API v2 is supported (see https://chat.docs.imzqqq.top/spec/identity_service/latest)
...
- API documentation: https://chat.docs.imzqqq.top/spec/identity_service/latest

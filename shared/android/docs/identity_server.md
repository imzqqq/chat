...
- Only API v2 is supported (see https://chat.docs.dingshunyu.top/spec/identity_service/latest)
...
- API documentation: https://chat.docs.dingshunyu.top/spec/identity_service/latest

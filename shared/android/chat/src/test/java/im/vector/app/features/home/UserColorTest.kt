...
class UserColorTest {
    ...
    @Test
    fun testName() {
        assertEquals(R.color.element_name_01, getColorFromUserId("@ganfra:chat.imzqqq.top"))
        assertEquals(R.color.element_name_04, getColorFromUserId("@benoit0816:chat.imzqqq.top"))
        assertEquals(R.color.element_name_05, getColorFromUserId("@hubert:uhoreg.ca"))
        assertEquals(R.color.element_name_07, getColorFromUserId("@nadonomy:chat.imzqqq.top"))
    }
}

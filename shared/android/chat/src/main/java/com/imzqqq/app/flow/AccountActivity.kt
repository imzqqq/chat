...
import com.imzqqq.app.databinding.ActivityAccountBinding
import com.imzqqq.app.flow.adapter.AccountFieldAdapter
...
import com.imzqqq.app.flow.pager.AccountPagerAdapter
import com.imzqqq.app.flow.settings.PrefKeys
import com.imzqqq.app.flow.util.DefaultTextWatcher
...
import com.imzqqq.app.flow.view.showMuteAccountDialog
...
@AndroidEntryPoint
class AccountActivity : BottomSheetActivity(), ActionButtonActivity, LinkListener {

    @Inject lateinit var flowViewModelFactory: VectorViewModelFactory

    private val viewModel: AccountViewModel by viewModels { flowViewModelFactory }
    ...
    private fun loadResources() {
        toolbarColor = com.imzqqq.app.flow.util.ThemeUtils.getColor(this, R.attr.colorSurface)
        statusBarColorTransparent = ContextCompat.getColor(this, R.color.transparent_statusbar_background)
        statusBarColorOpaque = com.imzqqq.app.flow.util.ThemeUtils.getColor(this, R.attr.colorPrimaryDark)
    ...
    private fun onAccountChanged(account: Account?) {
        ...
        com.imzqqq.app.flow.util.LinkHelper.setClickableText(binding.accountNoteTextView, emojifiedNote, null, this)
    ...
    private fun updateMovedAccount() {
        loadedAccount?.moved?.let { movedAccount ->
            ...
            val textColor = com.imzqqq.app.flow.util.ThemeUtils.getColor(this, android.R.attr.textColorTertiary)
        ...
        loadedAccount?.let { account ->
            if (account.isRemote()) {
                ...
                binding.accountRemoveView.setOnClickListener {
                    com.imzqqq.app.flow.util.LinkHelper.openLink(account.url, this)
                }
            }
        }
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        if (!viewModel.isSelf) {
            ...
            if (loadedAccount != null) {
                ...
                domain = com.imzqqq.app.flow.util.LinkHelper.getDomain(loadedAccount?.url)
                if (domain.isEmpty()) {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.action_open_in_web  -> {
                ...
                if (loadedAccount != null) {
                    com.imzqqq.app.flow.util.LinkHelper.openLink(loadedAccount?.url, this)
                }
                return true
            }
            R.id.action_block        -> {

...
import com.imzqqq.app.databinding.ActivityAboutBinding
import com.imzqqq.app.flow.util.NoUnderlineURLSpan
import com.imzqqq.app.flow.util.hide
import javax.inject.Inject

@AndroidEntryPoint
class AboutActivity @Inject constructor(): BottomSheetActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.versionTextView.text = getString(R.string.about_app_version, getString(R.string.app_flow_name), BuildConfig.VERSION_NAME)

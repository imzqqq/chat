...
import com.imzqqq.app.core.extensions.getMeasurements
import com.imzqqq.app.core.utils.PERMISSIONS_EMPTY
import com.imzqqq.app.core.utils.PERMISSIONS_FOR_PICKING_CONTACT
import com.imzqqq.app.core.utils.PERMISSIONS_FOR_TAKING_PHOTO
import com.imzqqq.app.databinding.ViewAttachmentTypeSelectorBinding
import com.imzqqq.app.features.attachments.AttachmentTypeSelectorView.Callback
...
class AttachmentTypeSelectorView(context: Context,
    ...
    fun show(anchor: View, isKeyboardOpen: Boolean) {
        ...
        /// MARK - imzqqq, TODO: only show panel at bottom
        if (isKeyboardOpen) {

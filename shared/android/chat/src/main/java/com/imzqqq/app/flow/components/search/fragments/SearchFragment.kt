...
import com.imzqqq.app.databinding.FragmentSearchFlowBinding
...
abstract class SearchFragment<T : Any> : Fragment(R.layout.fragment_search_flow),
        LinkListener, SwipeRefreshLayout.OnRefreshListener {

    @Inject lateinit var flowViewModelFactory: VectorViewModelFactory

    protected val viewModel: SearchViewModel by activityViewModels { flowViewModelFactory }
    lateinit var binding: FragmentSearchFlowBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentSearchFlowBinding.inflate(inflater, container, false)
        return binding.root
    }

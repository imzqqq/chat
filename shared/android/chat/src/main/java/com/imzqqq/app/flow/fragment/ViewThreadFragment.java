...
import com.imzqqq.app.flow.ViewThreadActivity;
...
import com.imzqqq.app.flow.view.ConversationLineItemDecoration;
...
public final class ViewThreadFragment extends SFragment implements
    ...
    @Inject public EventHub eventHub;
    @Inject public FilterModel filterModel;
    ...
    private void onThreadRequestFailure(final String id, final Throwable throwable) {
        ...
        if (view != null) {
            ...
            Timber.e(throwable, "Network request failed");
        }
    }
    ...
    private void reloadFilters() {
        mastodonApi.getFilters()
                ...
                .subscribe(
                        ...
                        (t) -> Timber.e(t, "Failed to load filters")
                );
    }

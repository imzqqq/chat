...
import com.imzqqq.app.core.extensions.setAttributeBackground
import com.imzqqq.app.core.extensions.setAttributeTintedBackground
...
import com.imzqqq.app.databinding.ViewVoiceMessageRecorderBinding
...
class VoiceMessageRecorderView : ConstraintLayout, VoiceMessagePlaybackTracker.Listener {
    ...
    private fun resetMicButtonUi() {
        ...
        // Also, Chat layout doesn't need any margin there, and doesn't enlarge the icon during recording, so no code needed here
        views.voiceMessageMicButton.updateLayoutParams<MarginLayoutParams> {
            if (rtlXMultiplier == -1) {
                // RTL

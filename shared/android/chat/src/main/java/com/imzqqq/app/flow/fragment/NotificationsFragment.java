...
import com.imzqqq.app.flow.adapter.NotificationsAdapter;
...
import com.imzqqq.app.flow.util.ListStatusAccessibilityDelegate;
import com.imzqqq.app.flow.util.ListUtils;
import com.imzqqq.app.flow.util.NotificationTypeConverterKt;
import com.imzqqq.app.flow.util.PairedList;
import com.imzqqq.app.flow.util.StatusDisplayOptions;
import com.imzqqq.app.flow.util.ViewDataUtils;
import com.imzqqq.app.flow.view.BackgroundMessageView;
...
import static com.imzqqq.app.flow.util.StringUtils.isLessThan;
...
public class NotificationsFragment extends SFragment implements
    ...
    public void onReblog(final boolean reblog, final int position) {
        ...
        timelineCases.reblog(status.getId(), reblog)
                ...
                .subscribe(
                        ...
                        (t) -> Timber.d(t, "Failed to reblog status: " + status.getId())
                );
    }
    ...
    public void onFavourite(final boolean favourite, final int position) {
        ...
        timelineCases.favourite(status.getId(), favourite)
                ...
                .subscribe(
                        ...
                        (t) -> Timber.d(t, "Failed to favourite status: " + status.getId())
                );
    }
    ...
    public void onBookmark(final boolean bookmark, final int position) {
        ...
        timelineCases.bookmark(status.getActionableId(), bookmark)
                ...
                .subscribe(
                        ...
                        (t) -> Timber.d(t, "Failed to bookmark status: " + status.getId())
                );
    }
    ...
    public void onVoteInPoll(int position, @NonNull List<Integer> choices) {
        ...
        timelineCases.voteInPoll(status.getId(), status.getPoll().getId(), choices)
                ...
                .subscribe(
                        ...
                        (t) -> Timber.d(t, "Failed to vote in poll: " + status.getId())
                );
    }
    ...
    public void onRespondToFollowRequest(boolean accept, String id, int position) {
        ...
        request.observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(
                        ...
                        (error) -> Timber.e(String.format("Failed to %s account id %s", accept ? "accept" : "reject", id))
                );
    }
    ...
    public void onViewStatusForNotificationId(String notificationId) {
        ...
        Timber.tag(TAG).w("Didn't find a notification for ID: " + notificationId);
    }
    ...
    private void onFetchNotificationsFailure(Throwable throwable, FetchEnd fetchEnd, int position) {
        ...
        Timber.e("Fetch failure: " + throwable.getMessage());
    ...
    private void saveNewestNotificationId(List<Notification> notifications) {
        ...
        if (account != null) {
            ...
            if (!account.getLastNotificationId().equals(lastNotificationId)) {
                Timber.d("saving newest noti id: " + lastNotificationId);

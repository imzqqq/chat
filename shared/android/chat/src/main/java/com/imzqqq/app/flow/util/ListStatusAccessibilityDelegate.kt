...
import com.imzqqq.app.flow.entity.Status.Companion.MAX_MEDIA_ATTACHMENTS
...
class ListStatusAccessibilityDelegate(
        ...
        private val statusActionListener: com.imzqqq.app.flow.interfaces.StatusActionListener,
    ...
    private val itemDelegate = object : RecyclerViewAccessibilityDelegate.ItemDelegate(this) {
        ...
        override fun performAccessibilityAction(
            ...
            when (action) {
                ...
                R.id.action_expand_cw -> {
                    ...
                    val holder = recyclerView.getChildViewHolder(host) as com.imzqqq.app.flow.adapter.StatusBaseViewHolder
        ...
        private fun showLinksDialog(host: View) {
            ...
            AlertDialog.Builder(host.context)
                ...
                ) { _, which -> com.imzqqq.app.flow.util.LinkHelper.openLink(links[which].link, host.context) }
                .show()

...
import com.imzqqq.app.flow.view.MediaPreviewImageView
import com.imzqqq.app.flow.viewdata.PollViewData
...
class StatusViewHelper(private val itemView: View) {
    ...
    fun setMediasPreview(
        ...
        val mediaPreviewUnloaded = ColorDrawable(com.imzqqq.app.flow.util.ThemeUtils.getColor(context, R.attr.colorBackgroundAccent))
    ...
    private fun getPollInfoText(timestamp: Long, poll: PollViewData, pollDescription: TextView, useAbsoluteTime: Boolean): CharSequence {
        ...
        val pollDurationInfo = if (poll.expired) {
            ...
            if (useAbsoluteTime) {
                ...
                com.imzqqq.app.flow.util.TimestampUtils.formatPollDuration(context, poll.expiresAt!!.time, timestamp)
            }
        }

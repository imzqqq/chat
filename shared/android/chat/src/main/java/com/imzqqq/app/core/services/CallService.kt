...
import com.imzqqq.app.features.call.CallArgs
import com.imzqqq.app.features.call.VectorCallActivity
import com.imzqqq.app.features.call.telecom.CallConnection
import com.imzqqq.app.features.call.webrtc.WebRtcCall
import com.imzqqq.app.features.call.webrtc.WebRtcCallManager
import com.imzqqq.app.features.call.webrtc.getOpponentAsMatrixItem
...
import com.imzqqq.app.features.popup.IncomingCallAlert
...
class CallService : VectorService() {
    ...
    companion object {
        ...
        private const val ACTION_INCOMING_RINGING_CALL = "com.imzqqq.app.core.services.CallService.ACTION_INCOMING_RINGING_CALL"
        private const val ACTION_OUTGOING_RINGING_CALL = "com.imzqqq.app.core.services.CallService.ACTION_OUTGOING_RINGING_CALL"
        private const val ACTION_CALL_CONNECTING = "com.imzqqq.app.core.services.CallService.ACTION_CALL_CONNECTING"
        private const val ACTION_ONGOING_CALL = "com.imzqqq.app.core.services.CallService.ACTION_ONGOING_CALL"
        private const val ACTION_CALL_TERMINATED = "com.imzqqq.app.core.services.CallService.ACTION_CALL_TERMINATED"
        private const val ACTION_NO_ACTIVE_CALL = "com.imzqqq.app.core.services.CallService.NO_ACTIVE_CALL"
//        private const val ACTION_ACTIVITY_VISIBLE = "com.imzqqq.app.core.services.CallService.ACTION_ACTIVITY_VISIBLE"
//        private const val ACTION_STOP_RINGING = "com.imzqqq.app.core.services.CallService.ACTION_STOP_RINGING"

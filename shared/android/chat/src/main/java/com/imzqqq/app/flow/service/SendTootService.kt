...
import com.imzqqq.app.flow.entity.NewStatus
...
class SendTootService : Service() {
    ...
    private fun cancelSendingIntent(tootId: Int): PendingIntent {
        ...
        return PendingIntent.getService(this, tootId, intent, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntentCompat.FLAG_IMMUTABLE)
        ///
    }

...
import com.imzqqq.app.core.extensions.getAllChildFragments
import com.imzqqq.app.core.extensions.toOnOff
...
import com.imzqqq.app.features.settings.devtools.GossipingEventsSerializer
import com.imzqqq.app.features.settings.locale.SystemLocaleProvider
            ...
            withContext(Dispatchers.IO) {
                ...
                if (!mIsCancelled) {
                    ...
                    val builder = BugReporterMultipartBody.Builder()
                            ...
                            .addFormDataPart("app", "chat-android")
                    ...
                    // Special for Element
                    //builder.addFormDataPart("label", "[Chat]")

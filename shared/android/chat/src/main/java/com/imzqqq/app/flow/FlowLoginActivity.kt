...
import com.imzqqq.app.databinding.ActivityLoginFlowBinding
import com.imzqqq.app.flow.entity.AccessToken
import com.imzqqq.app.flow.entity.AppCredentials
...
import com.imzqqq.app.flow.util.rickRoll
import com.imzqqq.app.flow.util.shouldRickRoll
...
class FlowLoginActivity : BaseActivity() {
    ...
    private fun onButtonClick() {
        ...
        mastodonApi
            .authenticateApp(
                domain, getString(R.string.app_flow_name), oauthRedirectUri,
                ...
                val callback = object : Callback<AccessToken> {
                    override fun onResponse(call: Call<AccessToken>, response: Response<AccessToken>) {
                        if (response.isSuccessful) {
                            ...
                            Timber.e("%s %s".format(getString(R.string.error_retrieving_oauth_token), response.message()))
                        }
                    }
                    ...
                    override fun onFailure(call: Call<AccessToken>, t: Throwable) {
                        setLoading(false)
                        binding.domainTextInputLayout.error = getString(R.string.error_retrieving_oauth_token)
                        Timber.e("%s %s".format(getString(R.string.error_retrieving_oauth_token), t.message))
                    }
                }
    ...
    companion object {
        ...
        fun getIntent(context: Context, mode: Boolean): Intent {
            val loginIntent = Intent(context, FlowLoginActivity::class.java)
        ...
        private fun openInCustomTab(uri: Uri, context: Context): Boolean {
            ...
            try {
                ...
                Timber.tag(TAG).w("Activity was not found for intent $customTabsIntent")
                return false
            }

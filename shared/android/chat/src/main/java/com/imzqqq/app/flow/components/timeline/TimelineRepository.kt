...
import com.imzqqq.app.flow.components.timeline.TimelineRequestMode.DISK
import com.imzqqq.app.flow.components.timeline.TimelineRequestMode.NETWORK
import com.imzqqq.app.flow.db.AccountManager
import com.imzqqq.app.flow.db.TimelineAccountEntity
import com.imzqqq.app.flow.db.TimelineDao
import com.imzqqq.app.flow.db.TimelineStatusEntity
import com.imzqqq.app.flow.db.TimelineStatusWithAccount
...
class TimelineRepositoryImpl(
    ...
    private fun TimelineStatusWithAccount.toStatus(): TimelineStatus {
        if (this.status.authorServerId == null) {
            return com.imzqqq.app.flow.util.Either.Left(Placeholder(this.status.serverId))
        }
        ...
        val poll: Poll? = gson.fromJson(status.poll, com.imzqqq.app.flow.entity.Poll::class.java)
        ...
        return com.imzqqq.app.flow.util.Either.Right(status)
    }
}
...
fun TimelineAccountEntity.toAccount(gson: Gson): Account {
    return Account(
        ...
        source = null,
        bot = bot,
        emojis = gson.fromJson(this.emojis, com.imzqqq.app.flow.components.timeline.emojisListTypeToken.type),
        fields = null,
        moved = null
    )
}
...
fun Status.lift(): Either<Placeholder, Status> = com.imzqqq.app.flow.util.Either.Right(this)

...
import com.imzqqq.app.BuildConfig.APPLICATION_ID
import com.imzqqq.app.R
import com.imzqqq.app.databinding.ActivityListsBinding
import com.imzqqq.app.databinding.ActivityViewMediaBinding
import com.imzqqq.app.flow.entity.Attachment
import com.imzqqq.app.flow.fragment.ViewImageFragment
import com.imzqqq.app.flow.pager.ImagePagerAdapter
import com.imzqqq.app.flow.pager.SingleImagePagerAdapter
import com.imzqqq.app.flow.util.getTemporaryMediaFilename
...
class ViewMediaActivity : BaseActivity(), ViewImageFragment.PhotoActionsListener {
    ...
    private fun downloadMedia() {
        ...
        request.setDestinationInExternalPublicDir(
            ...
            getString(R.string.app_flow_name) + "/" + filename
        )
    ...
    private fun shareMedia() {
        val directory = applicationContext.getExternalFilesDir("downloads")

...
internal class DefaultImageLoaderTarget(
    val holder: AnimatedImageViewHolder, private val contextView: ImageView
) : ImageLoaderTarget {
    ...
    internal class ZoomableImageTarget(
        val holder: ZoomableImageViewHolder, private val contextView: ImageView
    ) : ImageLoaderTarget {

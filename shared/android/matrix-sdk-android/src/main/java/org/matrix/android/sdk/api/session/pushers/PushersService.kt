...
interface PushersService {
    ...
    data class HttpPusher(
            ...
            /**
             * The URL to use to send notifications to. MUST be an HTTPS URL with a path of /chat/push/v1/notify.
             */
            val url: String,
             ...
             * Ref: https://chat.docs.dingshunyu.top/spec/push_gateway/r0.1.1#homeserver-behaviour
             */

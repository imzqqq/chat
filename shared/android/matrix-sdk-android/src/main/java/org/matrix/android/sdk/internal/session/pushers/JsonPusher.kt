 ...
 *              "lang": "en-US",
 *              "data": {
 *              "url": "https://example.com/chat/push/v1/notify"
 *          }
 *      }]
 *  }
 * </code>
...
internal data class JsonPusher(
    ...
    init {
        ...
        data?.url?.let { url -> if ("/chat/push/v1/notify" !in url) throw InvalidParameterException("url should contain '/chat/push/v1/notify'") }
    }
}

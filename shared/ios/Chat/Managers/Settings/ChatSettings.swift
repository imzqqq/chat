...
/// Store Chat specific app settings.
@objcMembers
final class ChatSettings: NSObject {
    ...
    static var defaults: UserDefaults = {
        guard let userDefaults = UserDefaults(suiteName: BuildSettings.applicationGroupIdentifier) else {
            fatalError("[ChatSettings] Fail to load shared UserDefaults")
        }
        return userDefaults
    }()
    ...
    var isUserDefaultsMigrated: Bool {
        return ChatSettings.defaults.object(forKey: UserDefaultsKeys.notificationsShowDecryptedContent) != nil
    }
    ...
    func migrate() {
        ...
        for (key, value) in dictionary {
            ChatSettings.defaults.set(value, forKey: key)
    ...
    var isEnableCrashReportHasBeenSetOnce: Bool {
        return ChatSettings.defaults.object(forKey: UserDefaultsKeys.enableCrashReport) != nil
    }
    ...
    var isAllowStunServerFallbackHasBeenSetOnce: Bool {
        return ChatSettings.defaults.object(forKey: UserDefaultsKeys.allowStunServerFallback) != nil
    }

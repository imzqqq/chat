...
class ChatSharedSettings: NSObject {
    ...
    func getIntegrationProvisioning() -> ChatSettingIntegrationProvisioning? {
    ...
    func setIntegrationProvisioning(enabled: Bool,
        ...
        integrationProvisioningDict[ChatSettingIntegrationProvisioning.CodingKeys.enabled.rawValue] = enabled
    ...
    func getAllowedWidgets() -> ChatSettingAllowedWidgets? {
    ...
    func setPermission(_ permission: WidgetPermission,
        ...
        allowedWidgetsDict[ChatSettingAllowedWidgets.CodingKeys.widgets.rawValue] = widgets
    ...
    func setPermission(_ permission: WidgetPermission,
        ...
        var allowedWidgetsDict = getAccountData(forEventType: Settings.allowedWidgets) ?? [:]
        allowedWidgetsDict[ChatSettingAllowedWidgets.CodingKeys.nativeWidgets.rawValue] = nativeWidgets

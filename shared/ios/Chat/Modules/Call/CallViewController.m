        ...
        [currentAlert addAction:[UIAlertAction actionWithTitle:[VectorL10n unknownDevicesVerify]
                                                       ...
                                                       handler:^(UIAlertAction * action) {
                                                           ...
                                                           if (weakSelf)
                                                           {
                                                               ...
                                                               UINavigationController *usersDevicesNavigationController = [[ChatNavigationController alloc] init];
                                                               
                                                               // Set Chat navigation bar colors
...
- (void)checkStunServerFallbackWithCallState:(MXCallState)callState
{
    ...
    if (!self.mainSession.callManager.turnServers
        ...
        && !ChatSettings.shared.isAllowStunServerFallbackHasBeenSetOnce)
    {
        switch (callState)
        {
...
- (void)openCallTransfer
{
    ...
    UINavigationController *navController = [[ChatNavigationController alloc] initWithRootViewController:controller];

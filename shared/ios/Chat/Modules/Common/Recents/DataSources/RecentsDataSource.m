...
- (MXKSessionRecentsDataSource *)addMatrixSession:(MXSession *)mxSession
{
    ...
    if (!_publicRoomsDirectoryDataSource)
    {
        ...
        _publicRoomsDirectoryDataSource.showNSFWRooms = ChatSettings.shared.showNSFWPublicRooms;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        static NSString* cellIdentifier = @"ChatRecentsMovingCell";
        
        UITableViewCell* cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"ChatRecentsMovingCell"];

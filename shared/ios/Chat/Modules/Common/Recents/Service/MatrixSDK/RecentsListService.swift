...
public class RecentsListService: NSObject, RecentsListServiceProtocol {
    ...
    private var showAllRoomsInHomeSpace: Bool {
        return ChatSettings.shared.showAllRoomsInHomeSpace
    }
    ...
    private var sortOptions: MXRoomListDataSortOptions {
        switch mode {
        case .home:
            let pinMissed = ChatSettings.shared.pinRoomsWithMissedNotificationsOnHome
            let pinUnread = ChatSettings.shared.pinRoomsWithUnreadMessagesOnHome
    ...
    //  MARK: - Chat Settings Observer
    
    private func addChatSettingsObserver() {
    ...
    private func removeChatSettingsObserver() {
    ...
    private func userDefaultsUpdated(_ notification: Notification) {
        ...
        switch key {
        case ChatSettings.UserDefaultsKeys.pinRoomsWithMissedNotificationsOnHome,
             ChatSettings.UserDefaultsKeys.pinRoomsWithUnreadMessagesOnHome:
            refresh()
        case ChatSettings.UserDefaultsKeys.showAllRoomsInHomeSpace:
            refresh()
        default:
            break
        }

...
- (void)viewDidLoad
{
    ...
    // Add the Chat background image when search bar is empty
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    // TODO: Notify ChatSettings.shared.showNSFWPublicRooms change for iPad as viewWillAppear may not be called
    recentsDataSource.publicRoomsDirectoryDataSource.showNSFWRooms = ChatSettings.shared.showNSFWPublicRooms;

...
- (void)updateSections
{
    ...
    if (ChatSettings.shared.settingsScreenShowChangePassword)
    {
    ...
    if (ChatSettings.shared.settingsScreenShowNotificationDecodedContentOption)
    {
    ...
    if (BuildSettings.allowVoIPUsage && BuildSettings.stunServerFallbackUrlString && ChatSettings.shared.settingsScreenShowEnableStunServerFallback)
    {
    ...
    if (ChatSettings.shared.matrixApps)
    {
    ...
    if (ChatSettings.shared.settingsScreenShowNsfwRoomsOption)
    {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (section == SECTION_TAG_SENDING_MEDIA)
    {
        if (row == SENDING_MEDIA_CONFIRM_SIZE)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on =  ChatSettings.shared.showMediaCompressionPrompt;
    ...
    else if (section == SECTION_TAG_LINKS)
    {
        if (row == LINKS_SHOW_URL_PREVIEWS_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = ChatSettings.shared.roomScreenShowsURLPreviews;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
    ...
    else if (section == SECTION_TAG_NOTIFICATIONS)
    {
        ...
        else if (row == NOTIFICATION_SETTINGS_SHOW_DECODED_CONTENT)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = ChatSettings.shared.showDecryptedContentInNotifications;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
        ...
        else if (row == NOTIFICATION_SETTINGS_PIN_MISSED_NOTIFICATIONS_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = ChatSettings.shared.pinRoomsWithMissedNotificationsOnHome;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
        ...
        else if (row == NOTIFICATION_SETTINGS_PIN_UNREAD_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = ChatSettings.shared.pinRoomsWithUnreadMessagesOnHome;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
    ...
    else if (section == SECTION_TAG_CALLS)
    {
        if (row == CALLS_ENABLE_STUN_SERVER_FALLBACK_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = ChatSettings.shared.allowStunServerFallback;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
    ...
    else if (section == SECTION_TAG_INTEGRATIONS)
    {
        switch (row) {
            ...
            {
                ChatSharedSettings *sharedSettings = [[ChatSharedSettings alloc] initWithSession:session];
    ...
    else if (section == SECTION_TAG_USER_INTERFACE)
    {
        ...
        else if (row == USER_INTERFACE_THEME_INDEX)
        {
            ...
            NSString *theme = ChatSettings.shared.userInterfaceTheme;
    ...
    else if (section == SECTION_TAG_ADVANCED)
    {
        if (row == ADVANCED_SHOW_NSFW_ROOMS_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = ChatSettings.shared.showNSFWPublicRooms;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
            labelAndSwitchCell.mxkSwitch.enabled = YES;
        ...
        else if (row == ADVANCED_CRASH_REPORT_INDEX)
        {
            ...
            sendCrashReportCell.mxkSwitch.on = ChatSettings.shared.enableCrashReport;
        ...
        else if (row == ADVANCED_ENABLE_RAGESHAKE_INDEX)
        {
            ...
            enableRageShakeCell.mxkSwitch.on = ChatSettings.shared.enableRageShake;
    ...
    else if (section == SECTION_TAG_LABS)
    {
        if (row == LABS_ENABLE_RINGING_FOR_GROUP_CALLS_INDEX)
        {
            ...
            labelAndSwitchCell.mxkSwitch.on = ChatSettings.shared.enableRingingForGroupCalls;
            labelAndSwitchCell.mxkSwitch.onTintColor = ThemeService.shared.theme.tintColor;
...
{
    ChatSettings.shared.showMediaCompressionPrompt = sender.on;
}
...
{
    ChatSettings.shared.allowStunServerFallback = sender.isOn;

    self.mainSession.callManager.fallbackSTUNServer = ChatSettings.shared.allowStunServerFallback ? BuildSettings.stunServerFallbackUrlString : nil;
}
...
- (void)toggleAllowIntegrations:(UISwitch *)sender
{
    ...
    __block ChatSharedSettings *sharedSettings = [[ChatSharedSettings alloc] initWithSession:session];
...
{
    ChatSettings.shared.showDecryptedContentInNotifications = sender.isOn;
}
...
{
    ChatSettings.shared.roomScreenShowsURLPreviews = sender.on;
...
{
    BOOL enable = ChatSettings.shared.enableCrashReport;
    if (enable)
    {
        MXLogDebug(@"[SettingsViewController] disable automatic crash report and analytics sending");
        
        ChatSettings.shared.enableCrashReport = NO;
    ...
    else
    {
        ...
        ChatSettings.shared.enableCrashReport = YES;
...
{
    ChatSettings.shared.enableRageShake = sender.isOn;
...
{
    ChatSettings.shared.enableRingingForGroupCalls = sender.isOn;
}

- (void)togglePinRoomsWithMissedNotif:(UISwitch *)sender
{
    ChatSettings.shared.pinRoomsWithMissedNotificationsOnHome = sender.isOn;
}

- (void)togglePinRoomsWithUnread:(UISwitch *)sender
{
    ChatSettings.shared.pinRoomsWithUnreadMessagesOnHome = sender.on;
}
...
- (void)showThemePicker
{
    ...
    void (^actionBlock)(UIAlertAction *action) = ^(UIAlertAction * action) {
        ...
        if (weakSelf)
        {
            ...
            {
                // Clear fake Chat Avatars based on the previous theme.
                [AvatarGenerator clear];

                // The user wants to select this theme
                ChatSettings.shared.userInterfaceTheme = newTheme;
...
- (void)deactivateAccountAction
{
    ...
    UINavigationController *navigationController = [[ChatNavigationController alloc] initWithRootViewController:deactivateAccountViewController];
...
{
    ChatSettings.shared.showNSFWPublicRooms = sender.isOn;
}
                       ...
                       checkingAccessForContactsOnAccept:(BOOL)checkAccessForContacts
{
    ...
    [session prepareIdentityServiceForTermsWithDefault:ChatSettings.shared.identityServerUrlString

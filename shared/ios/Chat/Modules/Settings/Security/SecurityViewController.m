...
- (void)updateSections
{
    ...
    if (ChatSettings.shared.settingsSecurityScreenShowSessions)
    {
    ...
    if (ChatSettings.shared.settingsSecurityScreenShowCryptographyInfo)
    {
        [cryptograhpySection addRowWithTag:CRYPTOGRAPHY_INFO];
    }
    
    if (ChatSettings.shared.settingsSecurityScreenShowCryptographyExport)
    {
    ...
    if (ChatSettings.shared.settingsSecurityScreenShowAdvancedUnverifiedDevices)
    {

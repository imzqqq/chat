...
class VersionCheckCoordinator: Coordinator, VersionCheckBannerViewDelegate, VersionCheckAlertViewControllerDelegate {
    ...
    func start() {
        ...
        let versionCheckNextDisplayDateTimeInterval = ChatSettings.shared.versionCheckNextDisplayDateTimeInterval
    ...
    private func dismissVersionCheckBanner() {
        ...
        ChatSettings.shared.versionCheckNextDisplayDateTimeInterval = nextDisplayDate?.timeIntervalSince1970 ?? 0.0
    }

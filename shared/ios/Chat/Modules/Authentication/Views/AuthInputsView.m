...
{
    // Take some shortcuts and make some assumptions (Chat uses MXFileStore and MXRealmCryptoStore) to
...
- (IBAction)selectPhoneNumberCountry:(id)sender
{
    if ([self.delegate respondsToSelector:@selector(authInputsView:presentViewController:animated:)])
    {
        ...
        phoneNumberPickerNavigationController = [[ChatNavigationController alloc] init];

...
final class JitsiService: NSObject {
    ...
    private func createJitsiWidgetContent(serverDomain: String,
        ...
        // Build widget url
        // Chat-iOS does not directly use it but extracts params from it (see `[JitsiViewController openWidget:withVideo:]`)
        // This url can be used as is inside a web container (like iframe for Chat-web)

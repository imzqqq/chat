...
- (void)updateSections
{
    ...
    if (ChatSettings.shared.roomSettingsScreenShowDirectChatOption)
    {
    ...
    if (ChatSettings.shared.roomSettingsScreenAllowChangingAccessSettings)
    {
    ...
    if (ChatSettings.shared.roomSettingsScreenAllowChangingHistorySettings)
    {
    ...
    if (ChatSettings.shared.roomSettingsScreenShowAddressSettings)
    {
    ...
    if (ChatSettings.shared.roomSettingsScreenShowFlairSettings)
    {
    ...
    if (ChatSettings.shared.roomSettingsScreenShowAdvancedSettings)
    {
        ...
        if (mxRoom.mxSession.crypto)
        {
            ...
            {
                if (ChatSettings.shared.roomSettingsScreenAdvancedShowEncryptToVerifiedOption)
                {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (section == SECTION_TAG_MAIN)
    {
        ...
        {
            if (ChatSettings.shared.roomSettingsScreenShowLowPriorityOption)
            {

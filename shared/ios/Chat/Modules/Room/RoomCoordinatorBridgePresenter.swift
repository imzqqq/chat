...
final class RoomCoordinatorBridgePresenter: NSObject {
    ...
    private func createRoomCoordinator(with navigationRouter: NavigationRouterType = NavigationRouter(navigationController: ChatNavigationController())) -> RoomCoordinator {

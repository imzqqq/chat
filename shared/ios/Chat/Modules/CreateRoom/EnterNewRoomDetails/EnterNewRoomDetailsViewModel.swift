...
final class EnterNewRoomDetailsViewModel: EnterNewRoomDetailsViewModelType {
    ...
    init(session: MXSession) {
        ...
        roomCreationParameters.isEncrypted = session.vc_homeserverConfiguration().isE2EEByDefaultEnabled &&  ChatSettings.shared.roomCreationScreenRoomIsEncrypted
        roomCreationParameters.isPublic = ChatSettings.shared.roomCreationScreenRoomIsPublic
        viewState = .loaded
    }

...
NSString *const kMXKRoomBubbleCellChatEditButtonPressed = @"kMXKRoomBubbleCellChatEditButtonPressed";
...
@implementation MXKRoomBubbleTableViewCell (Chat)
                             ...
                             displayOnLeft:(BOOL)displayOnLeft
{
    ...
    {
        MXLogDebug(@"[MXKRoomBubbleTableViewCell+Chat] bubbleInfoContainer property is missing for cell class: %@", NSStringFromClass(self.class));
        return;
    }
...
- (IBAction)onEditButtonPressed:(id)sender
{
    if (self.delegate)
    {
        ...
        if (selectedEvent)
        {
            [self.delegate cell:self didRecognizeAction:kMXKRoomBubbleCellChatEditButtonPressed userInfo:@{kMXKRoomBubbleCellEventKey:selectedEvent}];
        }
    }
}

 ...
 */
extern NSString *const kMXKRoomBubbleCellChatEditButtonPressed;
...
/**
 Define a `MXKRoomBubbleTableViewCell` category at Chat level to handle bubble customisation.
 */
@interface MXKRoomBubbleTableViewCell (Chat)

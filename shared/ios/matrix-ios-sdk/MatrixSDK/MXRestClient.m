 ...
 */
NSString *const kMXAPIPrefixPathR0 = @"chat/client/r0";
NSString *const kMXAPIPrefixPathUnstable = @"chat/client/unstable";
                        ...
                        failure:(void (^)(NSError *error))failure
{
    ...
    NSString *path = @"chat/client/versions";
...
- (NSString*)registerFallback;
{
    ...
    {
        registerFallback = [[NSURL URLWithString:@"chat/static/client/register/" relativeToURL:[NSURL URLWithString:self.credentials.homeServer]] absoluteString];
    }
...
- (NSString*)loginFallback;
{
    ...
    if (self.credentials.homeServer)
    {
        loginFallback = [[NSURL URLWithString:@"/chat/static/client/login/" relativeToURL:[NSURL URLWithString:self.credentials.homeServer]] absoluteString];
    }

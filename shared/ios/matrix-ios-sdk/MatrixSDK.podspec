Pod::Spec.new do |s|
  ...
  s.name         = "MatrixSDK"
  s.version      = "0.20.10"
  s.summary      = "The iOS SDK to build apps compatible with Chat server"

  s.description  = <<-DESC
				   Chat is a new open standard for interoperable Instant Messaging and VoIP, providing pragmatic HTTP APIs and open source reference implementations for creating and running your own real-time communication infrastructure.

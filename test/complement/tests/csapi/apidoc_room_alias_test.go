...
func TestRoomAlias(t *testing.T) {
	...
	t.Run("Parallel", func(t *testing.T) {
		...
		t.Run("PUT /directory/room/:room_alias creates alias", func(t *testing.T) {
			...
			_ = authedClient.MustDoFunc(t, "PUT", []string{"chat", "client", "r0", "directory", "room", roomAlias}, reqBody)

			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "directory", "room", roomAlias})
		...
		t.Run("GET /rooms/:room_id/aliases lists aliases", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "rooms", roomID, "aliases"})

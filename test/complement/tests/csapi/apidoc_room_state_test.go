...
func TestRoomState(t *testing.T) {
	...
	t.Run("Parallel", func(t *testing.T) {
		...
		t.Run("GET /rooms/:room_id/state/m.room.member/:user_id fetches my membership", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "rooms", roomID, "state", "m.room.member", authedClient.UserID})
		...
		t.Run("GET /rooms/:room_id/state/m.room.member/:user_id?format=event fetches my membership event", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "rooms", roomID, "state", "m.room.member", authedClient.UserID}, client.WithQueries(queryParams))
			must.MatchResponse(t, res, match.HTTPResponse{
				JSON: []match.JSON{
		...
		t.Run("GET /rooms/:room_id/state/m.room.power_levels fetches powerlevels", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "rooms", roomID, "state", "m.room.power_levels"})
		...
		t.Run("GET /rooms/:room_id/joined_members fetches my membership", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "rooms", roomID, "joined_members"})
			must.MatchResponse(t, res, match.HTTPResponse{
				JSON: []match.JSON{
		...
		t.Run("GET /publicRooms lists newly-created room", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "publicRooms"})
			foundRoom := false
		...
		t.Run("GET /directory/room/:room_alias yields room ID", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "directory", "room", "#room_new:hs1"})
		...
		t.Run("GET /joined_rooms lists newly-created room", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "joined_rooms"})
		...
		t.Run("GET /rooms/:room_id/state/m.room.name gets name", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "rooms", roomID, "state", "m.room.name"})
		...
		t.Run("POST /rooms/:room_id/state/m.room.name sets name", func(t *testing.T) {
			...
			_ = authedClient.MustDoFunc(t, "PUT", []string{"chat", "client", "r0", "rooms", roomID, "state", "m.room.name"}, reqBody)
		...
		t.Run("GET /rooms/:room_id/state/m.room.topic gets topic", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "rooms", roomID, "state", "m.room.topic"})
		...
		t.Run("PUT /rooms/:room_id/state/m.room.topic sets topic", func(t *testing.T) {
			...
			_ = authedClient.MustDoFunc(t, "PUT", []string{"chat", "client", "r0", "rooms", roomID, "state", "m.room.topic"}, reqBody)
		...
		t.Run("GET /rooms/:room_id/state fetches entire room state", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "rooms", roomID, "state"})
		...
		t.Run("PUT /createRoom with creation content", func(t *testing.T) {
			...
			res := authedClient.MustDoFunc(t, "GET", []string{"chat", "client", "r0", "rooms", roomID, "state", "m.room.create"})

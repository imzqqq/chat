...
func TestJoinViaRoomIDAndServerName(t *testing.T) {
	...
	srv.Mux().Handle("/chat/federation/v1/make_join/{roomID}/{userID}", http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
	...
	srv.Mux().Handle("/chat/federation/v2/send_join/{roomID}/{eventID}", http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
		if !acceptMakeSendJoinRequests {
			w.WriteHeader(502)
			return
		}
	...
	res := bob.DoFunc(t, "POST", []string{"chat", "client", "r0", "join", serverRoom.RoomID}, client.WithQueries(queryParams))
...
func TestBannedUserCannotSendJoin(t *testing.T) {
	...
	res := alice.MustDoFunc(
		t,
		"GET",
		[]string{"chat", "client", "r0", "rooms", roomID, "state", "m.room.member", charlie},
	)
...
func TestCannotSendNonJoinViaSendJoinV1(t *testing.T) {
	testValidationForSendMembershipEndpoint(t, "/chat/federation/v1/send_join", "join", nil)
}
...
func TestCannotSendNonJoinViaSendJoinV2(t *testing.T) {
	testValidationForSendMembershipEndpoint(t, "/chat/federation/v2/send_join", "join", nil)
}
...
func TestCannotSendNonLeaveViaSendLeaveV1(t *testing.T) {
	testValidationForSendMembershipEndpoint(t, "/chat/federation/v1/send_leave", "leave", nil)
}
...
func TestCannotSendNonLeaveViaSendLeaveV2(t *testing.T) {
	testValidationForSendMembershipEndpoint(t, "/chat/federation/v2/send_leave", "leave", nil)
}

...
func TestClientSpacesSummary(t *testing.T) {
	...
	t.Run("query whole graph", func(t *testing.T) {
		res := alice.MustDo(t, "GET", []string{"chat", "client", "unstable", "org.matrix.msc2946", "rooms", root, "spaces"}, nil)
		...
		res = alice.MustDo(t, "GET", []string{"chat", "client", "unstable", "org.matrix.msc2946", "rooms", root, "hierarchy"}, nil)
		must.MatchResponse(t, res, match.HTTPResponse{
			JSON: []match.JSON{
				match.JSONCheckOff("rooms", []interface{}{
					root, r1, r2, r3, r4, ss1, ss2,
	...
	t.Run("max_rooms_per_space", func(t *testing.T) {
		...
		res := alice.MustDoFunc(
			t,
			"GET",
			[]string{"chat", "client", "unstable", "org.matrix.msc2946", "rooms", ss1, "spaces"},
	...
	t.Run("max_depth", func(t *testing.T) {
		...
		res := alice.MustDoFunc(
			t,
			"GET",
			[]string{"chat", "client", "unstable", "org.matrix.msc2946", "rooms", root, "hierarchy"},
			client.WithQueries(query),
		)
		must.MatchResponse(t, res, match.HTTPResponse{
			JSON: []match.JSON{
...
func TestClientSpacesSummaryJoinRules(t *testing.T) {
	...
	res := bob.MustDo(t, "GET", []string{"chat", "client", "unstable", "org.matrix.msc2946", "rooms", root, "spaces"}, nil)
	must.MatchResponse(t, res, match.HTTPResponse{
		JSON: []match.JSON{
			match.JSONCheckOff("rooms", []interface{}{
				root,
	...
	res = bob.MustDo(t, "GET", []string{"chat", "client", "unstable", "org.matrix.msc2946", "rooms", root, "hierarchy"}, nil)
	must.MatchResponse(t, res, match.HTTPResponse{
		JSON: []match.JSON{
			match.JSONCheckOff("rooms", []interface{}{
				root,

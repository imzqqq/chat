...
export async function uploadAvatar(id, data, mime) {
    const resp = await fetch(`${BASE_PATH}/proxy/${id}/chat/media/r0/upload`, {
...
export function getAvatarURL({ id, avatar_url }) {
    ...
    return `${BASE_PATH}/proxy/${id}/chat/media/r0/download/${avatar_url}?access_token=${

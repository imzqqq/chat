...
class TestClass:
    ...
    async def test_mxc_to_http(self, async_client):
        ...
        url_path = "/chat/media/r0/download/privacytools.io/123foo"
    ...
    def test_register(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/register",
            status=200,
    ...
    async def test_login_info(self, async_client, aioresponse):
        ...
        aioresponse.get(
            "https://example.org/chat/client/r0/login",
            status=200,
            payload={
                "flows": [
                    {
    ...
    def test_logout(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/logout?access_token=abc123",
            status=200,
    ...
    def test_logout_all_devices(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/logout/all?access_token=abc123",
            status=200,
            payload=self.logout_response
        )
    ...
    async def test_sync(self, async_client: AsyncClient, aioresponse: aioresponses):
        ...
        url = (
            r"^https://example\.org/chat/client/r0/"
    ...
    async def test_sync_presence(self, async_client, aioresponse):
        ...
        aioresponse.get(
            "https://example.org/chat/client/r0/sync?access_token={}".format(async_client.access_token),
            status=200,
            payload=self.sync_response
        )
    ...
    async def test_sync_notification_counts(self, async_client, aioresponse):
        ...
        aioresponse.get(
            "https://example.org/chat/client/r0/sync?access_token=abc123",
            status=200,
            payload=self.sync_response,
        )
    ...
    def test_keys_upload(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/keys/upload?access_token=abc123",
            status=200,
    ...
    async def test_keys_query(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/keys/query?access_token=abc123",
            status=200,
    ...
    async def test_message_sending(self, async_client, aioresponse):
        ...
        aioresponse.put(
                "https://example.org/chat/client/r0/rooms/!testroom:example.org/send/m.room.encrypted/1?access_token=abc123",
            status=200,
            payload={"event_id": "$1555:example.org"}
        )
        aioresponse.get(
            "https://example.org/chat/client/r0/rooms/{}/"
    ...
    async def test_room_get_event(self, async_client, aioresponse):
        ...
        base_url = "https://example.org/chat/client/r0"
    ...
    async def test_key_claiming(self, alice_client, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/keys/claim?access_token=abc123",
            status=200,
    ...
    async def test_session_sharing(self, alice_client, async_client, aioresponse):
        ...
        aioresponse.put(
            "https://example.org/chat/client/r0/sendToDevice/m.room.encrypted/1?access_token=abc123",
            status=200,
            payload={}
        )
    ...
    async def test_joined_rooms(self, async_client, aioresponse):
        ...
        aioresponse.get(
            "https://example.org/chat/client/r0/joined_rooms?access_token=abc123",
            status=200,
    ...
    async def test_session_sharing(self, alice_client, async_client, aioresponse):
        ...
        aioresponse.put(
            "https://example.org/chat/client/r0/sendToDevice/m.room_key_request/1?access_token=abc123",
            status=200,
            payload={}
        )
    ...
    async def test_room_create(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/createRoom"
            "?access_token=abc123",
            status=200,
    ...
    async def test_join(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/join/{}"
    ...
    async def test_room_invite(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/rooms/{}/invite"
    ...
    async def test_room_leave(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/rooms/{}/leave"
            "?access_token=abc123".format(
                TEST_ROOM_ID
            ),
            status=200,
    ...
    async def test_room_forget(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/rooms/{}/forget"
            "?access_token=abc123".format(
                room_id
            ),
            status=200,
    ...
    async def test_room_kick(self, async_client, aioresponse):
        ...
        aioresponse.post(
            f"https://example.org/chat/client/r0/rooms/{room_id}/kick"
    ...
    async def test_room_ban(self, async_client, aioresponse):
        ...
        aioresponse.post(
            f"https://example.org/chat/client/r0/rooms/{room_id}/ban"
            f"?access_token=abc123",
            status=200,
            body={"user_id": ALICE_ID, "reason": "test"},
            payload={},
    ...
    async def test_room_unban(self, async_client, aioresponse):
        ...
        aioresponse.post(
            f"https://example.org/chat/client/r0/rooms/{room_id}/unban"
            f"?access_token=abc123",
            status=200,
    ...
    async def test_room_redact(self, async_client, aioresponse):
        ...
        aioresponse.put(
            "https://example.org/chat/client/r0/rooms/{}/redact/{}/{}"
            "?access_token=abc123".format(
    ...
    async def test_room_messages(self, async_client, aioresponse):
        ...
        url = (
            f"https://example.org/chat/client/r0/rooms/{TEST_ROOM_ID}/"
    ...
    async def test_room_typing(self, async_client, aioresponse):
        ...
        aioresponse.put(
            "https://example.org/chat/client/r0/rooms/{}/typing/{}"
            "?access_token=abc123".format(
                room_id,
    ...
    async def test_update_receipt_marker(self, async_client, aioresponse):
        ...
        aioresponse.post(
            f"https://example.org/chat/client/r0/rooms/{room_id}/receipt/"
    ...
    async def test_room_read_marker(
        ...
        aioresponse.post(
            f"https://example.org/chat/client/r0/rooms/{room_id}" + \
    ...
    async def test_content_repository_config(self, async_client, aioresponse):
        ...
        aioresponse.get(
            "https://example.org/chat/media/r0/config?access_token=abc123",
            status  = 200,
    ...
    async def test_upload(self, async_client, aioresponse):
        ...
        aioresponse.post(
            "https://example.org/chat/media/r0/upload"
    ...
    async def test_download(self, async_client, aioresponse):
        ...
        aioresponse.get(
            "https://example.org/chat/media/r0/download/{}/{}"
    ...
    async def test_thumbnail(self, async_client, aioresponse):
        ...
        aioresponse.get(
            "https://example.org/chat/media/r0/thumbnail/{}/{}"
    ...
    async def test_get_presence(self, async_client, aioresponse):
        ...
        aioresponse.get(
            "https://example.org/chat/client/r0/presence/{}/status?access_token={}".format(
                user_id,
    ...
    async def test_update_device(self, async_client: AsyncClient, aioresponse: aioresponses):
        ...
        aioresponse.put(
            "https://example.org/chat/client/r0/devices/{}?access_token={}".format(
                device_id,
                async_client.access_token
            ),
            status=200,
    ...
    async def test_room_resolve_alias(self, async_client, aioresponse):
        aioresponse.get(
                "https://example.org/chat/client/r0/directory/room/%23test%3Aexample.org",
            status=200,
    ...
    async def test_sync_forever(self, async_client, aioresponse, loop):
        sync_url = re.compile(
            r'^https://example\.org/chat/client/r0/sync\?access_token=.*'
        )
    ...
    async def test_session_unwedging(self, async_client_pair, aioresponse, loop):
        ...
        bob_to_device_url = re.compile(
            r"https://example\.org/chat/client/r0/sendToDevice/m\.room.encrypted/[0-9a-fA-f-]*\?access_token=bob_1234",
        )

        alice_to_device_url = re.compile(
            r"https://example\.org/chat/client/r0/sendToDevice/m\.room.encrypted/[0-9a-f-A-f-]*\?access_token=alice_1234",
        )
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/keys/claim?access_token=bob_1234",
            status=200,
            payload=key_claim_dict
        )
    ...
    async def test_key_sharing(self, async_client_pair, aioresponse, loop):
        ...
        alice_to_device_url = re.compile(
            r"https://example\.org/chat/client/r0/sendToDevice/m\.room[\._][_a-z]+/[0-9a-fA-f-]*\?access_token=alice_1234",
        )
    ...
    async def test_sas_verification(self, async_client_pair, aioresponse, loop):
        ...
        bob_to_device_url = re.compile(
            r"https://example\.org/chat/client/r0/sendToDevice/m\.(room|key)[a-z_\.]+/[0-9a-fA-f-]*\?access_token=bob_1234",
        )

        alice_to_device_url = re.compile(
            r"https://example\.org/chat/client/r0/sendToDevice/m\.(room|key)[a-z_\.]+/[0-9a-fA-f-]*\?access_token=alice_1234",
        )
    ...
    async def test_e2e_sending(self, async_client_pair, aioresponse, loop):
        ...
        alice_to_device_url = re.compile(
            r"https://example\.org/chat/client/r0/sendToDevice/m\.room.encrypted/[0-9]\?access_token=alice_1234",
        )

        bob_room_send_url = re.compile(
            r"https://example\.org/chat/client/r0/rooms/{}/send/m\.room\.encrypted/[0-9]\?access_token=bob_1234".format(TEST_ROOM_ID),
        )
        ...
        aioresponse.post(
            "https://example.org/chat/client/r0/keys/query?"
    ...
    async def test_upload_filter(self, async_client, aioresponse):
        ...
        aioresponse.post(
            f"https://example.org/chat/client/r0/user/"
    ...
    async def test_set_pushrule(self, async_client, aioresponse):
        ...
        aioresponse.put(
            "https://example.org/chat/client/r0/pushrules/"

...
class MediaRepoConfig(SerializableAttrs):
    """
    Matrix media repo config. See `GET /chat/media/r0/config`_.

    .. _GET /chat/media/r0/config:
...
class MXOpenGraph(SerializableAttrs):
    """
    Matrix URL preview response. See `GET /chat/media/r0/preview_url`_.

    .. _GET /chat/media/r0/preview_url:

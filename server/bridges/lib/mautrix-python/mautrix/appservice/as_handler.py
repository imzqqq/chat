...
class AppServiceServerMixin:
    ...
    def register_routes(self, app: web.Application) -> None:
        ...
        app.router.add_route("PUT", "/chat/app/v1/transactions/{transaction_id}",
                             self._http_handle_transaction)
        app.router.add_route("GET", "/chat/app/v1/rooms/{alias}", self._http_query_alias)
        app.router.add_route("GET", "/chat/app/v1/users/{user_id}", self._http_query_user)

...
class APIPath(Enum):
    ...
    """
    CLIENT = "chat/client/r0"
    CLIENT_UNSTABLE = "chat/client/unstable"
    MEDIA = "chat/media/r0"
    SYNAPSE_ADMIN = "_chat/admin"
...
class PathBuilder:
    ...
    Examples:
        ...
        "chat/client/r0/rooms/%21foo%3Aexample.com/event/%24bar%3Aexample.com"
    """
...
class HTTPAPI:
    ...
    async def request(self, method: Method, path: Union[PathBuilder, str],
        ...
        Args:
            ...
            path: The full API endpoint to call (including the chat/... prefix)
    ...
    def get_download_url(self, mxc_uri: str, download_type: str = "download") -> URL:
        ...
        Examples:
            ...
            "https://matrix.org/chat/media/r0/download/matrix.org/pqjkOuKZ1ZKRULWXgz2IVZV6"
        """

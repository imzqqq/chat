...
func (prov *ProvisioningAPI) Init() {
	...
	prov.bridge.AS.Router.HandleFunc("/chat/app/com.beeper.asmux/ping", prov.BridgeStatePing).Methods(http.MethodPost)
	prov.bridge.AS.Router.HandleFunc("/chat/app/com.beeper.bridge_state", prov.BridgeStatePing).Methods(http.MethodPost)

...
export class AppService extends EventEmitter {
    ...
    constructor (private config: { homeserverToken: string; httpMaxSizeBytes?: number}) {
        ...
        app.get("/chat/app/v1/users/:userId", this.onGetUsers.bind(this));
        app.get("/chat/app/v1/rooms/:alias", this.onGetRoomAlias.bind(this));
        app.put("/chat/app/v1/transactions/:txnId", this.onTransaction.bind(this));

...
export class Bridge {
    ...
    private customiseAppserviceThirdPartyLookup() {
        ...
        if (lookupController.getProtocol) {
            ...
            this.addAppServicePath({
                method: "GET",
                path: "/chat/app/:version(v1|unstable)/thirdparty/protocol/:protocol",
        ...
        if (lookupController.getLocation) {
            ...
            this.addAppServicePath({
                method: "GET",
                path: "/chat/app/:version(v1|unstable)/thirdparty/location/:protocol",
                checkToken: this.opts.authenticateThirdpartyEndpoints,
                handler: async (req, res) => {
                    const protocol = req.params.protocol;
        ...
        if (lookupController.parseLocation) {
            ...
            this.addAppServicePath({
                method: "GET",
                path: "/chat/app/:version(v1|unstable)/thirdparty/location",
                checkToken: this.opts.authenticateThirdpartyEndpoints,
                handler: async (req, res) => {
        ...
        if (lookupController.getUser) {
            ...
            this.addAppServicePath({
                method: "GET",
                path: "/chat/app/:version(v1|unstable)/thirdparty/user/:protocol",
                checkToken: this.opts.authenticateThirdpartyEndpoints,
                handler: async (req, res) => {
                    const protocol = req.params.protocol;
        ...
        if (lookupController.parseUser) {
            ...
            this.addAppServicePath({
                method: "GET",
                path: "/chat/app/:version(v1|unstable)/thirdparty/user",
                checkToken: this.opts.authenticateThirdpartyEndpoints,
                handler: async (req, res) => {
    ...
    public addAppServicePath(opts: {
        ...
        // Consider automatic "/chat/app/:version(v1|unstable)" path prefix
    ...
    public async checkHomeserverSupport(): Promise<void> {
        ...
        if (this.opts.bridgeEncryption) {
            ...
            const loginFlows: {flows: {type: string}[]} =
                await this.botSdkAS.botClient.doRequest("GET", "/chat/client/r0/login");

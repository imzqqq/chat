...
export class Provisioner {
    ...
    private isProvisionRequest(req: Request) {
        return req.url === '/chat/provision/unlink' ||
                req.url === '/chat/provision/link'||
                req.url === '/chat/provision/querynetworks' ||
                req.url === "/chat/provision/querylink" ||
                req.url.match(/^\/chat\/provision\/listlinks/)
    }

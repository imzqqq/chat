...
describe('MatrixAuth', () => {
    describe('passwordRegister', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/register").respond(200, (path, content) => {
        ...
        xit('should support UIA', async () => {
            ...
            // First is UIA
            http.when("POST", "/chat/client/r0/register").respond(401, (path, content) => {
                expect(content).toMatchObject({username, password});
                return {
                    session: sessionId,
                    flows: [
    ...
    describe('passwordLogin', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/login").respond(200, (path, content) => {
                expect(content).toMatchObject({

...
describe('Appservice', () => {
    ...
    it('should 401 requests with bad auth', async () => {
        ...
        try {
            ...
            await verifyAuth("GET", "/chat/app/v1/users/@_prefix_sample:example.org");
            await verifyAuth("GET", "/chat/app/v1/rooms/" + encodeURIComponent("#_prefix_sample:example.org"));
            await verifyAuth("PUT", "/chat/app/v1/transactions/txnId");
            await verifyAuth("GET", "/chat/app/v1/thirdparty/protocol/protocolId");
            await verifyAuth("GET", "/chat/app/v1/thirdparty/user/protocolId");
            await verifyAuth("GET", "/chat/app/v1/thirdparty/user");
            await verifyAuth("GET", "/chat/app/v1/thirdparty/location/protocolId");
            await verifyAuth("GET", "/chat/app/v1/thirdparty/location");
        } finally {
            appservice.stop();
        }
    });
    ...
    it('should validate inputs for transactions', async () => {
        ...
        try {
            ...
            await doCall("/chat/app/v1/transactions/1", {json: {hello: "world"}}, {
                errcode: "BAD_REQUEST",
                error: "Invalid JSON: expected events",
            });
        } finally {
    ...
    it('should emit events from transactions', async () => {
        ...
        try {
            ...
            await doCall("/chat/app/v1/transactions/2", {json: txnBody});
        } finally {
            appservice.stop();
        }
    });
    ...
    it('should not duplicate transactions', async () => {
        ...
        try {
            ...
            await doCall("/transactions/1", {json: txnBody});
            await doCall("/chat/app/v1/transactions/1", {json: txnBody});
        } finally {
            appservice.stop();
        }
    });
    ...
    it('should emit while querying users', async () => {
        ...
        try {
            ...
            await doCall("/chat/app/v1/users/" + userId);
        } finally {
            appservice.stop();
        }
    });
    ...
    it('should return user not found when a user is not created', async () => {
        ...
        try {
            ...
            await doCall("/chat/app/v1/users/" + encodeURIComponent(userId));
        } finally {
            appservice.stop();
        }
    });
    ...
    it('should emit while querying rooms', async () => {
        ...
        try {
            ...
            await doCall("/chat/app/v1/rooms/" + encodeURIComponent(roomAlias));
        } finally {
            appservice.stop();
        }
    });
    ...
    it("should handle third party protocol requests", async () => {
        ...
        try {
            ...
            const result = await doCall("/chat/app/v1/thirdparty/protocol/" + protos[0]);
            expect(result).toEqual(responseObj);
            const result2 = await doCall("/chat/app/v1/thirdparty/protocol/" + protos[1]);
    ...
    it("should reject unknown protocols when handling third party protocol requests", async () => {
        ...
        try {
            await doCall("/chat/app/v1/thirdparty/protocol/notaproto");
            // noinspection ExceptionCaughtLocallyJS
            throw new Error("Request finished when it should not have");
        } catch (e) {
    ...
    it("should lookup a remote user by given fields and respond with it", async () => {
        ...
        try {
            const result = await doCall("/chat/app/v1/thirdparty/user/" + protocolId, {}, userFields);
            expect(result).toEqual(responseObj);
        } finally {
            appservice.stop();
        }
    ...
    it("should lookup a matrix user by given fields and respond with it", async () => {
        ...
        try {
            const result = await doCall("/chat/app/v1/thirdparty/user", {}, {userid: expectedUserId});
            expect(result).toEqual(responseObj);
        } finally {
            appservice.stop();
        }
    ...
    it("should fail to lookup a remote user if the protocol is wrong", async () => {
        const {appservice, doCall} = await beginAppserviceWithProtocols(["fakeproto"]);
        try {
            await doCall("/chat/app/v1/thirdparty/user/pr0tocol");
            // noinspection ExceptionCaughtLocallyJS
            throw new Error("Request finished when it should not have");
        } catch (e) {
            expect(e.error).toMatchObject({
    ...
    it("should return 404 if no matrix users are found when handling a third party user request", async () => {
        ...
        appservice.on("thirdparty.user.matrix", getUserSpy);
        try {
            await doCall("/chat/app/v1/thirdparty/user", {}, {userid: expectedUserId});
        } catch (e) {
            expect(e.error).toMatchObject({
    ...
    it("should return 404 if no remote users are found when handling a thirdparty user request", async () => {
        ...
        appservice.on("thirdparty.user.remote", getUserSpy);
        try {
            await doCall("/chat/app/v1/thirdparty/user/" + protocolId, {}, userFields);
        } catch (e) {
            expect(e.error).toMatchObject({
                errcode: "NO_MAPPING_FOUND",
                error: "No mappings found"
    ...
    it("should fail to lookup a remote user if the mxid is empty", async () => {
        const {appservice, doCall} = await beginAppserviceWithProtocols(["fakeproto"]);
        try {
            await doCall("/chat/app/v1/thirdparty/user");
            // noinspection ExceptionCaughtLocallyJS
            throw new Error("Request finished when it should not have");
        } catch (e) {
            expect(e.error).toMatchObject({
    ...
    it("should lookup a remote location by given fields", async () => {
        ...
        try {
            const result = await doCall("/chat/app/v1/thirdparty/location/" + protocolId, {}, locationFields);
            expect(result).toEqual(responseObj);
        } finally {
            appservice.stop();
        }
    ...
    it("should lookup a matrix location by given fields", async () => {
        ...
        try {
            const result = await doCall("/chat/app/v1/thirdparty/location", {}, {alias: expectedAlias});
            expect(result).toEqual(responseObj);
        } finally {
            appservice.stop();
        }
    ...
    it("should fail to lookup a remote location if the protocol is wrong", async () => {
        const {appservice, doCall} = await beginAppserviceWithProtocols(["fakeproto"]);
        try {
            await doCall("/chat/app/v1/thirdparty/location/pr0tocol");
            // noinspection ExceptionCaughtLocallyJS
            throw new Error("Request finished when it should not have");
        } catch (e) {
            expect(e.error).toMatchObject({
    ...
    it("should return 404 if no matrix locations are found", async () => {
        ...
        try {
            await doCall("/chat/app/v1/thirdparty/location", {}, {alias: expectedAlias});
        } catch (e) {
            expect(e.error).toMatchObject({
                errcode: "NO_MAPPING_FOUND",
                error: "No mappings found"
    ...
    it("should return 404 if no remote location are found", async () => {
        ...
        appservice.on("thirdparty.location.remote", getLocationSpy);
        try {
            await doCall("/chat/app/v1/thirdparty/location/" + protocolId, {}, locationFields);
        } catch (e) {
            expect(e.error).toMatchObject({
                errcode: "NO_MAPPING_FOUND",
                error: "No mappings found"
    ...
    it("should fail to lookup a matrix location if the alias is empty", async () => {
        const {appservice, doCall} = await beginAppserviceWithProtocols(["fakeproto"]);
        try {
            await doCall("/chat/app/v1/thirdparty/location");
            // noinspection ExceptionCaughtLocallyJS
            throw new Error("Request finished when it should not have");
        } catch (e) {
            expect(e.error).toMatchObject({
    ...
    it("should set visibilty of a room on the appservice's network", async () => {
        ...
        http.when("PUT", "/chat/client/r0/directory/list/appservice").respond(200, (path, content) => {
            expect(path).toEqual(`${hsUrl}/chat/client/r0/directory/list/appservice/${encodeURIComponent(networkId)}/${encodeURIComponent(roomId)}`);

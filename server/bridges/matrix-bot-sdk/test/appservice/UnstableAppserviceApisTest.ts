...
describe('UnstableAppserviceApis', () => {
    describe('sendHistoricalEventBatch', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", `/chat/client/unstable/org.matrix.msc2716/rooms/`).respond(200, (path, content, {opts}) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/org.matrix.msc2716/rooms/${encodeURIComponent(roomId)}/batch_send`);
    ...
    describe('sendEventWithTimestamp', () => {
        it('should call the right endpoint with a timestamp', async () => {
            ...
            http.when("PUT", "/chat/client/r0/rooms").respond(200, (path, content, {opts}) => {

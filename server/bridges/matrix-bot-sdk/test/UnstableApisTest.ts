...
describe('UnstableApis', () => {
    describe('getRoomAliases', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/unstable/org.matrix.msc2432/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/org.matrix.msc2432/rooms/${encodeURIComponent(roomId)}/aliases`);
    ...
    describe('createGroup', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/unstable/create_group").respond(200, (path, content) => {
    ...
    describe('inviteUserToGroup', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/admin/users/invite/${encodeURIComponent(userId)}`);
    ...
    describe('kickUserFromGroup', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/admin/users/remove/${encodeURIComponent(userId)}`);
                expect(content).toMatchObject({});
                return {};
            });
    ...
    describe('setGroupProfile', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/profile`);
    ...
    describe('setGroupJoinPolicy', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/settings/m.join_policy`);
    ...
    describe('addRoomToGroup', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/admin/rooms/${encodeURIComponent(roomId)}`);
    ...
    describe('updateGroupRoomVisibility', () => {
        it('should call the right endpoint for private rooms', async () => {
            ...
            http.when("PUT", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/admin/rooms/${encodeURIComponent(roomId)}/config/m.visibility`);
    ...
    describe('removeRoomFromGroup', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("DELETE", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/admin/rooms/${encodeURIComponent(roomId)}`);
                return {};
            });
    ...
    describe('getGroupProfile', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/profile`);
                return {
                    name: "Test Group",
    ...
    describe('getGroupUsers', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/users`);
                return {
                    chunk: [
                        {
                            user_id: joinedUser,
    ...
    describe('getGroupInvitedUsers', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/invited_users`);
                return {
                    chunk: [
                        {
                            user_id: invitedUser,
    ...
    describe('getGroupRooms', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/rooms`);
                return {
                    chunk: [
                        {
                            room_id: roomId,
    ...
    describe('acceptGroupInvite', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/self/accept_invite`);
                return {};
            });
    ...
    describe('joinGroup', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/self/join`);
                return {};
            });
    ...
    describe('leaveGroup', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/self/leave`);
                return {};
            });
    ...
    describe('setGroupPublicity', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/unstable/groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/groups/${encodeURIComponent(groupId)}/self/update_publicity`);
    ...
    describe('getJoinedGroups', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/unstable/joined_groups").respond(200, (path, content) => {
                return {
                    groups: [groupId],
                };
            });
    ...
    describe('getPublicisedGroups', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/unstable/publicised_groups").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/unstable/publicised_groups/${encodeURIComponent(userId)}`);
                return {
                    groups: [groupId],
                };
            });
    ...
    describe('addReactionToEvent', () => {
        it('should send an m.reaction event', async () => {
            ...
            http.when("PUT", "/chat/client/r0/rooms").respond(200, (path, content) => {
                const idx = path.indexOf(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/send/m.reaction/`);
                expect(idx).toBe(0);

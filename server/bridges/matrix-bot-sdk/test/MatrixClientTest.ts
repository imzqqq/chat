...
describe('MatrixClient', () => {
    ...
    describe('getOpenIDConnectToken', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/user").respond(200, (path) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/user/${encodeURIComponent(userId)}/openid/request_token`);
                return testToken;
            });
    ...
    describe('getIdentityServerClient', () => {
        ...
        it('should prepare an identity server client', async () => {
            ...
            http.when("POST", "/chat/identity/v2/account").respond(200, (path) => {
                expect(path).toEqual(`https://${identityDomain}/chat/identity/v2/account/register`);
    ...
    describe('getAccountData', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/user").respond(200, (path) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/user/${encodeURIComponent(userId)}/account_data/${encodeURIComponent(eventType)}`);
                return {};
            });
    ...
    describe('getSafeAccountData', () => {
        ...
        it('should return the default on error', async () => {
            ...
            http.when("GET", "/chat/client/r0/user").respond(404, {});
    ...
    describe('getPresenceStatus', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/presence").respond(200, (path) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/presence/${encodeURIComponent(userId)}/status`);
                return presenceObj;
            });
    ...
    describe('setPresenceStatus', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/presence").respond(200, (path, obj) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/presence/${encodeURIComponent(userId)}/status`);
    ...
    describe('getRoomAccountData', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/user").respond(200, (path) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/user/${encodeURIComponent(userId)}/rooms/${encodeURIComponent(roomId)}/account_data/${encodeURIComponent(eventType)}`);
                return {};
            });
    ...
    describe('setAccountData', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/user").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/user/${encodeURIComponent(userId)}/account_data/${encodeURIComponent(eventType)}`);
    ...
    describe('getPublishedAlias', () => {
        it('should return falsey on 404', async () => {
            ...
            http.when("GET", "/chat/client/r0/rooms/").respond(404, {});
        ...
        it('should return falsey on no aliases (empty content)', async () => {
            ...
            http.when("GET", "/chat/client/r0/rooms/").respond(200, {});
    ...
    describe('createRoomAlias', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/directory/room/").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/directory/room/${encodeURIComponent(alias)}`);
    ...
    describe('deleteRoomAlias', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("DELETE", "/chat/client/r0/directory/room/").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/directory/room/${encodeURIComponent(alias)}`);
                return {};
            });
    ...
    describe('setDirectoryVisibility', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/directory/list/room/").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/directory/list/room/${encodeURIComponent(roomId)}`);
    ...
    describe('getDirectoryVisibility', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/directory/list/room/").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/directory/list/room/${encodeURIComponent(roomId)}`);
                return {};
            });
        ...
        it('should return the right visibility string', async () => {
            ...
            http.when("GET", "/chat/client/r0/directory/list/room/").respond(200, {visibility: visibility});
    ...
    describe('lookupRoomAlias', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/directory/room/").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/directory/room/${encodeURIComponent(alias)}`);
        ...
        it('should return a translated response', async () => {
            ...
            http.when("GET", "/chat/client/r0/directory/room/").respond(200, {room_id: roomId, servers: servers});
    ...
    describe('inviteUser', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/invite`);
    ...
    describe('kickUser', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/kick`);
                expect(content).toMatchObject({user_id: userId});
                return {};
            });
    ...
    describe('banUser', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/ban`);
                expect(content).toMatchObject({user_id: userId});
                return {};
            });
    ...
    describe('unbanUser', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/unban`);
                expect(content).toMatchObject({user_id: userId});
                return {};
            });
    ...
    describe('getWhoAmI', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/account/whoami").respond(200, response);
    ...
    describe('stop', () => {
        it('should stop when requested', async () => {
            ...
            http.when("GET", "/chat/client/r0/joined_rooms").respond(200, {joined_rooms: []});

            const waitPromise = new Promise((resolve, reject) => {
                for (let i = 0; i <= max * 2; i++) {
                    http.when("GET", "/chat/client/r0/sync").respond(200, (path, content) => {
    ...
    describe('start', () => {
        ...
        it('should create a filter when the stored filter is outdated', async () => {
            ...
            http.when("POST", "/chat/client/r0/user").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/user/${encodeURIComponent(userId)}/filter`);
        ...
        it('should use the filter ID when syncing', async () => {
            ...
            http.when("GET", "/chat/client/r0/sync").respond(200, (path, content, req) => {
    ...
    describe('getEvent', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/event/${encodeURIComponent(eventId)}`);
                return event;
            });
    ...
    describe('getRoomState', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/state`);
                return events;
            });
    ...
    describe('getRoomStateEvent', () => {
        it('should call the right endpoint with no state key', async () => {
            ...
            http.when("GET", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/state/${encodeURIComponent(eventType)}/`);
                return event;
            });
        ...
        it('should call the right endpoint with a state key', async () => {
            ...
            http.when("GET", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/state/${encodeURIComponent(eventType)}/${stateKey}`);
                return event;
            });
    ...
    describe('getEventContext', () => {
        it('should use the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/rooms").respond(200, (path, content, req) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/context/${encodeURIComponent(targetEvent.eventId)}`);
    ...
    describe('getUserProfile', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/profile").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/profile/${encodeURIComponent(userId)}`);
                return profile;
            });
    ...
    describe('createRoom', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/createRoom").respond(200, (path, content) => {
    ...
    describe('setDisplayName', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/profile").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/profile/${encodeURIComponent(userId)}/displayname`);
    ...
    describe('setAvatarUrl', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/profile").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/profile/${encodeURIComponent(userId)}/avatar_url`);
    ...
    describe('joinRoom', () => {
        it('should call the right endpoint for room IDs', async () => {
            ...
            http.when("POST", "/chat/client/r0/join").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/join/${encodeURIComponent(roomId)}`);
                return {room_id: roomId};
            });
        ...
        it('should call the right endpoint with server names', async () => {
            ...
            http.when("POST", "/chat/client/r0/join").respond(200, (path, content, req) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/join/${encodeURIComponent(roomId)}`);
        ...
        it('should call the right endpoint for room aliases', async () => {
            ...
            http.when("POST", "/chat/client/r0/join").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/join/${encodeURIComponent(roomAlias)}`);
                return {room_id: roomId};
            });
    ...
    describe('getJoinedRooms', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/joined_rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/joined_rooms`);
    ...
    describe('getJoinedRoomMembers', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/joined_members`);
                const obj = {};
    ...
    describe('getJoinedRoomMembersWithProfiles', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/rooms").respond(200, path => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/joined_members`);
    ...
    describe('getRoomMembers', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/members`);
    ...
    describe('leaveRoom', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/leave`);
                return {};
            });
    ...
    describe('sendReadReceipt', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/receipt/m.read/${encodeURIComponent(eventId)}`);
                return {};
            });
    ...
    describe('setTyping', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/rooms").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/typing/${encodeURIComponent(userId)}`);
    ...
    describe('replyText', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/rooms").respond(200, (path, content) => {
                const idx = path.indexOf(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/send/m.room.message/`);
                expect(idx).toBe(0);
        ...
        it('should try to encrypt in encrypted rooms', async () => {
            ...
            http.when("PUT", "/chat/client/r0/rooms").respond(200, (path, content) => {
                const idx = path.indexOf(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/send/m.room.encrypted/`);
                expect(idx).toBe(0);
                expect(content).toMatchObject(expectedContent);
                return {event_id: eventId};
            });
    ...
    describe('sendEvent', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/rooms").respond(200, (path, content) => {
                const idx = path.indexOf(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/send/${encodeURIComponent(eventType)}/`);
                expect(idx).toBe(0);
                expect(content).toMatchObject(eventContent);
                return {event_id: eventId};
            });
        ...
        it('should try to encrypt in encrypted rooms', async () => {
            ...
            http.when("PUT", "/chat/client/r0/rooms").respond(200, (path, content) => {
                const idx = path.indexOf(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/send/${encodeURIComponent(sEventType)}/`);
                expect(idx).toBe(0);
                expect(content).toMatchObject(eventContent);
                return {event_id: eventId};
            });
    ...
    describe('sendStateEvent', () => {
        it('should call the right endpoint with no state key', async () => {
            ...
            http.when("PUT", "/chat/client/r0/rooms").respond(200, (path, content) => {
                const idx = path.indexOf(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/state/${encodeURIComponent(eventType)}/`);
                expect(idx).toBe(0);
                expect(content).toMatchObject(eventContent);
                return {event_id: eventId};
            });
    ...
    describe('redactEvent', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/rooms").respond(200, (path, content) => {
                const idx = path.indexOf(`${hsUrl}/chat/client/r0/rooms/${encodeURIComponent(roomId)}/redact/${encodeURIComponent(eventId)}/`);
                expect(idx).toBe(0);
    ...
    describe('mxcToHttp', () => {
        it('should convert to the right URL', async () => {
            ...
            expect(http).toBe(`${hsUrl}/chat/media/r0/download/${encodeURIComponent(domain)}/${encodeURIComponent(mediaId)}`);
        });
    ...
    describe('mxcToHttpThumbnail', () => {
        it('should convert to the right URL', async () => {
            ...
            expect(http).toBe(`${hsUrl}/chat/media/r0/thumbnail/${encodeURIComponent(domain)}/${encodeURIComponent(mediaId)}?width=${width}&height=${height}&method=${encodeURIComponent(method)}`);
        });
    ...
    describe('uploadContent', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/media/r0/upload").respond(200, (path, content, req) => {
    ...
    describe('downloadContent', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/media/r0/download/").respond(200, (path, _, req) => {
                expect(path).toContain("/chat/media/r0/download/" + urlPart);
    ...
    describe('uploadDeviceKeys', () => {
        ...
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/keys/upload").respond(200, (path, content) => {
                expect(content).toMatchObject({
                    device_keys: {
                        user_id: userId,
    ...
    describe('getUserDevices', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/keys/query").respond(200, (path, content, req) => {
    ...
    describe('claimOneTimeKeys', () => {
        ...
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/client/r0/keys/claim").respond(200, (path, content) => {
                expect(content).toMatchObject({
                    timeout: 10000,
    ...
    describe('sendToDevices', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/chat/client/r0/sendToDevice").respond(200, (path, content) => {
                const idx = path.indexOf(`${hsUrl}/chat/client/r0/sendToDevice/${encodeURIComponent(type)}/`);
                expect(idx).toBe(0);

...
describe('SynapseAdminApis', () => {
    describe('isAdmin', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/_chat/admin/v1/users").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/_chat/admin/v1/users/${encodeURIComponent(userId)}/admin`);
                return response;
            });
    ...
    describe('isSelfAdmin', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/client/r0/account/whoami").respond(200, (path, content) => {
    ...
    describe('getUser', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/_chat/admin/v2/users").respond(200, (path) => {
                expect(path).toEqual(`${hsUrl}/_chat/admin/v2/users/${encodeURIComponent(userId)}`);
                return response;
            });
        ...
        it('should throw if the user cannot be found', async () => {
            ...
            http.when("GET", "/_chat/admin/v2/users").respond(404, (path) => {
                expect(path).toEqual(`${hsUrl}/_chat/admin/v2/users/${encodeURIComponent(userId)}`);
    ...
    describe('upsertUser', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("PUT", "/_chat/admin/v2/users").respond(200, (path, content) => {
                expect(path).toEqual(`${hsUrl}/_chat/admin/v2/users/${encodeURIComponent(userId)}`);
    ...
    describe('listUsers', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/_chat/admin/v2/users").respond(200, (path, _content, req) => {
                expect(req.opts.qs).toEqual(request);
                expect(path).toEqual(`${hsUrl}/_chat/admin/v2/users`);
                return response;
            });
    ...
    describe('listRooms', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/_chat/admin/v1/rooms").respond(200, (path, _content, req) => {
                expect(req.opts.qs).toEqual(request);
                expect(path).toEqual(`${hsUrl}/_chat/admin/v1/rooms`);
                return response;
            });
        ...
        describe('getRoomState', () => {
            it('should call the right endpoint', async () => {
                ...
                http.when("GET", "/_chat/admin/v1/rooms").respond(200, (path, _content, req) => {
                    expect(path).toEqual(`${hsUrl}/_chat/admin/v1/rooms/${encodeURIComponent(roomId)}/state`);
                    return {state};
                });
        ...
        describe('deleteRoom', () => {
            it('should call the right endpoint', async () => {
                ...
                http.when("POST", "/_chat/admin/v1/rooms").respond(200, (path, _content, req) => {
                    expect(JSON.parse(req.opts.body)).toMatchObject({purge: true});
                    expect(path).toEqual(`${hsUrl}/_chat/admin/v1/rooms/${encodeURIComponent(roomId)}/delete`);
                    return {};
                });

...
export async function createTestIdentityClient(): Promise<{ client: IdentityClient, mxClient: MatrixClient, http: MockHttpBackend, identityUrl: string, accessToken: string }> {
    ...
    result.http.when("POST", "/chat/identity/v2/account/register").respond(200, {token: idAccessToken});
...
describe('IdentityClient', () => {
    describe('getAccount', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/identity/v2/account").respond(200, (path, content) => {
                expect(path).toEqual(`${identityUrl}/chat/identity/v2/account`);
    ...
    describe('getTermsOfService', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("GET", "/chat/identity/v2/terms").respond(200, (path, content) => {
                expect(path).toEqual(`${identityUrl}/chat/identity/v2/terms`);
                return response;
            });
    ...
    describe('acceptTerms', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/identity/v2/terms").respond(200, (path, content) => {
                expect(path).toEqual(`${identityUrl}/chat/identity/v2/terms`);
    ...
    describe('lookup', () => {
        it('should call the right endpoint (sha256)', async () => {
            ...
            http.when("GET", "/chat/identity/v2/hash_details").respond(200, (path, content) => {
                expect(path).toEqual(`${identityUrl}/chat/identity/v2/hash_details`);
                return {
            ...
            http.when("POST", "/chat/identity/v2/lookup").respond(200, (path, content) => {
                expect(path).toEqual(`${identityUrl}/chat/identity/v2/lookup`);
    ...
    describe('makeEmailInvite', () => {
        it('should call the right endpoint', async () => {
            ...
            http.when("POST", "/chat/identity/v2/store-invite").respond(200, (path, content) => {
                expect(content).toMatchObject({
                    address: inviteEmail,
        ...
        it('should request room state events and user profile', async () => {
            ...
            const storedInvite = {
                display_name: "a...@e...",
                public_keys: [
                    {public_key: "serverkey", key_validity_url: "/chat/identity/v1/pubkey/isvalid"},
                    {public_key: "ephemeralkey", key_validity_url: "/chat/identity/v1/pubkey/isvalid"},
                ],

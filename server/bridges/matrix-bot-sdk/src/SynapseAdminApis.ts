...
export class SynapseAdminApis {
    ...
    public async getUser(userId: string): Promise<SynapseUser> {
        return this.client.doRequest(
            "GET", "/_chat/admin/v2/users/" + encodeURIComponent(userId),
        );
    }
    ...
    public async upsertUser(userId: string, opts: SynapseUserProperties = {}): Promise<SynapseUser> {
        return this.client.doRequest(
            "PUT", "/_chat/admin/v2/users/" + encodeURIComponent(userId), undefined, opts,
        );
    }
    ...
    public async listUsers(from?: string, limit?: number, name?: string, guests = true, deactivated = false): Promise<SynapseUserList> {
        ...
        return this.client.doRequest("GET", "/_chat/admin/v2/users", qs);
    }
    ...
    public async isAdmin(userId: string): Promise<boolean> {
        const response = await this.client.doRequest("GET", `/_chat/admin/v1/users/${encodeURIComponent(userId)}/admin`);
    ...
    public async listRooms(searchTerm?: string, from?: string, limit?: number, orderBy?: SynapseRoomProperty, reverseOrder = false): Promise<SynapseRoomList> {
        ...
        return this.client.doRequest("GET", "/_chat/admin/v1/rooms", params);
    }
    ...
    public async getRoomState(roomId: string): Promise<any[]> {
        const r = await this.client.doRequest("GET", `/_chat/admin/v1/rooms/${encodeURIComponent(roomId)}/state`);
        return r?.['state'] || [];
    }
    ...
    public async deleteRoom(roomId: string): Promise<void> {
        return this.client.doRequest("POST", `/_chat/admin/v1/rooms/${encodeURIComponent(roomId)}/delete`, {}, {purge: true});
    }
}

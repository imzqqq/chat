...
export class UnstableApis {
    ...
    public async getRoomAliases(roomId: string): Promise<string[]> {
        const r = await this.client.doRequest("GET", "/chat/client/unstable/org.matrix.msc2432/rooms/" + encodeURIComponent(roomId) + "/aliases");
        return r['aliases'] || [];
    }
    ...
    public async createGroup(localpart: string): Promise<string> {
        const response = await this.client.doRequest("POST", "/chat/client/unstable/create_group", null, {"localpart": localpart});
    ...
    public async inviteUserToGroup(groupId: string, userId: string): Promise<"join" | "invite" | "reject"> {
        const response = await this.client.doRequest("PUT", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/admin/users/invite/${encodeURIComponent(userId)}`, null, {});
    ...
    public async kickUserFromGroup(groupId: string, userId: string): Promise<any> {
        return this.client.doRequest("PUT", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/admin/users/remove/${encodeURIComponent(userId)}`, null, {});
    }
    ...
    public async setGroupProfile(groupId: string, profile: GroupProfile): Promise<any> {
        return this.client.doRequest("POST", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/profile`, null, profile);
    }
    ...
    public async setGroupJoinPolicy(groupId: string, policy: "open" | "invite"): Promise<any> {
        return this.client.doRequest("PUT", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/settings/m.join_policy`, null, {
            "m.join_policy": {
                "type": policy,
            },
        });
    ...
    public async addRoomToGroup(groupId: string, roomId: string, isPublic = true): Promise<any> {
        return this.client.doRequest("PUT", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/admin/rooms/${encodeURIComponent(roomId)}`, null, {
    ...
    public async updateGroupRoomVisibility(groupId: string, roomId: string, isPublic: boolean): Promise<any> {
        return this.client.doRequest("PUT", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/admin/rooms/${encodeURIComponent(roomId)}/config/m.visibility`, null, {
    ...
    public async removeRoomFromGroup(groupId: string, roomId: string): Promise<any> {
        return this.client.doRequest("DELETE", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/admin/rooms/${encodeURIComponent(roomId)}`);
    }
    ...
    public async getGroupProfile(groupId: string): Promise<GroupProfile> {
        return this.client.doRequest("GET", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/profile`);
    }
    ...
    public async getGroupUsers(groupId: string): Promise<any[]> {
        const response = await this.client.doRequest("GET", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/users`);
    ...
    public async getGroupInvitedUsers(groupId: string): Promise<any[]> {
        const response = await this.client.doRequest("GET", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/invited_users`);
        return response["chunk"];
    }
    ...
    public async getGroupRooms(groupId: string): Promise<any[]> {
        const response = await this.client.doRequest("GET", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/rooms`);
        return response["chunk"];
    }
    ...
    public async acceptGroupInvite(groupId: string): Promise<any> {
        return this.client.doRequest("PUT", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/self/accept_invite`, null, {});
    }
    ...
    public async joinGroup(groupId: string): Promise<any> {
        return this.client.doRequest("PUT", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/self/join`, null, {});
    }
    ...
    public async leaveGroup(groupId: string): Promise<any> {
        return this.client.doRequest("PUT", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/self/leave`, null, {});
    }
    ...
    public async setGroupPublicity(groupId: string, publicise: boolean): Promise<any> {
        return this.client.doRequest("PUT", `/chat/client/unstable/groups/${encodeURIComponent(groupId)}/self/update_publicity`, null, {
            publicise,
        });
    }
    ...
    public async getJoinedGroups(): Promise<string[]> {
        const response = await this.client.doRequest("GET", "/chat/client/unstable/joined_groups");
    ...
    public async getPublicisedGroups(userId: string): Promise<string[]> {
        const response = await this.client.doRequest("GET", `/chat/client/unstable/publicised_groups/${encodeURIComponent(userId)}`);
        return response["groups"];
    }
    ...
    public async getRelationsForEvent(roomId: string, eventId: string, relationType?: string, eventType?: string): Promise<{original_event: any, chunk: any[]}> {
        let url = `/chat/client/unstable/rooms/${roomId}/relations/${eventId}`;
        if (relationType) {
            url += `/${relationType}`;
        }
        if (eventType) {
    ...
    public async getMediaInfo(mxcUrl: string): Promise<MSC2380MediaInfo> {
        ...
        return this.client.doRequest("GET", `/chat/media/unstable/info/${encodeURIComponent(domain)}/${encodeURIComponent(mediaId)}`);
    }
}

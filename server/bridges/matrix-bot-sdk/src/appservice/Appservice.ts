...
export class Appservice extends EventEmitter {
    ...
    constructor(private options: IAppserviceOptions) {
        ...
        this.app.get("/chat/app/v1/users/:userId", this.onUser.bind(this));
        this.app.get("/chat/app/v1/rooms/:roomAlias", this.onRoomAlias.bind(this));
        this.app.put("/chat/app/v1/transactions/:txnId", this.onTransaction.bind(this));
        this.app.get("/chat/app/v1/thirdparty/protocol/:protocol", this.onThirdpartyProtocol.bind(this));
        this.app.get("/chat/app/v1/thirdparty/user/:protocol", this.onThirdpartyUser.bind(this));
        this.app.get("/chat/app/v1/thirdparty/user", this.onThirdpartyUser.bind(this));
        this.app.get("/chat/app/v1/thirdparty/location/:protocol", this.onThirdpartyLocation.bind(this));
        this.app.get("/chat/app/v1/thirdparty/location", this.onThirdpartyLocation.bind(this));
    ...
    public setRoomDirectoryVisibility(networkId: string, roomId: string, visibility: "public" | "private") {
        ...
        return this.botClient.doRequest("PUT", `/chat/client/r0/directory/list/appservice/${networkId}/${roomId}`, null, {
            visibility,
        });
    }

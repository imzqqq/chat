...
export class MatrixClient extends EventEmitter {
    ...
    public async getOpenIDConnectToken(): Promise<OpenIDConnectToken> {
        ...
        return this.doRequest("POST", "/chat/client/r0/user/" + userId + "/openid/request_token", null, {});
    }
    ...
    public async getAccountData<T>(eventType: string): Promise<T> {
        ...
        return this.doRequest("GET", "/chat/client/r0/user/" + userId + "/account_data/" + eventType);
    }
    ...
    public async getRoomAccountData<T>(eventType: string, roomId: string): Promise<T> {
        ...
        return this.doRequest("GET", "/chat/client/r0/user/" + userId + "/rooms/" + roomId + "/account_data/" + eventType);
    }
    ...
    public async setAccountData(eventType: string, content: any): Promise<any> {
        const userId = encodeURIComponent(await this.getUserId());
        eventType = encodeURIComponent(eventType);
        return this.doRequest("PUT", "/chat/client/r0/user/" + userId + "/account_data/" + eventType, null, content);
    }
    ...
    public async setRoomAccountData(eventType: string, roomId: string, content: any): Promise<any> {
        ...
        eventType = encodeURIComponent(eventType);
        roomId = encodeURIComponent(roomId);
        return this.doRequest("PUT", "/chat/client/r0/user/" + userId + "/rooms/" + roomId + "/account_data/" + eventType, null, content);
    }
    ...
    public async getPresenceStatusFor(userId: string): Promise<Presence> {
        return this.doRequest("GET", "/chat/client/r0/presence/" + encodeURIComponent(userId) + "/status").then(r => new Presence(r));
    }
    ...
    public async setPresenceStatus(presence: "online" | "offline" | "unavailable", statusMessage: string = null): Promise<any> {
        return this.doRequest("PUT", "/chat/client/r0/presence/" + encodeURIComponent(await this.getUserId()) + "/status", null, {
            presence: presence,
    ...
    public createRoomAlias(alias: string, roomId: string): Promise<any> {
        ...
        return this.doRequest("PUT", "/chat/client/r0/directory/room/" + alias, null, {
            "room_id": roomId,
        });
    }
    ...
    public deleteRoomAlias(alias: string): Promise<any> {
        alias = encodeURIComponent(alias);
        return this.doRequest("DELETE", "/chat/client/r0/directory/room/" + alias);
    }
    ...
    public setDirectoryVisibility(roomId: string, visibility: "public" | "private"): Promise<any> {
        roomId = encodeURIComponent(roomId);
        return this.doRequest("PUT", "/chat/client/r0/directory/list/room/" + roomId, null, {
    ...
    public getDirectoryVisibility(roomId: string): Promise<"public" | "private"> {
        roomId = encodeURIComponent(roomId);
        return this.doRequest("GET", "/chat/client/r0/directory/list/room/" + roomId).then(response => {
    ...
    public lookupRoomAlias(roomAlias: string): Promise<RoomDirectoryLookupResponse> {
        return this.doRequest("GET", "/chat/client/r0/directory/room/" + encodeURIComponent(roomAlias)).then(response => {
            return {
    ...
    public inviteUser(userId, roomId) {
        return this.doRequest("POST", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/invite", null, {
            user_id: userId,
        });
    }
    ...
    public kickUser(userId, roomId, reason = null) {
        return this.doRequest("POST", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/kick", null, {
            user_id: userId,
            reason: reason,
        });
    }
    ...
    public banUser(userId, roomId, reason = null) {
        return this.doRequest("POST", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/ban", null, {
            user_id: userId,
            reason: reason,
        });
    }
    ...
    public unbanUser(userId, roomId) {
        return this.doRequest("POST", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/unban", null, {
            user_id: userId,
        });
    }
    ...
    public getWhoAmI(): Promise<IWhoAmI> {
        return this.doRequest("GET", "/chat/client/r0/account/whoami");
    }
    ...
    public async start(filter: any = null): Promise<any> {
        ...
        if (createFilter && filter) {
            ...
            return this.doRequest("POST", "/chat/client/r0/user/" + encodeURIComponent(userId) + "/filter", null, filter).then(async response => {
    ...
    protected doSync(token: string): Promise<any> {
        ...
        return this.doRequest("GET", "/chat/client/r0/sync", conf, null, (token ? 40000 : 600000));
    }
    ...
    public getRawEvent(roomId: string, eventId: string): Promise<any> {
        return this.doRequest("GET", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/event/" + encodeURIComponent(eventId))
    ...
    public getRoomState(roomId: string): Promise<any[]> {
        return this.doRequest("GET", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/state")
    ...
    public getRoomStateEvent(roomId, type, stateKey): Promise<any> {
        return this.doRequest("GET", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/state/" + encodeURIComponent(type) + "/" + encodeURIComponent(stateKey ? stateKey : ''))
            .then(ev => this.processEvent(ev));
    }
    ...
    public async getEventContext(roomId: string, eventId: string, limit = 10): Promise<EventContext> {
        const res = await this.doRequest("GET", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/context/" + encodeURIComponent(eventId), {limit});
        return {
    ...
    public getUserProfile(userId: string): Promise<any> {
        return this.doRequest("GET", "/chat/client/r0/profile/" + encodeURIComponent(userId));
    }
    ...
    public async setDisplayName(displayName: string): Promise<any> {
        const userId = encodeURIComponent(await this.getUserId());
        return this.doRequest("PUT", "/chat/client/r0/profile/" + userId + "/displayname", null, {
    ...
    public async setAvatarUrl(avatarUrl: string): Promise<any> {
        const userId = encodeURIComponent(await this.getUserId());
        return this.doRequest("PUT", "/chat/client/r0/profile/" + userId + "/avatar_url", null, {
    ...
    public async joinRoom(roomIdOrAlias: string, viaServers: string[] = []): Promise<string> {
        const apiCall = (targetIdOrAlias: string) => {
            ...
            return this.doRequest("POST", "/chat/client/r0/join/" + targetIdOrAlias, qs).then(response => {
    ...
    public getJoinedRooms(): Promise<string[]> {
        return this.doRequest("GET", "/chat/client/r0/joined_rooms").then(response => response['joined_rooms']);
    }
    ...
    public getJoinedRoomMembers(roomId: string): Promise<string[]> {
        return this.doRequest("GET", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/joined_members").then(response => {
    ...
    public async getJoinedRoomMembersWithProfiles(roomId: string): Promise<{[userId: string]: {display_name?: string, avatar_url?: string}}> {
        return (await this.doRequest("GET", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/joined_members")).joined;
    }
    ...
    public getRoomMembers(roomId: string, batchToken: string = null, membership: Membership[] = null, notMembership: Membership[] = null): Promise<MembershipEvent[]> {
        ...
        return this.doRequest("GET", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/members", qs).then(r => {
    ...
    public leaveRoom(roomId: string): Promise<any> {
        return this.doRequest("POST", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/leave");
    }
    ...
    public sendReadReceipt(roomId: string, eventId: string): Promise<any> {
        return this.doRequest("POST", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/receipt/m.read/" + encodeURIComponent(eventId), null, {});
    }
    ...
    public async setTyping(roomId: string, typing: boolean, timeout = 30000): Promise<any> {
        const userId = await this.getUserId();
        return this.doRequest("PUT", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/typing/" + encodeURIComponent(userId), null, {
            typing,
            timeout,
        });
    }
    ...
    public async sendRawEvent(roomId: string, eventType: string, content: any): Promise<string> {
        ...
        return this.doRequest("PUT", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/send/" + encodeURIComponent(eventType) + "/" + encodeURIComponent(txnId), null, content).then(response => {
    ...
    public sendStateEvent(roomId: string, type: string, stateKey: string, content: any): Promise<string> {
        return this.doRequest("PUT", "/chat/client/r0/rooms/" + encodeURIComponent(roomId) + "/state/" + encodeURIComponent(type) + "/" + encodeURIComponent(stateKey), null, content).then(response => {
            return response['event_id'];
        });
    }
    ...
    public redactEvent(roomId: string, eventId: string, reason: string | null = null): Promise<string> {
        ...
        return this.doRequest("PUT", `/chat/client/r0/rooms/${encodeURIComponent(roomId)}/redact/${encodeURIComponent(eventId)}/${txnId}`, null, content).then(response => {
            return response['event_id'];
        });
    }
    ...
    public createRoom(properties: any = {}): Promise<string> {
        return this.doRequest("POST", "/chat/client/r0/createRoom", null, properties).then(response => {
            return response['room_id'];
        });
    }
    ...
    public mxcToHttp(mxc: string): string {
        ...
        return `${this.homeserverUrl}/chat/media/r0/download/${encodeURIComponent(originHomeserver)}/${encodeURIComponent(mediaId)}`;
    }
    ...
    public mxcToHttpThumbnail(mxc: string, width: number, height: number, method: "crop" | "scale"): string {
        ...
        return downloadUri.replace("/chat/media/r0/download", "/chat/media/r0/thumbnail")
    ...
    public uploadContent(data: Buffer, contentType = "application/octet-stream", filename: string = null): Promise<string> {
        ...
        return this.doRequest("POST", "/chat/media/r0/upload", {filename: filename}, data, 60000, false, contentType)
    ...
    public async downloadContent(mxcUrl: string, allowRemote = true): Promise<{ data: Buffer, contentType: string }> {
        ...
        const path = `/chat/media/r0/download/${domain}/${mediaId}`;
    ...
    public async uploadDeviceKeys(algorithms: EncryptionAlgorithm[], keys: Record<DeviceKeyLabel<DeviceKeyAlgorithm, string>, string>): Promise<OTKCounts> {
        ...
        return this.doRequest("POST", "/chat/client/r0/keys/upload", null, {
            device_keys: obj,
    ...
    public async getUserDevices(userIds: string[], federationTimeoutMs = 10000): Promise<MultiUserDeviceListResponse> {
        ...
        return this.doRequest("POST", "/chat/client/r0/keys/query", {}, {
    ...
    public async claimOneTimeKeys(userDeviceMap: Record<string, Record<string, OTKAlgorithm>>, federationTimeoutMs = 10000): Promise<OTKClaimResponse> {
        return this.doRequest("POST", "/chat/client/r0/keys/claim", {}, {
            timeout: federationTimeoutMs,
    ...
    public async sendToDevices(type: string, messages: Record<string, Record<string, any>>): Promise<void> {
        ...
        return this.doRequest("PUT", `/chat/client/r0/sendToDevice/${encodeURIComponent(type)}/${encodeURIComponent(txnId)}`, null, {
            messages: messages,
        });
    }
     ...
     * @param {string} endpoint The endpoint to call. For example: "/chat/client/r0/account/whoami"

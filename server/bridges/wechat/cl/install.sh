...
# homeserverUrl: http://synapse:8080
...
docker-compose exec synapse register_new_matrix_user http://localhost:8080 -c /data/homeserver.yaml -u $SYNAPSE_USER_NAME -p $SYNAPSE_USER_PASSWD --no-admin

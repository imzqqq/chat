...
const de = {
  ...
  synapseadmin: {
    auth: {
      ...
      welcome: "Willkommen bei Server-admin",
      server_version: "Server Version",
      username_error: "Bitte vollständigen Nutzernamen angeben: '@user:domain'",
      protocol_error: "Die URL muss mit 'http://' oder 'https://' beginnen",
      url_error: "Keine gültige Server URL",
    },
    users: {
      invalid_user_id:
        "Muss eine vollständige Benutzer-ID sein, z.B. @benutzer_id:homeserver",
      tabs: { sso: "SSO" },
    },
    rooms: {
      details: "Raumdetails",
  ...
  resources: {
    ...
    rooms: {
      ...
      helper: {
        forward_extremities:
          "Forward extremities are the leaf events at the end of a Directed acyclic graph (DAG) in a room, aka events that have no children. The more exist in a room, the more state resolution that Chat server needs to perform (hint: it's an expensive operation). While Chat server has code to prevent too many of these existing at one time in a room, bugs can sometimes make them crop up again. If a room has >10 forward extremities, it's worth checking which room is the culprit and potentially removing them using the SQL queries mentioned in #1760.",
      },
      enums: {
        join_rules: {
          public: "Öffentlich",

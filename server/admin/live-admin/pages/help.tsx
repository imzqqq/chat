  ...
  const otherResources = [
    {
      ...
      content: (
        <div>
          ...
          <a
            href="https://github.com/imzqqq/issues/new/choose"
            target="_blank"
            rel="noopener noreferrer"
          >
            {' '}
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          or exist in our{' '}
          <a href="https://github.com/imzqqq/discussions" target="_blank" rel="noopener noreferrer">
            discussions
          </a>
        </div>
      ),
    },
    {
      ...
      title: 'I want to build add-ons for Live',
      content: (
        <div>

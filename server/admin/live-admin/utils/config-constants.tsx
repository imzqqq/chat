...
export const TEXTFIELD_PROPS_SERVER_NAME = {
  ...
  placeholder: 'Live site name', // like "gothland"
  label: 'Name',
  tip: 'The name of your Live server',
  required: true,
  useTrimLead: true,
};
...
export const TEXTFIELD_PROPS_WEB_PORT = {
  ...
  placeholder: '8080',
  label: 'Live port',
  tip: 'What port is your Live web server listening? Default is 8080',
  required: true,
};
...
export const TEXTFIELD_PROPS_INSTANCE_URL = {
  ...
  configPath: 'yp',
  maxLength: 255,
  placeholder: 'https://live.mysite.com',
  label: 'Server URL',
  tip: 'The full url to your Live server.',
...
export const FIELD_PROPS_DISABLE_CHAT = {
  ...
  configPath: '',
  label: 'Chat',
  tip: 'Turn the chat functionality on/off on your Live server.',
  useSubmit: true,
};
...
export const S3_TEXT_FIELDS_INFO = {
  ...
  bucket: {
    ...
    tip: 'Create a new bucket for each Live instance you may be running.',
  },
  endpoint: {
    fieldName: 'endpoint',
    label: 'Endpoint',

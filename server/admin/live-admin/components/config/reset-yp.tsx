  ...
  return (
    <>
      ...
      <p className="description">
        If you are experiencing issues with your listing on the Live Directory and were asked to
      ...
      <Popconfirm
        placement="topLeft"
        title="Are you sure you want to reset your connection to the Live directory?"

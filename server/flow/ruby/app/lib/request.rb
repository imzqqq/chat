...
class Request
  ...
  def initialize(verb, url, **options)
    ...
    raise Flow::HostValidationError, 'Instance does not support hidden service connections' if block_hidden_service?
  ...
  def set_common_headers!
    ...
    @headers['User-Agent']      = Flow::Version.user_agent
  ...
  module ClientLimit
    def body_with_limit(limit = 1.megabyte)
      raise Flow::LengthValidationError if content_length.present? && content_length > limit
      ...
      while (chunk = readpartial)
        ...
        raise Flow::LengthValidationError if contents.bytesize > limit
      end
  ...
  class Socket < TCPSocket
    class << self
      ...
      def check_private_address(address)
        ...
        raise Flow::HostValidationError if PrivateAddressCheck.private_address?(addr)
      end

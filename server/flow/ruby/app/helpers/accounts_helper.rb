...
module AccountsHelper
  ...
  ### MARK - imzqqq: use the same size as svg
  def svg_logo
    content_tag(:svg, tag(:use, 'xlink:href' => '#flow-svg-logo'), 'viewBox' => '0 0 1024 1024')
  end

  def svg_logo_full
    content_tag(:svg, tag(:use, 'xlink:href' => '#flow-svg-logo-full'), 'viewBox' => '0 0 1024 1024')
  end
end

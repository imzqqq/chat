...
class FetchLinkCardService < BaseService
  ...
  rescue HTTP::Error, OpenSSL::SSL::SSLError, Addressable::URI::InvalidURIError, Flow::HostValidationError, Flow::LengthValidationError => e
  ...
  def html
    ...
    Request.new(:get, @url).add_headers('Accept' => 'text/html', 'User-Agent' => Flow::Version.user_agent + ' Bot').perform do |res|

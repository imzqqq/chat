...
class ActivityPub::ProcessAccountService < BaseService
  ...
  def set_fetchable_attributes!
    ...
    rescue Flow::UnexpectedResponseError, HTTP::TimeoutError, HTTP::ConnectionError, OpenSSL::SSL::SSLError
  ...
  rescue HTTP::Error, OpenSSL::SSL::SSLError, Flow::LengthValidationError

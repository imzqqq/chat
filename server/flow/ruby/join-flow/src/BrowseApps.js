...
const BrowseApps = ({ intl }) => (
  <div className='browse-apps'>
        ...
        <div className='app-intro__hero'>
          <div className='app-intro__hero__unit'>
            <h1>
              ...
              <br />
              <FormattedMessage id='ios.app_name' defaultMessage='Flow for iOS' />
            </h1>

            <p><FormattedMessage id='ios.download' defaultMessage="We've released an official app for Flow on iOS, in addition to the web version and all the third-party apps available below." /></p>
    ...
    <div className='container feature'>
      <div className='feature-angle-container'>
        <div className='feature-angle'>
          ...
          <p><FormattedMessage id='browse_apps.you_can_use_it_from_desktop' defaultMessage="You can always use Flow from the browser on your desktop or phone! It can be added to your home screen and some browsers even support push notifications, just like a native app!" /></p>
    ...
    <div className='testimonials container'>
      ...
      <p className='lead'><FormattedMessage id='browse_apps.lead2' defaultMessage="Thanks to Flow's open API, you can use it from any of these apps developed by third-party developers" /></p>
    ...
    <Helmet>
      <title>{intl.formatMessage({ id: 'browse_apps.page_title', defaultMessage: 'Get the Flow app' })} - Flow</title>
      <meta property="og:title" content={intl.formatMessage({ id: 'browse_apps.page_title', defaultMessage: 'Get the Flow app' })} />
      <meta name="description" content={intl.formatMessage({ id: 'browse_apps.page_description', defaultMessage: 'Browse official and third-party apps for the decentralized social network Flow' })} />
      <meta property="og:description" content={intl.formatMessage({ id: 'browse_apps.page_description', defaultMessage: 'Browse official and third-party apps for the decentralized social network Flow' })} />
    </Helmet>
  </div>
);

...
export const sponsors = [
  ...
  { href: 'https://masto.host/', src: sponsorMastoHost, alt: 'Masto.host - Fully managed Flow hosting' }, // Custom
      ...
      <div>
        <div className='intro'>
          ...
          <div className='hero'>
            ...
            <img className='desktop' src={screenshotFull} alt='Screenshot of Flow on desktop'/>
            <img className='mobile' src={screenshotMobile} alt='Screenshot of Flow on mobile'/>
          </div>
        </div>

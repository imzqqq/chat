  ...
  <div id='features'>
    <div className='feature container'>
      ...
      <div className='left text'>
        ...
        <p><FormattedMessage id='features.find_your_community_text' defaultMessage="Flow isn’t a single website like Twitter or Facebook, it's a network of thousands of communities operated by different organizations and individuals that provide a seamless social media experience." /></p>
      </div>
    </div>
    ...
    <div className='container feature'>
      <div className='feature-angle-container'>
        <div className='feature-angle'>
          ...
          <h3><FormattedMessage id='features.for_individual' defaultMessage='Flow for the individual' /></h3>
          <p><FormattedMessage id='features.for_individual_text' defaultMessage='Without an incentive to sell you things, Flow allows you to consume content you enjoy uninterrupted. Your feed is chronological, ad-free and non-algorithmic—you decide who you want to see!' /></p>

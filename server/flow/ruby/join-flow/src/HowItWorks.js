    ...
    <div className='container feature' style={{ marginBottom: 45 }}>
      <div className='feature-angle-container'>
        <div className='feature-angle'>
          ...
          <p><FormattedMessage id='how_it_works.server_text' defaultMessage='Flow is free, open-source software that anyone can install on a server. Independent operation, independent rules.' /></p>
        </div>

        <div className='feature-angle'>
          <i className='ion-md-git-network' />
          <h3><FormattedMessage id='how_it_works.network' defaultMessage='The network is interoperable' /></h3>
          <p><FormattedMessage id='how_it_works.network_text' defaultMessage='Using a suite of standard protocols, Flow communities can exchange information with each other, allowing users to interact seamlessly.' /></p>
        </div>
      </div>
    </div>
    ...
    <div className='container feature' style={{ marginTop: 0 }}>
      <div className='feature-angle-container'>
        <div className='feature-angle'>
          ...
          <h3><FormattedMessage id='how_it_works.future' defaultMessage='Flow is future-proof' /></h3>
          <p><FormattedMessage id='how_it_works.future_text' defaultMessage='Thanks to standard protocols, the network is not limited to Flow-based communities. If better software comes along, it can continue with the same social graph.' /></p>
        </div>

        <div className='feature-angle'>
          <i className='ion-md-megaphone' />
          <h3><FormattedMessage id='how_it_works.robust' defaultMessage='Flow is robust' /></h3>

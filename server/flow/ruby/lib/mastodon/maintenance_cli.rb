...
module Flow
  class MaintenanceCLI < Thor
    ...
    long_desc <<~LONG_DESC
      ...
      Flow has to be stopped to run this task, which will take a long time and may be destructive.
    LONG_DESC
    def fix_duplicates
      ...
      if ActiveRecord::Migrator.current_version < MIN_SUPPORTED_VERSION
        ...
        @prompt.warn 'Please update to at least Flow 3.0.0 before running this script.'
        exit(1)
      ...
      @prompt.warn 'Please make sure to stop Flow and have a backup.'

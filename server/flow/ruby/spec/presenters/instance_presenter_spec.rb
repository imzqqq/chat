...
describe InstancePresenter do
  ...
  describe '#version_number' do
    it 'returns Flow::Version' do
      expect(instance_presenter.version_number).to be(Flow::Version)
    end
  end

  describe '#source_url' do
    it 'returns "https://github.com/imzqqq"' do
      expect(instance_presenter.source_url).to eq('https://github.com/imzqqq')
    end
  end

...
describe LanguageDetector do
  ...
  describe 'detect' do
    ...
    it 'detects spanish language' do
      string = 'Obtener un Hola y bienvenidos a Flow. Obtener un Hola y bienvenidos a Flow. Obtener un Hola y bienvenidos a Flow. Obtener un Hola y bienvenidos a Flow'
      result = described_class.instance.detect(string, account_without_user_locale)

...
Tak jak blogowaniem nazwiemy publikowanie aktualności na stronie, **mikroblogowanie** to publikowanie mniejszych aktualności na strumieniu aktualności na własnym profilu. Możesz publikować wpisy tekstowe, dodatkowo umieszczając media takie jak zdjęcia, dźwięk, filmy czy ankiety. Flow pozwala na obserwowanie znajomych i poznawanie nowych.
...
Flow używa standaryzowanego, otwartego protokołu, aby implementować federację. Nazywa się on **ActivityPub**. Dowolne oprogramowanie, które również implementuje ActivityPub, może komunikować się z Mastodonem, tak jak serwery Mastodona komunikują się między sobą.
...
* Tube, pozwalające publikować filmy na kanałach,
...
Serwery Mastodona są zarządzane przez różne osoby bądź organizacje całkowicie niezależnie. Flow nie implementuje w oprogramowaniu żadnych możliwości monetyzacji.
...
Rozwój Mastodona jest finansowany społecznościowo na [Patreonie](https://patreon.com/flow) i [OpenCollective](https://opencollective.com/flow). **Nie ma tu udziału kapitału wysokiego ryzyka.**

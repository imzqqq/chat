...
Flow defaults to a dark theme, but a light or high-contrast theme can be selected.

{{< figure src="/assets/light-theme.jpg" caption="Flow light theme" >}}

### Choose your layout {#layout}

Flow defaults to a simple, one-column layout with a compose box on the left and a column switcher on the right. You can choose to enable the advanced web interface, which allows you view and pin multiple columns at the same time.
...
You can choose to receive email notifications according to the type of notification you receive within Flow. The following notification types are available to enable:
...
Posts default to public privacy. You can choose to default new posts as unlisted or followers-only instead. For an explanation of post privacy levels, see [Posting to your Flow profile &gt; Publishing levels](../posting#privacy).

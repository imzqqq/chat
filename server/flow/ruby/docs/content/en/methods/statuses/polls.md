...
{{< api-method method="get" host="https://flow.example" path="/api/v1/polls/:id" title="View a poll" >}}
...
{{< endapi-method-spec >}}
{{< endapi-method >}}
{{< api-method method="post" host="https://flow.example" path="/api/v1/polls/:id/votes" title="Vote on a poll" >}}
{{< api-method-description >}}

...
{{< api-method method="get" host="https://flow.example" path="/api/v1/follow_requests" title="Pending Follows" >}}
...
```javascript
Link: <https://flow.social/api/v1/follow_requests?max_id=23716836>; rel="next", <https://flow.social/api/v1/follow_requests?min_id=23716978>; rel="prev"
...
{{< endapi-method-spec >}}
{{< endapi-method >}}
{{< api-method method="post" host="https://flow.example" path="/api/v1/follow_requests/:id/authorize" title="Accept Follow" >}}
{{< api-method-description >}}
...
{{< endapi-method-spec >}}
{{< endapi-method >}}
{{< api-method method="post" host="https://flow.example" path="/api/v1/follow_requests/:id/reject" title="Reject Follow" >}}
{{< api-method-description >}}

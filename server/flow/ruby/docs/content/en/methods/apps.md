...
{{< api-method method="post" host="https://flow.example" path="/api/v1/apps" title="Create an application" >}}
...
{{< endapi-method-spec >}}
{{< endapi-method >}}
{{< api-method method="get" host="https://flow.example" path="/api/v1/apps/verify_credentials" title="Verify your app works" >}}
{{< api-method-description >}}

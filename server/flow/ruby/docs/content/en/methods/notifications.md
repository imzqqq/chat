...
{{< api-method method="get" host="https://flow.example" path="/api/v1/notifications" title="Get all notifications" >}}
...
```javascript
Link: <https://flow.social/api/v1/notifications?max_id=34975535>; rel="next", <https://flow.social/api/v1/notifications?min_id=34975861>;
...
[
  {
    ...
    "status": {
      ...
      ...
      "content": "<p><span class=\"h-card\"><a href=\"https://flow.social/@trwnh\" class=\"u-url mention\">@<span>trwnh</span></a></span> sup!</p>",
      ...
      "account": {
        "id": "971724",
        "username": "zsc",
...
{{< endapi-method-spec >}}
{{< endapi-method >}}
{{< api-method method="get" host="https://flow.example" path="/api/v1/notifications/:id" title="Get a single notification" >}}
{{< api-method-description >}}
...
{{< endapi-method-spec >}}
{{< endapi-method >}}
{{< api-method method="post" host="https://flow.example" path="/api/v1/notifications/clear" title="Dismiss all notifications" >}}
{{< api-method-description >}}
...
{{< endapi-method-spec >}}
{{< endapi-method >}}
{{< api-method method="post" host="https://flow.example" path="/api/v1/notifications/:id/dismiss" title="Dismiss a single notification" >}}
{{< api-method-description >}}
...
{{< endapi-method-spec >}}
{{< endapi-method >}}
{{< api-method method="post" host="https://flow.example" path="/api/v1/notifications/dismiss" title="\(DEPRECATED\) Dismiss a single notification" >}}
{{< api-method-description >}}

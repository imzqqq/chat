...
import { P2PMediaLoaderOptions, PeertubePlayerManagerOptions, PlayerMode } from '../../assets/player/tube-player-manager'
import { VideoJSCaption } from '../../assets/player/tube-videojs-typings'
import { TranslationsManager } from '../../assets/player/translations-manager'
import { isP2PEnabled } from '../../assets/player/utils'
import { getBoolOrDefault } from '../../root-helpers/local-storage-utils'
import { peertubeLocalStorage } from '../../root-helpers/tube-web-storage'
...
export class PeerTubeEmbed {
  ...
  private async buildVideoPlayer (videoResponse: Response, captionsPromise: Promise<Response>) {
    ...
    this.playerElement.className = 'video-js vjs-tube-skin'
  ...
  private async initCore () {
    ...
    this.PeertubePlayerManagerModulePromise = import('../../assets/player/tube-player-manager')

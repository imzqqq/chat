...
/**
 * Allows for programmatic control of a Tube embed running in an <iframe>
 * within a web page.
 */
export class PeerTubePlayer {
  ...
  /**
   * Construct a new PeerTubePlayer for the given Tube embed iframe.
   * Optionally provide a `scope` to ensure that messages are not crossed
   * between multiple Tube embeds. The string passed here must match the

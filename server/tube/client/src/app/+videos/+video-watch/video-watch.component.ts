...
import { cleanupVideoWatch, getStoredTheater, getStoredVideoWatchHistory } from '../../../assets/player/tube-player-local-storage'
import {
  ...
  PlayerMode,
  videojs
} from '../../../assets/player/tube-player-manager'
...
export class VideoWatchComponent implements OnInit, OnDestroy {
  ...
  private setOpenGraphTags () {
    ...
    this.metaService.setTag('og:site_name', 'Tube')

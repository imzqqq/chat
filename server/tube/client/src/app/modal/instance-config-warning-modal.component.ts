...
export class InstanceConfigWarningModalComponent {
  ...
  shouldOpen (serverConfig: ServerConfig, about: About) {
    ...
    return serverConfig.instance.name.toLowerCase() === 'tube' ||
  ...
  isDefaultShortDescription (description: string) {
    return description === 'Tube, an ActivityPub-federated video streaming platform using P2P directly in your web browser.'
  }

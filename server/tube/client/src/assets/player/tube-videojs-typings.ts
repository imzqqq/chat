...
import { PlayerMode } from './tube-player-manager'
import { PeerTubePlugin } from './tube-plugin'
import { PeerTubeResolutionsPlugin } from './tube-resolutions-plugin'

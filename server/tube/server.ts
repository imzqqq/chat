...
import { isHTTPSignatureDigestValid } from './server/helpers/tube-crypto'
import { PeerTubeSocket } from './server/lib/tube-socket'
import { updateStreamingPlaylistsInfohashesIfNeeded } from './server/lib/hls'
import { PluginsCheckScheduler } from './server/lib/schedulers/plugins-check-scheduler'
import { PeerTubeVersionCheckScheduler } from './server/lib/schedulers/tube-version-check-scheduler'
...
cli
  .option('--no-client', 'Start Tube without client interface')
  .option('--no-plugins', 'Start Tube without plugins/themes enabled')

...
describe('Test plugin storage', function () {
  ...
  describe('Disk storage', function () {
    ...
    it('Should still have the file after an uninstallation', async function () {
      await server.plugins.uninstall({ npmName: 'tube-plugin-test-six' })

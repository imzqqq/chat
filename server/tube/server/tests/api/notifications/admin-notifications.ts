...
describe('Test admin notifications', function () {
  ...
  before(async function () {
    ...
    await server.plugins.install({ npmName: 'tube-plugin-hello-world' })
    await server.plugins.install({ npmName: 'tube-theme-background-red' })
  })

  describe('Latest Tube version notification', function () {

...
describe('Test comments notifications', function () {
  ...
  const commentText = '**hello** <a href="https://joinpeertube.org">world</a>, <h1>what do you think about tube?</h1>'
  ...
  '-webkit-text-size-adjust: 100%; text-decoration: none; color: #f2690d;">world</a>, </p>what do you think about tube?'

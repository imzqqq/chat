...
describe('Test a client controllers', function () {
  ...
  describe('Index HTML', function () {
    ...
    it('Should have valid index html tags (title, description...)', async function () {
      ...
      const description = 'Tube, an ActivityPub-federated video streaming platform using P2P directly in your web browser.'
      checkIndexTags(res.text, 'Tube', description, '', config)
    })
    ...
    it('Should update the customized configuration and have the correct index html tags', async function () {
      ...
      checkIndexTags(res.text, 'Tube updated', 'my short description', 'body { background-color: red; }', config)
    })

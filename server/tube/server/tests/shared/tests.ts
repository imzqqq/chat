const FIXTURE_URLS = {
  ...
  badVideo: 'https://download.cpy.re/tube/bad_video.mp4',
  goodVideo: 'https://download.cpy.re/tube/good_video.mp4',
  goodVideo720: 'https://download.cpy.re/tube/good_video_720.mp4',

  file4K: 'https://download.cpy.re/tube/4k_file.txt'
}

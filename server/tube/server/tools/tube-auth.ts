    ...
    prompt.get({
      properties: {
        url: {
          ...
          message: 'It should be an URL (https://tube.example.com)',
          required: true
        },
        username: {
      ...
      try {
        ...
        // @see https://github.com/Chocobozzz/Tube/issues/3520
...
program.addHelpText('after', '\n\n  Examples:\n\n' +
  '    $ tube auth add -u https://tube.cpy.re -U "PEERTUBE_USER" --password "PEERTUBE_PASSWORD"\n' +
  '    $ tube auth add -u https://tube.cpy.re -U root\n' +
  '    $ tube auth list\n' +
  '    $ tube auth del https://tube.cpy.re\n'
)

...
const SORTABLE_COLUMNS = {
  ...
  // Don't forget to update tube-search-index with the same values
...
const LOG_FILENAME = 'tube.log'
const AUDIT_LOG_FILENAME = 'tube-audit.log'
...
function buildVideoMimetypeExt () {
  const data = {
    ...
    // it would be confusing for users because Tube will refuse their file (based on the mimetype)
    'video/ogg': [ '.ogv' ],
    'video/mp4': '.mp4'
  }

 ...
 *
 * WebDAV and other codes useless with regards to Tube are not listed.
 */
export const enum HttpStatusCode {
   ...
   * teapots requested to brew coffee. This HTTP status is used as an Easter egg in some websites, including Tube instances ;-).
   */

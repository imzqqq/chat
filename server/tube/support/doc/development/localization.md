...
Source files are in `client/src/locale` and translated files merged from [Weblate](https://weblate.framasoft.org/translate/tube).
 ...
 * Lock [weblate project](https://weblate.framasoft.org/projects/tube)

...
async function run () {
...

  {
    ...
    console.log(' * `tube-x` by Solen DP (CC-BY)')
...

  {
    ...
    console.log(
      ...
      `3.0.0 of Tube. Thanks to everyone who pitched in and shared the news!*\n\n`
    )
  }

  {
    ...
    console.log(
      `\n*We ran [a crowdfunding campaign](https://www.kisskissbankbank.com/en/projects/tube-a-free-and-federated-video-platform) ` +
      `in 2018 to pave the road to the version 1.0.0 of Tube, with 1,379 backers. ` +

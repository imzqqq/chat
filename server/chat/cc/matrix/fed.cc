...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
		json::get<"uri"_>(opts.request) = "/chat/federation/v1/get_groups_publicised";
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/unstable/rooms/%s/complexity",
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/publicRooms?limit=%zu%s%s",
			opts.limit,
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/get_missing_events/%s",
			url::encode(ridbuf, room_id)
		};
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/backfill/%s/?limit=%zu&v=%s",
			url::encode(ridbuf, room_id),
			opts.limit,
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/%s/%s/?%s%s%s",
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/query_auth/%s/%s",
			url::encode(ridbuf, room_id),
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		if(opts.ids_only)
			json::get<"uri"_>(opts.request) = fmt::sprintf
			{
				buf, "/chat/federation/v1/state_ids/%s/?event_id=%s&pdu_ids=0",
				url::encode(ridbuf, room_id),
				url::encode(eidbuf, event_id),
			};
		else
			json::get<"uri"_>(opts.request) = fmt::sprintf
			{
				buf, "/chat/federation/v1/event_auth/%s/%s%s",
				url::encode(ridbuf, room_id),
				url::encode(eidbuf, event_id),
				opts.ids?
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/event/%s/",
			url::encode(eidbuf, event_id),
		};
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/invite/%s/%s",
			url::encode(ridbuf, room_id),
			url::encode(eidbuf, event_id)
		};
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v2/invite/%s/%s",
			url::encode(ridbuf, room_id),
			url::encode(eidbuf, event_id)
		};
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/send_join/%s/%s",
			url::encode(ridbuf, room_id),
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/make_join/%s/%s"
			"?ver=1"
			"&ver=2"
			"&ver=3"
			"&ver=4"
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
		json::get<"uri"_>(opts.request) = "/chat/federation/v1/user/keys/query";
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
		json::get<"uri"_>(opts.request) = "/chat/federation/v1/user/keys/claim";
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		...
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/user/devices/%s",
			url::encode(uidbuf, user_id)
		};
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		json::get<"uri"_>(opts.request) = fmt::sprintf
		{
			buf, "/chat/federation/v1/query/%s%s%s",
			type,
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
	{
		if(!empty(key_id))
		{
			json::get<"uri"_>(opts.request) = fmt::sprintf
			{
				buf, "/chat/key/v2/server/%s/",
				key_id
			};

			consume(buf, size(json::get<"uri"_>(opts.request)));
		}
		else json::get<"uri"_>(opts.request) = "/chat/key/v2/server/";
	}
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
		json::get<"uri"_>(opts.request) = "/chat/key/v2/query";
...
:request{[&]
{
	...
	if(likely(!defined(json::get<"uri"_>(opts.request))))
		json::get<"uri"_>(opts.request) = "/chat/federation/v1/version";

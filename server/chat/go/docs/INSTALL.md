...
* `/chat/client` to the client API server
* `/chat/federation` to the federation API server
* `/chat/key` to the federation API server
* `/chat/media` to the media API server

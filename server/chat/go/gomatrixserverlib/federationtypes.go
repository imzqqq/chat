...
// A RespSend is the content of a response to PUT /chat/federation/v1/send/{txnID}/
...
// A RespStateIDs is the content of a response to GET /chat/federation/v1/state_ids/{roomID}/{eventID}
...
// A RespState is the content of a response to GET /chat/federation/v1/state/{roomID}/{eventID}
...
// A RespPeek is the content of a response to GET /chat/federation/v1/peek/{roomID}/{peekID}
...
// A RespMissingEvents is the content of a response to GET /chat/federation/v1/get_missing_events/{roomID}
...
// RespPublicRooms is the content of a response to GET /chat/federation/v1/publicRooms
...
// A RespEventAuth is the content of a response to GET /chat/federation/v1/event_auth/{roomID}/{eventID}
...
// RespUserDevices contains a response to /chat/federation/v1/user/devices/{userID}
...
// A RespMakeJoin is the content of a response to GET /chat/federation/v2/make_join/{roomID}/{userID}
...
// A RespSendJoin is the content of a response to PUT /chat/federation/v2/send_join/{roomID}/{eventID}
...
// A RespMakeLeave is the content of a response to GET /chat/federation/v2/make_leave/{roomID}/{userID}
...
// A RespDirectory is the content of a response to GET  /chat/federation/v1/query/directory
...
// RespProfile is the content of a response to GET /chat/federation/v1/query/profile
...
// RespInvite is the content of a response to PUT /chat/federation/v1/invite/{roomID}/{eventID}
...
// RespInvite is the content of a response to PUT /chat/federation/v2/invite/{roomID}/{eventID}

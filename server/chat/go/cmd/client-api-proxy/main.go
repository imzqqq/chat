...
func main() {
	...
	http.Handle("/chat/client/r0/sync", syncProxy)
	http.Handle("/chat/media/v1/", mediaProxy)
	...
	fmt.Println("  /chat/client/r0/sync            => ", *syncServerURL+"/api/chat/client/r0/sync")
	fmt.Println("  /chat/media/v1                  => ", *mediaAPIURL+"/api/chat/media/v1")

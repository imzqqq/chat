...
```text
GET /chat/client/v1/rooms/{roomID}/hierarchy
```
...
```text
GET /chat/client/v1/rooms/%21ol19s%3Ableecker.street/hierarchy?
    limit=30&
    suggested_only=true&
    max_depth=4
```
...
```text
GET /chat/federation/v1/hierarchy/{roomID}
```
...
`/chat/client/unstable/org.matrix.msc2946/rooms/{roomID}/hierarchy`

The server-server API will be:
`/chat/federation/unstable/org.matrix.msc2946/hierarchy/{roomID}`

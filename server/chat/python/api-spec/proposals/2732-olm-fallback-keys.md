...
[`/keys/upload` client-server API](https://chat.api-spec.dingshunyu.top/client_server/r0.6.1#post-matrix-client-r0-keys-upload), which is in the same format as the

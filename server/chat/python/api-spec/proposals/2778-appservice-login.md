...
Chat device which means bridge users need to be able to generate a device on demand. In the past,
...
log into the accounts without having to use the /login process at all. Chat server provides such a function,
...
- [chat](https://github.com/matrix-org/chat/pull/8320)

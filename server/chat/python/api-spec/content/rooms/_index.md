...
Rooms are central to how Chat operates, and have strict rules for what
...
`0-9` and `.` are reserved for future versions of the Chat protocol.
...
-   `1` (would be reserved by the Chat protocol)
-   `1.2` (would be reserved by the Chat protocol)
-   `1.2-beta`
-   `com.example.version`

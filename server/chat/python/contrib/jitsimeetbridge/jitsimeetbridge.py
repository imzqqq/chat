...
"""
This is an attempt at bridging Chat clients into a Meet room via Chat
video call. It uses hard-coded xml strings overg XMPP BOSH. It can display one
of the streams from the Meet bridge until the second lot of SDP comes down and
...
MATRIXBASE = "https://matrix.org/chat/client/api/v1/"

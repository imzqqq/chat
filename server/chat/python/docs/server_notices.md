...
'Server Notices' are a new feature introduced in Chat server 0.30. They provide a
...
This is a feature specific to Chat server, but it uses standard Chat
communication mechanisms, so should work with any Chat client.

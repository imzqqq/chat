...
The `server_name` configured in the Chat server configuration file (often
...
server (via port 8880). This is easy to set up and will work provided
...
in the HTTP library used by Chat server, 308 redirects are currently not followed by
...
release of Chat server.

## Running a demo federation of Chat server

If you want to get up and running quickly with a trio of homeservers in a
private federation, there is a script in the `demo` directory. This is mainly
useful just for development purposes. See [demo/README](https://github.com/matrix-org/chat/tree/develop/demo/).

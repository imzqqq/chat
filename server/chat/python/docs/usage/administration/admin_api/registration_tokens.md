...
```
GET /_chat/admin/v1/registration_tokens
```
...
```
GET /_chat/admin/v1/registration_tokens?valid=false
```
```
200 OK
...
```
GET /_chat/admin/v1/registration_tokens/<token>
```
...
```
GET /_chat/admin/v1/registration_tokens/abcd
```
```
200 OK
...
```
POST /_chat/admin/v1/registration_tokens/new
```
...
```
PUT /_chat/admin/v1/registration_tokens/<token>
```
...
```
PUT /_chat/admin/v1/registration_tokens/defg
...
```
DELETE /_chat/admin/v1/registration_tokens/<token>
```
...
```
DELETE /_chat/admin/v1/registration_tokens/wxyz
```
```
200 OK
...
the [Chat Client-Server API specification](https://matrix.org/docs/spec/client_server/r0.6.1#api-standards).

For example, if the token specified in a path parameter does not exist a
`404 Not Found` error will be returned.

```
GET /_chat/admin/v1/registration_tokens/1234
```

...
```
GET /_chat/admin/v2/users/<user_id>
```
...
```
PUT /_chat/admin/v2/users/<user_id>
```
...
```
GET /_chat/admin/v2/users?from=0&limit=10&guests=false
```
...
```
GET /_chat/admin/v1/whois/<user_id>
```

and:

```
GET /chat/client/r0/admin/whois/<userId>
```
...
```
POST /_chat/admin/v1/deactivate/<user_id>
```
...
```
POST /_chat/admin/v1/reset_password/<user_id>
```
...
```
GET /_chat/admin/v1/users/<user_id>/admin
```
...
```
PUT /_chat/admin/v1/users/<user_id>/admin
```
...
```
GET /_chat/admin/v1/users/<user_id>/joined_rooms
```
...
```
GET /_chat/admin/v1/users/<user_id>/media
```
...
```
DELETE /_chat/admin/v1/users/<user_id>/media
```
...
```
POST /_chat/admin/v1/users/<user_id>/login
{}
```
...
```
GET /_chat/admin/v2/users/<user_id>/devices
```
...
```
POST /_chat/admin/v2/users/<user_id>/delete_devices
...
```
GET /_chat/admin/v2/users/<user_id>/devices/<device_id>
```
...
```
PUT /_chat/admin/v2/users/<user_id>/devices/<device_id>
...
```
DELETE /_chat/admin/v2/users/<user_id>/devices/<device_id>
...
```
GET /_chat/admin/v1/users/<user_id>/pushers
```
...
```
POST /_chat/admin/v1/users/<user_id>/shadow_ban
```
...
```
GET /_chat/admin/v1/users/<user_id>/override_ratelimit
```
...
```
POST /_chat/admin/v1/users/<user_id>/override_ratelimit
```
...
```
DELETE /_chat/admin/v1/users/<user_id>/override_ratelimit
```
...
`/chat/client/r0/register/available`.

The API is:

```
POST /_chat/admin/v1/username_availabile?username=$localpart
```

The request and response format is the same as the [/chat/client/r0/register/available](https://matrix.org/docs/spec/client_server/r0.6.0#get-matrix-client-r0-register-available) API.

...
The API is:
```
GET /_chat/admin/v1/room/<room_id>/media
```
...
```
POST /_chat/admin/v1/media/quarantine/<server_name>/<media_id>
...
```
POST /_chat/admin/v1/media/unquarantine/<server_name>/<media_id>
...
```
POST /_chat/admin/v1/room/<room_id>/media/quarantine
...
/_chat/admin/v1/quarantine_media/<room_id>`, that operates the same.
...
```
POST /_chat/admin/v1/user/<user_id>/media/quarantine
...
```
POST /_chat/admin/v1/media/protect/<media_id>
...
```
POST /_chat/admin/v1/media/unprotect/<media_id>
...
```
DELETE /_chat/admin/v1/media/<server_name>/<media_id>
...
```
POST /_chat/admin/v1/media/<server_name>/delete?before_ts=<before_ts>
...
```
POST /_chat/admin/v1/purge_media_cache?before_ts=<unix_timestamp_in_ms>
...
If the user re-requests purged remote media, chat will re-request the media

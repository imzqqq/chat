...
The api is:
```
GET /_chat/admin/v1/event_reports?from=0&limit=10
```
...
The api is:
```
GET /_chat/admin/v1/event_reports/<report_id>
```
To use it, you will need to authenticate by providing an `access_token` for a
server admin: see [Admin API](../usage/administration/admin_api).
...
```jsonc
{
    ...
    "event_json": {
        ...
        "content": {
            "body": "matrix.org: This Week in Chat",
            "format": "org.matrix.custom.html",
            "formatted_body": "<strong>matrix.org</strong>:<br><a href=\"https://matrix.org/blog/\"><strong>This Week in Chat</strong></a>",
            "msgtype": "m.notice"
        },
        "depth": 546,
        "hashes": {

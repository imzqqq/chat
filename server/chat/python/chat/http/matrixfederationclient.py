...
from chat.http import QuieterFileBodyProducer
from chat.http.client import (
...
from chat.logging import opentracing
from chat.logging.context import make_deferred_yieldable
from chat.logging.opentracing import set_tag, start_active_span, tags
from chat.types import JsonDict
from chat.util import json_decoder
from chat.util.async_helpers import timeout_deferred
...
class MatrixFederationHttpClient:
    ...
    async def _send_request_with_optional_trailing_slash(
        ...
        **send_request_args,
        ...
        'M_UNRECOGNIZED' errcode. This is a workaround for Chat <= v0.99.3
        due to #3622.
        ...
        try:
            ...
            # trailing slash on Chat <= v0.99.3.
    ...
    async def _send_request(
        ...
        limiter = await chat.util.retryutils.get_retry_limiter(
            request.destination,
            self.clock,
            self._store,
    ...
    async def put_json(
        ...
        Args:
            ...
            try_trailing_slash_on_400: True if on a 400 M_UNRECOGNIZED
                ...
                of the request. Workaround for #3622 in Chat <= v0.99.3. This
    ...
    async def get_json(
        ...
        Args:
            ...
            try_trailing_slash_on_400: True if on a 400 M_UNRECOGNIZED
                ...
                the request. Workaround for #3622 in Chat <= v0.99.3.
        Returns:
            Succeeds when we get a 2xx HTTP response. The
            result will be the decoded JSON body.

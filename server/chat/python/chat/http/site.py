...
from chat.http import get_request_user_agent, redact_uri
from chat.http.request_metrics import RequestMetrics, requests_counter
...
class SynapseRequest(Request):
    """Class which encapsulates an HTTP request to chat.

    All of the requests processed in chat are of this type.
    ...
    def connectionLost(self, reason):
        ...
        # More information: https://github.com/matrix-org/chat/issues/7441
...
class XForwardedForRequest(SynapseRequest):
    ...
    def _process_forwarded_headers(self):
        ...
        # see https://github.com/matrix-org/chat/issues/9471
...
class SynapseSite(Site):
    """
    Chat-specific twisted http Site

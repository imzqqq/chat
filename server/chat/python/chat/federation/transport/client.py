...
from chat.api.room_versions import RoomVersion
...
from chat.http.matrixfederationclient import ByteParser
...
class TransportLayerClient:
    ...
    async def get_public_rooms(
        ...
        See chat.federation.federation_client.FederationClient.get_public_rooms for
        more information.
        """
        if search_filter:

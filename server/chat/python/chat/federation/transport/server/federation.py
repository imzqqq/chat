...
from chat.api.urls import FEDERATION_UNSTABLE_PREFIX, FEDERATION_V2_PREFIX
...
class FederationV2InviteServlet(BaseFederationServerServlet):
    ...
    async def on_PUT(
        ...
        # Chat expects invite_room_state to be in unsigned, as it is in v1
        # API
...
class FederationVersionServlet(BaseFederationServlet):
    ...
    async def on_GET(
        ...
        return (
            200,
            {"server": {"name": "Chat", "version": get_version_string(chat)}},
        )

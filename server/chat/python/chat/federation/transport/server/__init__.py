...
from chat.api.errors import FederationDeniedError, SynapseError
from chat.federation.transport.server._base import (
    Authenticator,
    BaseFederationServlet,
)
from chat.federation.transport.server.federation import FEDERATION_SERVLET_CLASSES
from chat.federation.transport.server.groups_local import GROUP_LOCAL_SERVLET_CLASSES
from chat.federation.transport.server.groups_server import (

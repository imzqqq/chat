...
from chat.events import EventBase, builder
from chat.federation.federation_base import FederationBase, event_from_pdu_json
from chat.federation.transport.client import SendJoinResponse
...
class FederationClient(FederationBase):
    ...
    def _is_unknown_endpoint(
        ...
        #
        # Dendrite returns a 404 (with no body); chat returns a 400
        # with M_UNRECOGNISED.

...
from chat.logging.opentracing import SynapseTags, set_tag
from chat.metrics import sent_transactions_counter
from chat.metrics.background_process_metrics import run_as_background_process
from chat.types import ReadReceipt
from chat.util.retryutils import NotRetryingDestination, get_retry_limiter
...
class PerDestinationQueue:
    ...
    def __init__(
        ...
        transaction_manager: "chat.federation.sender.TransactionManager",
        destination: str,
    ):
        ...
        # https://github.com/matrix-org/chat/issues/7549

...
from chat.api.constants import EduTypes, EventTypes, Membership
...
from chat.api.room_versions import KNOWN_ROOM_VERSIONS, RoomVersion
...
from chat.federation.federation_base import FederationBase, event_from_pdu_json
from chat.federation.persistence import TransactionActions
from chat.federation.units import Edu, Transaction
...
from chat.logging.opentracing import log_kv, start_active_span_from_edu, trace
...
from chat.storage.databases.main.lock import Lock
from chat.types import JsonDict, get_domain_from_id
from chat.util import glob_to_regex, json_decoder, unwrapFirstError
...
from chat.util.stringutils import parse_server_name
...
class FederationServer(FederationBase):
    ...
    async def _handle_pdus_in_txn(
        ...
        for p in transaction.pdus:
            ...
            #  https://github.com/matrix-org/chat/issues/8429
            if "unsigned" in p:
                unsigned = p["unsigned"]
                if "age" in unsigned:
                    p["age"] = unsigned["age"]

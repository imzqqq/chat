...
from chat.storage.database import DatabasePool, LoggingTransaction
from chat.storage.databases.main.roommember import ProfileInfo
from chat.storage.state import StateFilter
from chat.types import JsonDict, Requester, UserID, UserInfo, create_requester
...
class ModuleApi:
    ...
    #################################################################################
    # The following methods should only be called during the module's initialization.
    ...
    def register_web_resource(self, path: str, resource: IResource):
        ...
        This function should be called during initialization of the module.
    ...
    def http_client(self):
        ...
        An instance of chat.http.client.SimpleHttpClient
        """
    ...
    def public_room_list_manager(self):
        ...
        An instance of chat.module_api.PublicRoomListManager
        """
    ...
    async def get_threepids_for_user(self, user_id: str) -> List[Dict[str, str]]:
        ...
        Args:
            user_id: The Chat user ID to look up threepids for.
    ...
    def invalidate_access_token(self, access_token):
        ...
        Raises:
            chat.api.errors.AuthError: the access token is invalid
        """
    ...
    def get_state_events_in_room(
        ...
        Returns:
            twisted.internet.defer.Deferred[list(chat.events.FrozenEvent)]:
    ...
    async def send_mail(
        ...
        """Send an email on behalf of the Chat server.
    ...
    def read_templates(
        ...
        By default, Chat will look for these templates in its configured template

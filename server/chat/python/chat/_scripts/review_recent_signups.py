...
from chat.config._base import RootConfig, find_config_files, read_config_files
from chat.config.database import DatabaseConfig
from chat.storage.database import DatabasePool, LoggingTransaction, make_conn
...
def main():
    ...
    parser.add_argument(
        ...
        action="append",
        metavar="CONFIG_FILE",
        help="The config files for Chat.",
        required=True,
    )
    parser.add_argument(
        "-s",

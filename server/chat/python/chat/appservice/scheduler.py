...
from chat.appservice import ApplicationService, ApplicationServiceState
...
class _TransactionController:
    ...
    Args:
        clock (chat.util.Clock):
        store (chat.storage.DataStore):
        as_api (chat.appservice.api.ApplicationServiceApi):
    """
    ...
    def start_recoverer(self, service):
        ...
        Args:
            service (chat.appservice.ApplicationService):
        """
...
class _Recoverer:
    ...
    Args:
        ...
        store (chat.storage.DataStore):
        as_api (chat.appservice.api.ApplicationServiceApi):
        service (chat.appservice.ApplicationService): the service we are managing

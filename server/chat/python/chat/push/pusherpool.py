...
from chat.push import Pusher, PusherConfig, PusherConfigException
from chat.push.pusher import PusherFactory
from chat.replication.http.push import ReplicationRemovePusherRestServlet
...
synapse_pushers = Gauge(
    "synapse_pushers", "Number of active chat pushers", ["kind", "app_id"]
)

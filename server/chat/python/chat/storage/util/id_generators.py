...
from chat.storage.util.sequence import PostgresSequenceGenerator
...
def _load_current_id(db_conn, table, column, step=1):
    ...
    Returns:
        int
    """
    # debug logging for https://github.com/matrix-org/chat/issues/7968
...
class MultiWriterIdGenerator:
    ...
    def get_current_token_for_writer(self, instance_name: str) -> int:
        ...
        # persisted up to position. This stops Chat from doing a full table

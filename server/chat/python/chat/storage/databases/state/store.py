...
from chat.storage.databases.state.bg_updates import StateBackgroundUpdateStore
...
from chat.types import MutableStateMap, StateMap
from chat.util.caches.descriptors import cached
from chat.util.caches.dictionary_cache import DictionaryCache

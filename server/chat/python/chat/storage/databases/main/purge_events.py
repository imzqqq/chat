...
from chat.storage.databases.main import CacheInvalidationWorkerStore
from chat.storage.databases.main.state import StateGroupWorkerStore
from chat.types import RoomStreamToken
...
class PurgeEventsStore(StateGroupWorkerStore, CacheInvalidationWorkerStore):
    ...
    def _purge_history_txn(
        ...
        # chat tries to take out an exclusive lock on room_depth whenever it

...
from chat.storage.engines import Sqlite3Engine
from chat.storage.roommember import (
    GetRoomsForUserWithStreamOrdering,
    MemberSummary,
    ProfileInfo,
    RoomsForUser,
)
from chat.types import PersistedEventPosition, StateMap, get_domain_from_id
from chat.util.async_helpers import Linearizer
from chat.util.caches import intern_string
from chat.util.caches.descriptors import _CacheContext, cached, cachedList
from chat.util.metrics import Measure

if TYPE_CHECKING:
    from chat.state import _StateCacheEntry
...
class RoomMemberWorkerStore(EventsWorkerStore):
    ...
    async def get_rooms_for_local_user_where_membership_is(
        ...
        Args:
            user_id: The user ID.
            membership_list: A list of chat.api.constants.Membership

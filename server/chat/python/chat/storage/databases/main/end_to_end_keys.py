...
from chat.api.constants import DeviceKeyAlgorithms
from chat.logging.opentracing import log_kv, set_tag, trace
from chat.storage._base import SQLBaseStore, db_to_json
from chat.storage.database import DatabasePool, make_in_list_sql_clause
...
if TYPE_CHECKING:
    from chat.handlers.e2e_keys import SignatureListItem
...
class EndToEndKeyWorkerStore(EndToEndKeyBackgroundStore):
    ...
    async def get_e2e_device_keys_for_cs_api(
        ...
        Returns:
            ...
            DeviceKeys type returned by POST /chat/client/r0/keys/query.
        """

...
import chat.metrics
from chat.api.constants import EventContentFields, EventTypes, RelationTypes
from chat.api.room_versions import RoomVersions
from chat.crypto.event_signing import compute_event_reference_hash
from chat.events import EventBase  # noqa: F401
from chat.events.snapshot import EventContext  # noqa: F401
from chat.logging.utils import log_function
from chat.storage._base import db_to_json, make_in_list_sql_clause
from chat.storage.database import DatabasePool, LoggingTransaction
from chat.storage.databases.main.search import SearchEntry
from chat.storage.types import Connection
from chat.storage.util.id_generators import MultiWriterIdGenerator
from chat.storage.util.sequence import SequenceGenerator
from chat.types import StateMap, get_domain_from_id
from chat.util import json_encoder
from chat.util.iterutils import batch_iter, sorted_topologically
...
class PersistEventsStore:
    ...
    async def _persist_events_and_state_updates(
        ...
        async with stream_ordering_manager as stream_orderings:
            ...
            if not backfilled:
                ...
                chat.metrics.event_persisted_position.set(
    ...
    def _update_outliers_txn(self, txn, events_and_contexts):
        ...
        for event, context in events_and_contexts:
            ...
            if not event.internal_metadata.is_outlier() and outlier_persisted:
                ...
                # TODO: This is unused as of Chat server v1.31. Remove it once we are happy
    ...
    def _store_event_txn(self, txn, events_and_contexts):
        ...
        def get_internal_metadata(event):
            ...
            # temporary hack for database compatibility with Chat 1.30 and earlier:
            # store the `outlier` flag inside the internal_metadata json as well as in
            # the `events` table, so that if anyone rolls back to an older Chat,

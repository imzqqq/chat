...
from chat.metrics import GaugeBucketCollector
...
class ServerMetricsStore(EventPushActionsWorkerStore, SQLBaseStore):
    ...
    async def count_monthly_users(self) -> int:
        ...
        from the mau figure in chat.storage.monthly_active_users which,
    ...
    async def generate_user_daily_visits(self) -> None:
        ...
        def _generate_user_daily_visits(txn):
            ...
            # https://github.com/matrix-org/chat/pull/8503#discussion_r502306111
            sql = """

...
from chat.config.server import DEFAULT_IP_RANGE_BLACKLIST, generate_ip_set
...
The Chat server config url_preview_ip_range_blacklist will be ignored as an HTTP(s) proxy is configured."""
...
class ContentRepositoryConfig(Config):
    ...
    def read_config(self, config, **kwargs):
        ...
        if (
            ...
            and config.get("worker_app") != "chat.app.media_repository"
        ):
        ...
        for i, provider_config in enumerate(storage_providers):
            ...
            if provider_config["module"] == "file_system":
                provider_config["module"] = (
                    "chat.rest.media.v1.storage_provider"
    ...
    def generate_config_section(self, data_dir_path, **kwargs):
        ...
        # Enable the media store service in the Chat server master. Uncomment the
        ...
        # See https://chat.docs.dingshunyu.top/reverse_proxy.html.
        #
...
%(formatted_thumbnail_sizes)s
        ...
        # internal services in your network that you do not want Chat server to try
        # to connect to, otherwise anyone in any Matrix room could cause your
        # Chat server to issue arbitrary GET requests to your internal services,
...
%(ip_range_blacklist)s
        ...
        # you know that will never want Chat server to try to spider.
        #
        ...
        # Chat server to specify the preferred languages that URL previews should

...
from chat.util.stringutils import random_string, random_string_with_symbols
...
Chat server requires that a list of trusted key servers are specified in order to
...
### MARK - imzqqq, TODO: use local trusted key server
...
class KeyConfig(Config):
    ...
    def generate_config_section(
        ...
        old_signing_keys:
          ...
          # `export_signing_key` script which is provided with Chat server.
          #
          # For example:
          #
        ...
        # will make Chat server check that the response is signed by that key.
        #
        ...
        #       and federation_verify_certificates is not `true`, Chat server will refuse

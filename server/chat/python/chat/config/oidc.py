...
from chat.util.stringutils import parse_and_validate_mxc_uri

from ._base import Config, ConfigError, read_file

DEFAULT_USER_MAPPING_PROVIDER = "chat.handlers.oidc.JinjaOidcMappingProvider"
# The module that JinjaOidcMappingProvider is in was renamed, we want to
# transparently handle both the same.
LEGACY_USER_MAPPING_PROVIDER = "chat.handlers.oidc_handler.JinjaOidcMappingProvider"
...
class OIDCConfig(Config):
    ...
    def read_config(self, config, **kwargs):
        ...
        # after Chat server has forked so doesn't give nice errors.)
        ...
        self.oidc_callback_url = public_baseurl + "_chat/client/oidc/callback"
    ...
    def generate_config_section(self, config_dir_path, server_name, **kwargs):
        ...
        #       by Chat server; should be a single word such as 'github'.
        #
        ...
        #       by clients and Chat server's own IdP picker page. If given, must be an
        ...
        #           in the ID Token.
        #
        #   It is possible to configure Chat server to only allow logins if certain attributes

...
from chat.types import RoomAlias, UserID
from chat.util.stringutils import random_string_with_symbols, strtobool
...
class RegistrationConfig(Config):
            ...
            if self.auto_join_room_requires_invite:
                if not mxid_localpart:
                    raise ConfigError(
                        ...
                        "Chat server knows who to send invitations from. Please "
    ...
    def generate_config_section(self, generate_secrets=False, **kwargs):
        ...
        # identifier to their account. This is due to Chat server currently not supporting

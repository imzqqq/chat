...
from chat.util.templates import _create_mxc_to_http_filter, _format_ts_filter
...
growth of the Chat community, and helps us to make Chat a success, as well
...
CONFIG_FILE_HEADER = """\
# Configuration file for Chat server.
#
...
class Config:
    ...
    def __init__(self, root_config=None):
        ...
        # Get the path to the default chat server template directory
    ...
    def read_template(self, filename: str) -> jinja2.Template:
        ...
        This function will attempt to load the given template from the default chat server
        template directory.
    ...
    def read_templates(
        ...
        This function will attempt to load the given templates from the default chat server
        ...
        chat server's default directory.
        ...
        Args:
            ...
            custom_template_directories: A list of directory to try to look for the
                templates before using the default chat server template directory instead.
        ...
        # TODO: switch to chat.util.templates.build_jinja_env
    ...
    def generate_config(
        ...
        Args:
            ...
            listeners (list(dict)|None): A list of descriptions of the listeners
                Chat server should start with each of which specifies a port (str), a list of

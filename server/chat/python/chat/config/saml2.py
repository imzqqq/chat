...
from chat.util.module_loader import load_module, load_python_module
...
DEFAULT_USER_MAPPING_PROVIDER = "chat.handlers.saml.DefaultSamlMappingProvider"
...
LEGACY_USER_MAPPING_PROVIDER = (
    "chat.handlers.saml_handler.DefaultSamlMappingProvider"
)
...
class SAML2Config(Config):
    ...
    def _default_saml_config_dict(
        ...
        Args:
            ...
            optional_attributes: SAML auth response attributes that can be used to add
                additional information to Chat server user accounts, but are not required
        ...
        metadata_url = public_baseurl + "_chat/client/saml2/metadata.xml"
        response_url = public_baseurl + "_chat/client/saml2/authn_response"
        return {
    ...
    def generate_config_section(self, config_dir_path, server_name, **kwargs):
        ...
        # The following settings can be used to make Chat server use a single sign-on
        ...
        # https://<server>:<port>/_chat/client/saml2/metadata.xml, which you may be able to
        # use to configure your SAML IdP with. Alternatively, you can manually configure
        # the IdP to use an ACS location of
        # https://<server>:<port>/_chat/client/saml2/authn_response.
        #
        saml2_config:
          ...
          # In previous versions of Chat server, the mapping from SAML attribute to
          ...
          # It is possible to configure Chat server to only allow logins if SAML attributes

...
async def get_retry_limiter(destination, clock, store, ignore_backoff=False, **kwargs):
    ...
    Args:
        ...
        clock (chat.util.clock): timing source
        store (chat.storage.transactions.TransactionStore): datastore
...
class RetryDestinationLimiter:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        chat.logging.context.run_in_background(store_retry_timings)

...
from chat.logging.context import make_deferred_yieldable, preserve_fn
from chat.util import unwrapFirstError
from chat.util.caches.deferred_cache import DeferredCache
...
class _CachedFunction(Generic[F]):
    ...
    # Note: This function signature is actually fiddled with by the chat mypy

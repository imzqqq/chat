...
from chat.util.caches.treecache import TreeCache, iterate_tree_cache_entry
...
class DeferredCache(Generic[KT, VT]):
    ...
    def get(
        ...
        For symmetry with set(), this method does *not* follow the chat logcontext
    ...
    def set(
        ...
        *original* `value`, (c) any future calls to `get()` will complete with the
        ...
        It is expected that `value` does *not* follow the chat logcontext rules - ie,

...
from chat.api.filtering import Filtering
from chat.api.ratelimiting import Ratelimiter
from chat.appservice.api import ApplicationServiceApi
from chat.appservice.scheduler import ApplicationServiceScheduler
from chat.config.homeserver import HomeServerConfig
from chat.crypto import context_factory
from chat.crypto.context_factory import RegularPolicyForHTTPS
from chat.crypto.keyring import Keyring
from chat.events.builder import EventBuilderFactory
from chat.events.presence_router import PresenceRouter
from chat.events.spamcheck import SpamChecker
from chat.events.third_party_rules import ThirdPartyEventRules
from chat.events.utils import EventClientSerializer
from chat.federation.federation_client import FederationClient
from chat.federation.federation_server import (
    FederationHandlerRegistry,
    FederationServer,
)
from chat.federation.send_queue import FederationRemoteSendQueue
from chat.federation.sender import AbstractFederationSender, FederationSender
from chat.federation.transport.client import TransportLayerClient
from chat.groups.attestations import GroupAttestationSigning, GroupAttestionRenewer
from chat.groups.groups_server import GroupsServerHandler, GroupsServerWorkerHandler
from chat.handlers.account_data import AccountDataHandler
from chat.handlers.account_validity import AccountValidityHandler
from chat.handlers.admin import AdminHandler
from chat.handlers.appservice import ApplicationServicesHandler
from chat.handlers.auth import AuthHandler, MacaroonGenerator
from chat.handlers.cas import CasHandler
from chat.handlers.deactivate_account import DeactivateAccountHandler
from chat.handlers.device import DeviceHandler, DeviceWorkerHandler
from chat.handlers.devicemessage import DeviceMessageHandler
from chat.handlers.directory import DirectoryHandler
from chat.handlers.e2e_keys import E2eKeysHandler
from chat.handlers.e2e_room_keys import E2eRoomKeysHandler
from chat.handlers.event_auth import EventAuthHandler
from chat.handlers.events import EventHandler, EventStreamHandler
from chat.handlers.federation import FederationHandler
from chat.handlers.groups_local import GroupsLocalHandler, GroupsLocalWorkerHandler
from chat.handlers.identity import IdentityHandler
from chat.handlers.initial_sync import InitialSyncHandler
from chat.handlers.message import EventCreationHandler, MessageHandler
from chat.handlers.pagination import PaginationHandler
from chat.handlers.password_policy import PasswordPolicyHandler
from chat.handlers.presence import (
    BasePresenceHandler,
    PresenceHandler,
    WorkerPresenceHandler,
)
from chat.handlers.profile import ProfileHandler
from chat.handlers.read_marker import ReadMarkerHandler
from chat.handlers.receipts import ReceiptsHandler
from chat.handlers.register import RegistrationHandler
from chat.handlers.room import (
    RoomContextHandler,
    RoomCreationHandler,
    RoomShutdownHandler,
)
from chat.handlers.room_list import RoomListHandler
from chat.handlers.room_member import RoomMemberHandler, RoomMemberMasterHandler
from chat.handlers.room_member_worker import RoomMemberWorkerHandler
from chat.handlers.room_summary import RoomSummaryHandler
from chat.handlers.search import SearchHandler
from chat.handlers.send_email import SendEmailHandler
from chat.handlers.set_password import SetPasswordHandler
from chat.handlers.sso import SsoHandler
from chat.handlers.stats import StatsHandler
from chat.handlers.sync import SyncHandler
from chat.handlers.typing import FollowerTypingHandler, TypingWriterHandler
from chat.handlers.user_directory import UserDirectoryHandler
from chat.http.client import InsecureInterceptableContextFactory, SimpleHttpClient
from chat.http.matrixfederationclient import MatrixFederationHttpClient
from chat.module_api import ModuleApi
from chat.notifier import Notifier
from chat.push.action_generator import ActionGenerator
from chat.push.pusherpool import PusherPool
from chat.replication.tcp.client import ReplicationDataHandler
from chat.replication.tcp.external_cache import ExternalCache
from chat.replication.tcp.handler import ReplicationCommandHandler
from chat.replication.tcp.resource import ReplicationStreamer
from chat.replication.tcp.streams import STREAMS_MAP, Stream
from chat.rest.media.v1.media_repository import (
    MediaRepository,
    MediaRepositoryResource,
)
from chat.server_notices.server_notices_manager import ServerNoticesManager
from chat.server_notices.server_notices_sender import ServerNoticesSender
from chat.server_notices.worker_server_notices_sender import (
    WorkerServerNoticesSender,
)
from chat.state import StateHandler, StateResolutionHandler
from chat.storage import Databases, DataStore, Storage
from chat.streams.events import EventSources
from chat.types import DomainSpecificString, ISynapseReactor
from chat.util import Clock
from chat.util.distributor import Distributor
...
if TYPE_CHECKING:
    ...
    from chat.handlers.oidc import OidcHandler
    from chat.handlers.saml import SamlHandler
...
class HomeServer(metaclass=abc.ABCMeta):
    """A basic Chat server object without lazy component builders.
    ...
    Attributes:
        config (chat.config.homeserver.HomeserverConfig):
    ...
    # (such as chat.app.homeserver.SynapseHomeServer) and gives the class to be
    ...
    def get_instance_id(self) -> str:
        """A unique ID for this chat process instance.
    ...
    def get_instance_name(self) -> str:
        """A unique name for this chat process.
    ...
    def get_outbound_redis_connection(self) -> Optional["RedisProtocol"]:
        ...
        from chat.replication.tcp.redis import lazyConnection

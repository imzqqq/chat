...
DEFAULT_LOGGERS = {"chat": {"level": "info"}}
...
def setup_structured_logging(
    ...
    """
    Convert a legacy structured logging configuration (from Chat < v1.23.0)
    ...
    new_config = {
        "version": 1,
        "formatters": {
            "json": {"class": "chat.logging.JsonFormatter"},
            "tersejson": {"class": "chat.logging.TerseJsonFormatter"},
        },
        "handlers": {},

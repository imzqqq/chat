...
class MediaRepository:
    ...
    async def _download_remote_file(
        ...
        with self.media_storage.store_into_file(file_info) as (f, fname, finish):
            request_path = "/".join(
                ("/chat/media/r0/download", server_name, media_id)
            )
            try:
...
class MediaRepositoryResource(Resource):
    ...
    the download::
        ...
        => POST /chat/media/r0/upload HTTP/1.1
        ...
        => GET /chat/media/r0/download/<server-name>/<media-id> HTTP/1.1
    ...
    thumbnailing method::
        ...
        => GET /chat/media/r0/thumbnail/<server_name>
    ...
    def __init__(self, hs: "HomeServer"):
        ...
        if not hs.config.can_load_media_repo:
            raise ConfigError("Chat is not configured to use a media repo.")

...
from chat.api.errors import Codes, SynapseError, cs_error
from chat.http.server import finish_request, respond_with_json
from chat.logging.context import make_deferred_yieldable
from chat.util.stringutils import is_ascii
...
def add_file_headers(
    ...
    if upload_name:
        ...
        # We avoid the quoted-string version of `filename`, because (a) chat didn't

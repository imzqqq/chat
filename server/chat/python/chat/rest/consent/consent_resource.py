...
from chat.api.errors import NotFoundError, StoreError, SynapseError
from chat.config import ConfigError
from chat.http.server import DirectServeHtmlResource, respond_with_html
from chat.http.servlet import parse_bytes_from_args, parse_string
...
class ConsentResource(DirectServeHtmlResource):
    ...
    def __init__(self, hs):
        """
        Args:
            hs (chat.server.HomeServer): homeserver
        """
        super().__init__()

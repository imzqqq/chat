...
from chat.crypto.keyring import ServerKeyFetcher
from chat.http.server import DirectServeJsonResource, respond_with_json
from chat.http.servlet import parse_integer, parse_json_object_from_request
...
class RemoteKey(DirectServeJsonResource):
    ...
    GET /chat/key/v2/query/remote.server.example.com HTTP/1.1

    GET /chat/key/v2/query/remote.server.example.com/a.key.id HTTP/1.1

    POST /chat/v2/query HTTP/1.1

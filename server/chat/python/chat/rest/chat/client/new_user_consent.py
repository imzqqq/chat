...
from chat.handlers.sso import get_username_mapping_session_cookie_from_request
from chat.http.server import DirectServeHtmlResource, respond_with_html
from chat.http.servlet import parse_string
from chat.types import UserID
from chat.util.templates import build_jinja_env
...
class NewUserConsentResource(DirectServeHtmlResource):
    ...
    This resource gets mounted at /_chat/client/new_user_consent, and is shown
    ...
    async def _async_render_GET(self, request: Request) -> None:
        ...
        template_params = {
            ...
            "terms_url": "/chat/consent?v=%s" % (self._consent_version,),
        }

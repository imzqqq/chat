...
from chat.api.errors import ThreepidValidationError
...
from chat.util.stringutils import assert_valid_client_secret
...
class PasswordResetSubmitTokenResource(DirectServeHtmlResource):
    ...
    This resource gets mounted under /_chat/client/password_reset/email/submit_token
    """

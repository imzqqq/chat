...
from chat.rest.admin._base import (
    admin_patterns,
...
class UsersRestServletV2(RestServlet):
    ...
    This needs user to have administrator access in Chat.
...
class ResetPasswordRestServlet(RestServlet):
    ...
    This needs user to have administrator access in Chat.
        Example:
            http://localhost:8080/_chat/admin/v1/reset_password/
...
class SearchUsersRestServlet(RestServlet):
    ...
    This needs user to have administrator access in Chat.
        Example:
            http://localhost:8080/_chat/admin/v1/search_users/
    ...
    async def on_GET(
        ...
        """Get request to search user table for specific users according to
        search term.
        This needs user to have a administrator access in Chat.
        """
        await assert_requester_is_admin(self.auth, request)
...
class UserAdminServlet(RestServlet):
    ...
    Examples:
        * Get
            GET /_chat/admin/v1/users/@nonadmin:example.com/admin
            response on success:
                {
                    "admin": false
                }
        * Set
            PUT /_chat/admin/v1/users/@reivilibre:librepush.net/admin
            request body:
                {
                    "admin": true
                }
...
class PushersRestServlet(RestServlet):
    ...
    Example:
        http://localhost:8080/_chat/admin/v1/users/
        @user:server/pushers
...
class UserTokenRestServlet(RestServlet):
    ...
    Example:
        ...
        POST /_chat/admin/v1/users/@test:example.com/login
        {}
...
class ShadowBanRestServlet(RestServlet):
    ...
    Example:
        ...
        POST /_chat/admin/v1/users/@test:example.com/shadow_ban
        {}
...
class RateLimitRestServlet(RestServlet):
    ...
    Example:
        POST /_chat/admin/v1/users/@test:example.com/override_ratelimit
        {

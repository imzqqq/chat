...
from chat.api.filtering import Filter
from chat.events.utils import format_event_for_client_v2
...
from chat.types import JsonDict, StreamToken, ThirdPartyInstanceID, UserID
from chat.util import json_decoder
from chat.util.stringutils import parse_and_validate_server_name, random_string
...
class RoomAliasListServlet(RestServlet):
    PATTERNS = [
        re.compile(
            r"^/chat/client/unstable/org\.matrix\.msc2432"
...
class RoomSpaceSummaryRestServlet(RestServlet):
    PATTERNS = (
        re.compile(
            "^/chat/client/unstable/org.matrix.msc2946"
...
class RoomSummaryRestServlet(ResolveRoomIdMixin, RestServlet):
    PATTERNS = (
        re.compile(
            "^/chat/client/unstable/im.nheko.summary"

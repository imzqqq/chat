...
from chat.api.constants import EventContentFields, EventTypes
from chat.api.errors import AuthError, Codes, SynapseError
...
from chat.types import Requester, UserID, create_requester
...
class RoomBatchSendEventRestServlet(RestServlet):
    ...
    POST /chat/client/unstable/org.matrix.msc2716/rooms/<roomID>/batch_send?prev_event=<eventID>&chunk_id=<chunkID>
    {
        "events": [ ... ],
    ...
    PATTERNS = (
        re.compile(
            "^/chat/client/unstable/org.matrix.msc2716"

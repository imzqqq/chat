...
from chat.api.errors import Codes, LoginError, SynapseError
from chat.api.ratelimiting import Ratelimiter
from chat.api.urls import CLIENT_API_PREFIX
from chat.appservice import ApplicationService
from chat.handlers.sso import SsoIdentityProvider
from chat.http import get_request_uri
from chat.http.server import HttpServer, finish_request
...
from chat.rest.well_known import WellKnownBuilder
...
class LoginRestServlet(RestServlet):
    ...
    def on_GET(self, request: SynapseRequest):
        ...
        if self.cas_enabled or self.saml2_enabled or self.oidc_enabled:
            ...
            # chat currently only gives out these tokens as part of the
            # SSO login flow.
...
def _get_auth_flow_dict_for_idp(
    ...
    response to GET /chat/client/r0/login
...
class SsoRedirectServlet(RestServlet):
    ...
    async def on_GET(
        ...
        if not requested_uri.startswith(baseurl_bytes):
            ...
            #    https://foo.bar/whatever/chat/...
            # to
            #    https://public.baseurl/chat/...
            #
            i = requested_uri.index(b"/chat")

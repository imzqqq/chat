...
from chat.api.constants import Membership, PresenceState
from chat.api.errors import Codes, StoreError, SynapseError
from chat.api.filtering import DEFAULT_FILTER_COLLECTION, FilterCollection
from chat.events.utils import (
    format_event_for_client_v2_without_room_id,
    format_event_raw,
)
from chat.handlers.presence import format_user_presence_state
from chat.handlers.sync import KnockedSyncResult, SyncConfig
from chat.http.servlet import RestServlet, parse_boolean, parse_integer, parse_string
from chat.http.site import SynapseRequest
from chat.types import JsonDict, StreamToken
...
class SyncRestServlet(RestServlet):
    ...
    async def encode_response(self, time_now, sync_result, access_token_id, filter):
        ...
        # Corresponding chat issue: https://github.com/matrix-org/chat/issues/10456
    ...
    async def encode_joined(
        ...
        Args:
            rooms(list[chat.handlers.sync.JoinedSyncResult]): list of sync
    ...
    async def encode_invited(self, rooms, time_now, token_id, event_formatter):
        ...
        Args:
            rooms(list[chat.handlers.sync.InvitedSyncResult]): list of
    ...
    async def encode_archived(
        ...
        Args:
            rooms (list[chat.handlers.sync.ArchivedSyncResult]): list of

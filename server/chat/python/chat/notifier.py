...
import chat.server
from chat.api.constants import EventTypes, HistoryVisibility, Membership
...
from chat.logging import issue9533_logger
from chat.logging.context import PreserveLoggingContext
from chat.logging.opentracing import log_kv, start_active_span
...
from chat.types import PersistedEventPosition, RoomStreamToken, StreamToken, UserID
from chat.util.async_helpers import ObservableDeferred, timeout_deferred
...
class Notifier:
    ...
    def __init__(self, hs: "chat.server.HomeServer"):

...
from chat import event_auth
from chat.api.constants import (
    EventContentFields,
    EventTypes,
    Membership,
    RejectedReason,
...
from chat.api.room_versions import KNOWN_ROOM_VERSIONS, RoomVersion, RoomVersions
from chat.crypto.event_signing import compute_event_signature
from chat.event_auth import auth_types_for_event
from chat.events import EventBase
from chat.events.snapshot import EventContext
from chat.events.validator import EventValidator
from chat.handlers._base import BaseHandler
from chat.http.servlet import assert_params_in_dict
...
from chat.replication.http.devices import ReplicationUserDevicesResyncRestServlet
from chat.replication.http.federation import (
    ReplicationCleanRoomRestServlet,
    ReplicationFederationSendEventsRestServlet,
    ReplicationStoreRoomOnOutlierMembershipRestServlet,
)
from chat.state import StateResolutionStore
from chat.storage.databases.main.events_worker import EventRedactBehaviour
...
from chat.util.async_helpers import Linearizer, concurrently_execute
from chat.util.iterutils import batch_iter
from chat.util.retryutils import NotRetryingDestination
from chat.util.stringutils import shortstr
from chat.visibility import filter_events_for_server
...
class FederationHandler(BaseHandler):
    ...
    async def _get_missing_events_for_pdu(
        ...
        # https://github.com/matrix-org/chat/issues/1733.
        ...
        # apparently.
        #
        # see https://github.com/matrix-org/chat/pull/1744
        #
        # ----
        #
        ...
        #   https://github.com/matrix-org/chat/pull/3456) reject any PDUs where the
    ...
    async def on_backfill_request(
        ...
        # Chat asks for 100 events per backfill request. Do not allow more.
        limit = min(limit, 100)

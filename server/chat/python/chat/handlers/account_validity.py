...
from chat.api.errors import AuthError, StoreError, SynapseError
...
# Temporary hooks to allow for a transition from `/chat/client` endpoints
# to `/_chat/client/account_validity`. See `register_account_validity_callbacks`.
...
class AccountValidityHandler:
    ...
    def register_account_validity_callbacks(
        ...
        # the path from /chat/client/unstable/account_validity/... to
        # /_chat/client/account_validity, because:
        #
        #   * the feature isn't part of the Matrix spec thus shouldn't live under /chat

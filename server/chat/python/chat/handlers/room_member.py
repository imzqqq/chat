...
from chat.event_auth import get_named_level, get_power_level_event
...
from chat.util.distributor import user_left_room
...
class RoomMemberHandler(metaclass=abc.ABCMeta):
    ...
    async def update_membership(
        ...
        Params:
            ...
            action: The membership change, see chat.api.constants.Membership.
        ...
        if effective_membership_state == Membership.JOIN:
            ...
            if not is_host_in_room:
                ...
                if current_membership_type == Membership.INVITE:
                    ...
                    #
                    # see: https://github.com/matrix-org/chat/issues/7139

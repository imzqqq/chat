...
from chat.api.constants import ToDeviceEventTypes
...
from chat.logging.opentracing import (
    SynapseTags,
...
from chat.types import JsonDict, Requester, UserID, get_domain_from_id
...
class DeviceMessageHandler:
    def __init__(self, hs: "HomeServer"):
        ...
        # `chat.app.generic_worker.FederationSenderHandler` when it sees it

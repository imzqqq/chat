...
import chat.metrics
from chat.api.constants import EventTypes, Membership, PresenceState
...
from chat.logging.context import run_in_background
...
from chat.replication.http.presence import (
    ReplicationBumpPresenceActiveTime,
    ReplicationPresenceSetState,
)
from chat.replication.http.streams import ReplicationGetStreamUpdates
from chat.replication.tcp.commands import ClearUserSyncsCommand
from chat.replication.tcp.streams import PresenceFederationStream, PresenceStream
from chat.storage.databases.main import DataStore
from chat.types import JsonDict, UserID, get_domain_from_id
from chat.util.async_helpers import Linearizer
from chat.util.caches.descriptors import _CacheContext, cached
from chat.util.metrics import Measure
from chat.util.wheel_timer import WheelTimer
    ...
    async def update_external_syncs_row(
        ...
        Args:
            process_id: An identifier for the process the users are
                syncing against. This allows chat to process updates
...
class PresenceHandler(BasePresenceHandler):
    ...
    async def _on_shutdown(self) -> None:
        ...
        earlier than they should when chat is restarted. This affect of this
    ...
    async def _unsafe_process(self) -> None:
        ...
        while True:
            with Measure(self.clock, "presence_delta"):
                ...
                chat.metrics.event_processing_positions.labels("presence").set(
                    max_pos
                )

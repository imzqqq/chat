...
from chat.api.constants import AccountDataTypes, EventTypes, Membership
from chat.api.filtering import FilterCollection
...
from chat.logging.opentracing import SynapseTags, log_kv, set_tag, start_active_span
from chat.push.clientformat import format_push_rules_for_user
from chat.storage.roommember import MemberSummary
from chat.storage.state import StateFilter
...
from chat.util.async_helpers import concurrently_execute
from chat.util.caches.expiringcache import ExpiringCache
from chat.util.caches.lrucache import LruCache
from chat.util.caches.response_cache import ResponseCache, ResponseCacheContext
from chat.util.metrics import Measure, measure_func
from chat.visibility import filter_events_for_client
...
# Debug logger for https://github.com/matrix-org/chat/issues/4422
issue4422_logger = logging.getLogger("chat.handler.sync.4422_debug")
...
class SyncHandler:
    ...
    async def get_state_at(
        ...
        # (https://github.com/matrix-org/chat/issues/3305)
    ...
    async def compute_summary(
        ...
        # FIXME: this promulgates https://github.com/matrix-org/chat/issues/3305
    ...
    async def generate_sync_result(
        ...
        # debug for https://github.com/matrix-org/chat/issues/4422
    ...
    async def _get_rooms_changed(
        ...
        for room_id in sync_result_builder.joined_room_ids:
            ...
            if newly_joined:
                # debugging for https://github.com/matrix-org/chat/issues/4422
                issue4422_logger.debug(
    ...
    async def _generate_room_entry(
        ...
        # tag was added by chat e.g. for server notice rooms.
        if full_state:
            user_id = sync_result_builder.sync_config.user.to_string()
...
def _calculate_state(
    ...
    # see https://github.com/matrix-org/chat/pull/2970

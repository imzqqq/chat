...
from chat.api.room_versions import KNOWN_ROOM_VERSIONS, RoomVersions
from chat.api.urls import ConsentURIBuilder
from chat.events import EventBase
from chat.events.builder import EventBuilder
from chat.events.snapshot import EventContext
from chat.events.validator import EventValidator
from chat.logging.context import make_deferred_yieldable, run_in_background
from chat.metrics.background_process_metrics import run_as_background_process
from chat.replication.http.send_event import ReplicationSendEventRestServlet
from chat.storage.databases.main.events_worker import EventRedactBehaviour
from chat.storage.state import StateFilter
from chat.types import Requester, RoomAlias, StreamToken, UserID, create_requester
from chat.util import json_decoder, json_encoder, log_failure
from chat.util.async_helpers import Linearizer, unwrapFirstError
from chat.util.caches.expiringcache import ExpiringCache
from chat.util.metrics import measure_func
...
class EventCreationHandler:
    ...
    async def create_event(
        ...
        # chat.handlers.directory pointless.

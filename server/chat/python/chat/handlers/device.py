...
from chat.logging.opentracing import log_kv, set_tag, trace
...
class DeviceListUpdater:
    ...
    async def user_device_resync(
        ...
        try:
            ...
            # as otherwise chat will 'forget' that its device list
        ...
        # inbound federation worker to the chat master may time out

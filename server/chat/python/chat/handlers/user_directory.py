...
import chat.metrics
from chat.api.constants import EventTypes, HistoryVisibility, JoinRules, Membership
from chat.handlers.state_deltas import StateDeltasHandler
    ...
    async def _unsafe_process(self) -> None:
        ...
        while True:
            with Measure(self.clock, "user_dir_delta"):
                ...
                chat.metrics.event_processing_positions.labels("user_dir").set(
                    max_pos
                )

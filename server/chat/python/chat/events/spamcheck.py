...
from chat.rest.media.v1.media_storage import ReadableFileWrapper
from chat.spam_checker_api import RegistrationBehaviour
from chat.types import RoomAlias
...
def load_legacy_spam_checkers(hs: "chat.server.HomeServer"):
...
class SpamChecker:
    ...
    async def check_event_for_spam(
        self, event: "chat.events.EventBase"
    ) -> Union[bool, str]:

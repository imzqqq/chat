...
from chat.api.room_versions import EventFormatVersions, RoomVersion, RoomVersions
from chat.types import JsonDict, RoomStreamToken
from chat.util.caches import intern_dict
from chat.util.frozenutils import freeze
from chat.util.stringutils import strtobool

# Whether we should use frozen_dict in FrozenEvent. Using frozen_dicts prevents
# bugs where we accidentally share e.g. signature dicts. However, converting a
# dict to frozen_dicts is expensive.
#
# NOTE: This is overridden by the configuration by the Chat worker apps, but
...
class _EventInternalMetadata:
    ...
    def is_out_of_band_membership(self) -> bool:
        ...
        (Added in chat 0.99.0, so may be unreliable for events received before that)
        """

"""A replication client for use by chat workers.
"""
import logging
...
from chat.federation import send_queue
from chat.federation.sender import FederationSender
from chat.logging.context import PreserveLoggingContext, make_deferred_yieldable
from chat.metrics.background_process_metrics import run_as_background_process
from chat.replication.tcp.protocol import ClientReplicationStreamProtocol
from chat.replication.tcp.streams import (
    AccountDataStream,
    DeviceListsStream,
    GroupServerStream,
    PushersStream,
...
from chat.replication.tcp.streams.events import (
    EventsStream,
    EventsStreamEventRow,
    EventsStreamRow,
)
from chat.types import PersistedEventPosition, ReadReceipt, UserID
from chat.util.async_helpers import Linearizer, timeout_deferred
...
class FederationSenderHandler:
    ...
    async def _on_new_receipts(self, rows):
        """
        Args:
            rows (Iterable[chat.replication.tcp.streams.ReceiptsStream.ReceiptsStreamRow]):

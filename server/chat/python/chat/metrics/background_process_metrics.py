...
from chat.logging.context import LoggingContext, PreserveLoggingContext
...
def run_as_background_process(desc: str, func, *args, bg_start_span=True, **kwargs):
    ...
    follow the chat logcontext rules, which makes it appropriate for passing to
    clock.looping_call and friends (or for firing-and-forgetting in the middle of a
    normal chat async function).
    ...
    Returns: Deferred which returns the result of func, but note that it does not
        follow the chat logcontext rules.
    """

...
from chat.push import PusherConfigException
from chat.rest.client import login, receipts, room
    ...
    def test_sends_http(self):
        ...
        self.get_success(
            self.hs.get_pusherpool().add_pusher(
                ...
                pushkey="a@example.com",
                lang=None,
                data={"url": "http://example.com/chat/push/v1/notify"},
            )
        )
        ...
        self.assertEqual(
            self.push_attempts[0][1], "http://example.com/chat/push/v1/notify"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.push_attempts[1][1], "http://example.com/chat/push/v1/notify"
        )
        self.assertEqual(

...
from chat.api.constants import EduTypes
...
from chat.rest.client import login, presence, room
...
def _test_sending_local_online_presence_to_local_user(
    ...
    Args:
        test_with_workers: If True, this method will call ModuleApi.send_local_online_presence_to on a
            ...
            with a worker is to check whether a Chat module running on a worker can inform other workers/
    ...
    if test_with_workers:
        ...
        worker_hs = test_case.make_worker_hs(
            "chat.app.generic_worker", {"worker_name": "presence_writer"}
        )

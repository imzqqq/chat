...
from chat.api.constants import RoomEncryptionAlgorithms
from chat.rest import admin
from chat.rest.client import login
from chat.types import JsonDict, ReadReceipt
...
class FederationSenderDevicesTestCases(HomeserverTestCase):
    ...
    def test_prune_outbound_device_pokes1(self):
        ...
        # chat uses an empty prev_id list to indicate "needs a full resync".

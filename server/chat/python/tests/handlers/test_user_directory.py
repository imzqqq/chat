...
from chat.api.constants import EventTypes, RoomEncryptionAlgorithms, UserTypes
from chat.api.room_versions import RoomVersion, RoomVersions
from chat.rest.client import login, room, user_directory
...
class UserDirectoryTestCase(unittest.HomeserverTestCase):
    ...
    def test_prefer_local_users(self):
        ...
        # Typically we'd expect Chat to return users in lexicographical order,

...
from chat.handlers.room_summary import _child_events_comparison_key, _RoomEntry
...
class SpaceSummaryTestCase(unittest.HomeserverTestCase):
    ...
    def test_fed_complex(self):
        ...
        with mock.patch(
            "chat.handlers.room_summary.RoomSummaryHandler._summarize_remote_room",
        ...
        with mock.patch(
            "chat.handlers.room_summary.RoomSummaryHandler._summarize_remote_room_hierarchy",

...
from chat.api.constants import EventTypes, JoinRules
from chat.api.errors import Codes, ResourceLimitError
from chat.api.filtering import DEFAULT_FILTER_COLLECTION
from chat.api.room_versions import RoomVersions
from chat.handlers.sync import SyncConfig
from chat.rest import admin
from chat.rest.client import knock, login, room
...
class SyncTestCase(tests.unittest.HomeserverTestCase):
    ...
    def test_unknown_room_version(self):
        ...
        channel = self.make_request(
            "POST",
            "/chat/client/r0/knock/%s" % (knock_room,),
            b"{}",
            tok,
        )

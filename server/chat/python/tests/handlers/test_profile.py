...
class ProfileTestCase(unittest.HomeserverTestCase):
    ...
    def test_set_my_name(self):
        self.get_success(
            self.handler.set_displayname(
                self.frank, chat.types.create_requester(self.frank), "Frank Jr."
            )
        )
        ...
        self.get_success(
            self.handler.set_displayname(
                self.frank, chat.types.create_requester(self.frank), "Frank"
            )
        )
        ...
        self.get_success(
            self.handler.set_displayname(
                self.frank, chat.types.create_requester(self.frank), ""
            )
        )
    ...
    def test_set_my_name_noauth(self):
        self.get_failure(
            self.handler.set_displayname(
                self.frank, chat.types.create_requester(self.bob), "Frank Jr."
            ),
            AuthError,
        )
    ...
    def test_set_my_avatar(self):
        self.get_success(
            self.handler.set_avatar_url(
                self.frank,
                chat.types.create_requester(self.frank),

...
import chat
from chat.rest.client import devices, login
...
class PasswordAuthProviderTests(unittest.HomeserverTestCase):
    ...
    def test_custom_auth_password_disabled_localdb_enabled(self):
        ...
        Regression test for https://github.com/matrix-org/chat/issues/8914: check
    ...
    def _send_login(self, type, user, **params) -> FakeChannel:
        ...
        channel = self.make_request("POST", "/chat/client/r0/login", params)
        return channel

...
from chat.handlers.sso import MappingException
from chat.server import HomeServer
from chat.types import UserID
from chat.util.macaroons import get_value_from_macaroon
...
BASE_URL = "https://chat/"
CALLBACK_URL = BASE_URL + "_chat/client/oidc/callback"
SCOPES = ["openid"]
...
class OidcHandlerTestCase(HomeserverTestCase):
    ...
    def make_homeserver(self, reactor, clock):
        ...
        self.http_client.user_agent = "Chat Test"
    ...
    def test_redirect_request(self):
        ...
        self.assertIn(b"Path=/_chat/client/oidc", parts)
    ...
    def test_callback(self):
        ...
        from chat.handlers.oidc import OidcError
    ...
    def _generate_oidc_session_token(
        ...
        from chat.handlers.oidc import OidcSessionData

...
from chat.storage import prepare_database
...
class CleanupExtremDummyEventsTestCase(HomeserverTestCase):
    ...
    @patch("chat.handlers.message._DUMMY_EVENT_ROOM_EXCLUSION_EXPIRY", new=0)
    ...
    @patch("chat.handlers.message._DUMMY_EVENT_ROOM_EXCLUSION_EXPIRY", new=250)

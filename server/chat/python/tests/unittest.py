...
from chat.config.ratelimiting import FederationRateLimitConfig
from chat.federation.transport import server as federation_server
from chat.http.server import JsonResource
from chat.http.site import SynapseRequest, SynapseSite
...
from chat.types import UserID, create_requester
...
def logcontext_clean(target):
    ...
    patcher = patch("chat.logging.context.logcontext_error", new=logcontext_error)
    ...
    * On a per-test basis, you can use the @override_config decorator to give a
    ...
    def setUp(self):
        ...
        self.site = SynapseSite(
            logger_name="chat.access.http.fake",
    ...
    def make_homeserver(self, reactor, clock):
        ...
        Args:
            ...
            clock (chat.util.Clock): The Clock, associated with the reactor.

        Returns:
            A homeserver (chat.server.HomeServer) suitable for testing.
    ...
    def create_resource_dict(self) -> Dict[str, Resource]:
        ...
        return {
            "/chat/client": servlet_resource,
            "/_chat/admin": servlet_resource,
        }
    ...
    def prepare(self, reactor, clock, homeserver):
        ...
        Args:
            reactor: A Twisted Reactor, or something that pretends to be one.
            clock (chat.util.Clock): The Clock, associated with the reactor.
            homeserver (chat.server.HomeServer): The HomeServer to test
            against.
    ...
    def register_user(
        ...
        # Create the user
        channel = self.make_request("GET", "/_chat/admin/v1/register")
        ...
        channel = self.make_request(
            "POST", "/_chat/admin/v1/register", body.encode("utf8")
        )
    ...
    def attempt_wrong_password_login(self, username, password):
        ...
        channel = self.make_request(
            "POST", "/chat/client/r0/login", json.dumps(body).encode("utf8")
        )
...
class FederatingHomeserverTestCase(HomeserverTestCase):
    ...
    def create_resource_dict(self) -> Dict[str, Resource]:
        ...
        d["/chat/federation"] = TestTransportLayerServer(self.hs)
        return d

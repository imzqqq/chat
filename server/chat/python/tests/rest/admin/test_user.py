...
from chat.api.constants import UserTypes
from chat.api.errors import Codes, HttpResponseException, ResourceLimitError
from chat.api.room_versions import RoomVersions
from chat.rest.client import devices, login, logout, profile, room, sync
from chat.rest.media.v1.filepath import MediaFilePaths
...
class UserRegisterTestCase(unittest.HomeserverTestCase):
    ...
    servlets = [
        chat.rest.admin.register_servlets_for_client_rest_resource,
        profile.register_servlets,
    ]

    def make_homeserver(self, reactor, clock):

        self.url = "/_chat/admin/v1/register"
    ...
    def test_missing_parts(self):
        """
        Chat will complain if you don't give nonce, username, password, and
...
class DeactivateAccountTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url_other_user = "/_chat/admin/v2/users/%s" % urllib.parse.quote(
            self.other_user
        )
        self.url = "/_chat/admin/v1/deactivate/%s" % urllib.parse.quote(
            self.other_user
        )
    ...
    def test_requester_is_not_admin(self):
        ...
        If the user is not a server admin, an error is returned.
        """
        url = "/_chat/admin/v1/deactivate/@bob:test"
    ...
    def test_user_does_not_exist(self):
        ...
        channel = self.make_request(
            "POST",
            "/_chat/admin/v1/deactivate/@unknown_person:test",
            access_token=self.admin_user_tok,
        )
    ...
    def test_user_is_not_local(self):
        ...
        """
        url = "/_chat/admin/v1/deactivate/@unknown_person:unknown_domain"
...
class UserRestTestCase(unittest.HomeserverTestCase):
    ...
    def test_requester_is_no_admin(self):
        ...
        If the user is not a server admin, an error is returned.
        """
        url = "/_chat/admin/v2/users/@bob:test"
    ...
    def test_user_does_not_exist(self):
        ...
        channel = self.make_request(
            "GET",
            "/_chat/admin/v2/users/@unknown_person:test",
            access_token=self.admin_user_tok,
        )
    ...
    def _deactivate_user(self, user_id: str) -> None:
        ...
        channel = self.make_request(
            "PUT",
            "/_chat/admin/v2/users/%s" % urllib.parse.quote(user_id),
            access_token=self.admin_user_tok,
            content={"deactivated": True},
        )
        self.assertEqual(200, channel.code, msg=channel.json_body)
...
class UserMembershipRestTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_chat/admin/v1/users/%s/joined_rooms" % urllib.parse.quote(
            self.other_user
        )
    ...
    def test_user_does_not_exist(self):
        ...
        """
        url = "/_chat/admin/v1/users/@unknown_person:test/joined_rooms"
        channel = self.make_request(
            "GET",
            url,
            access_token=self.admin_user_tok,
    ...
    def test_user_is_not_local(self):
        ...
        """
        url = "/_chat/admin/v1/users/@unknown_person:unknown_domain/joined_rooms"
    ...
    def test_get_rooms_with_nonlocal_user(self):
        ...
        # Now get rooms
        url = "/_chat/admin/v1/users/@joiner:remote_hs/joined_rooms"
        channel = self.make_request(
            "GET",
            url,
            access_token=self.admin_user_tok,
...
class PushersRestTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.other_user = self.register_user("user", "pass")
        self.url = "/_chat/admin/v1/users/%s/pushers" % urllib.parse.quote(
            self.other_user
        )
    ...
    def test_user_does_not_exist(self):
        ...
        Tests that a lookup for a user that does not exist returns a 404
        """
        url = "/_chat/admin/v1/users/@unknown_person:test/pushers"
        channel = self.make_request(
            "GET",
            url,
            access_token=self.admin_user_tok,
    ...
    def test_user_is_not_local(self):
        ...
        """
        url = "/_chat/admin/v1/users/@unknown_person:unknown_domain/pushers"
    ...
    def test_get_pushers(self):
        ...
        self.get_success(
            self.hs.get_pusherpool().add_pusher(
                ...
                lang=None,
                data={"url": "https://example.com/chat/push/v1/notify"},
            )
        )
...
class UserMediaRestTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.other_user = self.register_user("user", "pass")
        self.url = "/_chat/admin/v1/users/%s/media" % urllib.parse.quote(
            self.other_user
        )
    ...
    def test_user_does_not_exist(self, method: str):
        """Tests that a lookup for a user that does not exist returns a 404"""
        url = "/_chat/admin/v1/users/@unknown_person:test/media"
        channel = self.make_request(
            method,
            url,
            access_token=self.admin_user_tok,
    ...
    def test_user_is_not_local(self, method: str):
        """Tests that a lookup for a user that is not a local returns a 400"""
        url = "/_chat/admin/v1/users/@unknown_person:unknown_domain/media"
...
class UserTokenRestTestCase(unittest.HomeserverTestCase):
    """Test for /_chat/admin/v1/users/<user>/login"""
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_chat/admin/v1/users/%s/login" % urllib.parse.quote(
            self.other_user
        )
...
class WhoisRestTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.other_user = self.register_user("user", "pass")
        self.url1 = "/_chat/admin/v1/whois/%s" % urllib.parse.quote(self.other_user)
        self.url2 = "/chat/client/r0/admin/whois/%s" % urllib.parse.quote(
            self.other_user
        )
    ...
    def test_user_is_not_local(self):
        ...
        Tests that a lookup for a user that is not a local returns a 400
        """
        url1 = "/_chat/admin/v1/whois/@unknown_person:unknown_domain"
        url2 = "/chat/client/r0/admin/whois/@unknown_person:unknown_domain"
...
class ShadowBanRestTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_chat/admin/v1/users/%s/shadow_ban" % urllib.parse.quote(
            self.other_user
        )
    ...
    def test_user_is_not_local(self):
        ...
        """
        url = "/_chat/admin/v1/whois/@unknown_person:unknown_domain"
...
class RateLimitTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.other_user = self.register_user("user", "pass")
        self.url = (
            "/_chat/admin/v1/users/%s/override_ratelimit"
    ...
    def test_user_does_not_exist(self):
        ...
        Tests that a lookup for a user that does not exist returns a 404
        """
        url = "/_chat/admin/v1/users/@unknown_person:test/override_ratelimit"
    ...
    def test_user_is_not_local(self):
        ...
        """
        url = (
            "/_chat/admin/v1/users/@unknown_person:unknown_domain/override_ratelimit"
        )

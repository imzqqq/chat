...
class DeviceRestTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_chat/admin/v2/users/%s/devices/%s" % (
    ...
    def test_user_does_not_exist(self):
        ...
        """
        url = (
            "/_chat/admin/v2/users/@unknown_person:test/devices/%s"
            % self.other_user_device_id
        )
    ...
    def test_user_is_not_local(self):
        ...
        """
        url = (
            "/_chat/admin/v2/users/@unknown_person:unknown_domain/devices/%s"
            % self.other_user_device_id
        )
    ...
    def test_unknown_device(self):
        ...
        """
        url = "/_chat/admin/v2/users/%s/devices/unknown_device" % urllib.parse.quote(
            self.other_user
        )
    ...
    def test_update_device_too_long_display_name(self):
        ...
        update = {
            "display_name": "a"
            * (chat.handlers.device.MAX_DEVICE_DISPLAY_NAME_LEN + 1)
        }
...
class DevicesRestTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_chat/admin/v2/users/%s/devices" % urllib.parse.quote(
            self.other_user
        )
    ...
    def test_user_does_not_exist(self):
        ...
        Tests that a lookup for a user that does not exist returns a 404
        """
        url = "/_chat/admin/v2/users/@unknown_person:test/devices"
        channel = self.make_request(
            "GET",
            url,
            access_token=self.admin_user_tok,
    ...
    def test_user_is_not_local(self):
        ...
        Tests that a lookup for a user that is not a local returns a 400
        """
        url = "/_chat/admin/v2/users/@unknown_person:unknown_domain/devices"
...
class DeleteDevicesRestTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_chat/admin/v2/users/%s/delete_devices" % urllib.parse.quote(
            self.other_user
        )
    ...
    def test_user_does_not_exist(self):
        ...
        Tests that a lookup for a user that does not exist returns a 404
        """
        url = "/_chat/admin/v2/users/@unknown_person:test/delete_devices"
        channel = self.make_request(
            "POST",
            url,
            access_token=self.admin_user_tok,
    ...
    def test_user_is_not_local(self):
        ...
        Tests that a lookup for a user that is not a local returns a 400
        """
        url = "/_chat/admin/v2/users/@unknown_person:unknown_domain/delete_devices"

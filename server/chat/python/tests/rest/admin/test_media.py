...
from chat.rest.client import login, profile, room
...
class DeleteMediaByIDTestCase(unittest.HomeserverTestCase):
    ...
    def test_no_auth(self):
        ...
        """
        url = "/_chat/admin/v1/media/%s/%s" % (self.server_name, "12345")
    ...
    def test_media_is_not_local(self):
        ...
        """
        url = "/_chat/admin/v1/media/%s/%s" % ("unknown_domain", "12345")
    ...
    def test_delete_media(self):
        ...
        url = "/_chat/admin/v1/media/%s/%s" % (self.server_name, media_id)
...
class DeleteMediaByDateSizeTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.filepaths = MediaFilePaths(hs.config.media_store_path)
        self.url = "/_chat/admin/v1/media/%s/delete" % self.server_name
    ...
    def test_media_is_not_local(self):
        ...
        """
        url = "/_chat/admin/v1/media/%s/delete" % "unknown_domain"
...
class QuarantineMediaByIDTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_chat/admin/v1/media/%s/%s/%s"
...
class ProtectMediaByIDTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_chat/admin/v1/media/%s/%s"

...
from chat.rest.client import login, report_event, room
...
class EventReportsTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_chat/admin/v1/event_reports"
...
class EventReportDetailTestCase(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        ...
        self.url = "/_chat/admin/v1/event_reports/2"
    ...
    def test_invalid_report_id(self):
        ...
        channel = self.make_request(
            "GET",
            "/_chat/admin/v1/event_reports/-123",
            access_token=self.admin_user_tok,
        )
        ...
        channel = self.make_request(
            "GET",
            "/_chat/admin/v1/event_reports/abcdef",
            access_token=self.admin_user_tok,
        )

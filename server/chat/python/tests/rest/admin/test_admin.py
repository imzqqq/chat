...
from chat.rest.admin import VersionServlet
from chat.rest.client import groups, login, room
...
class VersionTestCase(unittest.HomeserverTestCase):
    url = "/_chat/admin/v1/server_version"
...
class DeleteGroupTestCase(unittest.HomeserverTestCase):
    ...
    def test_delete_group(self):
        ...
        url = "/_chat/admin/v1/delete_group/" + group_id
        channel = self.make_request(
            "POST",
            url.encode("ascii"),
            access_token=self.admin_user_tok,
...
class QuarantineMediaTestCase(unittest.HomeserverTestCase):
    ...
    servlets = [
        ...
        chat.rest.admin.register_servlets_for_media_repo,
        login.register_servlets,
    ...
    def make_homeserver(self, reactor, clock):
        ...
        provider_config = {
            "module": "chat.rest.media.v1.storage_provider.FileStorageProviderBackend",
            "store_local": True,
    ...
    def test_quarantine_media_requires_admin(self):
        ...
        url = "/_chat/admin/v1/media/quarantine/example.org/abcde12345"
        channel = self.make_request(
            "POST",
            url.encode("ascii"),
        ...
        url = "/_chat/admin/v1/room/!room%3Aexample.com/media/quarantine"
        channel = self.make_request(
            "POST",
            url.encode("ascii"),
            access_token=non_admin_user_tok,
    ...
    def test_quarantine_media_by_id(self):
        ...
        url = "/_chat/admin/v1/media/quarantine/%s/%s" % (
    ...
    def test_quarantine_all_media_in_room(self, override_url_template=None):
        ...
        if override_url_template:
            ...
            url = "/_chat/admin/v1/room/%s/media/quarantine" % urllib.parse.quote(
                room_id
            )
        channel = self.make_request(
            "POST",
    ...
    def test_quarantine_all_media_in_room_deprecated_api_path(self):
        ...
        self.test_quarantine_all_media_in_room("/_chat/admin/v1/quarantine_media/%s")
    ...
    def test_quarantine_all_media_by_user(self):
        ...
        url = "/_chat/admin/v1/user/%s/media/quarantine" % urllib.parse.quote(
            non_admin_user
        )
        channel = self.make_request(
            "POST",
    ...
    def test_cannot_quarantine_safe_media(self):
        ...
        # Quarantine the media
        url = "/_chat/admin/v1/media/protect/%s" % (urllib.parse.quote(media_id_2),)

...
from chat.rest.media.v1._base import FileInfo
from chat.rest.media.v1.filepath import MediaFilePaths
from chat.rest.media.v1.media_storage import MediaStorage
from chat.rest.media.v1.storage_provider import FileStorageProviderBackend
...
class MediaStorageTests(unittest.HomeserverTestCase):
    ...
    def prepare(self, reactor, clock, hs):
        self.test_dir = tempfile.mkdtemp(prefix="chat-tests-")
...
class MediaRepoTests(unittest.HomeserverTestCase):
    ...
    def _req(self, content_disposition):
        ...
        self.assertEqual(
            self.fetches[0][2], "/chat/media/r0/download/" + self.media_id
        )
    ...
    def test_disposition_filename_ascii(self):
        """
        If the filename is filename=<ascii> then Chat will decode it as an
    ...
    def test_disposition_filenamestar_utf8escaped(self):
        """
        If the filename is filename=*utf8''<utf8 escaped> then Chat will
    ...
    def test_thumbnail_repeated_thumbnail(self):
        ...
        # Chat should regenerate missing thumbnails.

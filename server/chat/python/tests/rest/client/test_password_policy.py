...
from chat.rest.client import account, login, password_policy, register
...
class PasswordPolicyTestCase(unittest.HomeserverTestCase):
    ...
    When validating a password, Chat server does the necessary checks in this order:
    ...
    def make_homeserver(self, reactor, clock):
        self.register_url = "/chat/client/r0/register"
        self.policy = {
            "enabled": True,
            "minimum_length": 10,
            "require_digit": True,
    ...
    def test_get_policy(self):
        ...
        channel = self.make_request("GET", "/chat/client/r0/password_policy")
    ...
    def test_password_change(self):
        ...
        channel = self.make_request(
            "POST",
            "/chat/client/r0/account/password",
            request_data,
            access_token=tok,
        )

...
from chat.rest.client import account, account_validity, login, logout, register, sync
...
class RegisterRestServletTestCase(unittest.HomeserverTestCase):
    ...
    def test_POST_registration_requires_token(self):
        ...
        # Chat adds a dummy stage to differentiate flows where otherwise one
...
class AccountValidityTestCase(unittest.HomeserverTestCase):
    ...
    def test_manual_renewal(self):
        ...
        url = "/_chat/admin/v1/account_validity/validity"
...
class AccountValidityRenewalByEmailTestCase(unittest.HomeserverTestCase):
    ...
    def make_homeserver(self, reactor, clock):
        ...
        config["email"] = {
            ...
            "template_dir": os.path.abspath(
                pkg_resources.resource_filename("chat", "res/templates")
            ),
    ...
    def test_renewal_email(self):
        ...
        url = "/chat/client/unstable/account_validity/renew?token=%s" % renewal_token
    ...
    def test_renewal_invalid_token(self):
        ...
        url = "/chat/client/unstable/account_validity/renew?token=123"
        channel = self.make_request(b"GET", url)
    ...
    def test_manual_email_send(self):
        ...
        channel = self.make_request(
            b"POST",
            "/chat/client/unstable/account_validity/send_mail",
            access_token=tok,
        )
        self.assertEquals(channel.result["code"], b"200", channel.result)
...
class AccountValidityBackgroundJobTestCase(unittest.HomeserverTestCase):
    ...
    servlets = [chat.rest.admin.register_servlets_for_client_rest_resource]
    ...
    def make_homeserver(self, reactor, clock):
        ...
        # Chat when account_validity.enabled is False.
...
class RegistrationTokenValidityRestServletTestCase(unittest.HomeserverTestCase):
    ...
    url = "/chat/client/unstable/org.matrix.msc3231/register/org.matrix.msc3231.login.registration_token/validity"

...
from chat.api.constants import EventTypes, RelationTypes
from chat.rest import admin
from chat.rest.client import login, register, relations, room
...
class RelationsTestCase(unittest.HomeserverTestCase):
    ...
    def test_basic_paginate_relations(self):
        ...
        channel = self.make_request(
            "GET",
            "/chat/client/unstable/rooms/%s/relations/%s?limit=1"
    ...
    def test_repeated_paginate_relations(self):
        ...
        for _ in range(20):
            ...
            channel = self.make_request(
                "GET",
                "/chat/client/unstable/rooms/%s/relations/%s?limit=1%s"
    ...
    def test_aggregation_pagination_groups(self):
        ...
        for _ in range(20):
            ...
            channel = self.make_request(
                "GET",
                "/chat/client/unstable/rooms/%s/aggregations/%s?limit=1%s"
                % (self.room, self.parent_id, from_token),
                access_token=self.user_token,
            )
            self.assertEquals(200, channel.code, channel.json_body)
    ...
    def test_aggregation(self):
        ...
        channel = self.make_request(
            "GET",
            "/chat/client/unstable/rooms/%s/aggregations/%s"
            % (self.room, self.parent_id),
            access_token=self.user_token,
        )
        self.assertEquals(200, channel.code, channel.json_body)
    ...
    def test_aggregation_redactions(self):
        ...
        channel = self.make_request(
            "POST",
            "/chat/client/r0/rooms/%s/redact/%s" % (self.room, to_redact_event_id),
            access_token=self.user_token,
            content={},
        )
        self.assertEquals(200, channel.code, channel.json_body)
    ...
    def test_aggregation_must_be_annotation(self):
        ...
        channel = self.make_request(
            "GET",
            "/chat/client/unstable/rooms/%s/aggregations/%s/%s?limit=1"
    ...
    def test_relations_redaction_redacts_edits(self):
        ...
        channel = self.make_request(
            "GET",
            "/chat/client/unstable/rooms/%s/relations/%s/m.replace/m.room.message"
    ...
    def test_aggregations_redaction_prevents_access_to_aggregations(self):
        ...
        channel = self.make_request(
            "GET",
            "/chat/client/unstable/rooms/%s/aggregations/%s/m.annotation/m.reaction"
            % (self.room, original_event_id),
            access_token=self.user_token,
        )
        self.assertEquals(200, channel.code, channel.json_body)
    ...
    def _send_relation(
        ...
        channel = self.make_request(
            "POST",
            "/chat/client/unstable/rooms/%s/send_relation/%s/%s/%s%s"

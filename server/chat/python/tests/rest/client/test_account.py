...
from chat.api.constants import LoginType, Membership
from chat.api.errors import Codes, HttpResponseException
from chat.appservice import ApplicationService
from chat.rest.client import account, login, register, room
from chat.rest.chat.client.password_reset import PasswordResetSubmitTokenResource
...
class ThreepidEmailRestTestCase(unittest.HomeserverTestCase):
    ...
    def test_add_email_if_disabled(self):
        ...
        channel = self.make_request(
            "POST",
            b"/chat/client/unstable/account/3pid/add",
            {
                "client_secret": client_secret,
                "sid": session_id,
                "auth": {

...
from chat.logging.context import LoggingContext, LoggingContextFilter
...
class TerseJsonTestCase(LoggerCleanupMixin, TestCase):
    ...
    def test_with_request_context(self):
        ...
        with patch.object(Request, "render"):
            request.requestReceived(b"POST", b"/chat/client/versions", b"1.1")
        ...
        self.assertEqual(log["url"], "/chat/client/versions")

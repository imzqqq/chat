...
class SimpleHttpClientTests(HomeserverTestCase):
    ...
    def test_dns_error(self):
        ...
        """
        d = defer.ensureDeferred(self.cl.get_json("http://testserv2:8080/foo/bar"))
        self.pump()
    ...
    def test_client_connection_refused(self):
        d = defer.ensureDeferred(self.cl.get_json("http://testserv:8080/foo/bar"))
    ...
    def test_client_ip_range_blacklist(self):
        ...
        # ------------------------------------------------------
        # Make the request
        d = defer.ensureDeferred(cl.get_json("http://internal:8080/foo/bar"))
        self.pump(1)
        ...
        d = defer.ensureDeferred(
            cl.post_json_get_json("http://internalv6:8080/foo/bar", {})
        )
        ...
        # ----------------------------------------------------------
        # Make the request
        d = defer.ensureDeferred(cl.get_json("http://testserv:8080/foo/bar"))

...
from chat.api.errors import RequestSendFailed
from chat.http.matrixfederationclient import (
    MAX_RESPONSE_SIZE,
    MatrixFederationHttpClient,
    MatrixFederationRequest,
)
from chat.logging.context import SENTINEL_CONTEXT, LoggingContext, current_context
...
class FederationClientTests(HomeserverTestCase):
    ...
    def test_client_get(self):
        ...
        def do_request():
            with LoggingContext("one") as context:
                fetch_d = defer.ensureDeferred(
                    self.cl.get_json("testserv:8080", "foo/bar")
                )
        ...
        self.assertRegex(transport.value(), b"Host: testserv:8080")
    ...
    def test_dns_error(self):
        ...
        d = defer.ensureDeferred(
            self.cl.get_json("testserv2:8080", "foo/bar", timeout=10000)
        )
        self.pump()
    ...
    def test_client_connection_refused(self):
        d = defer.ensureDeferred(
            self.cl.get_json("testserv:8080", "foo/bar", timeout=10000)
        )
    ...
    def test_client_never_connect(self):
        ...
        self.assertEqual(clients[0][1], 8080)
    ...
    def test_client_ip_range_blacklist(self):
        """Ensure that Chat does not try to connect to blacklisted IPs"""
        ...
        # ------------------------------------------------------
        # Make the request
        d = defer.ensureDeferred(cl.get_json("internal:8080", "foo/bar", timeout=10000))
        ...
        # Make the request
        d = defer.ensureDeferred(
            cl.post_json("internalv6:8080", "foo/bar", timeout=10000)
        )
        ...
        # ----------------------------------------------------------
        # Make the request
        d = defer.ensureDeferred(cl.post_json("fine:8080", "foo/bar", timeout=10000))
    ...
    def test_client_gets_headers(self):
        ...
        request = MatrixFederationRequest(
            method="GET", destination="testserv:8080", path="foo/bar"
        )
    ...
    def test_timeout_reading_body(self, method_name: str):
        ...
        d = defer.ensureDeferred(method("testserv:8080", "foo/bar", timeout=10000))
    ...
    def test_client_requires_trailing_slashes(self):
        ...
        trailing slash. Workaround for Chat <= v0.99.3, explained in #3622.
        """
        d = defer.ensureDeferred(
            self.cl.get_json("testserv:8080", "foo/bar", try_trailing_slash_on_400=True)
        )
    ...
    def test_client_sends_body(self):
        defer.ensureDeferred(
            self.cl.post_json(
                "testserv:8080", "foo/bar", timeout=10000, data={"a": "b"}
            )
        )
    ...
    def test_closes_connection(self):
        ...
        d = defer.ensureDeferred(self.cl.get_json("testserv:8080", "foo/bar"))
    ...
    def test_json_error(self, return_value):
        ...
        test_d = defer.ensureDeferred(self.cl.get_json("testserv:8080", "foo/bar"))

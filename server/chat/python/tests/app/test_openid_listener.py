...
from chat.app.homeserver import SynapseHomeServer
...
class FederationReaderOpenIDListenerTests(HomeserverTestCase):
    ...
    def test_openid_listener(self, names, expectation):
        ...
        try:
            site.resource.children[b"chat"].children[b"federation"]
        except KeyError:
        ...
        channel = make_request(
            self.reactor, site, "GET", "/chat/federation/v1/openid/userinfo"
        )

        self.assertEqual(channel.code, 401)


@patch("chat.app.homeserver.KeyApiV2Resource", new=Mock())

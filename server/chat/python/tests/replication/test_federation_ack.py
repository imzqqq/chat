...
from chat.replication.tcp.commands import FederationAckCommand
from chat.replication.tcp.protocol import IReplicationConnection
...
class FederationAckTestCase(HomeserverTestCase):
    def default_config(self) -> dict:
        ...
        config["worker_app"] = "chat.app.federation_sender"
    ...
    def test_federation_ack_sent(self):
        ...
        XXX: it might be nice to do this by pretending to be a chat master worker

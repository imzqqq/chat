...
from chat.app.generic_worker import GenericWorkerServer
from chat.http.server import JsonResource
from chat.http.site import SynapseRequest, SynapseSite
from chat.replication.http import ReplicationRestResource
...
from chat.replication.tcp.resource import (
...
class BaseStreamTestCase(unittest.HomeserverTestCase):
    ...
    def create_resource_dict(self) -> Dict[str, Resource]:
        ...
        d["/_chat/replication"] = ReplicationRestResource(self.hs)
        return d

    def _get_worker_hs_config(self) -> dict:
        config = self.default_config()
        config["worker_app"] = "chat.app.generic_worker"
    ...
    def assert_request_is_get_repl_stream_updates(
        ...
        self.assertRegex(
            path,
            br"^/_chat/replication/get_repl_stream_updates/%s/[^/]+$"
...
class BaseMultiWorkerStreamTestCase(unittest.HomeserverTestCase):
    ...
    def make_worker_hs(
        ...
        Args:
            worker_app: Type of worker, e.g. `chat.app.federation_sender`.

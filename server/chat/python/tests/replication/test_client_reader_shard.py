...
from chat.rest.client import register
...
class ClientReaderTestCase(BaseMultiWorkerStreamTestCase):
    ...
    def _get_worker_hs_config(self) -> dict:
        ...
        config["worker_app"] = "chat.app.client_reader"
    ...
    def test_register_single_worker(self):
        ...
        worker_hs = self.make_worker_hs("chat.app.client_reader")
    ...
    def test_register_multi_worker(self):
        ...
        worker_hs_1 = self.make_worker_hs("chat.app.client_reader")
        worker_hs_2 = self.make_worker_hs("chat.app.client_reader")

...
from chat.events import FrozenEvent, _EventInternalMetadata, make_event_from_dict
from chat.handlers.room import RoomEventSource
from chat.replication.slave.storage.events import SlavedEventStore
from chat.storage.roommember import GetRoomsForUserWithStreamOrdering, RoomsForUser
...
class SlavedEventStoreTestCase(BaseSlavedStoreTestCase):
    ...
    def persist(self, backfill=False, **kwargs):
        """
        Returns:
            chat.events.FrozenEvent: The event that was persisted.
        """

...
/// # `POST /chat/client/r0/publicRooms`
///
...
#[cfg_attr(
    feature = "conduit_bin",
    post("/chat/client/r0/publicRooms", data = "<body>")
)]
...
/// # `GET /chat/client/r0/publicRooms`
///
/// Lists the public rooms on this server.
///
/// - Rooms are ordered by the number of joined members
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/publicRooms", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
/// # `PUT /chat/client/r0/directory/list/room/{roomId}`
///
...
#[cfg_attr(
    feature = "conduit_bin",
    put("/chat/client/r0/directory/list/room/<_>", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
/// # `GET /chat/client/r0/directory/list/room/{roomId}`
///
/// Gets the visibility of a given room in the room directory.
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/directory/list/room/<_>", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]

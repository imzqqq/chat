...
/// # `GET /chat/client/r0/login`
///
/// Get the supported login types of this server. One of these should be used as the `type` field
/// when logging in.
#[cfg_attr(feature = "conduit_bin", get("/chat/client/r0/login"))]
#[tracing::instrument]
...
///
/// Note: You can use [`GET /chat/client/r0/login`](fn.get_supported_versions_route.html) to see
/// supported login types.
#[cfg_attr(
    feature = "conduit_bin",
    post("/chat/client/r0/login", data = "<body>")
)]
...
#[cfg_attr(
    feature = "conduit_bin",
    post("/chat/client/r0/logout", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
/// # `POST /chat/client/r0/logout/all`
///
...
/// - Triggers device list updates
///
/// Note: This is equivalent to calling [`GET /chat/client/r0/logout`](fn.logout_route.html)
/// from each device of this user.
#[cfg_attr(
    feature = "conduit_bin",
    post("/chat/client/r0/logout/all", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]

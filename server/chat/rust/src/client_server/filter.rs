...
/// # `GET /chat/client/r0/user/{userId}/filter/{filterId}`
///
/// TODO: Loads a filter that was previously created.
#[cfg_attr(feature = "conduit_bin", get("/chat/client/r0/user/<_>/filter/<_>"))]
#[tracing::instrument]
...
/// # `PUT /chat/client/r0/user/{userId}/filter`
///
/// TODO: Creates a new filter to be used by other endpoints.
#[cfg_attr(feature = "conduit_bin", post("/chat/client/r0/user/<_>/filter"))]
#[tracing::instrument]

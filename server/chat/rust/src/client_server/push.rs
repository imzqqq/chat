...
/// # `GET /chat/client/r0/pushrules`
///
/// Retrieves the push rules event for this user.
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/pushrules", data = "<body>")
)]
...
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/pushrules/<_>/<_>/<_>", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
#[cfg_attr(
    feature = "conduit_bin",
    put("/chat/client/r0/pushrules/<_>/<_>/<_>", data = "<req>")
)]
...
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/pushrules/<_>/<_>/<_>/actions", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
#[cfg_attr(
    feature = "conduit_bin",
    put("/chat/client/r0/pushrules/<_>/<_>/<_>/actions", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/pushrules/<_>/<_>/<_>/enabled", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
#[cfg_attr(
    feature = "conduit_bin",
    put("/chat/client/r0/pushrules/<_>/<_>/<_>/enabled", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
#[cfg_attr(
    feature = "conduit_bin",
    delete("/chat/client/r0/pushrules/<_>/<_>/<_>", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
/// # `GET /chat/client/r0/pushers`
///
/// Gets all currently active pushers for the sender user.
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/pushers", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
/// # `POST /chat/client/r0/pushers/set`
///
...
#[cfg_attr(
    feature = "conduit_bin",
    post("/chat/client/r0/pushers/set", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]

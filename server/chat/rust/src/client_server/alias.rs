...
/// # `PUT /chat/client/r0/directory/room/{roomAlias}`
///
/// Creates a new room alias on this server.
#[cfg_attr(
    feature = "conduit_bin",
    put("/chat/client/r0/directory/room/<_>", data = "<body>")
)]
...
/// # `DELETE /chat/client/r0/directory/room/{roomAlias}`
///
...
#[cfg_attr(
    feature = "conduit_bin",
    delete("/chat/client/r0/directory/room/<_>", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
/// # `GET /chat/client/r0/directory/room/{roomAlias}`
///
...
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/directory/room/<_>", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]

...
/// # `POST /chat/client/r0/createRoom`
///
/// Creates a new room.
///
...
#[cfg_attr(
    feature = "conduit_bin",
    post("/chat/client/r0/createRoom", data = "<body>")
)]
...
/// # `GET /chat/client/r0/rooms/{roomId}/event/{eventId}`
///
/// Gets a single event.
///
...
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/rooms/<_>/event/<_>", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
/// # `GET /chat/client/r0/rooms/{roomId}/aliases`
///
...
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/rooms/<_>/aliases", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]
...
#[cfg_attr(
    feature = "conduit_bin",
    post("/chat/client/r0/rooms/<_>/upgrade", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]

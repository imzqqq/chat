...
/// # `PUT /chat/client/r0/presence/{userId}/status`
///
/// Sets the presence state of the sender user.
#[cfg_attr(
    feature = "conduit_bin",
    put("/chat/client/r0/presence/<_>/status", data = "<body>")
)]
...
/// # `GET /chat/client/r0/presence/{userId}/status`
///
...
#[cfg_attr(
    feature = "conduit_bin",
    get("/chat/client/r0/presence/<_>/status", data = "<body>")
)]
#[tracing::instrument(skip(db, body))]

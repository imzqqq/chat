...
ProxyPass /chat/ http://127.0.0.1:6167/chat/ nocanon
ProxyPassReverse /chat/ http://127.0.0.1:6167/chat/
...
```bash
$ curl https://your.server.name/chat/client/versions
$ curl https://your.server.name:8448/chat/client/versions
```

...
describe('handlers', () => {
    ...
    describe('GET /chat/media_proxy/unstable/download/matrix.org/EawFuailhYTuSPSGDGsNFigt', () => {
        beforeEach(() => {
            clearReportCache();
        });
        ...
        it('responds with the expected Content-Type header', async () => {
            ...
            return request(app)
                .get('/chat/media_proxy/unstable/download/matrix.org/EawFuailhYTuSPSGDGsNFigt')
                .expect('Content-Type', /png/)
                .expect(200);
        });
    });

    describe('GET /chat/media_proxy/unstable/scan/matrix.org/EawFuailhYTuSPSGDGsNFigt', () => {
        beforeEach(() => {
            clearReportCache();
        });
        ...
        it('responds with the requested scan (when the file has not been scanned before)', async () => {
            const app = await createApp();
            return request(app)
                .get('/chat/media_proxy/unstable/scan/matrix.org/EawFuailhYTuSPSGDGsNFigt')
    ...
    describe('GET /chat/media_proxy/unstable/thumbnail/matrix.org/EawFuailhYTuSPSGDGsNFigt?width=100&height=100&method=scale', () => {
        beforeEach(() => {
            clearReportCache();
        });
        ...
        it('responds with the requested thumbnail (when the file has not been scanned before)', async () => {
            const app = await createApp();
            return request(app)
                .get('/chat/media_proxy/unstable/thumbnail/matrix.org/EawFuailhYTuSPSGDGsNFigt?width=100&height=100&method=scale')
                .expect('Content-Type', /png/)
                .expect(200);
        });
    });

    describe('GET /chat/media_proxy/unstable/public_key', () => {
        it('responds with a public key', async () => {
            const app = await createApp();
            return request(app)
                .get('/chat/media_proxy/unstable/public_key')
                .expect('Content-Type', /json/)
                .expect(200)
                .then(response => {
    ...
    describe('POST /chat/media_proxy/unstable/scan_encrypted', () => {
        it('responds with a scan report if `encrypted_body` is given', async () => {
            ...
            return request(app)
                .post('/chat/media_proxy/unstable/scan_encrypted')
